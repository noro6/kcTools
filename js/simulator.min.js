...
Math.floor(this.manualCorr*b);this.defense2AirPower=Math.floor(this.rocketBonus*b);switch(c){case 0:this.superDefenseCorrB=0;break;case 1:this.superDefenseCorrB=.11;break;case 2:this.superDefenseCorrB=.14;break;default:this.superDefenseCorrB=.287}switch(d){case 0:this.superDefenseCorrC=0;break;case 1:this.superDefenseCorrC=.177;break;case 2:this.superDefenseCorrC=.287;break;default:this.superDefenseCorrC=.287}switch(a){case 0:this.superRocketCorr1=1;this.superRocketCorr2=.3;break;case 1:this.superRocketCorr1=
1;this.superRocketCorr2=.55;break;case 2:this.superRocketCorr1=1;this.superRocketCorr2=.85;break;case 3:this.superRocketCorr2=this.superRocketCorr1=1;break;default:this.superRocketCorr1=1,this.superRocketCorr2=1.07}this.sumSuperCorr=(this.superDefenseCorrA+this.superDefenseCorrB+this.superDefenseCorrC)*this.superRocketCorr1+this.superRocketCorr2;this.fullDefense3AirPower=this.defense3AirPower=Math.floor(b*this.sumSuperCorr)};
