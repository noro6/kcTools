...
l=h.airPower;h.updateAirPower();a.airPower-=l-h.airPower;a.unionAirPower-=l-h.airPower;0>a.airPower&&(a.airPower=0);0>a.unionAirPower&&(a.unionAirPower=0)}}}return d}
...
function showEnemyStatusToolTip(a){if(a.length&&a[0].dataset.enemyid){var b=ENEMY_DATA.find(function(k){return k.id===castInt(a[0].dataset.enemyid)});if(b){for(var c=new Enemy(b.id),d="",e=0,f={},g=0;g<b.eqp.length;f={$jscomp$loop$prop$itemId$398:f.$jscomp$loop$prop$itemId$398},g++){f.$jscomp$loop$prop$itemId$398=b.eqp[g];var h=b.slot[g],l=ENEMY_ITEM.find(function(k){return function(m){return m.id===k.$jscomp$loop$prop$itemId$398}}(f));l&&(e+=l.armor,d+='\n\t\t\t<div class="d-flex">\n\t\t\t\t<div class="align-self-center enemy_tool_slot">'+
