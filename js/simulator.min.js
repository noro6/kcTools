...
'<span class="font_size_12">'+D.remarks+"</span>";z.appendChild(A);A=!0;break}if(v&&!A)continue}A=document.createElement("div");A.className="pl-1 d-flex align-self-center flex-grow-1";B=!1;16===w.$jscomp$loop$prop$item$299.itype&&8<=w.$jscomp$loop$prop$item$299.antiAir?B=!0:21===w.$jscomp$loop$prop$item$299.type&&9<=w.$jscomp$loop$prop$item$299.antiAir?B=!0:ROCKETS.includes(w.$jscomp$loop$prop$item$299.id)?B=!0:TAICHI.includes(w.$jscomp$loop$prop$item$299.id)&&(B=!0);D=document.createElement("div");
...
k.items.some(function(r){return 61===r.id})&&([353,354].includes(k.id)&&2>k.range&&(k.range=2),1>k.range&&(k.range+=1),k.range+=1);k.updateEquipmentBonusScout()}}c.updateAirPower();c.initFullAirPower();c.updateStage2All();c.updateScoutScores();c.updateBonusTorpedo();return c}
