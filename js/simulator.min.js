...
"";this.specialInfo=[];this.enabled=!1};SpecialOperator.prototype.update=function(a){this.selectedMode=a;this.specialInfo=[];this.enabled=!1;var b=SPECIAL_DATA.find(function(d){return d.mode===a});if(b){this.enabled=!0;b=$jscomp.makeIterator(b.special);for(var c=b.next();!c.done;c=b.next())c=c.value,this.specialInfo.push(new SpecialItemInfo(c.name,c.remarks,c.items))}};
...
$("#main");var g=[];d=[];var h=[];f=$("#main_header_info");e=$("#footer_info");c.find(".contents").each(function(m,n){g.push($(n).attr("id"));h.push($(n))});c.empty();c.append(f);var l={},k=$jscomp.makeIterator(setting.contentsOrder);for(f=k.next();!f.done;l={$jscomp$loop$prop$id$163$296:l.$jscomp$loop$prop$id$163$296},f=k.next())l.$jscomp$loop$prop$id$163$296=f.value,g.includes(l.$jscomp$loop$prop$id$163$296)&&(f=h.find(function(m){return function(n){return n.attr("id")===m.$jscomp$loop$prop$id$163$296}}(l)),
c.append(f),d.push(l.$jscomp$loop$prop$id$163$296));c.append(e);if(g.length!==d.length){e={};l=$jscomp.makeIterator(g);for(f=l.next();!f.done;e={$jscomp$loop$prop$id$164$298:e.$jscomp$loop$prop$id$164$298},f=l.next())e.$jscomp$loop$prop$id$164$298=f.value,d.includes(e.$jscomp$loop$prop$id$164$298)||(f=h.find(function(m){return function(n){return n.attr("id")===m.$jscomp$loop$prop$id$164$298}}(e)),c.append(f),d.push(e.$jscomp$loop$prop$id$164$298));setting.contentsOrder=d.concat();saveSetting()}}$("#stage2_detail_slot").val(18);
...
function setPlaneTypeIconSelect(a,b){a.innerHTML=(void 0===b?0:b)?"":'\n\t\t<div class="general_tr item_type active p-2" data-type="0">\n\t\t\t<img src="../img/type/all.png" class="img-size-32" alt="\u5168\u3066">\n\t\t</div>';for(var c=document.createDocumentFragment(),d={},e=$jscomp.makeIterator([6,7,8,9,57,10,45,41,1,2,3,4,5,12,14,21,24,47,48,49,17]),f=e.next();!f.done;d={$jscomp$loop$prop$typeId$300:d.$jscomp$loop$prop$typeId$300},f=e.next()){d.$jscomp$loop$prop$typeId$300=f.value;f=ITEM_API_TYPE.find(function(k){return function(m){return m.id===
k.$jscomp$loop$prop$typeId$300}}(d));var g=document.createElement("div");g.className="general_tr item_type p-2";g.dataset.type=f.id;var h=f.name;switch(d.$jscomp$loop$prop$typeId$300){case 10:h="\u6c34\u4e0a\u5075\u5bdf\u6a5f / \u6c34\u4e0a\u7206\u6483\u6a5f";break;case 12:h="\u96fb\u63a2";break;case 14:h="\u5bfe\u6f5c\u88c5\u5099";break;case 24:h="\u8f38\u9001 / \u4e0a\u9678\u7528\u5175\u88c5";break;case 48:h="\u5c40\u5730\u6226\u95d8\u6a5f / \u9678\u8ecd\u6226\u95d8\u6a5f";break;case 17:h="\u305d\u306e\u4ed6"}var l=
...
10))):(e.addClass("remodel_disabled"),e.find(".remodel_value").text(0));e=a.find(".item_special");e.addClass("d-none");if(specialOperator.enabled)for(var f=$jscomp.makeIterator(specialOperator.specialInfo),g=f.next();!g.done;g=f.next())if(g=g.value,g.items.includes(d.id)){e.removeClass("d-none");e.html(g.name+'<span class="font_size_12">'+g.remarks+"</span>");break}e=0;if(f=setting.defaultProf.find(function(h){return h.id===d.type}))e=f.prof;312===d.id&&(e=2);0<=b.prof&&(e=b.prof);f=a.find(".prof_select");
f.attr("src","../img/util/prof"+e+".png");f[0].dataset.prof=e;c&&(b.hasOwnProperty("slot")||(b.slot=0),a.find(".slot").text(b.slot));return!0}
...
[14,15].includes(b)?t=["asw","fire","accuracy","avoid2","armor"]:[5,22,32].includes(b)?t=["torpedo","fire","accuracy","avoid2","armor"]:21===b?t=["antiAir","antiAirWeight","antiAirBonus","fire","torpedo"]:LB_ATTACKERS.includes(b)?t=["antiAir","radius","torpedo","avoid","cost"]:48===b&&(t=["antiAir","radius","battleAntiAir","defenseAntiAir","cost"]);$target&&!$target.hasClass("ship_plane")&&(t[1]="radius",t[4]="cost",0===b&&(t=["antiAir","radius","battleAntiAir","cost","avoid"]));var w=0;$("#plane_table_thead").find(".plane_td_basic").each(function(M,
K){$(K).text(convertHeaderText(t[w]));$(K)[0].dataset.sortkey=t[w++];q===$(K)[0].dataset.sortkey?$(K).addClass("active"):$(K).removeClass("active")});"multi"===g?(c.addClass("modal-xl"),c.removeClass("modal-lg"),d.addClass("multi_mode"),c.find(".scroll_thead").addClass("d-none").removeClass("d-flex")):(c.addClass("modal-lg"),c.removeClass("modal-xl"),d.removeClass("multi_mode"),c.find(".scroll_thead").addClass("d-flex").removeClass("d-none"));l?($("#divide_stock").closest("div").removeClass("d-none"),
$("#disp_equipped").closest("div").removeClass("d-none"),$("#disp_in_stock").prop("checked",!0)):($("#divide_stock").closest("div").addClass("d-none"),$("#disp_equipped").closest("div").addClass("d-none"),$("#disp_in_stock").prop("checked",!1));c=a.length;var v=0;d=0;for(var r=-1,x=0,z={},D=0;D<c;z={$jscomp$loop$prop$item$304:z.$jscomp$loop$prop$item$304},D++)if(z.$jscomp$loop$prop$item$304=a[D],!n||setting.favoritePlane.includes(z.$jscomp$loop$prop$item$304.id)){if(l&&h){var y=p.find(function(M){return function(K){return K.id===
M.$jscomp$loop$prop$item$304.id}}(z));if(k){if(-1===z.$jscomp$loop$prop$item$304.stock)continue;r=z.$jscomp$loop$prop$item$304.stock-(y?y.num[z.$jscomp$loop$prop$item$304.remodel]:0);if(!m&&1>r)continue;d=z.$jscomp$loop$prop$item$304.remodel}else{if(0<=z.$jscomp$loop$prop$item$304.stock)continue;var B=h.find(function(M){return function(K){return K.id===M.$jscomp$loop$prop$item$304.id}}(z)),A=y?getArraySum(y.num):0;x=B?getArraySum(B.num):0;if(0===x||!m&&A>=x)continue;r=x-A;for(x=10;0<=x;x--)if(y&&
(B.num[x]-=y.num[x]),0<B.num[x]){d=x;break}}}else if(0<z.$jscomp$loop$prop$item$304.remodel||0<=z.$jscomp$loop$prop$item$304.stock)continue;B="";B="multi"===g?"tr_multi px-1":"px-2";y=document.createElement("div");y.className="plane plane_tr general_tr d-flex py-2 py-lg-1 "+B;y.dataset.planeid=z.$jscomp$loop$prop$item$304.id;y.dataset.type=z.$jscomp$loop$prop$item$304.type;y.dataset.remodel=d;l&&m&&0>=r&&(y.classList.remove("plane_tr","plane","general_tr"),y.classList.add("plane_tr_disabled"));B=
document.createElement("div");B.className="align-self-center size-25 relative";x=document.createElement("canvas");A=x.getContext("2d");x.width=25;x.height=25;A.drawImage(IMAGES["type"+z.$jscomp$loop$prop$item$304.itype],0,0,25,25);if(specialOperator.enabled){A=!1;for(var C=$jscomp.makeIterator(specialOperator.specialInfo),E=C.next();!E.done;E=C.next())if(E=E.value,E.items.includes(z.$jscomp$loop$prop$item$304.id)){A=document.createElement("div");A.className="item_special flash";A.innerHTML=E.name+
'<span class="font_size_12">'+E.remarks+"</span>";B.appendChild(A);A=!0;break}if(u&&!A)continue}A=document.createElement("div");A.className="pl-1 d-flex align-self-center flex-grow-1";C=!1;if(16===z.$jscomp$loop$prop$item$304.itype&&8<=z.$jscomp$loop$prop$item$304.antiAir)C=!0;else if(21===z.$jscomp$loop$prop$item$304.type&&9<=z.$jscomp$loop$prop$item$304.antiAir)C=!0;else if(350===z.$jscomp$loop$prop$item$304.id||351===z.$jscomp$loop$prop$item$304.id||352===z.$jscomp$loop$prop$item$304.id)C=!0;E=
document.createElement("div");E.className="pl-1 plane_td_name align-self-center"+(C?" special_item":"");E.textContent=z.$jscomp$loop$prop$item$304.name;A.appendChild(E);C=document.createElement("div");C.className="ml-2 plane_td_stock align-self-center";C.textContent="\u00d7"+(0<r?r:0);E=document.createDocumentFragment();var F=document.createElement("div");F.className="ml-auto plane_td_basic align-self-center";var H=document.createElement("div");H.className="plane_td_basic align-self-center";var G=
document.createElement("div");G.className="plane_td_basic align-self-center d-none d-lg-block";var I=document.createElement("div");I.className="plane_td_basic align-self-center d-none d-lg-block";var L=document.createElement("div");L.className="plane_td_basic align-self-center d-none d-lg-block";F.textContent=sFormat(z.$jscomp$loop$prop$item$304[t[0]],t[0]);H.textContent=sFormat(z.$jscomp$loop$prop$item$304[t[1]],t[1]);G.textContent=sFormat(z.$jscomp$loop$prop$item$304[t[2]],t[2]);I.textContent=sFormat(z.$jscomp$loop$prop$item$304[t[3]],
t[3]);L.textContent=sFormat(z.$jscomp$loop$prop$item$304[t[4]],t[4]);if("multi"===g&&v!==z.$jscomp$loop$prop$item$304.type&&"default"===q){v=document.createElement("div");v.className="type_divider mt-3 mb-1";var J=document.createElement("div");J.className="font_size_12 font_color_half align-self-center";J.textContent=ITEM_API_TYPE.find(function(M){return function(K){return K.id===M.$jscomp$loop$prop$item$304.type}}(z)).name;var N=document.createElement("div");N.className="flex-grow-1 border-bottom align-self-center mx-2";
v.appendChild(J);v.appendChild(N);f.appendChild(v)}B.appendChild(x);y.appendChild(B);k&&0<z.$jscomp$loop$prop$item$304.remodel&&(v=document.createElement("div"),v.className="plane_td_remodel text_remodel align-self-center",v.dataset.remodel=z.$jscomp$loop$prop$item$304.remodel,B="",B="multi"===g?"\u2605"+z.$jscomp$loop$prop$item$304.remodel:10>z.$jscomp$loop$prop$item$304.remodel?"\u2605+"+z.$jscomp$loop$prop$item$304.remodel:"\u2605MAX",v.textContent=B,A.appendChild(v),A.appendChild(C));0<r&&A.appendChild(C);
y.appendChild(A);"single"===g&&(E.appendChild(F),E.appendChild(H),E.appendChild(G),E.appendChild(I),E.appendChild(L),y.appendChild(E));f.appendChild(y);v=z.$jscomp$loop$prop$item$304.type}f.childNodes.length||(g=document.createElement("div"),g.className="text-center",l&&!m&&(g.textContent+="\u88c5\u5099\u6240\u6301\u6570\u304c\u767b\u9332\u3055\u308c\u3066\u3044\u306a\u3044\u304b\u3001\u5168\u3066\u306e\u88c5\u5099\u304c\u914d\u5099\u6e08\u307f\u3067\u3059\u3002"),l&&!m&&(g.textContent+="\u88c5\u5099\u6240\u6301\u6570\u304c\u767b\u9332\u3055\u308c\u3066\u3044\u306a\u3044\u304b\u3001\u5168\u3066\u306e\u88c5\u5099\u304c\u914d\u5099\u6e08\u307f\u3067\u3059\u3002"));
...
l;saveSetting();g?$("#disp_equipped_ship").closest("div").removeClass("d-none"):$("#disp_equipped_ship").closest("div").addClass("d-none");var q=SHIP_DATA.filter(function(A){return e?A.name.includes(e):n.includes(A.type)&&(d?0<A["final"]:!0)});setting.hasSlotOnly&&(q=q.filter(function(A){return A.slot.some(function(C){return 0<C})}));if(l){var p=setting.favoriteShip;q=q.filter(function(A){return p.includes(A.id)})}if(g){l={};m=$jscomp.makeIterator(k);for(var u=m.next();!u.done;l={$jscomp$loop$prop$stock$306:l.$jscomp$loop$prop$stock$306,
$jscomp$loop$prop$baseLv$307:l.$jscomp$loop$prop$baseLv$307,$jscomp$loop$prop$baseArea$308:l.$jscomp$loop$prop$baseArea$308},u=m.next())if(l.$jscomp$loop$prop$stock$306=u.value,!(0>=l.$jscomp$loop$prop$stock$306.details.length||(l.$jscomp$loop$prop$stock$306.details.sort(function(A,C){return A.lv-C.lv}),u=q.findIndex(function(A){return function(C){return C.id===A.$jscomp$loop$prop$stock$306.id}}(l)),0>u))){var t=q[u];l.$jscomp$loop$prop$baseLv$307=l.$jscomp$loop$prop$stock$306.details[0].lv;l.$jscomp$loop$prop$baseArea$308=
l.$jscomp$loop$prop$stock$306.details[0].area<=MAX_AREA?l.$jscomp$loop$prop$stock$306.details[0].area:0;t.lv=l.$jscomp$loop$prop$baseLv$307;t.area=l.$jscomp$loop$prop$baseArea$308;t.stock=l.$jscomp$loop$prop$stock$306.details.filter(function(A){return function(C){return C.lv===A.$jscomp$loop$prop$baseLv$307&&C.area===A.$jscomp$loop$prop$baseArea$308}}(l)).length;var w=[{lv:l.$jscomp$loop$prop$baseLv$307,area:l.$jscomp$loop$prop$baseArea$308}];if(2<=l.$jscomp$loop$prop$stock$306.details.length)for(var v=
{},r=1;r<l.$jscomp$loop$prop$stock$306.details.length;v={$jscomp$loop$prop$lv$312:v.$jscomp$loop$prop$lv$312,$jscomp$loop$prop$area$313:v.$jscomp$loop$prop$area$313},r++)if(v.$jscomp$loop$prop$lv$312=l.$jscomp$loop$prop$stock$306.details[r].lv,v.$jscomp$loop$prop$area$313=l.$jscomp$loop$prop$stock$306.details[r].area<=MAX_AREA?l.$jscomp$loop$prop$stock$306.details[r].area:0,!w.find(function(A){return function(C){return C.lv===A.$jscomp$loop$prop$lv$312&&C.area===A.$jscomp$loop$prop$area$313}}(v))){var x=
Object.assign({},t);x.lv=v.$jscomp$loop$prop$lv$312;x.area=v.$jscomp$loop$prop$area$313;x.stock=l.$jscomp$loop$prop$stock$306.details.filter(function(A){return function(C){return C.lv===A.$jscomp$loop$prop$lv$312&&C.area===A.$jscomp$loop$prop$area$313}}(v)).length;q.splice(u,0,x);w.push({lv:v.$jscomp$loop$prop$lv$312,area:v.$jscomp$loop$prop$area$313})}}}if(f&&setting.selectedHistory[1]){var z=setting.selectedHistory[1];q.sort(function(A,C){return z.filter(function(E){return E===C.id}).length-z.filter(function(E){return E===
A.id}).length})}q.sort(function(A,C){return 7===A.type&&7!==C.type||7===C.type&&7!==A.type?C.type-A.type:6===A.type&&6!==C.type||6===C.type&&6!==A.type?C.type-A.type:10===A.type&&10!==C.type||10===C.type&&10!==A.type?C.type-A.type:A.type-C.type});l=document.createDocumentFragment();u=w=0;m={};q=$jscomp.makeIterator(q);for(t=q.next();!t.done;m={$jscomp$loop$prop$ship$317:m.$jscomp$loop$prop$ship$317},t=q.next()){m.$jscomp$loop$prop$ship$317=t.value;v=1;if(g&&k){if(!m.$jscomp$loop$prop$ship$317.lv)continue;
m.$jscomp$loop$prop$ship$317.stock&&(v=m.$jscomp$loop$prop$ship$317.stock);t=usedShip.filter(function(A){return function(C){return C.id===A.$jscomp$loop$prop$ship$317.id&&C.lv===A.$jscomp$loop$prop$ship$317.lv&&C.area===A.$jscomp$loop$prop$ship$317.area}}(m)).length;v-=t;if(0>=v&&!h)continue}t=document.createElement("div");t.className=g&&h&&!v?"ship_tr ship_tr_disabled d-flex "+("multi"===c?"tr_multi":""):"ship_tr general_tr d-flex "+("multi"===c?"tr_multi":"");t.dataset.shipid=m.$jscomp$loop$prop$ship$317.id;
t.dataset.level=m.$jscomp$loop$prop$ship$317.lv?m.$jscomp$loop$prop$ship$317.lv:99;t.dataset.area=0<m.$jscomp$loop$prop$ship$317.area?m.$jscomp$loop$prop$ship$317.area:0;t.id="ship_tr_"+m.$jscomp$loop$prop$ship$317.id;r=document.createElement("div");r.className="ml-1 align-self-center pt-1";x=document.createElement("img");x.width=120;x.height=30;x.src="../img/ship/"+m.$jscomp$loop$prop$ship$317.id+".png";r.appendChild(x);g&&0<m.$jscomp$loop$prop$ship$317.area&&(r.classList.add("exist_area"),x=document.createElement("img"),
x.className="area_banner",x.src="../img/util/area"+m.$jscomp$loop$prop$ship$317.area+".png",r.appendChild(x));x=document.createElement("div");x.className="ml-1 align-self-center";var D=document.createElement("div");D.className="text-primary font_size_11";D.textContent=g?"Lv : "+m.$jscomp$loop$prop$ship$317.lv:"ID : "+m.$jscomp$loop$prop$ship$317.id;var y=document.createElement("div");y.className="d-flex";y.textContent=m.$jscomp$loop$prop$ship$317.name;var B=document.createElement("div");B.className=
"ml-1 ship_td_stock align-self-center "+(g?"":"d-none");B.textContent="\u00d7"+v;y.appendChild(B);x.appendChild(D);x.appendChild(y);t.appendChild(r);t.appendChild(x);if("multi"!==c)for(v=0;5>v;v++)r=document.createElement("div"),r.className="ship_td_slot font_size_12 align-self-center "+(0===v?"ml-auto":""),r.textContent=v<m.$jscomp$loop$prop$ship$317.slot.length?m.$jscomp$loop$prop$ship$317.slot[v]:"",t.appendChild(r);w!==m.$jscomp$loop$prop$ship$317.type&&(w=document.createElement("div"),w.className=
"type_divider mt-4",v=document.createElement("div"),v.className="align-self-center font_size_16",v.textContent=API_SHIP_TYPE.find(function(A){return function(C){return C.id===A.$jscomp$loop$prop$ship$317.type}}(m)).name,r=document.createElement("div"),r.className="flex-grow-1 border-bottom align-self-center mx-2",w.appendChild(v),w.appendChild(r),l.appendChild(w));f||u===m.$jscomp$loop$prop$ship$317.type2||(u=document.createElement("div"),u.className="type_divider mt-2 ml-1",w=document.createElement("div"),
w.className="font_size_12 font_color_half align-self-center",v=API_CTYPE.find(function(A){return function(C){return C.id===A.$jscomp$loop$prop$ship$317.type2}}(m))||{name:""},w.textContent=v.name,u.appendChild(w),l.appendChild(u));w=m.$jscomp$loop$prop$ship$317.type;u=m.$jscomp$loop$prop$ship$317.type2;l.appendChild(t)}"multi"===c?(a.classList.add("modal-xl"),b.classList.add("multi_mode"),a=a.getElementsByClassName("scroll_thead")[0],a.classList.add("d-none"),a.classList.remove("d-flex")):(a.classList.remove("modal-xl"),
...
function initializeEnemyTable(){for(var a=document.createDocumentFragment(),b=[],c=0,d={},e=$jscomp.makeIterator(ENEMY_TYPE),f=e.next();!f.done;d={$jscomp$loop$prop$typeObject$319:d.$jscomp$loop$prop$typeObject$319},f=e.next())d.$jscomp$loop$prop$typeObject$319=f.value,1!==d.$jscomp$loop$prop$typeObject$319.id&&(f=ENEMY_DATA.filter(function(k){return function(m){return m.type[0]===k.$jscomp$loop$prop$typeObject$319.id}}(d)),b=b.concat(f.sort(function(k,m){return k.orig>m.orig?1:k.orig<m.orig?-1:k.id-
m.id})));d=ENEMY_DATA.filter(function(k){return 1===k.type[0]});b=b.concat(d.sort(function(k,m){return k.id>m.id?1:-1}));d={};b=$jscomp.makeIterator(b);for(e=b.next();!e.done;d={$jscomp$loop$prop$enemy$321:d.$jscomp$loop$prop$enemy$321},e=b.next()){d.$jscomp$loop$prop$enemy$321=new Enemy(e.value.id);e=document.createElement("div");e.className="enemy enemy_tr general_tr d-flex";e.dataset.enemyid=d.$jscomp$loop$prop$enemy$321.id;e.id="enemy_tr_"+d.$jscomp$loop$prop$enemy$321.id;f=document.createElement("div");
...
"E":b.$jscomp$loop$prop$world$327)+"-"+e.area%10+" : "+e.name+"</option>"}$("#map_select").html(a);$("#select_preset_category").html(a)}function btn_zoom_map_Clicked(){var a=castInt($("#map_select").val());document.getElementById("big_map_img").src="../img/map/detail/"+a+".png";$("#modal_big_map").modal("show")}
function createNodeSelect(){var a=castInt($("#map_select").val()),b=0;200>a?$("#select_difficulty_div").addClass("d-none"):($("#select_difficulty_div").removeClass("d-none"),b=castInt($("#select_difficulty").val()));$("#map_img").attr("src","../img/map/"+a+".png");510<a||[11,65].includes(a)?document.getElementById("btn_zoom_map").classList.remove("d-none"):document.getElementById("btn_zoom_map").classList.add("d-none");var c=ENEMY_PATTERN.filter(function(k){return k.a===a&&k.l===b});c=c.filter(function(k,
m,n){return n.findIndex(function(q){return q.n===k.n})===m});c.sort(function(k,m){return"\u7a7a\u8972"==k.n&&"\u7a7a\u8972"==m.n?0:"\u7a7a\u8972"==k.n?-1:"\u7a7a\u8972"==m.n?1:0});for(var d=c.length,e="",f="",g=0;g<d;g++){var h=c[g].n,l=c[g].c;e+='\n\t\t<div class="d-flex node_tr '+(c[g].t===CELL_TYPE.night?"is_night":"")+' general_tr justify-content-center py-1 w-100 cur_pointer" data-node="'+h+'">\n\t\t\t<div class="align-self-center">'+h+"</div>\n\t\t</div>\n\t";""!==l&&(f+='<area class="node" title="'+
h+'" coords="'+l+'" shape="rect">')}$("#node_tbody").html(e);$("#clickable_nodes").html(f);$("#enemy_pattern_tbody").html("");$("#enemy_pattern_select").html('<li class="nav-item"><a class="nav-link '+("#000000"===mainColor?"":"nav-link-dark")+' active" data-toggle="tab" href="#">\u7de8\u62101</a></li>');$("#enemy_pattern_air_power").text("0");$("#enemy_display_mode_parent").addClass("d-none").removeClass("d-flex");$("#btn_expand_enemies").prop("disabled",!0);$("#btn_continue_expand").prop("disabled",
!0)}
function createEnemyPattern(a){a=void 0===a?0:a;var b=castInt($("#map_select").val()),c=$(".node_selected").data("node"),d=0;100>b?$("#select_difficulty_div").addClass("d-none"):($("#select_difficulty_div").removeClass("d-none"),d=castInt($("#select_difficulty").val()));for(var e="",f=0,g=0,h=ENEMY_PATTERN.filter(function(u){return u.a===b&&u.n===c&&u.l===d}),l=h[a],k=l.e,m=k.length,n={$jscomp$loop$prop$index$329:0};n.$jscomp$loop$prop$index$329<m;n={$jscomp$loop$prop$index$329:n.$jscomp$loop$prop$index$329},n.$jscomp$loop$prop$index$329++){var q=
ENEMY_DATA.find(function(u){return function(t){return t.id===k[u.$jscomp$loop$prop$index$329]}}(n));if(q){var p=new Enemy(q.id);f+=p.airPower;g+=p.antiAirBonus;e+='\n\t\t<div class="enemy_pattern_tr mx-1 d-flex border-bottom" data-enemyid="'+q.id+'">\n\t\t\t<div class="enemy_pattern_tr_image mr-1">\n\t\t\t\t<img src="../img/enemy/'+q.id+'.png" class="enemy_img">\n\t\t\t</div>\n\t\t\t<div class="enemy_pattern_tr_text">\n\t\t\t\t<div class="font_size_11 text-primary">ID: '+(q.id+1500)+"</div>\n\t\t\t\t<div>"+
drawEnemyGradeColor(q.name)+"</div>\n\t\t\t</div>\n\t\t</div>\n\t\t"}}n=FORMATION.find(function(u){return u.id===l.f});g=2*Math.floor(n.correction*g);$("#enemy_pattern_anti_air").text(g);$("#enemy_pattern_formation").text(n.name);0<l.r?($("#enemy_pattern_radius_parent").removeClass("d-none"),$("#enemy_pattern_radius").removeClass("d-none"),$("#enemy_pattern_radius").text(l.r)):($("#enemy_pattern_radius_parent").addClass("d-none"),$("#enemy_pattern_radius").addClass("d-none"));if(0===a){a="";for(g=
...
$("#enemy_pattern_status2").text(h[2]);$("#enemy_pattern_status3").text(h[3]);l.t===CELL_TYPE.night?($("#btn_expand_enemies").prop("disabled",!0),$("#btn_continue_expand").prop("disabled",!0)):($("#btn_expand_enemies").prop("disabled",!1),$("#btn_continue_expand").prop("disabled",!1));6<m?($("#enemy_display_mode_parent").removeClass("d-none").addClass("d-flex"),setting.enemyDisplayImage?$("#enemy_pattern_tbody").find(".enemy_pattern_tr_text").addClass("d-none"):$("#enemy_pattern_tbody").find(".enemy_pattern_tr_image").addClass("d-none")):
...
function expandMainPreset(a,b,c,d){b=void 0===b?!0:b;c=void 0===c?!0:c;d=void 0===d?!0:d;if(a)try{var e=a[0];$(".lb_plane").each(function(D,y){if(e&&0!==e.length){var B=e[0].find(function(A){return A[4]===D});B&&0!==B.length?(B={id:B[0],prof:B[1],remodel:B[2],slot:B[3]},setLBPlaneDiv($(y),B)):b&&setLBPlaneDiv($(y))}});$(".ohuda_select").each(function(D,y){$(y).find("option").prop("disabled",!1);if(e&&2<=e.length){var B=castInt(e[1][D],-1);$(y).val(1===B?2:B)}else b&&$(y).val(-1)});if(e&&3<=e.length)for(var f=
0;2>=f;f++)document.getElementById("lb"+(f+1)+"_target_1").value=e[2][2*f],document.getElementById("lb"+(f+1)+"_target_2").value=e[2][2*f+1];5<=a.length?toggleDefenseMode(a[4]):toggleDefenseMode(!1);if(c){var g=6;a[1].length&&a[1][0]&&6<=a[1][0].length&&(g=2===a[1][0][5]?7:6,document.getElementById("union_fleet").checked=1===a[1][0][5],document.getElementById("yugeki_fleet").checked=2===a[1][0][5]);clearShipDivAll(g);var h=0,l=0;$(".ship_tab:not(.d-none)").each(function(D,y){var B=a[1].find(function(E){return E[2]===
D});if(B){var A=$(y);setShipDiv(A,B[0],99,8<=B.length&&B[7]?B[7]:0);A.find(".ship_plane").each(function(E,F){var H=$(F),G=B[1].find(function(I){return I[4]===E});!G&&H.hasClass("expanded_slot")&&(G=B[1].find(function(I){return-1===I[4]}));G&&!H.hasClass("d-none")&&(setPlaneDiv(H,{id:G[0],prof:G[1],remodel:G[2],slot:G[3]},!0),6<=G.length&&G[5]&&plane_unlock_Clicked(H.find(".plane_unlock")))});if(4<=B.length){var C=A.find(".ship_disabled");B[3]?(C.addClass("disabled"),C.children().addClass("fa-eye-slash").removeClass("fa-eye no_capture"),
A.addClass("opacity4")):(C.removeClass("disabled"),C.children().removeClass("fa-eye-slash").addClass("fa-eye no_capture"),A.removeClass("opacity4"))}5<=B.length&&(B[4]?A.find(".ship_level").text(B[4]):A.find(".ship_level").text(99));7<=B.length&&0<B[6]&&A.find(".ship_luck").text(B[6]);D<g?h+=1:l+=1}});display_ship_count_Changed($("#friendFleet_item1"),Math.max(h,1),!0);display_ship_count_Changed($("#friendFleet_item2"),Math.max(l,1),!0)}document.getElementById("fleet_formation").value=1;if(4<=a.length&&
...
!0;document.getElementById("fleet_formation").value=q}}}else document.getElementById("adapt_stage2").checked=!1,selectedFormations=[];q=1;for(k=0;k<a[2].length;k++)q<a[2][k][0]+1&&(q=a[2][k][0]+1);q=Math.min(q,10);if(0!==a[2].length||d)clearEnemyDivAll(q),$("#battle_count").val(q);var p=isDefMode&&6>a.length;$(p?"#air_raid_enemies":".battle_content").each(function(D,y){var B=a[2].find(function(F){return F[0]===D});if(B){3<=B.length?$(y)[0].dataset.celldata=B[2]:$(y)[0].dataset.celldata="";if(4<=B.length){var A=
castInt(B[3]);p?$(y).find(".cell_type").val([0,5].includes(A)?5:3):$(y).find(".cell_type").val(A);cell_type_Changed($(y).find(".cell_type"),!1)}else $(y).find(".cell_type").val(1);5<=B.length?$(y).find(".formation").val(B[4]):$(y).find(".formation").val(1);6<=B.length?$(y).find(".enemy_range").text(B[5]):$(y).find(".enemy_range").text(0);A=0;B=$jscomp.makeIterator(B[1]);for(var C=B.next();!C.done;C=B.next()){C=C.value;var E=$(y).find(".enemy_content").eq(A++);0<C?setEnemyDiv(E,C):0>C?setEnemyDiv(E,
-1,-C):clearEnemyDiv(E);E.addClass("d-flex").removeClass("d-none")}}});if(6<=a.length){var u=a[5];if(u&&3===u.length){var t=$("#air_raid_enemies"),w=castInt(u[1]);t.find(".cell_type").val([0,5].includes(w)?5:3);cell_type_Changed(t.find(".cell_type"),!1);t.find(".formation").val(u[2]);d=0;for(var v=$jscomp.makeIterator(u[0]),r=v.next();!r.done;r=v.next()){var x=r.value,z=t.find(".enemy_content").eq(d++);0<x?setEnemyDiv(z,x):0>x?setEnemyDiv(z,-1,-x):clearEnemyDiv(z);z.addClass("d-flex").removeClass("d-none")}}}7<=
a.length?$("#admin_lv").val(a[6]):$("#admin_lv").val(120)}catch(D){$(".ohuda_select").val(-1),$(".lb_plane").each(function(y,B){setLBPlaneDiv($(B))}),clearShipDivAll(6),clearEnemyDivAll(1),$("#battle_count").val(1),sendErrorLog(D)}}
...
d.push(resultData.enemyAirPowers[6])):(c=resultData.landBaseAirPowers,c.push(resultData.fleetAirPower),d=resultData.enemyAirPowers,e=resultData.landBaseAirStatus);e.push(resultData.fleetAirStatus);for(var f={},g=0;g<=b;f={$jscomp$loop$prop$abbr$331:f.$jscomp$loop$prop$abbr$331,$jscomp$loop$prop$ap$332:f.$jscomp$loop$prop$ap$332,$jscomp$loop$prop$status$334:f.$jscomp$loop$prop$status$334},g++){var h=isDefMode?8:g+1,l=$("#result_bar_"+h),k=$("#rate_row_"+h);f.$jscomp$loop$prop$ap$332=c[g];var m=d[g],
n=e[g],q=getAirStatusBorder(m);f.$jscomp$loop$prop$status$334=isDefMode?getAirStatusIndex(f.$jscomp$loop$prop$ap$332,m):n.indexOf(getArrayMax(n));var p=0,u=!1;4===f.$jscomp$loop$prop$status$334?p=f.$jscomp$loop$prop$ap$332/q[3]*10:3===f.$jscomp$loop$prop$status$334?p=f.$jscomp$loop$prop$ap$332/q[2]*20:2===f.$jscomp$loop$prop$status$334?p=f.$jscomp$loop$prop$ap$332/q[1]*45:1>=f.$jscomp$loop$prop$status$334&&(p=f.$jscomp$loop$prop$ap$332/q[0]*90);if(5===f.$jscomp$loop$prop$status$334&&7!==h)f.$jscomp$loop$prop$status$334=
0,p=100;else if(5===f.$jscomp$loop$prop$status$334){f.$jscomp$loop$prop$abbr$331=$("#shoot_down_table").find(".cond.battle"+(displayBattle+1)).text();var t=AIR_STATUS.find(function(v){return function(r){return r.abbr===v.$jscomp$loop$prop$abbr$331}}(f));t&&(f.$jscomp$loop$prop$status$334=t.id);0===f.$jscomp$loop$prop$status$334&&(p=100)}p=Math.min(100,p);var w=l.data("airstatus");t="bar_status"+f.$jscomp$loop$prop$status$334;l.removeClass("bar_status"+w).addClass(t).css({width:p+"%"}).data("airstatus",
f.$jscomp$loop$prop$status$334);k.find(".rate_td_ap").text(f.$jscomp$loop$prop$ap$332);w=k.find(".rate_td_eap");w.find(".avg_eap").text(m);w.find(".eap_border").html("( "+q.slice(0,4).map(function(v){return function(r){return r<=v.$jscomp$loop$prop$ap$332?"<b>"+r+"</b>":r.toString()}}(f)).join(" / ")+" )");w=100;for(m=0;m<n.length;m++)k.find(".rate_td_status"+m).text("-"),isDefMode?k.find(".rate_td_status"+f.$jscomp$loop$prop$status$334).text("100 %"):0<n[m]&&(u=Math.floor(1E3*n[m])/10,q=0,m+1<n.length&&
0<n[m+1]?(q=u,w-=u):q=w.toFixed(1),k.find(".rate_td_status"+m).text(q+" %"),u=!0);if(u||isDefMode&&8===h)k.removeClass("d-none disabled_tr"),l.closest(".progress_area").addClass("d-flex").removeClass("d-none disabled_bar");l="bar_ex_status"+f.$jscomp$loop$prop$status$334;isDefMode&&(k=$("#simple_lb_def_bar"),m=k.find(".result_bar"),w=m.data("airstatus"),m.removeClass("bar_status"+w+" bar_ex_status"+w).addClass(t+" "+l).css({width:p+"%"}).data("airstatus",f.$jscomp$loop$prop$status$334),k.find(".simple_label").text(AIR_STATUS.find(function(v){return function(r){return r.id===
v.$jscomp$loop$prop$status$334}}(f)).abbr),k.removeClass("d-none"));7===h&&u&&-1<f.$jscomp$loop$prop$status$334&&(h=$("#fleet_simple_bar"),u=h.find(".result_bar"),w=u.data("airstatus"),u.removeClass("bar_status"+w+" bar_ex_status"+w).addClass(t+" "+l).css({width:p+"%"}).data("airstatus",f.$jscomp$loop$prop$status$334),n=AIR_STATUS.find(function(v){return function(r){return r.id===v.$jscomp$loop$prop$status$334}}(f)).abbr+"("+Math.floor(100*n[f.$jscomp$loop$prop$status$334])+"%)",h.find(".simple_label").text(n),
...
e<=f?[e,f]:[f,e],e=e<=f?[0,1]:[1,0],f={},g=0;1>=g;f={$jscomp$loop$prop$status$192$336:f.$jscomp$loop$prop$status$192$336},g++)n=c.results[d[g]].airStatusIndex[e[g]],t=c.results[d[g]].mainAirPower[e[g]]/a,h=c.results[d[g]].enemyAirPower[e[g]]/a,f.$jscomp$loop$prop$status$192$336=n.indexOf(getArrayMax(n)),p=0,h=getAirStatusBorder(h),4===f.$jscomp$loop$prop$status$192$336?p=t/h[3]*10:3===f.$jscomp$loop$prop$status$192$336?p=t/h[2]*20:2===f.$jscomp$loop$prop$status$192$336?p=t/h[1]*45:1>=f.$jscomp$loop$prop$status$192$336&&
(p=t/h[0]*90),5===f.$jscomp$loop$prop$status$192$336&&(f.$jscomp$loop$prop$status$192$336=0,p=100),h="bar_status"+f.$jscomp$loop$prop$status$192$336,u="bar_ex_status"+f.$jscomp$loop$prop$status$192$336,t=$("#simple_lb_bar_"+c.baseNo+"_"+(g+1)),l=t.find(".result_bar"),k=l.data("airstatus"),l.removeClass("bar_status"+k+" bar_ex_status"+k).addClass(h+" "+u).css({width:(100<p?100:p)+"%"}).data("airstatus",f.$jscomp$loop$prop$status$192$336),p=AIR_STATUS.find(function(v){return function(r){return r.id===
v.$jscomp$loop$prop$status$192$336}}(f)).abbr,n=Math.floor(getArrayMax(n)/a*100),n=p+"("+n+"%)"+(100===n?"":10<=n?'<span class="opacity0">1</span>':'<span class="opacity0">11</span>'),t.find(".simple_label").html(n),t.removeClass("d-none");display_result_Changed();resultData.enemyAirPowerResults=null;resultData.fleetSlots=null}
...
function updateFleetView(){var a=inputItems.fleet,b=document.getElementById("shoot_down_table"),c=document.getElementById("shoot_down_table_tbody"),d=-1;b.getElementsByTagName("tbody")[0].innerHTML="";b=$jscomp.makeIterator(b.getElementsByTagName("tfoot")[0].getElementsByClassName("td_battle"));for(var e=b.next();!e.done;e=b.next())e.value.innerHTML="";$("#fleet_formation").find("option").each(function(y,B){var A=castInt($(B).val());a.isUnion&&10<A?$(B).removeClass("d-none"):!a.isUnion&&10<A&&$(B).addClass("d-none")});
$("#fleet_antiair_formation").find("option").each(function(y,B){var A=castInt($(B).val());a.isUnion&&10<A?$(B).removeClass("d-none"):!a.isUnion&&10<A&&$(B).addClass("d-none")});setting.visibleAntiAirStatus?($(".anti_air_status").removeClass("d-none"),$(".anti_air_status").addClass("d-flex")):($(".anti_air_status").addClass("d-none"),$(".anti_air_status").removeClass("d-flex"));b=document.getElementsByClassName("fleet_ap")[0];e=document.getElementsByClassName("fleet_ap")[1];for(var f=document.getElementsByClassName("contact_start_rate")[0],
...
function updateEnemyView(){var a=inputItems.battleInfo,b=0,c=0,d=!1,e=!1,f="",g=[],h=[];document.getElementById("enemy_shoot_down_table").getElementsByTagName("tbody")[0].innerHTML="";for(var l=isDefMode?0:displayBattle,k={},m=0;m<a.battles.length;k={$jscomp$loop$prop$battle$346:k.$jscomp$loop$prop$battle$346},m++){k.$jscomp$loop$prop$battle$346=a.battles[m];for(var n=b=0,q={},p=$jscomp.makeIterator(k.$jscomp$loop$prop$battle$346.enemies),u=p.next();!u.done;q={$jscomp$loop$prop$enemy$342:q.$jscomp$loop$prop$enemy$342},
u=p.next())if(q.$jscomp$loop$prop$enemy$342=u.value,b+=q.$jscomp$loop$prop$enemy$342.antiAirBonus,!d&&ANTIAIR_CUTIN_ENEMY.includes(q.$jscomp$loop$prop$enemy$342.id)&&(d=!0),!e&&UNKNOWN_ENEMY.includes(q.$jscomp$loop$prop$enemy$342.id)&&(e=!0),m===l&&!q.$jscomp$loop$prop$enemy$342.onlyScout&&q.$jscomp$loop$prop$enemy$342.slots.length){for(var t=u="",w=!0,v=-1,r={$jscomp$loop$prop$j$344:0};r.$jscomp$loop$prop$j$344<q.$jscomp$loop$prop$enemy$342.equipments.length;r={$jscomp$loop$prop$j$344:r.$jscomp$loop$prop$j$344},
r.$jscomp$loop$prop$j$344++){var x=ENEMY_ITEM.find(function(E,F){return function(H){return H.id===E.$jscomp$loop$prop$enemy$342.equipments[F.$jscomp$loop$prop$j$344].id}}(q,r));if(x&&PLANE_TYPE.includes(x.type)){v+=1;var z=q.$jscomp$loop$prop$enemy$342.slots[v],D=getItemCss(x.itype).replace("css","shoot_table"),y=v===q.$jscomp$loop$prop$enemy$342.slots.length-1?" last_slot":"",B="",A="",C="";u+='<img src="../img/plane/'+x.id+'.png" class="img-size-36" data-planeid="'+x.id+'">';w&&(B='\n\t\t\t\t\t<td class="td_name align-middle last_slot" rowspan="'+
q.$jscomp$loop$prop$enemy$342.slots.length+'">\n\t\t\t\t\t\t<div>'+drawEnemyGradeColor(q.$jscomp$loop$prop$enemy$342.name)+'</div>\n\t\t\t\t\t\t<div class="d-none d-md-block">xxPxx</div>\n\t\t\t\t\t</td>',C='<td class="td_all_dead align-middle last_slot" rowspan="'+q.$jscomp$loop$prop$enemy$342.slots.length+'"></td>',A='<td class="td_detail_slot align-middle last_slot" rowspan="'+q.$jscomp$loop$prop$enemy$342.slots.length+'"><i class="fas fa-file-text"></i></td>',w=!1);t+='\n\t\t\t\t<tr class="enemy_no_'+
n+" slot_"+v+'" data-rowindex="'+n+'" data-slot="'+v+'" data-css="'+D+'_hover">\n\t\t\t\t\t'+B+'\n\t\t\t\t\t<td class="pl-1 td_plane_name align-middle '+(D+y)+'">'+x.name+'</td>\n\t\t\t\t\t<td class="td_init_slot align-middle'+y+'">'+z+'</td>\n\t\t\t\t\t<td class="td_avg_slot align-middle'+y+'">'+z+'</td>\n\t\t\t\t\t<td class="td_max_slot align-middle'+y+'">'+z+'</td>\n\t\t\t\t\t<td class="td_min_slot align-middle'+y+'">'+z+"</td>\n\t\t\t\t\t"+(isDefMode?"":C)+"\n\t\t\t\t\t"+(isDefMode?"":A)+"\n\t\t\t\t</tr>"}}h.push(t.replace("xxPxx",
u));n+=1}n=document.getElementsByClassName("battle_content")[c++];n.getElementsByClassName("enemy_sum_ap")[0].textContent=k.$jscomp$loop$prop$battle$346.getAirPower();n.getElementsByClassName("enemy_sum_lbap")[0].textContent=k.$jscomp$loop$prop$battle$346.getLandBaseAirPower();q=n.getElementsByClassName("enemy_range")[0];castInt(q.textContent)?q.parentNode.classList.remove("d-none"):q.parentNode.classList.add("d-none");q=(q=FORMATION.find(function(E){return function(F){return F.id===E.$jscomp$loop$prop$battle$346.formation}}(k)))?
...
function shootDownEnemy(a,b,c,d){c=void 0===c?!1:c;d=void 0===d?[]:d;var e=0,f=0;f=null;var g=0;c&&(e=Math.random(),f=d.findIndex(function(u){return u.border>e}),f=0<=f?d[f].table:[],g=f.length);d=b.length;for(var h=0;h<d;h++){var l=b[h],k=l.slots.length;l.airPower=0;for(var m=l.landBaseAirPower=0,n=0;n<k;n++){var q=l.slots[n];l.slots[n]-=getShootDownSlot(a,q);if(c&&0<g&&l.attackers[n]){q=l.slots[n];var p=f[Math.floor(Math.random()*g)];Math.floor(2*Math.random())&&(q-=Math.floor(p.rateDown*q));Math.floor(2*
...
function shootDownFleet(a,b,c,d,e){e=void 0===e?!0:e;var f=c.stage2[0][0].length;5===a&&(a=0);for(var g=c.enabledStage2,h=b.ships.length,l=0;l<h;l++){var k=b.ships[l];if(!k.ignoreSlot){for(var m=0,n=!c.isUnion&&k.isEscort,q=k.items.length,p=0;p<q;p++){var u=k.items[p];e&&(u.results[d]+=u.slot);if(!(0>=u.slot||!u.canBattle||n)&&f){var t=getShootDownSlotFF(a,u.slot);u.slot-=Math.floor(u.isJet?.6*t:t);if(u.isAttacker&&g){t=Math.floor(Math.random()*f);var w=c.stage2[u.avoid];Math.floor(2*Math.random())&&
(u.slot-=Math.floor(w[0][t]*u.slot));Math.floor(2*Math.random())&&(u.slot-=w[1][t])}u.canBattle&&0<u.slot?u.airPower=Math.floor(u.antiAir*Math.sqrt(u.slot)+u.bonusAirPower):(0>=u.slot&&(u.slot=0),u.airPower=0)}m+=u.airPower}k.airPower=m}}b.updateAirPower()}
...
function rateCalculate(){var a=inputItems.landBase,b=inputItems.fleet,c=inputItems.battleInfo,d=castInt($("#calculate_count").val());d=0>=d?1:d;$("#calculate_count").val(d);for(var e=b.ships.length,f=c.battles,g=isDefMode?0:displayBattle,h=[0,0,0,0,0,0],l=[],k=[],m=[],n=[],q=[[],[]],p=isDefMode?1:battleCount,u=0,t=[],w=$jscomp.makeIterator(f),v=w.next();!v.done;v=w.next())v=v.value,v.enemies=v.enemies.filter(function(J){return-1===J.id||0<J.slots.length});g=g<c.battles.length?g:c.battles.length-1;
for(c=0;c<p;c++)l.push(0),k.push(0);for(c=0;c<e;c++)if(w=b.ships[c],!w.ignoreSlot)for(v=0;v<w.items.length;v++)w.items[v].isPlane&&m.push(Array(d));for(c=0;c<f[g].enemies.length;c++)if(w=f[g].enemies[c],!(w.onlyScout||0>w.id)){v=0===n.length?0:n[n.length-1][0]+1;for(var r=0;r<w.slots.length;r++)n.push([v,r,0,0,999]);t.push(0)}c=f[0].cellType===CELL_TYPE.highAirRaid?a.defense2AirPower:a.defenseAirPower;resultData.defenseAirPower=c;isDefMode&&(b.fullAirPower=c,b.airPower=c,b.fullUnionAirPower=c,b.unionAirPower=
c);c=0;if(isDefMode||f[0])c=f[0].getAirPower();w=!isDefMode&&document.getElementById("adapt_stage2").checked;v=[];w&&(v=castInt($("#fleet_formation").val()),b.isUnion&&f[g].cellType===CELL_TYPE.airRaid?b.updateStage2All(v,!0):b.updateStage2All(v),v=b.allStage2);for(r=0;r<d;r++){for(var x=0;x<p;x++){var z=f[x],D=z.enemies,y=!1;y=calculateLandBase(a,z,x);u+=doJetPhase(b,z);var B=z.isUnion?b.unionAirPower:b.airPower,A=z.getAirPower(),C=getAirStatusIndex(B,A);x===g&&(h[C]+=1);l[x]+=B;k[x]+=A;shootDownFleet(C,
b,z,x);z.cellType===CELL_TYPE.aerialCombat&&(shootDownEnemy(C,D,w,v),y=!0,C=getAirStatusIndex(b.airPower,z.getAirPower()),shootDownFleet(C,b,z,x,!1));if(x===g){shootDownEnemy(C,D,w,v);for(C=B=y=z=0;C<D.length;C++){var E=D[C];if(!E.onlyScout&&E.id){for(var F=E.slots,H=E.attackers.concat(),G=0;G<F.length;G++){var I=F[G],L=n[z];z+=1;L[2]+=I;L[3]<I&&(L[3]=I);L[4]>I&&(L[4]=I);0===I&&(H[G]=!1)}0>H.indexOf(!0)&&(t[y]+=1);y+=1;B+=E.airPower}E.slots=E.fullSlots.concat();E.airPower=E.fullAirPower;E.landBaseAirPower=
E.fullLandBaseAirPower}q[0].push(A);q[1].push(B);y=!1}if(y)for(D=$jscomp.makeIterator(D),A=D.next();!A.done;A=D.next())A=A.value,A.slots=A.fullSlots.concat(),A.airPower=A.fullAirPower,A.landBaseAirPower=A.fullLandBaseAirPower}for(x=0;3>x;x++)if(D=a.landBases[x],0!==D.mode){for(A=0;A<D.planes.length;A++)z=D.planes[A],z.slot=z.fullSlot,z.airPower=z.fullAirPower;D.airPower=D.fullAirPower}for(D=x=0;D<e;D++)if(A=b.ships[D],!A.ignoreSlot){z=A.items.length;for(y=0;y<z;y++)B=A.items[y],B.isPlane&&(m[x++][r]=
B.slot,B.slot=B.fullSlot,B.airPower=B.fullAirPower);A.airPower=A.fullAirPower}b.airPower=b.fullAirPower;b.escortAirPower=b.fullEscortAirPower;b.unionAirPower=b.fullUnionAirPower}for(w=f=0;w<e;w++)if(v=b.ships[w],!v.ignoreSlot)for(r=0;r<v.items.length;r++)v.items[r].isPlane&&(x=m[f],D={shipNo:v.shipNo,slot:v.items[r].slotNo,max:getArrayMax(x),min:getArrayMin(x),avg:x.reduce(function(J,N){return J+N})/d,death:x.filter(function(J){return 0===J}).length,deathRate:0},D.deathRate=D.death/x.length,resultData.fleetSlots.push(D),
...
d});resultData.enemySlots=n;resultData.enemyAirPowerResults=q;resultData.enemySlotAllDead=t;resultData.usedSteels=u}
...
var n=[];m&&(n=castInt($("#fleet_formation").val()),e.isUnion&&f.battles[k].cellType===CELL_TYPE.airRaid?e.updateStage2All(n,!0):e.updateStage2All(n),n=e.allStage2);for(var q=l.items[b],p=$jscomp.makeIterator(f.battles),u=p.next();!u.done;u=p.next())u=u.value,u.enemies=u.enemies.filter(function(z){return 0<z.slots.length});for(p=0;p<g;p++){for(u=0;u<=k;u++){var t=f.battles[u],w=t.enemies;calculateLandBase(d,t,u);doJetPhase(e,t);var v=t.cellType,r=t.isUnion?e.unionAirPower:e.airPower,x=t.getAirPower();
r=getAirStatusIndex(r,x);shootDownFleet(r,e,t,u);v===CELL_TYPE.aerialCombat&&(shootDownEnemy(r,w,m,n),r=getAirStatusIndex(e.airPower,t.getAirPower()),shootDownFleet(r,e,t,u,!1));t=$jscomp.makeIterator(w);for(w=t.next();!w.done;w=t.next())w=w.value,w.slots=w.fullSlots.concat(),w.airPower=w.fullAirPower,w.landBaseAirPower=w.fullLandBaseAirPower}for(u=0;3>u;u++){t=d.landBases[u];for(w=0;w<t.planes.length;w++)v=t.planes[w],v.slot=v.fullSlot,v.updateAirPower();t.updateAirPower()}for(u=0;u<e.ships.length;u++)for(t=
e.ships[u],w=t.items.length,v=t.airPower=0;v<w;v++)r=t.items[v],u===a&&r.slotNo===b&&h.push(r.slot),r.slot=r.fullSlot,r.updateAirPower(),t.airPower+=r.airPower;e.updateAirPower()}chartSlotDistribution=updateDetailChart(h,"\u6b8b\u6a5f\u6570 [\u6a5f]",{mode:"index",callbacks:{title:function(z,D){var y=castInt(z[0].xLabel);return"\u6b8b\u6a5f\u6570\uff1a"+y+" \u6a5f\n\u822a\u7a7a\u6226\u706b\u529b\uff1a"+ShipItem.getFirePower(q,y).join(" or ")},label:function(z,D){return[z.yLabel+" %"]}}});e=SHIP_DATA.find(function(z){return z.id===
...
a={};k=$jscomp.makeIterator(l.items);for(h=k.next();!h.done;a={$jscomp$loop$prop$pl$352:a.$jscomp$loop$prop$pl$352},h=k.next()){a.$jscomp$loop$prop$pl$352=h.value;h=ITEM_DATA.find(function(z){return function(D){return D.id===z.$jscomp$loop$prop$pl$352.id}}(a));if(g===(e?e.slot.length:4))break;m=h?h.name:"-";n=PLANE_TYPE.includes(h?h.type:0);p="";n&&FIGHTERS.includes(h.type)?p=h.antiAir?'<span class="mx-1">\u5bfe\u7a7a: '+h.antiAir+"</span>":"":n&&RECONNAISSANCES.includes(h.type)?(p=h.antiAir?'<span class="mx-1">\u5bfe\u7a7a: '+
...
0;n<f;n++){for(var q=0;q<=h;q++){for(var p=e.battles[q],u=p.enemies,t=0;3>t;t++){var w=d.landBases[t],v=w.target[0],r=w.target[1];if(v===q||r===q){if(v===q){doLandBaseJetPhase(w,p);var x=w.airPower,z=p.getLandBaseAirPower();x=0===x&&0===z?0:getAirStatusIndex(x,z);shootDownEnemy(x,u);v!==r&&shootDownLandBase(x,w,p)}r===q&&(v!==r&&doLandBaseJetPhase(w,p),v=w.airPower,r=p.getLandBaseAirPower(),v=0===v&&0===r?0:getAirStatusIndex(v,r),shootDownEnemy(v,u),shootDownLandBase(v,w,p))}}p=$jscomp.makeIterator(u);
for(u=p.next();!u.done;u=p.next())u=u.value,u.slots=u.fullSlots.concat(),u.airPower=u.fullAirPower,u.landBaseAirPower=u.fullLandBaseAirPower}for(q=0;3>q;q++){p=d.landBases[q];for(t=u=0;t<p.planes.length;t++)w=p.planes[t],a+1===p.baseNo&&b===t&&g.push(w.slot),u+=w.slot,w.slot=w.fullSlot,w.updateAirPower();a+1===p.baseNo&&m.push(u);p.updateAirPower()}}var D=l[b].id,y=l[b].remodel,B=l.find(function(C){return 312===C.id})?1.15:l.find(function(C){return 311===C.id})?1.125:1,A=e.battles[h].isUnion?1.1:
1;chartSlotDistribution=updateDetailChart(g,"\u6b8b\u6a5f\u6570 [\u6a5f]",{mode:"index",callbacks:{title:function(C,E){var F=C[0].xLabel,H="\u822a\u7a7a\u6226\u706b\u529b\uff1a"+(LandBaseItem.getFirePower(D,F,y)*B*A).toFixed(1);return F?"\u6b8b\u6a5f\u6570\uff1a"+F+" \u6a5f\n"+H:"\u6b8b\u6a5f\u6570\uff1a0 \u6a5f\n\u822a\u7a7a\u6226\u706b\u529b\uff1a0"},label:function(C,E){return[C.yLabel+" %"]}}});n=h=g=0;m=$jscomp.makeIterator(m);for(q=m.next();!q.done;q=m.next())q=q.value,p=q/k,0===q?n+=1:.25>p?
...
m={};g=$jscomp.makeIterator(d.landBases[a].planes);for(h=g.next();!h.done;m={$jscomp$loop$prop$pl$354:m.$jscomp$loop$prop$pl$354},h=g.next())m.$jscomp$loop$prop$pl$354=h.value,n=(h=ITEM_DATA.find(function(C){return function(E){return E.id===C.$jscomp$loop$prop$pl$354.id}}(m)))?h.name:"-",q="",FIGHTERS.includes(h.type)?q=h.antiAir?'<span class="mx-1">\u5bfe\u7a7a: '+h.antiAir+"</span>":"":RECONNAISSANCES.includes(h.type)?(q=h.antiAir?'<span class="mx-1">\u5bfe\u7a7a: '+h.antiAir+"</span>":"",q+='<span class="mx-1">\u7d22\u6575: '+
h.scout+"</span>"):(q=h.torpedo?'<span class="mx-1">\u96f7\u88c5: '+h.torpedo+"</span>":"",q+=h.bomber?'<span class="mx-1">\u7206\u88c5: '+h.bomber+"</span>":""),q+='<span class="mx-1">\u534a\u5f84: '+h.radius+"</span>",f+='\n\t\t<div class="d-flex px-2 py-1 '+(b===k?"selected":"")+" "+(h?"general_tr btn_show_detail":"")+'" data-slot_no="'+k+'">\n\t\t\t<div class="w_5 align-self-center font_size_11 text-right pr-1">'+m.$jscomp$loop$prop$pl$354.slot+'</div>\n\t\t\t<div class="w_55 d-flex align-self-center font_size_12 pl-0">\n\t\t\t\t<img src="../img/type/'+
(h?"icon"+h.itype:"undefined")+'.png" class="plane_img_sm align-self-center">\n\t\t\t\t<div class="align-self-center detail_item_name"><span>'+n+'</span></div>\n\t\t\t\t<div class="align-self-center ml-auto d-flex">\n\t\t\t\t\t'+(h&&m.$jscomp$loop$prop$pl$354.remodel?'<div class="align-self-center text_remodel mr-1">\u2605'+m.$jscomp$loop$prop$pl$354.remodel+"</div>":"")+"\n\t\t\t\t\t"+(h&&m.$jscomp$loop$prop$pl$354.level?'<img class="ml-auto mr-1 h_20" alt="'+getProfString(m.$jscomp$loop$prop$pl$354.level)+
'" data-prof="'+m.$jscomp$loop$prop$pl$354.level+'" src="../img/util/prof'+m.$jscomp$loop$prop$pl$354.level+'.png">':"")+'\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t\t<div class="w_40 font_size_11 align-self-center">('+q+")</div>\n\t\t</div>",k+=1;$("#detail_legend").html("<span>\u7b2c"+(a+1)+"\u57fa\u5730\u822a\u7a7a\u968a</span>");$("#detail_info").html(f);b=chartSlotDistribution.map(function(C){return C.slot});f=getArrayMax(b);document.getElementById("stage3_all_slot").checked&&(document.getElementById("stage3_slot").value=
f);document.getElementById("stage3_all_slot_label").textContent="\u6b8b\u6a5f\u6570\u5206\u5e03\u306e\u7d50\u679c\u3092\u5229\u7528\uff08"+getArrayMin(b)+"\u6a5f ~ "+f+"\u6a5f\uff09";document.getElementById("stage3_remodel").value=y?y:0;l.some(function(C){return 311===C.id})&&(document.getElementById("enabled_rikutei").checked=!0);l.some(function(C){return 312===C.id})&&(document.getElementById("enabled_rikutei_z").checked=!0);l='<option value="99">\u4efb\u610f</option>';e=e.battles.length-1;b=castInt(document.getElementById("target_enemy").value,
...
function enemySlotDetailCalculate(a,b,c){c=void 0===c?!1:c;setPreCalculateTable();var d=createLandBaseInstance(),e=createFleetInstance(),f=updateEnemyFleetInfo(!1),g=castInt($("#detail_calculate_count").val()),h=isDefMode?0:displayBattle;h=h<f.battles.length?h:f.battles.length-1;var l=[],k=[],m=f.battles[h].enemies.filter(function(y){return 0<y.slots.length&&!y.onlyScout})[a],n=ENEMY_DATA.find(function(y){return y.id===m.id}),q=n.eqp.map(function(y){return ENEMY_ITEM.find(function(B){return B.id===
y})});q=q.filter(function(y){return FIGHTERS.includes(y.type)||ATTACKERS.includes(y.type)});c&&!ATTACKERS.includes(q[b].type)&&q.some(function(y){return ATTACKERS.includes(y.type)})&&(b=q.findIndex(function(y){return ATTACKERS.includes(y.type)}));var p=new EnemyItem(q[b].id);c=$("#slot_detail").prop("checked");var u=[];if(q=document.getElementById("enabled_manual_stage2").checked){u=castInt($("#fleet_formation").val());e.isUnion&&f.battles[h].cellType===CELL_TYPE.airRaid?e.updateStage2All(u,!0):e.updateStage2All(u);
var t=document.getElementById("aa_cutin_miss").checked;document.getElementById("aa_cutin_miss").parentElement.classList.remove("d-none");u=e.allStage2;t&&(u=[u[u.length-1]])}else document.getElementById("aa_cutin_miss").parentElement.classList.add("d-none");t=$jscomp.makeIterator(f.battles);for(var w=t.next();!w.done;w=t.next())w=w.value,w.enemies=w.enemies.filter(function(y){return 0<y.slots.length});for(t=0;t<g;t++){for(w=0;w<=h;w++){var v=f.battles[w],r=v.enemies;calculateLandBase(d,v,w);doJetPhase(e,
v);var x=v.cellType,z=v.isUnion?e.unionAirPower:e.airPower,D=v.getAirPower();z=getAirStatusIndex(z,D);shootDownFleet(z,e,v,w);x===CELL_TYPE.aerialCombat&&(shootDownEnemy(z,r,q,u),z=getAirStatusIndex(e.airPower,v.getAirPower()),shootDownFleet(z,e,v,w,!1));w===h&&(shootDownEnemy(z,r,q,u),v=m.slots[b],k.push(v),c||(v=p.getFirePower(v),2===v.length?(l.push(v[0]),l.push(v[1])):l.push(v[0])));for(v=0;v<r.length;v++)x=r[v],x.onlyScout||(x.slots=x.fullSlots.concat(),x.airPower=x.fullAirPower,x.landBaseAirPower=
x.fullLandBaseAirPower)}for(w=0;3>w;w++){r=d.landBases[w];for(v=0;v<r.planes.length;v++)x=r.planes[v],x.slot=x.fullSlot,x.updateAirPower();r.updateAirPower()}for(w=0;w<e.ships.length;w++)for(r=e.ships[w],v=r.items.length,x=r.airPower=0;x<v;x++)z=r.items[x],z.slot=z.fullSlot,z.updateAirPower(),r.airPower+=z.airPower;e.updateAirPower()}chartSlotDistribution=updateDetailChart(c?k:l,c?"\u6b8b\u6a5f\u6570 [\u6a5f]":"\u822a\u7a7a\u6226\u706b\u529b",{mode:"index",callbacks:{title:function(y){y=y[0].xLabel;
if($("#slot_detail").prop("checked")){if(!y)return"\u6b8b\u6a5f\u6570\uff1a"+y+" \u6a5f\n\u822a\u7a7a\u6226\u706b\u529b\uff1a0";var B="\u822a\u7a7a\u6226\u706b\u529b\uff1a"+p.getFirePower(y).join(" or ");return"\u6b8b\u6a5f\u6570\uff1a"+y+" \u6a5f\n"+B}return"\u822a\u7a7a\u6226\u706b\u529b\uff1a"+y},label:function(y){return[y.yLabel+" %"]}}});if(!c)for(chartSlotDistribution=[],d=getArrayMax(k),f=getArrayMin(k),e=k.length,f={$jscomp$loop$prop$i$269$356:f};f.$jscomp$loop$prop$i$269$356<=d;f={$jscomp$loop$prop$i$269$356:f.$jscomp$loop$prop$i$269$356},
f.$jscomp$loop$prop$i$269$356++)(g=k.filter(function(y){return function(B){return B===y.$jscomp$loop$prop$i$269$356}}(f)).length)&&chartSlotDistribution.push({slot:f.$jscomp$loop$prop$i$269$356,rate:g/e});$("#land_base_detail_table").addClass("d-none");$(".detail_fire").removeClass("d-none").addClass("d-flex");$(".detail_wave").addClass("d-none").removeClass("d-flex");$("#detail_info").data("mode","enemy_slot_detail");$("#detail_info").data("base_no",a);$("#detail_info").data("slot_no",b);$("#detail_info").data("battle_no",
h);$("#detail_warning").text("\u203b \u30b0\u30e9\u30d5\u5185\u306e\u822a\u7a7a\u6226\u706b\u529b\u306f\u30ad\u30e3\u30c3\u30d7\u524d\u3067\u30af\u30ea\u30c6\u30a3\u30ab\u30eb\u3001\u89e6\u63a5\u88dc\u6b63\u306a\u3057\u3002\u5c0f\u6570\u5207\u6368\u3066");a=document.getElementById("graph_title").textContent="";d=h=0;e={};f=$jscomp.makeIterator(n.eqp);for(g=f.next();!g.done;e={$jscomp$loop$prop$id$358:e.$jscomp$loop$prop$id$358},g=f.next())e.$jscomp$loop$prop$id$358=g.value,g=ENEMY_ITEM.find(function(y){return function(B){return B.id===
y.$jscomp$loop$prop$id$358}}(e)),l=n.slot[h],c=PLANE_TYPE.includes(g?g.type:0),q="",c&&FIGHTERS.includes(g.type)?q=g.antiAir?'<span class="mx-1">\u5bfe\u7a7a: '+g.antiAir+"</span>":"":c&&(q=g.antiAir?'<span class="mx-1">\u5bfe\u7a7a: '+g.antiAir+"</span>":"",q+=g.torpedo?'<span class="mx-1">\u96f7\u88c5: '+g.torpedo+"</span>":"",q+=g.bomber?'<span class="mx-1">\u7206\u88c5: '+g.bomber+"</span>":""),a+='\n\t\t<div class="d-flex px-2 py-1 '+(b===d?"selected":"")+" "+(c?"general_tr btn_show_detail":
...
var e=getManualEnemySearchBox();d={};e=$jscomp.makeIterator(e);for(var f=e.next();!f.done;d={$jscomp$loop$prop$text$364:d.$jscomp$loop$prop$text$364},f=e.next()){d.$jscomp$loop$prop$text$364=f.value;var g=ENEMY_DATA.filter(function(l){return function(k){return k.id+1500==l.$jscomp$loop$prop$text$364||0<=k.name.indexOf(l.$jscomp$loop$prop$text$364)}}(d));f={};g=$jscomp.makeIterator(g);for(var h=g.next();!h.done;f={$jscomp$loop$prop$enemy$270$366:f.$jscomp$loop$prop$enemy$270$366},h=g.next())f.$jscomp$loop$prop$enemy$270$366=
h.value,12>aerialSetting.targetEnemies.length&&!aerialSetting.targetEnemies.some(function(l){return function(k){return k.id===l.$jscomp$loop$prop$enemy$270$366.id}}(f))&&(h=new Enemy(f.$jscomp$loop$prop$enemy$270$366.id),h.isEscort=c,aerialSetting.targetEnemies.push(h))}}else aerialSetting.targetEnemies=c.battles[d].enemies.concat(),document.getElementById("manual_enemy").classList.add("d-none"),aerialSetting.isUnion=c.battles[d].isUnion;aerialSetting.levelCriticalBonus=a.getProfCriticalBonus();a=
...
document.getElementById("jet_phase").checked,n=aerialSetting.isAllSlot,q="",p=chartSlotDistribution,u=0;u<a.length;u++){var t=a[u];if(!(0>=t.id)){var w=t.armor+t.sumItemArmor,v=[];v=d?f&&t.type.includes(16)?getLandBaseAerialPowersMod(p):g&&t.type.includes(13)?getLandBaseAerialPowersMod2(p):t.type.includes(2)?getLandBaseAerialPowersLandBase(p,t):t.type.includes(18)&&h?getLandBaseASWPower(p):!e||86!==t.id&&120!==t.id?getLandBaseAerialPowers(p):getLandBaseAerialPowers(p,3.2):c?getFleetAerialPower(p,
t,1,m):getEnemyAerialPowers(p,t);var r=t.hp,x=createDamageDistribution(v,w,k,c,r),z=x.map(function(E){return E.damage}),D=getArrayMin(z),y=getArrayMax(z);z=[{min:r,max:getArrayMax(x.map(function(E){return E.damage}))+1,value:0},{min:Math.ceil(.75*r),max:r,value:0},{min:Math.ceil(.5*r),max:Math.ceil(.75*r),value:0}];v=v.map(function(E){return E.power}).some(function(E){return 0>=E});D=(1<=D?D:v?"0":"\u5272\u5408")+"~"+(1<=y?y:"\u5272\u5408");n||0!==l||(D="-");v="";y={};for(var B=0;B<z.length;y={$jscomp$loop$prop$borderMin$370:y.$jscomp$loop$prop$borderMin$370,
$jscomp$loop$prop$borderMax$371:y.$jscomp$loop$prop$borderMax$371},B++){var A=z[B];y.$jscomp$loop$prop$borderMin$370=A.min;y.$jscomp$loop$prop$borderMax$371=A.max;var C=x.filter(function(E){return function(F){return F.damage>=E.$jscomp$loop$prop$borderMin$370&&F.damage<E.$jscomp$loop$prop$borderMax$371}}(y)).map(function(E){return E.rate});C=C.length===x.length?1:getArraySum(C);A.value=C;if(b.isAttacker||!c||t.type.includes(18)&&h){if(c&&t.type.includes(18)&&!h||!c&&[13,14].includes(t.type)){v+='<td class="text-center" colspan="'+
z.length+'">\u5bfe\u6f5c\u653b\u6483\u4e0d\u53ef</td>';D="";x=$jscomp.makeIterator(z);for(y=x.next();!y.done;y=x.next())y.value.value=0;break}if(1!==C||0!==B||n)1===C?v+='<td>100 <span class="font_size_11 font_color_half">%</span></td>':(A=Math.floor(1E3*C)/10,v+="<td>"+(0===A&&0!==C?.1:A)+' <span class="font_size_11 font_color_half">%</span></td>');else{v+='<td colspan="'+z.length+'" class="text-center text_red">\u78ba\u6bba</td>';break}}else v+="<td>-</td>",D=""}x=Math.floor(1E3*(z[0].value+z[1].value))/
...
function createDamageDistribution(a,b,c,d,e){for(var f=[],g=1/b,h=0;h<b;h++)for(var l=.7*b+.6*h,k={},m=$jscomp.makeIterator(a),n=m.next();!n.done;k={$jscomp$loop$prop$damage$389:k.$jscomp$loop$prop$damage$389},n=m.next())if(n=n.value,k.$jscomp$loop$prop$damage$389=0<n.power-l?Math.floor((n.power-l)*c):0,k.$jscomp$loop$prop$damage$389>=e&&!d)for(var q=1/e,p={},u=0;u<e;p={$jscomp$loop$prop$damage2$387:p.$jscomp$loop$prop$damage2$387},u++){p.$jscomp$loop$prop$damage2$387=Math.floor(.5*e+.3*u);var t=
g*n.rate*q,w=f.find(function(v){return function(r){return r.damage===v.$jscomp$loop$prop$damage2$387}}(p));w?w.rate+=t:f.push({damage:p.$jscomp$loop$prop$damage2$387,rate:t})}else n=g*n.rate,(q=f.find(function(v){return function(r){return r.damage===v.$jscomp$loop$prop$damage$389}}(k)))?q.rate+=n:f.push({damage:k.$jscomp$loop$prop$damage$389,rate:n});return f}
function updateDetailChart(a,b,c){for(var d=[],e=[],f=[],g=[],h=getArrayMax(a),l=getArrayMin(a),k=a.length,m=0,n=0,q=0,p=0,u=0,t={$jscomp$loop$prop$i$391:l};t.$jscomp$loop$prop$i$391<=h;t={$jscomp$loop$prop$i$391:t.$jscomp$loop$prop$i$391},t.$jscomp$loop$prop$i$391++){var w=a.filter(function(v){return function(r){return r===v.$jscomp$loop$prop$i$391}}(t)).length;w&&(d.push(t.$jscomp$loop$prop$i$391),e.push((100*w/k).toFixed(1E5<=k?5:1E4<=k?4:1E3<=k?3:2)),g.push({slot:t.$jscomp$loop$prop$i$391,rate:w/
k}),u+=100*w/k,f.push(u.toFixed(1)),!m&&50<=u&&(m=t.$jscomp$loop$prop$i$391),!n&&90<=u&&(n=t.$jscomp$loop$prop$i$391),!q&&95<=u&&(q=t.$jscomp$loop$prop$i$391),!p&&99<=u&&(p=t.$jscomp$loop$prop$i$391))}$("#detail_max").text(h);$("#detail_min").text(l);$("#detail_50").text(m);$("#detail_90").text(n);$("#detail_95").text(q);$("#detail_99").text(p);chartInstance?(chartInstance.data.labels=d,chartInstance.data.datasets[0].data=e,chartInstance.data.datasets[1].data=f,chartInstance.options.scales.xAxes[0].scaleLabel.labelString=
...
function getItemTooltipContext(a,b,c,d,e){c=void 0===c?0:c;d=void 0===d?0:d;e=void 0===e?0:e;var f=null;f=(void 0===b?0:b)?new LandBaseItem(a,c,d,e):new ShipItem(a,c,d,e);if(!f.id)return"";var g=ITEM_DATA.find(function(y){return y.id===f.id}),h=g.type;b=f.bonusAntiAir;c=Item.getBonusFire(h,d);e=Item.getBonusScout(h,d);var l=Item.getBonusTorpedo(h,d),k=Item.getBonusAccuracy(a,h,d),m=Item.getBonusBomber(a,h,d);h=Item.getBonusASW(a,h,d,g.antiAir);var n=RANGES.find(function(y){return y.id===g.range2});
n=g.range2&&n?n.name:"";d=d?'<span class="text_remodel">\u2605'+d+"</span>":"";var q=b?'<span class="ml-1 text_remodel">(+'+b.toFixed(2)+")</span>":"",p=c?'<span class="ml-1 text_remodel">(+'+c.toFixed(2)+")</span>":"",u=l?'<span class="ml-1 text_remodel">(+'+l.toFixed(2)+")</span>":"",t=m?'<span class="ml-1 text_remodel">(+'+m.toFixed(2)+")</span>":"",w=k?'<span class="ml-1 text_remodel">(+'+k.toFixed(2)+")</span>":"",v=h?'<span class="ml-1 text_remodel">(+'+h.toFixed(2)+")</span>":"",r=e?'<span class="ml-1 text_remodel">(+'+
e.toFixed(2)+")</span>":"",x=0<g.avoid?AVOID_TYPE.find(function(y){return y.id===g.avoid}):null,z=f.selectRate.length?f.selectRate.map(function(y){return(100*y).toFixed(0)+"%"}):null,D=PLANE_TYPE.includes(g.type)?getRequiredgBattleCountString(g.grow):null;return('\n\t<div class="text-left m-1 item_tooltip">\n\t\t<div>\n\t\t\t<img src="../img/type/icon'+g.itype+'.png" alt="'+g.itype+'" class="img-size-25">\n\t\t\t<span>'+g.name+"</span>"+d+'\n\t\t</div>\n\t\t<div class="d-flex flex-wrap my-1">\n\t\t\t'+
...
function showEnemyStatusToolTip(a){if(a.length&&a[0].dataset.enemyid){var b=ENEMY_DATA.find(function(k){return k.id===castInt(a[0].dataset.enemyid)});if(b){for(var c=new Enemy(b.id),d="",e=0,f={},g=0;g<b.eqp.length;f={$jscomp$loop$prop$itemId$393:f.$jscomp$loop$prop$itemId$393},g++){f.$jscomp$loop$prop$itemId$393=b.eqp[g];var h=b.slot[g],l=ENEMY_ITEM.find(function(k){return function(m){return m.id===k.$jscomp$loop$prop$itemId$393}}(f));l&&(e+=l.armor,d+='\n\t\t\t<div class="d-flex">\n\t\t\t\t<div class="align-self-center enemy_tool_slot">'+
...
var q=getArrayMax(f[k]),p=getArrayMin(f[k]),u=getArrayMax(g[k]),t=getArrayMin(g[k]);h+='\n\t\t<tr class="'+(m.isEscort?"escort_fleet":"main_fleet")+'">\n\t\t\t<td class="text-left text-truncate">\n\t\t\t\t<span class="font_size_11 '+(m.isEscort?"text-primary":"text-success")+'">'+(0<n?n:l)+".</span>\n\t\t\t\t<span>"+m.name+'</span>\n\t\t\t</td>\n\t\t\t<td class="rate_shoot_down">'+Math.floor(1E4*m.rateDown)/100+' %</td>\n\t\t\t<td class="fixed_shoot_down">'+(2<=g[k].length?t+" ~ "+u:u)+'</td>\n\t\t\t<td class="minimum_shoot_down">'+
(2<=f[k].length?p+" ~ "+q:q)+"</td>\n\t\t</tr>"}$("#antiair_input_table tbody").html(h);if(!d.innerHTML){b=document.createDocumentFragment();c={};a=$jscomp.makeIterator(a.allStage2);for(l=a.next();!l.done;c={$jscomp$loop$prop$stage2$277$395:c.$jscomp$loop$prop$stage2$277$395},l=a.next())c.$jscomp$loop$prop$stage2$277$395=l.value,h=ANTIAIR_CUTIN.find(function(w){return function(v){return v.id===w.$jscomp$loop$prop$stage2$277$395.cutin.id}}(c)),k=e.includes(h.id),f=document.createElement("div"),f.className=
...
var k=EXPANDED_SPECIAL_ITEM.filter(function(r){return r.shipApiIds.includes(h.api)});e={};k=$jscomp.makeIterator(k);for(var m=k.next();!m.done;e={$jscomp$loop$prop$sp$397:e.$jscomp$loop$prop$sp$397},m=k.next())e.$jscomp$loop$prop$sp$397=m.value,(m=ITEM_LIST.find(function(r){return function(x){return x.id===r.$jscomp$loop$prop$sp$397.itemId}}(e)))&&!g.includes(m.type)&&g.push(m.type),a.push(m)}setting.planeOnly&&(g=g.filter(function(r){return PLANE_TYPE.includes(r)}));var n=castInt($target.index());
...
r.id});if(1472===h.id){var p=FORBIDDEN_LINK_SHIP_ITEM.find(function(r){return r.shipId===h.id}).itemIDs;e=e.filter(function(r){return!p.includes(r.id)})}if(l){e=e.filter(function(r){return 34!==r.id&&87!==r.id});var u=a.map(function(r){return r.id});l={};a=$jscomp.makeIterator(a);for(k=a.next();!k.done;l={$jscomp$loop$prop$spItem$278$399:l.$jscomp$loop$prop$spItem$278$399},k=a.next())l.$jscomp$loop$prop$spItem$278$399=k.value,e=e.filter(function(r){return function(x){return u.includes(x.id)||r.$jscomp$loop$prop$spItem$278$399.type!==
...
function node_DoubleClicked(){$(".node_tr").hasClass("node_selected")&&!$(".node_selected").hasClass("is_night")&&($("#btn_expand_enemies").hasClass("d-none")?(btn_continue_expand_Clicked(),$(".node_tr").removeClass("node_selected")):btn_expand_enemies())}function btn_expand_enemies(){$(".node_selected").hasClass("is_night")||(expandEnemy(),$("#modal_enemy_pattern").modal("hide"))}
function btn_continue_expand_Clicked(){if(!$(".node_selected").hasClass("is_night")){var a=castInt($("#expand_target").text());1===a&&clearEnemyDivAll();createEnemyInput(a);$("#expand_target").text(a+1);$target=$(document.getElementsByClassName("battle_content")[a-1]);expandEnemy();$("#enemy_pattern_tbody").html("<div>"+a+" \u6226\u76ee\u306e\u6575\u8266\u968a\u304c\u633f\u5165\u3055\u308c\u307e\u3057\u305f\u3002</div><div>\u7d9a\u3051\u308b\u5834\u5408\u306f\u518d\u5ea6\u6226\u95d8\u30de\u30b9\u3092\u9078\u629e\u3057\u3066\u304f\u3060\u3055\u3044\u3002<div>");
...
d.$jscomp$loop$prop$planeId$406=castInt(b.getElementsByClassName("enemy_planes")[e].value);var g=ENEMY_ITEM.find(function(h){return function(l){return l.id===h.$jscomp$loop$prop$planeId$406}}(d));g?(c.slot.push(PLANE_TYPE.includes(g.type)?f:0),c.eqp.push(g.id)):(c.slot.push(-1),c.eqp.push(-1))}b=loadLocalStorage("manual_enemies")||[];d=b.findIndex(function(h){return h.id===c.id});0>d?b.push(c):b[d]=c;d=ENEMY_DATA.findIndex(function(h){return h.id===c.id});ENEMY_DATA[d]=c;saveLocalStorage("manual_enemies",
...
document.createDocumentFragment();b=1;c=[];for(e={$jscomp$loop$prop$ap$412:getArrayMax(d.map(function(m){return m.airPower}))};0<e.$jscomp$loop$prop$ap$412;e={$jscomp$loop$prop$ap$412:e.$jscomp$loop$prop$ap$412},e.$jscomp$loop$prop$ap$412--)f=d.filter(function(m){return function(n){return n.airPower===m.$jscomp$loop$prop$ap$412}}(e)).length,0<f&&c.push({rank:b++,airPower:e.$jscomp$loop$prop$ap$412,count:f});b=1;e={};c=$jscomp.makeIterator(c);for(f=c.next();!f.done;e={$jscomp$loop$prop$obj$414:e.$jscomp$loop$prop$obj$414},
f=c.next())for(e.$jscomp$loop$prop$obj$414=f.value,f=d.filter(function(m){return function(n){return n.airPower===m.$jscomp$loop$prop$obj$414.airPower}}(e)),g=0;g<f.length;g++){h=f[g];var l='\n\t\t\t\t<div class="d-flex">\n\t\t\t\t<img class="align-self-center plane_img_sm" src="../img/type/icon'+h.itype+'.png">\n\t\t\t\t<div class="align-self-center ml-1">'+h.name+"</div>\n\t\t\t\t\t"+(h.remodel?'<div class="align-self-center text_remodel font_size_12 ml-1"><i class="fas fa-star"></i>+'+h.remodel+
...
function createFuckingEnemiesRanking(){if(!document.getElementById("fucking_enemie_table_tbody").innerHTML){var a=ENEMY_DATA.map(function(q){var p=new Battle;p.enemies=[new Enemy(q.id)];p.createStage2Table();return p});a.sort(function(q,p){var u=q.stage2[0][1][0],t=p.stage2[0][1][0];if(u!==t)return t-u;u=q.enemies[0].antiAirBonus;t=p.enemies[0].antiAirBonus;if(u!==t)return t-u;u=q.stage2[0][0][0];t=p.stage2[0][0][0];return u!==t?t-u:p.enemies[0].id-q.enemies[0].id});var b=document.createDocumentFragment(),
...
b.sort(function(h,l){return h.grow===l.grow?h.type-l.type:h.grow-l.grow});for(var c=[],d={$jscomp$loop$prop$c$422:15};0<d.$jscomp$loop$prop$c$422;d={$jscomp$loop$prop$c$422:d.$jscomp$loop$prop$c$422},d.$jscomp$loop$prop$c$422--){var e=b.filter(function(h){return function(l){return l.grow===h.$jscomp$loop$prop$c$422}}(d));e.length&&c.push({c:d.$jscomp$loop$prop$c$422,planes:e})}b=$jscomp.makeIterator(c);for(c=b.next();!c.done;c=b.next())for(c=c.value,d=0;d<c.planes.length;d++){e=c.planes[d];var f=
...
$("#main").on("click",".btn_reset_content",function(){btn_reset_content_Clicked($(this))});$("#main").on("click",".btn_content_trade",function(){btn_content_trade_Clicked($(this))});$("#main").on("click",".btn_commit_trade",commit_content_order);$("#main").on("click",".btn_ex_setting",function(){btn_ex_setting_Clicked($(this))});$("#main_header_info").on("click","input",function(){display_special_Changed($(this))});$("#site_warning").on("click",".cur_pointer",function(){$("#site_warning").removeClass("d-flex").addClass("d-none")});
$("#landBase").on("click",".btn_air_raid",btn_air_raid_Clicked);$("#landBase").on("click","#alert_air_raid_button",btn_air_raid_Clicked);$("#landBase").on("click",".btn_supply",btn_supply_Clicked);$("#landBase_content").on("change",".ohuda_select",function(){calculate(!0,!1,!1)});$("#landBase_content").on("click",".btn_remove_plane",function(){btn_remove_lb_plane_Clicked($(this))});$("#landBase_content").on("click",".btn_reset_landBase",function(){btn_reset_landBase_Clicked($(this))});$("#landBase_content").on("click",
".prof_item",function(){proficiency_Changed($(this))});$("#landBase_content").on("click",".btn_show_contact_rate_lb",function(){btn_show_contact_rate_lb_Clicked($(this))});$("#landBase_content").on("click",".btn_toggle_lb_info",function(){btn_toggle_lb_info_Clicked($(this))});$("#landBase_content").on("click","#toggle_def_mode",toggle_def_mode_Checked);$("#landBase_content").on("click",".simple_lb_progress",function(){simple_lb_progress_Clicked($(this))});$("#landBase_content").on("click",".plane_name",
function(){plane_name_Clicked($(this))});$("#landBase_content").on("touchend",".plane_name",function(){plane_name_Clicked($(this))});$("#friendFleet_content").on("click",".plane_name",function(){plane_name_Clicked($(this))});$("#friendFleet_content").on("touchend",".plane_name",function(){plane_name_Clicked($(this))});$("#friendFleet_content").on("click",".btn_ship_create",function(){btn_ship_create_Clicked($(this))});$("#friendFleet_content").on("click",".btn_reset_ship_plane",function(){btn_reset_ship_plane_Clicked($(this))});
...
".btn_reset_ship_plane");$("#friendFleet_content").on("click",".prof_item",function(){proficiency_Changed($(this))});$("#friendFleet_content").on("click",".btn_ship_toggle",function(){btn_ship_toggle_Clicked($(this))});$("#friendFleet_content").on("click",".ship_disabled",function(){ship_disabled_Changed($(this))});$("#friendFleet_content").on("click","#union_fleet",union_fleet_Checked);$("#friendFleet_content").on("click","#yugeki_fleet",yugeki_fleet_Checked);$("#friendFleet_content").on("click",
"#visible_anti_air_status",visible_anti_air_status_Clicked);$('#friendFleet_content .nav-link[data-toggle="tab"]').on("shown.bs.tab",fleet_select_tab_Clicked);$("#friendFleet_content").on("click",".plane_lock",function(){plane_lock_Clicked($(this))});$("#friendFleet_content").on("click",".plane_unlock",function(){plane_unlock_Clicked($(this))});$("#friendFleet_content").on("click",".slot_ini",function(){slot_ini_Clicked($(this))});$("#friendFleet_content").on("click",".btn_show_contact_rate",function(){btn_show_contact_rate_Clicked()});
$("#friendFleet_content").on("click",".btn_antiair_input",btn_antiair_input_Clicked);$("#friendFleet_content").on("click",".form_ship_level",function(){form_ship_level_Clicked($(this))});$("#friendFleet_content").on("click",".form_ship_luck",function(){form_ship_luck_Clicked($(this))});$("#friendFleet_content").on("input","#admin_lv",admin_lv_Changed);$("#enemyFleet_content").on("change",".cell_type",function(){cell_type_Changed($(this))});$("#enemyFleet_content").on("change",".formation",function(){calculate(!1,
!1,!0)});$("#enemyFleet_content").on("click",".enemy_content",function(){enemy_name_Clicked($(this))});$("#enemyFleet_content").on("click",".btn_reset_battle",function(){btn_reset_battle_Clicked($(this))});$("#enemyFleet_content").on("click","#btn_world_expand",btn_world_expand_Clicked);$("#enemyFleet_content").on("click",".btn_enemy_preset",function(){btn_enemy_preset_Clicked($(this))});$("#enemyFleet_content").on("click",".btn_stage2",function(){btn_stage2_Clicked($(this))});$("#enemyFleet_content").on("change",
"#battle_count",function(){battle_count_Changed($(this))});$("#enemyFleet_content").on("click","#btn_lb_target",btn_lb_target_Clicked);$("#enemyFleet_content").on("click",'input[name="enemy_fleet_display_mode"]',function(){enemy_fleet_display_mode_Changed($(this))});$("#result").on("click","#btn_calculate",function(){calculate(!1,!1,!1)});$("#result_content").on("click","#btn_more_calc",btn_more_calc_Clicked);$("#result_content").on("click","#display_battle_tab .nav-item",function(){display_battle_tab_Changed($(this))});
$("#result_content").on("click","#empty_slot_invisible",function(){calculate(!1,!1,!1)});$("#result_content").on("click","#display_setting .custom-check",display_result_Changed);$("#result_content").on("click","#shoot_down_table_tbody tr",function(){fleet_slot_Clicked($(this))});$("#result_content").on("click","#rate_table .land_base_detail",function(){land_base_detail_Clicked($(this))});$("#result_content").on("click","#result_bar .progress_area",function(){land_base_bar_Clicked($(this))});$("#result_content").on("click",
"#enemy_shoot_down_tbody .td_detail_slot",function(){enemy_slot_Clicked($(this))});$("#result_content").on("click",".btn_antiair_input",btn_antiair_input_Clicked);$("#result_content").on("click","#adapt_stage2",function(){calculate(!1,!0,!1)});$("#result_content").on("change","#fleet_formation",function(){calculate(!1,!1,!1)});$("#config_content").on("focus","#calculate_count",function(){$(this).select()});$("#config_content").on("input","#calculate_count",function(){calculate_count_Changed($(this))});
...
$("#modal_plane_select").on("click",".btn_remove",function(){modal_plane_select_btn_remove_Clicked($(this))});$("#modal_plane_select").on("click","#plane_type_select .item_type",function(){plane_type_select_Changed($(this))});$("#modal_plane_select").on("click","#fav_only",fav_only_Checked_Chenged);$("#modal_plane_select").on("click","#disp_in_stock",disp_in_stock_Checked_Chenged);$("#modal_plane_select").on("click","#divide_stock",divide_stock_Checked_Chenged);$("#modal_plane_select").on("click",
"#disp_equipped",disp_equipped_Checked_Chenged);$("#modal_plane_select").on("click","#disp_special",function(){plane_type_select_Changed()});$("#modal_plane_select").on("input","#plane_word",plane_word_TextChanged);$("#modal_plane_select").on("change","#plane_sort_select",function(){sort_Changed($(this))});$("#modal_plane_select").on("change","#plane_filter_key_select",plane_filter_Changed);$("#modal_plane_select").on("change","#plane_filter_value",plane_filter_Changed);$("#modal_plane_select").on("click",
".toggle_display_type",function(){plane_type_select_Changed()});$("#modal_plane_select").on("click","#plane_only",plane_only_Clicked);$("#modal_plane_select").on("click","#plane_table_thead .sortable_td",function(){sortable_td_Clicked($(this))});$("#modal_plane_preset").on("click",".preset_tr",function(){plane_preset_tr_Clicked($(this))});$("#modal_plane_preset").on("click",".btn_commit_preset",function(){btn_commit_plane_preset_Clicked($(this))});$("#modal_plane_preset").on("click",".btn_delete_preset",
function(){btn_delete_plane_preset_Clicked($(this))});$("#modal_plane_preset").on("click",".btn_expand_preset",btn_expand_plane_preset_Clicked);$("#modal_ship_select").on("click",".ship_tr:not(.ship_tr_disabled)",function(){modal_ship_Selected($(this))});$("#modal_ship_select").on("click",".btn_remove",function(){modal_ship_select_btn_remove_Clicked($(this))});$("#modal_ship_select").on("click","#display_final",createShipTable);$("#modal_ship_select").on("click","#frequent_ship",createShipTable);
$("#modal_ship_select").on("click","#fav_only_ship",createShipTable);$("#modal_ship_select").on("click","#disp_in_stock_ship",createShipTable);$("#modal_ship_select").on("click","#disp_equipped_ship",createShipTable);$("#modal_ship_select").on("click","#ship_type_select .ship_type",function(){ship_type_select_Changed($(this))});$("#modal_ship_select").on("click","#has_slot_only",has_slot_only_Clicked);$("#modal_ship_select").on("click",".toggle_display_type",createShipTable);$("#modal_ship_select").on("input",
"#ship_word",ship_word_TextChanged);$("#modal_enemy_select").on("click",".modal-body .enemy",function(){modal_enemy_Selected($(this))});$("#modal_enemy_select").on("click",".btn_remove",function(){modal_enemy_select_btn_remove($(this))});$("#modal_enemy_select").on("click",".toggle_display_type",createEnemyTable);$("#modal_enemy_select").on("change","#enemy_type_select",createEnemyTable);$("#modal_enemy_select").on("input","#enemy_word",enemy_word_TextChanged);$("#modal_enemy_pattern").on("show.bs.modal",
modal_enemy_pattern_Shown);$("#modal_enemy_pattern").on("click",".node_tr",function(){node_tr_Clicked($(this))});$("#modal_enemy_pattern").on("click","#btn_zoom_map",btn_zoom_map_Clicked);$("#modal_enemy_pattern").on("change","#map_select",createNodeSelect);$("#modal_enemy_pattern").on("change","#node_select",createEnemyPattern);$("#modal_enemy_pattern").on("change","#select_difficulty",createNodeSelect);$("#modal_enemy_pattern").on("click","#btn_expand_enemies",btn_expand_enemies);$("#modal_enemy_pattern").on("click",
"#btn_continue_expand",btn_continue_expand_Clicked);$("#modal_enemy_pattern").on("click",".node",function(){node_Clicked($(this))});$("#modal_enemy_pattern").on("click","#enemy_pattern_select .nav-link:not(.active)",function(){pattern_Changed($(this))});$("#modal_enemy_pattern").on("click",'input[name="enemy_display_mode"]',function(){enemy_display_mode_Changed($(this))});$("#modal_enemy_pattern").on("dblclick",".node",node_DoubleClicked);$("#modal_enemy_pattern").on("dblclick",".node_tr",node_DoubleClicked);
$("#modal_enemy_pattern").on("dblclick","#enemy_pattern_select .nav-link.active",node_DoubleClicked);$("#modal_big_map").on("hidden.bs.modal",function(){$(document.body).addClass("modal-open")});$("#modal_main_preset").on("show.bs.modal",modal_main_preset_Shown);$("#modal_main_preset").on("change","#select_preset_category",select_preset_category_Changed);$("#modal_main_preset").on("click",".btn_commit_preset",btn_commit_main_preset_Clicked);$("#modal_main_preset").on("click","#allow_upload_preset",
allow_upload_preset_Clicked);$("#modal_main_preset").on("click","#btn_upload_preset",btn_upload_preset_Clicked);$("#modal_main_preset").on("input","#input_preset_name",function(){preset_name_Changed($(this))});$("#modal_main_preset").on("input","#preset_remarks",function(){preset_remarks_Changed($(this))});$("#modal_share").on("click",".btn_load_deck",btn_load_deck_Clicked);$("#modal_share").on("input","#input_deck",function(){input_deck_Changed($(this))});$("#modal_share").on("focus","#input_deck",
function(){$(this).select()});$("#modal_share").on("click",".btn_output_url",btn_output_url_Clicked);$("#modal_share").on("click",".btn_output_deck",btn_output_deck_Clicked);$("#modal_share").on("focus","#output_url",function(){$(this).select()});$("#modal_share").on("focus","#output_deck",function(){$(this).select()});$("#modal_share").on("input","#output_url",function(){output_data_Changed($(this))});$("#modal_share").on("input","#output_deck",function(){output_data_Changed($(this))});$("#modal_share").on("click",
"#output_url",function(){output_data_Clicked($(this))});$("#modal_share").on("click","#output_deck",function(){output_data_Clicked($(this))});$("#modal_share").on("click","#open_deckBuilder",open_deckBuilder);$("#modal_share").on("click","#open_jervis",open_Jervis);$("#modal_result_detail").on("click","#btn_calculate_detail",btn_calculate_detail);$("#modal_result_detail").on("change","#detail_calculate_count",function(){return $("#btn_calculate_detail").prop("disabled",!1)});$("#modal_result_detail").on("change",
".custom-radio",btn_calculate_detail);$("#modal_result_detail").on("change","#target_enemy",btn_calculate_detail);$("#modal_result_detail").on("change","#enabled_manual_stage2",btn_calculate_detail);$("#modal_result_detail").on("change","#aa_cutin_miss",btn_calculate_detail);$("#modal_result_detail").on("click","#critical_hit",stage3PowerCalculate);$("#modal_result_detail").on("click","#stage3_all_slot",stage3PowerCalculate);$("#modal_result_detail").on("click","#enabled_rikutei",stage3PowerCalculate);
$("#modal_result_detail").on("click","#enabled_rikutei_z",stage3PowerCalculate);$("#modal_result_detail").on("click","#manual_enemy_union",stage3PowerCalculate);$("#modal_result_detail").on("click","#manual_union_main",stage3PowerCalculate);$("#modal_result_detail").on("click","#manual_union_escort",stage3PowerCalculate);$("#modal_result_detail").on("click","#btn_apply_search",stage3PowerCalculate);$("#modal_result_detail").on("click","#hp_1",stage3PowerCalculate);$("#modal_result_detail").on("click",
"#hp_2",stage3PowerCalculate);$("#modal_result_detail").on("click","#jet_phase",stage3PowerCalculate);$("#modal_result_detail").on("change","#contact_bonus",stage3PowerCalculate);$("#modal_result_detail").on("change","#ammo_bonus",stage3PowerCalculate);$("#modal_result_detail").on("change","#manual_enemy_type",manual_enemy_type_Changed);$("#modal_result_detail").on("change","#manual_enemy_id",stage3PowerCalculate);$("#modal_result_detail").on("input","#stage3_slot",stage3PowerCalculate);$("#modal_result_detail").on("input",
"#ship_bonus",stage3PowerCalculate);$("#modal_result_detail").on("input","#stage3_remodel",stage3PowerCalculate);$("#modal_result_detail").on("focus",'input[type="number"]:not([readonly])',function(){$(this).select()});$("#modal_result_detail").on("click","#show_detail_slot .nav-item",function(){detail_slot_tab_Changed($(this))});$("#modal_result_detail").on("click",".btn_show_detail:not(.disabled)",function(){btn_show_detail_Clicked($(this))});$("#modal_result_detail").on("click","#btn_output_slot_dist",
...
$("#modal_stage2_detail").on("input","#free_anti_air_bornus",function(){free_modify_input_Changed($(this))});$("#modal_contact_detail").on("change",".custom-check",contact_detail_redraw);$("#modal_fleet_antiair_input").on("change","#antiair_air_raid",updateFleetStage2Table);$("#modal_fleet_antiair_input").on("change","#fleet_antiair_formation",updateFleetStage2Table);$("#modal_fleet_antiair_input").on("click",".anti_air_cutin_toggle",function(){anti_air_cutin_toggle_Clicked($(this))});$("#modal_manual_enemy").on("input",
...
$("#modal_preset_memo").on("click",".btn_commit_preset",function(){btn_commit_preset_memo_Clicked($(this))});$("#modal_ship_reserve").on("click","#btn_add_reserve",btn_add_reserve_Clicked);$("#modal_ship_reserve").on("click",".reserve_ship",function(){reserve_ship_Clicked($(this))});$("#modal_ship_reserve").on("click",".btn_remove_reserve",function(a){btn_remove_reserve_Clicked($(this),a)});$("#modal_ship_reserve").on("click",".btn_reset",btn_reset_reserve_Clicked);$("#modal_include_selector").on("click",
".fleet_selectable",function(){fleet_selectable_Clicked($(this))});$("#modal_include_selector").on("click","#btn_include_deck",btn_include_deck_Clicked);$("#modal_reference").on("click","#anti_air_ranking_normal_registed",createAirPowerRanking);$("#modal_reference").on("click","#anti_air_ranking_defense_registed",createDefenceRanking);$("#modal_reference").on("click","#recover_planes_checkes .custom-check",createRecoverPlaneTable);$("#btn_save_preset").click(btn_save_preset_Clicked);$("#btn_save_preset_sub").click(btn_save_preset_sub_Clicked);
$("#btn_reference").click(btn_reference_Clicked);$("#btn_twitter").click(btn_twitter_Clicked);$("#btn_share").click(function(){$("#modal_share").modal("show")});$("#btn_undo").click(btn_undo_Clicked);$("#btn_redo").click(btn_redo_Clicked);$("#input_url").click(function(){$(this).select()});$("#btn_url_shorten").click(btn_url_shorten_Clicked);$("#tool_bar").on({mouseenter:function(){showTooltip($(this)[0],"\u30c7\u30c3\u30ad\u30d3\u30eb\u30c0\u30fc\u5f62\u5f0f\u306e\u7de8\u6210\u306e\u8aad\u307f\u8fbc\u307f\u3084\u3001URL\u306e\u77ed\u7e2e\u3001\u6240\u6301\u88c5\u5099\u3084\u6240\u6301\u8266\u5a18\u60c5\u5831\u306e\u53cd\u6620\u304c\u53ef\u80fd\u3067\u3059\u3002")},
mouseleave:function(){hideTooltip($(this)[0])}},"#btn_url_shorten");$("#landBase_content").on({mouseenter:function(){showItemToolTip($(this).parent(),!0)},mouseleave:function(){hideTooltip($(this).parent()[0])}},".plane_img");$("#friendFleet_content").on({mouseenter:function(){showItemToolTip($(this).parent())},mouseleave:function(){hideTooltip($(this).parent()[0])}},".plane_img");$("#friendFleet_content").on({mouseenter:function(){showTooltip($(this)[0],"\u30ed\u30c3\u30af\u3059\u308b\u3068\u3001\u304a\u307e\u304b\u305b\u914d\u5099\u4f7f\u7528\u6642\u306b\u3053\u306e\u30b9\u30ed\u30c3\u30c8\u306e\u4e0a\u66f8\u304d\u3092\u4fdd\u8b77\u3067\u304d\u307e\u3059\u3002")},
