...
10))):(e.addClass("remodel_disabled"),e.find(".remodel_value").text(0));e=a.find(".item_special");PLANE_TYPE.includes(d.type)?SPECIAL_A.includes(d.id)?(e.removeClass("d-none"),e.html("A")):SPECIAL_B.includes(d.id)?(e.removeClass("d-none"),e.html("B")):SPECIAL_C1.includes(d.id)?(e.removeClass("d-none"),e.html('C<span class="font_size_8">1</span>')):SPECIAL_C2.includes(d.id)?(e.removeClass("d-none"),e.html('C<span class="font_size_8">2</span>')):SPECIAL_C3.includes(d.id)?(e.removeClass("d-none"),e.html('C<span class="font_size_8">3</span>')):
SPECIAL_C4.includes(d.id)?(e.removeClass("d-none"),e.html('C<span class="font_size_8">4</span>')):e.addClass("d-none"):e.addClass("d-none");e=0;var f=setting.defaultProf.find(function(g){return g.id===d.type});f&&(e=f.prof);312===d.id&&(e=2);0<=b.prof&&(e=b.prof);f=a.find(".prof_select");f.attr("src","../img/util/prof"+e+".png");f[0].dataset.prof=e;c&&(b.hasOwnProperty("slot")||(b.slot=0),a.find(".slot").text(b.slot));return!0}
