...
$("#main");var g=[];d=[];var h=[];f=$("#footer_info");c.find(".contents").each(function(m,n){g.push($(n).attr("id"));h.push($(n))});c.empty();var l={},k=$jscomp.makeIterator(setting.contentsOrder);for(e=k.next();!e.done;l={$jscomp$loop$prop$id$159$296:l.$jscomp$loop$prop$id$159$296},e=k.next())l.$jscomp$loop$prop$id$159$296=e.value,g.includes(l.$jscomp$loop$prop$id$159$296)&&(e=h.find(function(m){return function(n){return n.attr("id")===m.$jscomp$loop$prop$id$159$296}}(l)),c.append(e),d.push(l.$jscomp$loop$prop$id$159$296));
c.append(f);if(g.length!==d.length){f={};l=$jscomp.makeIterator(g);for(e=l.next();!e.done;f={$jscomp$loop$prop$id$160$298:f.$jscomp$loop$prop$id$160$298},e=l.next())f.$jscomp$loop$prop$id$160$298=e.value,d.includes(f.$jscomp$loop$prop$id$160$298)||(e=h.find(function(m){return function(n){return n.attr("id")===m.$jscomp$loop$prop$id$160$298}}(f)),c.append(e),d.push(f.$jscomp$loop$prop$id$160$298));setting.contentsOrder=d.concat();saveSetting()}}$("#stage2_detail_slot").val(18);$("#stage2_detail_avoid").val(0);
...
10))):(e.addClass("remodel_disabled"),e.find(".remodel_value").text(0));PLANE_TYPE.includes(d.type)&&(e=a.find(".item_special"),SPECIAL_A.includes(d.id)?(e.removeClass("d-none"),e.html("A")):SPECIAL_B.includes(d.id)?(e.removeClass("d-none"),e.html("B")):SPECIAL_C1.includes(d.id)?(e.removeClass("d-none"),e.html('C<span class="font_size_8">1</span>')):SPECIAL_C2.includes(d.id)?(e.removeClass("d-none"),e.html('C<span class="font_size_8">2</span>')):SPECIAL_C3.includes(d.id)?(e.removeClass("d-none"),
e.html('C<span class="font_size_8">3</span>')):SPECIAL_C4.includes(d.id)?(e.removeClass("d-none"),e.html('C<span class="font_size_8">4</span>')):e.addClass("d-none"));e=0;var f=setting.defaultProf.find(function(g){return g.id===d.type});f&&(e=f.prof);312===d.id&&(e=2);0<=b.prof&&(e=b.prof);f=a.find(".prof_select");f.attr("src","../img/util/prof"+e+".png");f[0].dataset.prof=e;c&&(b.hasOwnProperty("slot")||(b.slot=0),a.find(".slot").text(b.slot));return!0}
...
$("#disp_equipped").closest("div").removeClass("d-none"),$("#disp_in_stock").prop("checked",!0)):($("#divide_stock").closest("div").addClass("d-none"),$("#disp_equipped").closest("div").addClass("d-none"),$("#disp_in_stock").prop("checked",!1));c=a.length;var v=0;d=0;for(var r=-1,x=0,y={},D=0;D<c;y={$jscomp$loop$prop$item$304:y.$jscomp$loop$prop$item$304},D++)if(y.$jscomp$loop$prop$item$304=a[D],!n||setting.favoritePlane.includes(y.$jscomp$loop$prop$item$304.id)){if(l&&h){var z=p.find(function(M){return function(K){return K.id===
M.$jscomp$loop$prop$item$304.id}}(y));if(k){if(-1===y.$jscomp$loop$prop$item$304.stock)continue;r=y.$jscomp$loop$prop$item$304.stock-(z?z.num[y.$jscomp$loop$prop$item$304.remodel]:0);if(!m&&1>r)continue;d=y.$jscomp$loop$prop$item$304.remodel}else{if(0<=y.$jscomp$loop$prop$item$304.stock)continue;var B=h.find(function(M){return function(K){return K.id===M.$jscomp$loop$prop$item$304.id}}(y)),A=z?getArraySum(z.num):0;x=B?getArraySum(B.num):0;if(0===x||!m&&A>=x)continue;r=x-A;for(x=10;0<=x;x--)if(z&&
(B.num[x]-=z.num[x]),0<B.num[x]){d=x;break}}}else if(0<y.$jscomp$loop$prop$item$304.remodel||0<=y.$jscomp$loop$prop$item$304.stock)continue;B="";B="multi"===g?"tr_multi px-1":"px-2";z=document.createElement("div");z.className="plane plane_tr general_tr d-flex py-2 py-lg-1 "+B;z.dataset.planeid=y.$jscomp$loop$prop$item$304.id;z.dataset.type=y.$jscomp$loop$prop$item$304.type;z.dataset.remodel=d;l&&m&&0>=r&&(z.classList.remove("plane_tr","plane","general_tr"),z.classList.add("plane_tr_disabled"));B=
document.createElement("div");B.className="align-self-center size-25 relative";x=document.createElement("canvas");A=x.getContext("2d");x.width=25;x.height=25;A.drawImage(IMAGES["type"+y.$jscomp$loop$prop$item$304.itype],0,0,25,25);if(PLANE_TYPE.includes(y.$jscomp$loop$prop$item$304.type))if(SPECIAL_A.includes(y.$jscomp$loop$prop$item$304.id))A=document.createElement("div"),A.className="item_special flash A",A.textContent="A",B.appendChild(A);else if(SPECIAL_B.includes(y.$jscomp$loop$prop$item$304.id))A=
document.createElement("div"),A.className="item_special flash B",A.textContent="B",B.appendChild(A);else if(SPECIAL_C1.includes(y.$jscomp$loop$prop$item$304.id))A=document.createElement("div"),A.className="item_special flash C1",A.innerHTML='C<span class="font_size_8">1</span>',B.appendChild(A);else if(SPECIAL_C2.includes(y.$jscomp$loop$prop$item$304.id))A=document.createElement("div"),A.className="item_special flash C2",A.innerHTML='C<span class="font_size_8">2</span>',B.appendChild(A);else if(SPECIAL_C3.includes(y.$jscomp$loop$prop$item$304.id))A=
document.createElement("div"),A.className="item_special flash C3",A.innerHTML='C<span class="font_size_8">3</span>',B.appendChild(A);else if(SPECIAL_C4.includes(y.$jscomp$loop$prop$item$304.id))A=document.createElement("div"),A.className="item_special flash C4",A.innerHTML='C<span class="font_size_8">4</span>',B.appendChild(A);else{if(t)continue}else if(t)continue;A=document.createElement("div");A.className="pl-1 d-flex align-self-center flex-grow-1";var C=!1;if(16===y.$jscomp$loop$prop$item$304.itype&&
8<=y.$jscomp$loop$prop$item$304.antiAir)C=!0;else if(21===y.$jscomp$loop$prop$item$304.type&&9<=y.$jscomp$loop$prop$item$304.antiAir)C=!0;else if(350===y.$jscomp$loop$prop$item$304.id||351===y.$jscomp$loop$prop$item$304.id||352===y.$jscomp$loop$prop$item$304.id)C=!0;var E=document.createElement("div");E.className="pl-1 plane_td_name align-self-center"+(C?" special_item":"");E.textContent=y.$jscomp$loop$prop$item$304.name;A.appendChild(E);C=document.createElement("div");C.className="ml-2 plane_td_stock align-self-center";
C.textContent="\u00d7"+(0<r?r:0);E=document.createDocumentFragment();var F=document.createElement("div");F.className="ml-auto plane_td_basic align-self-center";var H=document.createElement("div");H.className="plane_td_basic align-self-center";var G=document.createElement("div");G.className="plane_td_basic align-self-center d-none d-lg-block";var I=document.createElement("div");I.className="plane_td_basic align-self-center d-none d-lg-block";var L=document.createElement("div");L.className="plane_td_basic align-self-center d-none d-lg-block";
F.textContent=sFormat(y.$jscomp$loop$prop$item$304[u[0]],u[0]);H.textContent=sFormat(y.$jscomp$loop$prop$item$304[u[1]],u[1]);G.textContent=sFormat(y.$jscomp$loop$prop$item$304[u[2]],u[2]);I.textContent=sFormat(y.$jscomp$loop$prop$item$304[u[3]],u[3]);L.textContent=sFormat(y.$jscomp$loop$prop$item$304[u[4]],u[4]);if("multi"===g&&v!==y.$jscomp$loop$prop$item$304.type&&"default"===q){v=document.createElement("div");v.className="type_divider mt-3 mb-1";var J=document.createElement("div");J.className=
"font_size_12 font_color_half align-self-center";J.textContent=ITEM_API_TYPE.find(function(M){return function(K){return K.id===M.$jscomp$loop$prop$item$304.type}}(y)).name;var N=document.createElement("div");N.className="flex-grow-1 border-bottom align-self-center mx-2";v.appendChild(J);v.appendChild(N);f.appendChild(v)}B.appendChild(x);z.appendChild(B);k&&0<y.$jscomp$loop$prop$item$304.remodel&&(v=document.createElement("div"),v.className="plane_td_remodel text_remodel align-self-center",v.dataset.remodel=
y.$jscomp$loop$prop$item$304.remodel,B="",B="multi"===g?"\u2605"+y.$jscomp$loop$prop$item$304.remodel:10>y.$jscomp$loop$prop$item$304.remodel?"\u2605+"+y.$jscomp$loop$prop$item$304.remodel:"\u2605MAX",v.textContent=B,A.appendChild(v),A.appendChild(C));0<r&&A.appendChild(C);z.appendChild(A);"single"===g&&(E.appendChild(F),E.appendChild(H),E.appendChild(G),E.appendChild(I),E.appendChild(L),z.appendChild(E));f.appendChild(z);v=y.$jscomp$loop$prop$item$304.type}f.childNodes.length||(g=document.createElement("div"),
g.className="text-center",l&&!m&&(g.textContent+="\u88c5\u5099\u6240\u6301\u6570\u304c\u767b\u9332\u3055\u308c\u3066\u3044\u306a\u3044\u304b\u3001\u5168\u3066\u306e\u88c5\u5099\u304c\u914d\u5099\u6e08\u307f\u3067\u3059\u3002"),l&&!m&&(g.textContent+="\u88c5\u5099\u6240\u6301\u6570\u304c\u767b\u9332\u3055\u308c\u3066\u3044\u306a\u3044\u304b\u3001\u5168\u3066\u306e\u88c5\u5099\u304c\u914d\u5099\u6e08\u307f\u3067\u3059\u3002"));e.innerHTML="";e.appendChild(f)}
...
l;saveSetting();g?$("#disp_equipped_ship").closest("div").removeClass("d-none"):$("#disp_equipped_ship").closest("div").addClass("d-none");var q=SHIP_DATA.filter(function(A){return e?A.name.includes(e):n.includes(A.type)&&(d?0<A["final"]:!0)});setting.hasSlotOnly&&(q=q.filter(function(A){return A.slot.some(function(C){return 0<C})}));if(l){var p=setting.favoriteShip;q=q.filter(function(A){return p.includes(A.id)})}if(g){l={};m=$jscomp.makeIterator(k);for(var t=m.next();!t.done;l={$jscomp$loop$prop$stock$306:l.$jscomp$loop$prop$stock$306,
$jscomp$loop$prop$baseLv$307:l.$jscomp$loop$prop$baseLv$307,$jscomp$loop$prop$baseArea$308:l.$jscomp$loop$prop$baseArea$308},t=m.next())if(l.$jscomp$loop$prop$stock$306=t.value,!(0>=l.$jscomp$loop$prop$stock$306.details.length||(l.$jscomp$loop$prop$stock$306.details.sort(function(A,C){return A.lv-C.lv}),t=q.findIndex(function(A){return function(C){return C.id===A.$jscomp$loop$prop$stock$306.id}}(l)),0>t))){var u=q[t];l.$jscomp$loop$prop$baseLv$307=l.$jscomp$loop$prop$stock$306.details[0].lv;l.$jscomp$loop$prop$baseArea$308=
l.$jscomp$loop$prop$stock$306.details[0].area<=MAX_AREA?l.$jscomp$loop$prop$stock$306.details[0].area:0;u.lv=l.$jscomp$loop$prop$baseLv$307;u.area=l.$jscomp$loop$prop$baseArea$308;u.stock=l.$jscomp$loop$prop$stock$306.details.filter(function(A){return function(C){return C.lv===A.$jscomp$loop$prop$baseLv$307&&C.area===A.$jscomp$loop$prop$baseArea$308}}(l)).length;var w=[{lv:l.$jscomp$loop$prop$baseLv$307,area:l.$jscomp$loop$prop$baseArea$308}];if(2<=l.$jscomp$loop$prop$stock$306.details.length)for(var v=
...
Object.assign({},u);x.lv=v.$jscomp$loop$prop$lv$312;x.area=v.$jscomp$loop$prop$area$313;x.stock=l.$jscomp$loop$prop$stock$306.details.filter(function(A){return function(C){return C.lv===A.$jscomp$loop$prop$lv$312&&C.area===A.$jscomp$loop$prop$area$313}}(v)).length;q.splice(t,0,x);w.push({lv:v.$jscomp$loop$prop$lv$312,area:v.$jscomp$loop$prop$area$313})}}}if(f&&setting.selectedHistory[1]){var y=setting.selectedHistory[1];q.sort(function(A,C){return y.filter(function(E){return E===C.id}).length-y.filter(function(E){return E===
A.id}).length})}q.sort(function(A,C){return 7===A.type&&7!==C.type||7===C.type&&7!==A.type?C.type-A.type:6===A.type&&6!==C.type||6===C.type&&6!==A.type?C.type-A.type:10===A.type&&10!==C.type||10===C.type&&10!==A.type?C.type-A.type:A.type-C.type});l=document.createDocumentFragment();t=w=0;m={};q=$jscomp.makeIterator(q);for(u=q.next();!u.done;m={$jscomp$loop$prop$ship$317:m.$jscomp$loop$prop$ship$317},u=q.next()){m.$jscomp$loop$prop$ship$317=u.value;v=1;if(g&&k){if(!m.$jscomp$loop$prop$ship$317.lv)continue;
m.$jscomp$loop$prop$ship$317.stock&&(v=m.$jscomp$loop$prop$ship$317.stock);u=usedShip.filter(function(A){return function(C){return C.id===A.$jscomp$loop$prop$ship$317.id&&C.lv===A.$jscomp$loop$prop$ship$317.lv&&C.area===A.$jscomp$loop$prop$ship$317.area}}(m)).length;v-=u;if(0>=v&&!h)continue}u=document.createElement("div");u.className=g&&h&&!v?"ship_tr ship_tr_disabled d-flex "+("multi"===c?"tr_multi":""):"ship_tr general_tr d-flex "+("multi"===c?"tr_multi":"");u.dataset.shipid=m.$jscomp$loop$prop$ship$317.id;
u.dataset.level=m.$jscomp$loop$prop$ship$317.lv?m.$jscomp$loop$prop$ship$317.lv:99;u.dataset.area=0<m.$jscomp$loop$prop$ship$317.area?m.$jscomp$loop$prop$ship$317.area:0;u.id="ship_tr_"+m.$jscomp$loop$prop$ship$317.id;r=document.createElement("div");r.className="ml-1 align-self-center pt-1";x=document.createElement("img");x.width=120;x.height=30;x.src="../img/ship/"+m.$jscomp$loop$prop$ship$317.id+".png";r.appendChild(x);g&&0<m.$jscomp$loop$prop$ship$317.area&&(r.classList.add("exist_area"),x=document.createElement("img"),
x.className="area_banner",x.src="../img/util/area"+m.$jscomp$loop$prop$ship$317.area+".png",r.appendChild(x));x=document.createElement("div");x.className="ml-1 align-self-center";var D=document.createElement("div");D.className="text-primary font_size_11";D.textContent=g?"Lv : "+m.$jscomp$loop$prop$ship$317.lv:"ID : "+m.$jscomp$loop$prop$ship$317.id;var z=document.createElement("div");z.className="d-flex";z.textContent=m.$jscomp$loop$prop$ship$317.name;var B=document.createElement("div");B.className=
"ml-1 ship_td_stock align-self-center "+(g?"":"d-none");B.textContent="\u00d7"+v;z.appendChild(B);x.appendChild(D);x.appendChild(z);u.appendChild(r);u.appendChild(x);if("multi"!==c)for(v=0;5>v;v++)r=document.createElement("div"),r.className="ship_td_slot font_size_12 align-self-center "+(0===v?"ml-auto":""),r.textContent=v<m.$jscomp$loop$prop$ship$317.slot.length?m.$jscomp$loop$prop$ship$317.slot[v]:"",u.appendChild(r);w!==m.$jscomp$loop$prop$ship$317.type&&(w=document.createElement("div"),w.className=
"type_divider mt-4",v=document.createElement("div"),v.className="align-self-center font_size_16",v.textContent=API_SHIP_TYPE.find(function(A){return function(C){return C.id===A.$jscomp$loop$prop$ship$317.type}}(m)).name,r=document.createElement("div"),r.className="flex-grow-1 border-bottom align-self-center mx-2",w.appendChild(v),w.appendChild(r),l.appendChild(w));f||t===m.$jscomp$loop$prop$ship$317.type2||(t=document.createElement("div"),t.className="type_divider mt-2 ml-1",w=document.createElement("div"),
w.className="font_size_12 font_color_half align-self-center",v=API_CTYPE.find(function(A){return function(C){return C.id===A.$jscomp$loop$prop$ship$317.type2}}(m))||{name:""},w.textContent=v.name,t.appendChild(w),l.appendChild(t));w=m.$jscomp$loop$prop$ship$317.type;t=m.$jscomp$loop$prop$ship$317.type2;l.appendChild(u)}"multi"===c?(a.classList.add("modal-xl"),b.classList.add("multi_mode"),a=a.getElementsByClassName("scroll_thead")[0],a.classList.add("d-none"),a.classList.remove("d-flex")):(a.classList.remove("modal-xl"),
...
function createEnemyPattern(a){a=void 0===a?0:a;var b=castInt($("#map_select").val()),c=$(".node_selected").data("node"),d=0;100>b?$("#select_difficulty_div").addClass("d-none"):($("#select_difficulty_div").removeClass("d-none"),d=castInt($("#select_difficulty").val()));for(var e="",f=0,g=0,h=ENEMY_PATTERN.filter(function(t){return t.a===b&&t.n===c&&t.l===d}),l=h[a],k=l.e,m=k.length,n={$jscomp$loop$prop$index$329:0};n.$jscomp$loop$prop$index$329<m;n={$jscomp$loop$prop$index$329:n.$jscomp$loop$prop$index$329},
n.$jscomp$loop$prop$index$329++){var q=ENEMY_DATA.find(function(t){return function(u){return u.id===k[t.$jscomp$loop$prop$index$329]}}(n));if(q){var p=new Enemy(q.id);f+=p.airPower;g+=p.antiAirBonus;e+='\n\t\t<div class="enemy_pattern_tr mx-1 d-flex border-bottom" data-enemyid="'+q.id+'">\n\t\t\t<div class="enemy_pattern_tr_image mr-1">\n\t\t\t\t<img src="../img/enemy/'+q.id+'.png" class="enemy_img">\n\t\t\t</div>\n\t\t\t<div class="enemy_pattern_tr_text">\n\t\t\t\t<div class="font_size_11 text-primary">ID: '+
...
function expandMainPreset(a,b,c,d){b=void 0===b?!0:b;c=void 0===c?!0:c;d=void 0===d?!0:d;if(a)try{var e=a[0];$(".lb_plane").each(function(D,z){if(e&&0!==e.length){var B=e[0].find(function(A){return A[4]===D});B&&0!==B.length?(B={id:B[0],prof:B[1],remodel:B[2],slot:B[3]},setLBPlaneDiv($(z),B)):b&&setLBPlaneDiv($(z))}});$(".ohuda_select").each(function(D,z){$(z).find("option").prop("disabled",!1);if(e&&2<=e.length){var B=castInt(e[1][D],-1);$(z).val(1===B?2:B)}else b&&$(z).val(-1)});if(e&&3<=e.length)for(var f=
0;2>=f;f++)document.getElementById("lb"+(f+1)+"_target_1").value=e[2][2*f],document.getElementById("lb"+(f+1)+"_target_2").value=e[2][2*f+1];5<=a.length?toggleDefenseMode(a[4]):toggleDefenseMode(!1);if(c){var g=6;a[1].length&&a[1][0]&&6<=a[1][0].length&&(g=2===a[1][0][5]?7:6,document.getElementById("union_fleet").checked=1===a[1][0][5],document.getElementById("yugeki_fleet").checked=2===a[1][0][5]);clearShipDivAll(g);var h=0,l=0;$(".ship_tab:not(.d-none)").each(function(D,z){var B=a[1].find(function(E){return E[2]===
D});if(B){var A=$(z);setShipDiv(A,B[0],99,8<=B.length&&B[7]?B[7]:0);A.find(".ship_plane").each(function(E,F){var H=$(F),G=B[1].find(function(I){return I[4]===E});!G&&H.hasClass("expanded_slot")&&(G=B[1].find(function(I){return-1===I[4]}));G&&!H.hasClass("d-none")&&(setPlaneDiv(H,{id:G[0],prof:G[1],remodel:G[2],slot:G[3]},!0),6<=G.length&&G[5]&&plane_unlock_Clicked(H.find(".plane_unlock")))});if(4<=B.length){var C=A.find(".ship_disabled");B[3]?(C.addClass("disabled"),C.children().addClass("fa-eye-slash").removeClass("fa-eye no_capture"),
...
!0;document.getElementById("fleet_formation").value=q}}}else document.getElementById("adapt_stage2").checked=!1,selectedFormations=[];q=1;for(k=0;k<a[2].length;k++)q<a[2][k][0]+1&&(q=a[2][k][0]+1);q=Math.min(q,10);if(0!==a[2].length||d)clearEnemyDivAll(q),$("#battle_count").val(q);var p=isDefMode&&6>a.length;$(p?"#air_raid_enemies":".battle_content").each(function(D,z){var B=a[2].find(function(F){return F[0]===D});if(B){3<=B.length?$(z)[0].dataset.celldata=B[2]:$(z)[0].dataset.celldata="";if(4<=B.length){var A=
castInt(B[3]);p?$(z).find(".cell_type").val([0,5].includes(A)?5:3):$(z).find(".cell_type").val(A);cell_type_Changed($(z).find(".cell_type"),!1)}else $(z).find(".cell_type").val(1);5<=B.length?$(z).find(".formation").val(B[4]):$(z).find(".formation").val(1);6<=B.length?$(z).find(".enemy_range").text(B[5]):$(z).find(".enemy_range").text(0);A=0;B=$jscomp.makeIterator(B[1]);for(var C=B.next();!C.done;C=B.next()){C=C.value;var E=$(z).find(".enemy_content").eq(A++);0<C?setEnemyDiv(E,C):0>C?setEnemyDiv(E,
-1,-C):clearEnemyDiv(E);E.addClass("d-flex").removeClass("d-none")}}});if(6<=a.length){var t=a[5];if(t&&3===t.length){var u=$("#air_raid_enemies"),w=castInt(t[1]);u.find(".cell_type").val([0,5].includes(w)?5:3);cell_type_Changed(u.find(".cell_type"),!1);u.find(".formation").val(t[2]);d=0;for(var v=$jscomp.makeIterator(t[0]),r=v.next();!r.done;r=v.next()){var x=r.value,y=u.find(".enemy_content").eq(d++);0<x?setEnemyDiv(y,x):0>x?setEnemyDiv(y,-1,-x):clearEnemyDiv(y);y.addClass("d-flex").removeClass("d-none")}}}7<=
a.length?$("#admin_lv").val(a[6]):$("#admin_lv").val(120)}catch(D){$(".ohuda_select").val(-1),$(".lb_plane").each(function(z,B){setLBPlaneDiv($(B))}),clearShipDivAll(6),clearEnemyDivAll(1),$("#battle_count").val(1),sendErrorLog(D)}}
...
e<=f?[e,f]:[f,e],e=e<=f?[0,1]:[1,0],f={},g=0;1>=g;f={$jscomp$loop$prop$status$193$336:f.$jscomp$loop$prop$status$193$336},g++)n=c.results[d[g]].airStatusIndex[e[g]],u=c.results[d[g]].mainAirPower[e[g]]/a,h=c.results[d[g]].enemyAirPower[e[g]]/a,f.$jscomp$loop$prop$status$193$336=n.indexOf(getArrayMax(n)),p=0,h=getAirStatusBorder(h),4===f.$jscomp$loop$prop$status$193$336?p=u/h[3]*10:3===f.$jscomp$loop$prop$status$193$336?p=u/h[2]*20:2===f.$jscomp$loop$prop$status$193$336?p=u/h[1]*45:1>=f.$jscomp$loop$prop$status$193$336&&
(p=u/h[0]*90),5===f.$jscomp$loop$prop$status$193$336&&(f.$jscomp$loop$prop$status$193$336=0,p=100),h="bar_status"+f.$jscomp$loop$prop$status$193$336,t="bar_ex_status"+f.$jscomp$loop$prop$status$193$336,u=$("#simple_lb_bar_"+c.baseNo+"_"+(g+1)),l=u.find(".result_bar"),k=l.data("airstatus"),l.removeClass("bar_status"+k+" bar_ex_status"+k).addClass(h+" "+t).css({width:(100<p?100:p)+"%"}).data("airstatus",f.$jscomp$loop$prop$status$193$336),p=AIR_STATUS.find(function(v){return function(r){return r.id===
v.$jscomp$loop$prop$status$193$336}}(f)).abbr,n=Math.floor(getArrayMax(n)/a*100),n=p+"("+n+"%)"+(100===n?"":10<=n?'<span class="opacity0">1</span>':'<span class="opacity0">11</span>'),u.find(".simple_label").html(n),u.removeClass("d-none");display_result_Changed();resultData.enemyAirPowerResults=null;resultData.fleetSlots=null}
...
function updateFleetView(){var a=inputItems.fleet,b=document.getElementById("shoot_down_table"),c=document.getElementById("shoot_down_table_tbody"),d=-1;b.getElementsByTagName("tbody")[0].innerHTML="";b=$jscomp.makeIterator(b.getElementsByTagName("tfoot")[0].getElementsByClassName("td_battle"));for(var e=b.next();!e.done;e=b.next())e.value.innerHTML="";$("#fleet_formation").find("option").each(function(z,B){var A=castInt($(B).val());a.isUnion&&10<A?$(B).removeClass("d-none"):!a.isUnion&&10<A&&$(B).addClass("d-none")});
$("#fleet_antiair_formation").find("option").each(function(z,B){var A=castInt($(B).val());a.isUnion&&10<A?$(B).removeClass("d-none"):!a.isUnion&&10<A&&$(B).addClass("d-none")});setting.visibleAntiAirStatus?($(".anti_air_status").removeClass("d-none"),$(".anti_air_status").addClass("d-flex")):($(".anti_air_status").addClass("d-none"),$(".anti_air_status").removeClass("d-flex"));b=document.getElementsByClassName("fleet_ap")[0];e=document.getElementsByClassName("fleet_ap")[1];for(var f=document.getElementsByClassName("contact_start_rate")[0],
...
t=p.next())if(q.$jscomp$loop$prop$enemy$342=t.value,b+=q.$jscomp$loop$prop$enemy$342.antiAirBonus,!d&&ANTIAIR_CUTIN_ENEMY.includes(q.$jscomp$loop$prop$enemy$342.id)&&(d=!0),!e&&UNKNOWN_ENEMY.includes(q.$jscomp$loop$prop$enemy$342.id)&&(e=!0),m===l&&!q.$jscomp$loop$prop$enemy$342.onlyScout&&q.$jscomp$loop$prop$enemy$342.slots.length){for(var u=t="",w=!0,v=-1,r={$jscomp$loop$prop$j$344:0};r.$jscomp$loop$prop$j$344<q.$jscomp$loop$prop$enemy$342.equipments.length;r={$jscomp$loop$prop$j$344:r.$jscomp$loop$prop$j$344},
r.$jscomp$loop$prop$j$344++){var x=ENEMY_ITEM.find(function(E,F){return function(H){return H.id===E.$jscomp$loop$prop$enemy$342.equipments[F.$jscomp$loop$prop$j$344].id}}(q,r));if(x&&PLANE_TYPE.includes(x.type)){v+=1;var y=q.$jscomp$loop$prop$enemy$342.slots[v],D=getItemCss(x.itype).replace("css","shoot_table"),z=v===q.$jscomp$loop$prop$enemy$342.slots.length-1?" last_slot":"",B="",A="",C="";t+='<img src="../img/plane/'+x.id+'.png" class="img-size-36" data-planeid="'+x.id+'">';w&&(B='\n\t\t\t\t\t<td class="td_name align-middle last_slot" rowspan="'+
q.$jscomp$loop$prop$enemy$342.slots.length+'">\n\t\t\t\t\t\t<div>'+drawEnemyGradeColor(q.$jscomp$loop$prop$enemy$342.name)+'</div>\n\t\t\t\t\t\t<div class="d-none d-md-block">xxPxx</div>\n\t\t\t\t\t</td>',C='<td class="td_all_dead align-middle last_slot" rowspan="'+q.$jscomp$loop$prop$enemy$342.slots.length+'"></td>',A='<td class="td_detail_slot align-middle last_slot" rowspan="'+q.$jscomp$loop$prop$enemy$342.slots.length+'"><i class="fas fa-file-text"></i></td>',w=!1);u+='\n\t\t\t\t<tr class="enemy_no_'+
n+" slot_"+v+'" data-rowindex="'+n+'" data-slot="'+v+'" data-css="'+D+'_hover">\n\t\t\t\t\t'+B+'\n\t\t\t\t\t<td class="pl-1 td_plane_name align-middle '+(D+z)+'">'+x.name+'</td>\n\t\t\t\t\t<td class="td_init_slot align-middle'+z+'">'+y+'</td>\n\t\t\t\t\t<td class="td_avg_slot align-middle'+z+'">'+y+'</td>\n\t\t\t\t\t<td class="td_max_slot align-middle'+z+'">'+y+'</td>\n\t\t\t\t\t<td class="td_min_slot align-middle'+z+'">'+y+"</td>\n\t\t\t\t\t"+(isDefMode?"":C)+"\n\t\t\t\t\t"+(isDefMode?"":A)+"\n\t\t\t\t</tr>"}}h.push(u.replace("xxPxx",
...
c);c=0;if(isDefMode||f[0])c=f[0].getAirPower();w=!isDefMode&&document.getElementById("adapt_stage2").checked;v=[];w&&(v=castInt($("#fleet_formation").val()),b.isUnion&&f[g].cellType===CELL_TYPE.airRaid?b.updateStage2All(v,!0):b.updateStage2All(v),v=b.allStage2);for(r=0;r<d;r++){for(var x=0;x<p;x++){var y=f[x],D=y.enemies,z=!1;z=calculateLandBase(a,y,x);t+=doJetPhase(b,y);var B=y.isUnion?b.unionAirPower:b.airPower,A=y.getAirPower(),C=getAirStatusIndex(B,A);x===g&&(h[C]+=1);l[x]+=B;k[x]+=A;shootDownFleet(C,
b,y,x);y.cellType===CELL_TYPE.aerialCombat&&(shootDownEnemy(C,D,w,v),z=!0,C=getAirStatusIndex(b.airPower,y.getAirPower()),shootDownFleet(C,b,y,x,!1));if(x===g){shootDownEnemy(C,D,w,v);for(C=B=z=y=0;C<D.length;C++){var E=D[C];if(!E.onlyScout&&E.id){for(var F=E.slots,H=E.attackers.concat(),G=0;G<F.length;G++){var I=F[G],L=n[y];y+=1;L[2]+=I;L[3]<I&&(L[3]=I);L[4]>I&&(L[4]=I);0===I&&(H[G]=!1)}0>H.indexOf(!0)&&(u[z]+=1);z+=1;B+=E.airPower}E.slots=E.fullSlots.concat();E.airPower=E.fullAirPower;E.landBaseAirPower=
E.fullLandBaseAirPower}q[0].push(A);q[1].push(B);z=!1}if(z)for(D=$jscomp.makeIterator(D),A=D.next();!A.done;A=D.next())A=A.value,A.slots=A.fullSlots.concat(),A.airPower=A.fullAirPower,A.landBaseAirPower=A.fullLandBaseAirPower}for(x=0;3>x;x++)if(D=a.landBases[x],0!==D.mode){for(A=0;A<D.planes.length;A++)y=D.planes[A],y.slot=y.fullSlot,y.airPower=y.fullAirPower;D.airPower=D.fullAirPower}for(D=x=0;D<e;D++)if(A=b.ships[D],!A.ignoreSlot){y=A.items.length;for(z=0;z<y;z++)B=A.items[z],B.isPlane&&(m[x++][r]=
...
var n=[];m&&(n=castInt($("#fleet_formation").val()),e.isUnion&&f.battles[k].cellType===CELL_TYPE.airRaid?e.updateStage2All(n,!0):e.updateStage2All(n),n=e.allStage2);for(var q=l.items[b],p=$jscomp.makeIterator(f.battles),t=p.next();!t.done;t=p.next())t=t.value,t.enemies=t.enemies.filter(function(y){return 0<y.slots.length});for(p=0;p<g;p++){for(t=0;t<=k;t++){var u=f.battles[t],w=u.enemies;calculateLandBase(d,u,t);doJetPhase(e,u);var v=u.cellType,r=u.isUnion?e.unionAirPower:e.airPower,x=u.getAirPower();
...
e.ships[t],w=u.items.length,v=u.airPower=0;v<w;v++)r=u.items[v],t===a&&r.slotNo===b&&h.push(r.slot),r.slot=r.fullSlot,r.updateAirPower(),u.airPower+=r.airPower;e.updateAirPower()}chartSlotDistribution=updateDetailChart(h,"\u6b8b\u6a5f\u6570 [\u6a5f]",{mode:"index",callbacks:{title:function(y,D){var z=castInt(y[0].xLabel);return"\u6b8b\u6a5f\u6570\uff1a"+z+" \u6a5f\n\u822a\u7a7a\u6226\u706b\u529b\uff1a"+ShipItem.getFirePower(q,z).join(" or ")},label:function(y,D){return[y.yLabel+" %"]}}});e=SHIP_DATA.find(function(y){return y.id===
...
a={};k=$jscomp.makeIterator(l.items);for(h=k.next();!h.done;a={$jscomp$loop$prop$pl$352:a.$jscomp$loop$prop$pl$352},h=k.next()){a.$jscomp$loop$prop$pl$352=h.value;h=ITEM_DATA.find(function(y){return function(D){return D.id===y.$jscomp$loop$prop$pl$352.id}}(a));if(g===(e?e.slot.length:4))break;m=h?h.name:"-";n=PLANE_TYPE.includes(h?h.type:0);p="";n&&FIGHTERS.includes(h.type)?p=h.antiAir?'<span class="mx-1">\u5bfe\u7a7a: '+h.antiAir+"</span>":"":n&&RECONNAISSANCES.includes(h.type)?(p=h.antiAir?'<span class="mx-1">\u5bfe\u7a7a: '+
...
f);document.getElementById("stage3_all_slot_label").textContent="\u6b8b\u6a5f\u6570\u5206\u5e03\u306e\u7d50\u679c\u3092\u5229\u7528\uff08"+getArrayMin(b)+"\u6a5f ~ "+f+"\u6a5f\uff09";document.getElementById("stage3_remodel").value=z?z:0;l.some(function(C){return 311===C.id})&&(document.getElementById("enabled_rikutei").checked=!0);l.some(function(C){return 312===C.id})&&(document.getElementById("enabled_rikutei_z").checked=!0);l='<option value="99">\u4efb\u610f</option>';e=e.battles.length-1;b=castInt(document.getElementById("target_enemy").value,
...
function enemySlotDetailCalculate(a,b,c){c=void 0===c?!1:c;setPreCalculateTable();var d=createLandBaseInstance(),e=createFleetInstance(),f=updateEnemyFleetInfo(!1),g=castInt($("#detail_calculate_count").val()),h=isDefMode?0:displayBattle;h=h<f.battles.length?h:f.battles.length-1;var l=[],k=[],m=f.battles[h].enemies.filter(function(z){return 0<z.slots.length&&!z.onlyScout})[a],n=ENEMY_DATA.find(function(z){return z.id===m.id}),q=n.eqp.map(function(z){return ENEMY_ITEM.find(function(B){return B.id===
z})});q=q.filter(function(z){return FIGHTERS.includes(z.type)||ATTACKERS.includes(z.type)});c&&!ATTACKERS.includes(q[b].type)&&q.some(function(z){return ATTACKERS.includes(z.type)})&&(b=q.findIndex(function(z){return ATTACKERS.includes(z.type)}));var p=new EnemyItem(q[b].id);c=$("#slot_detail").prop("checked");var t=[];if(q=document.getElementById("enabled_manual_stage2").checked){t=castInt($("#fleet_formation").val());e.isUnion&&f.battles[h].cellType===CELL_TYPE.airRaid?e.updateStage2All(t,!0):e.updateStage2All(t);
var u=document.getElementById("aa_cutin_miss").checked;document.getElementById("aa_cutin_miss").parentElement.classList.remove("d-none");t=e.allStage2;u&&(t=[t[t.length-1]])}else document.getElementById("aa_cutin_miss").parentElement.classList.add("d-none");u=$jscomp.makeIterator(f.battles);for(var w=u.next();!w.done;w=u.next())w=w.value,w.enemies=w.enemies.filter(function(z){return 0<z.slots.length});for(u=0;u<g;u++){for(w=0;w<=h;w++){var v=f.battles[w],r=v.enemies;calculateLandBase(d,v,w);doJetPhase(e,
v);var x=v.cellType,y=v.isUnion?e.unionAirPower:e.airPower,D=v.getAirPower();y=getAirStatusIndex(y,D);shootDownFleet(y,e,v,w);x===CELL_TYPE.aerialCombat&&(shootDownEnemy(y,r,q,t),y=getAirStatusIndex(e.airPower,v.getAirPower()),shootDownFleet(y,e,v,w,!1));w===h&&(shootDownEnemy(y,r,q,t),v=m.slots[b],k.push(v),c||(v=p.getFirePower(v),2===v.length?(l.push(v[0]),l.push(v[1])):l.push(v[0])));for(v=0;v<r.length;v++)x=r[v],x.onlyScout||(x.slots=x.fullSlots.concat(),x.airPower=x.fullAirPower,x.landBaseAirPower=
x.fullLandBaseAirPower)}for(w=0;3>w;w++){r=d.landBases[w];for(v=0;v<r.planes.length;v++)x=r.planes[v],x.slot=x.fullSlot,x.updateAirPower();r.updateAirPower()}for(w=0;w<e.ships.length;w++)for(r=e.ships[w],v=r.items.length,x=r.airPower=0;x<v;x++)y=r.items[x],y.slot=y.fullSlot,y.updateAirPower(),r.airPower+=y.airPower;e.updateAirPower()}chartSlotDistribution=updateDetailChart(c?k:l,c?"\u6b8b\u6a5f\u6570 [\u6a5f]":"\u822a\u7a7a\u6226\u706b\u529b",{mode:"index",callbacks:{title:function(z){z=z[0].xLabel;
if($("#slot_detail").prop("checked")){if(!z)return"\u6b8b\u6a5f\u6570\uff1a"+z+" \u6a5f\n\u822a\u7a7a\u6226\u706b\u529b\uff1a0";var B="\u822a\u7a7a\u6226\u706b\u529b\uff1a"+p.getFirePower(z).join(" or ");return"\u6b8b\u6a5f\u6570\uff1a"+z+" \u6a5f\n"+B}return"\u822a\u7a7a\u6226\u706b\u529b\uff1a"+z},label:function(z){return[z.yLabel+" %"]}}});if(!c)for(chartSlotDistribution=[],d=getArrayMax(k),f=getArrayMin(k),e=k.length,f={$jscomp$loop$prop$i$270$356:f};f.$jscomp$loop$prop$i$270$356<=d;f={$jscomp$loop$prop$i$270$356:f.$jscomp$loop$prop$i$270$356},
f.$jscomp$loop$prop$i$270$356++)(g=k.filter(function(z){return function(B){return B===z.$jscomp$loop$prop$i$270$356}}(f)).length)&&chartSlotDistribution.push({slot:f.$jscomp$loop$prop$i$270$356,rate:g/e});$("#land_base_detail_table").addClass("d-none");$(".detail_fire").removeClass("d-none").addClass("d-flex");$(".detail_wave").addClass("d-none").removeClass("d-flex");$("#detail_info").data("mode","enemy_slot_detail");$("#detail_info").data("base_no",a);$("#detail_info").data("slot_no",b);$("#detail_info").data("battle_no",
h);$("#detail_warning").text("\u203b \u30b0\u30e9\u30d5\u5185\u306e\u822a\u7a7a\u6226\u706b\u529b\u306f\u30ad\u30e3\u30c3\u30d7\u524d\u3067\u30af\u30ea\u30c6\u30a3\u30ab\u30eb\u3001\u89e6\u63a5\u88dc\u6b63\u306a\u3057\u3002\u5c0f\u6570\u5207\u6368\u3066");a="";d=h=0;e={};f=$jscomp.makeIterator(n.eqp);for(g=f.next();!g.done;e={$jscomp$loop$prop$id$358:e.$jscomp$loop$prop$id$358},g=f.next())e.$jscomp$loop$prop$id$358=g.value,g=ENEMY_ITEM.find(function(z){return function(B){return B.id===z.$jscomp$loop$prop$id$358}}(e)),
...
var e=getManualEnemySearchBox();d={};e=$jscomp.makeIterator(e);for(var f=e.next();!f.done;d={$jscomp$loop$prop$text$364:d.$jscomp$loop$prop$text$364},f=e.next()){d.$jscomp$loop$prop$text$364=f.value;var g=ENEMY_DATA.filter(function(l){return function(k){return k.id+1500==l.$jscomp$loop$prop$text$364||0<=k.name.indexOf(l.$jscomp$loop$prop$text$364)}}(d));f={};g=$jscomp.makeIterator(g);for(var h=g.next();!h.done;f={$jscomp$loop$prop$enemy$271$366:f.$jscomp$loop$prop$enemy$271$366},h=g.next())f.$jscomp$loop$prop$enemy$271$366=
h.value,12>aerialSetting.targetEnemies.length&&!aerialSetting.targetEnemies.some(function(l){return function(k){return k.id===l.$jscomp$loop$prop$enemy$271$366.id}}(f))&&(h=new Enemy(f.$jscomp$loop$prop$enemy$271$366.id),h.isEscort=c,aerialSetting.targetEnemies.push(h))}}else aerialSetting.targetEnemies=c.battles[d].enemies.concat(),document.getElementById("manual_enemy").classList.add("d-none"),aerialSetting.isUnion=c.battles[d].isUnion;aerialSetting.levelCriticalBonus=a.getProfCriticalBonus();a=
...
u,1,m):getEnemyAerialPowers(p,u);var r=u.hp,x=createDamageDistribution(v,w,k,c,r),y=x.map(function(E){return E.damage}),D=getArrayMin(y),z=getArrayMax(y);y=[{min:r,max:getArrayMax(x.map(function(E){return E.damage}))+1,value:0},{min:Math.ceil(.75*r),max:r,value:0},{min:Math.ceil(.5*r),max:Math.ceil(.75*r),value:0}];v=v.map(function(E){return E.power}).some(function(E){return 0>=E});D=(1<=D?D:v?"0":"\u5272\u5408")+"~"+(1<=z?z:"\u5272\u5408");n||0!==l||(D="-");v="";z={};for(var B=0;B<y.length;z={$jscomp$loop$prop$borderMin$370:z.$jscomp$loop$prop$borderMin$370,
$jscomp$loop$prop$borderMax$371:z.$jscomp$loop$prop$borderMax$371},B++){var A=y[B];z.$jscomp$loop$prop$borderMin$370=A.min;z.$jscomp$loop$prop$borderMax$371=A.max;var C=x.filter(function(E){return function(F){return F.damage>=E.$jscomp$loop$prop$borderMin$370&&F.damage<E.$jscomp$loop$prop$borderMax$371}}(z)).map(function(E){return E.rate});C=C.length===x.length?1:getArraySum(C);A.value=C;if(b.isAttacker||!c||u.type.includes(18)&&h){if(c&&u.type.includes(18)&&!h||!c&&[13,14].includes(u.type)){v+='<td class="text-center" colspan="'+
y.length+'">\u5bfe\u6f5c\u653b\u6483\u4e0d\u53ef</td>';D="";x=$jscomp.makeIterator(y);for(z=x.next();!z.done;z=x.next())z.value.value=0;break}if(1!==C||0!==B||n)1===C?v+='<td>100 <span class="font_size_11 font_color_half">%</span></td>':(A=Math.floor(1E3*C)/10,v+="<td>"+(0===A&&0!==C?.1:A)+' <span class="font_size_11 font_color_half">%</span></td>');else{v+='<td colspan="'+y.length+'" class="text-center text_red">\u78ba\u6bba</td>';break}}else v+="<td>-</td>",D=""}x=Math.floor(1E3*(y[0].value+y[1].value))/
10;z=Math.floor(1E3*(y[0].value+y[1].value+y[2].value))/10;q+='\n\t\t<tr class="stage3_calc_detail '+(90<=Math.floor(1E3*y[0].value)/10?"tr_death":70<=x?"tr_damaged":50<=z?"tr_half_damaged":"")+'"\n\t\t\tdata-toggle="tooltip" data-html="true" title="\n\t\t<div class=\'text-left\'>\n\t\t\t<div>'+(u.name+"</div>\n\t\t\t<div class='mt-1 ml-3'>\u5927\u7834\u4ee5\u4e0a: "+x+" %</div>\n\t\t\t<div class='ml-3'>\u4e2d\u7834\u4ee5\u4e0a: "+z+' %</div>\n\t\t</div>">\n\t\t\t<td class="px-0">\n\t\t\t\t<img class="enemy_img_sm" src="../img/')+
...
n*h;(n=l.find(function(p){return function(t){return t.power===p.$jscomp$loop$prop$a$373}}(k)))?n.rate+=q:l.push({power:k.$jscomp$loop$prop$a$373,rate:q});if(!f)break}return l}
...
n*h;(n=l.find(function(p){return function(t){return t.power===p.$jscomp$loop$prop$a$375}}(k)))?n.rate+=q:l.push({power:k.$jscomp$loop$prop$a$375,rate:q});if(!f)break}return l}
...
function getLandBaseASWPower(a,b){for(var c=aerialSetting.item,d=aerialSetting.isCritical,e=aerialSetting.levelCriticalBonus,f=aerialSetting.isAllSlot,g=aerialSetting.manualSlot,h=aerialSetting.contactBonus*(void 0===b?1:b),l=[],k=$jscomp.makeIterator(a),m=k.next();!m.done;m=k.next()){m=m.value;var n=f?m.slot:g;n=0<n?c.asw*Math.sqrt(1.8*n)+25:0;for(var q=10<=c.asw?.7:.35,p=10<=c.asw?.3:.45,t=1/(100*p+1),u={},w=0;w<=100*p;u={$jscomp$loop$prop$power$381:u.$jscomp$loop$prop$power$381},w++){var v=f?m.rate*
t:t,r=Math.floor(softCap(n*(q+w/100),AS_CAP));d&&(r=Math.floor(1.5*r*e));u.$jscomp$loop$prop$power$381=r*(47===c.type?1.8:1)*h;RECONNAISSANCES.includes(c.type)&&(u.$jscomp$loop$prop$power$381=1);(r=l.find(function(x){return function(y){return y.power===x.$jscomp$loop$prop$power$381}}(u)))?r.rate+=v:l.push({power:u.$jscomp$loop$prop$power$381,rate:v})}if(!f)break}return l}
...
{$jscomp$loop$prop$a$383:p.$jscomp$loop$prop$a$383},t=q.next())p.$jscomp$loop$prop$a$383=t.value*c,p.$jscomp$loop$prop$a$383=f?Math.floor(1.5*p.$jscomp$loop$prop$a$383*g):p.$jscomp$loop$prop$a$383,(t=m.find(function(u){return function(w){return w.power===u.$jscomp$loop$prop$a$383}}(p)))?t.rate+=n:m.push({power:p.$jscomp$loop$prop$a$383,rate:n});if(!h)break}return m}
...
p=n.next())q.$jscomp$loop$prop$a$385=p.value*c,q.$jscomp$loop$prop$a$385=e?Math.floor(1.5*q.$jscomp$loop$prop$a$385*f):q.$jscomp$loop$prop$a$385,(p=k.find(function(t){return function(u){return u.power===t.$jscomp$loop$prop$a$385}}(q)))?p.rate+=m:k.push({power:q.$jscomp$loop$prop$a$385,rate:m});if(!g)break}return k}
...
function createDamageDistribution(a,b,c,d,e){for(var f=[],g=1/b,h=0;h<b;h++)for(var l=.7*b+.6*h,k={},m=$jscomp.makeIterator(a),n=m.next();!n.done;k={$jscomp$loop$prop$damage$389:k.$jscomp$loop$prop$damage$389},n=m.next())if(n=n.value,k.$jscomp$loop$prop$damage$389=0<n.power-l?Math.floor((n.power-l)*c):0,k.$jscomp$loop$prop$damage$389>=e&&!d)for(var q=1/e,p={},t=0;t<e;p={$jscomp$loop$prop$damage2$387:p.$jscomp$loop$prop$damage2$387},t++){p.$jscomp$loop$prop$damage2$387=Math.floor(.5*e+.3*t);var u=
g*n.rate*q,w=f.find(function(v){return function(r){return r.damage===v.$jscomp$loop$prop$damage2$387}}(p));w?w.rate+=u:f.push({damage:p.$jscomp$loop$prop$damage2$387,rate:u})}else n=g*n.rate,(q=f.find(function(v){return function(r){return r.damage===v.$jscomp$loop$prop$damage$389}}(k)))?q.rate+=n:f.push({damage:k.$jscomp$loop$prop$damage$389,rate:n});return f}
function updateDetailChart(a,b,c){for(var d=[],e=[],f=[],g=[],h=getArrayMax(a),l=getArrayMin(a),k=a.length,m=0,n=0,q=0,p=0,t=0,u={$jscomp$loop$prop$i$391:l};u.$jscomp$loop$prop$i$391<=h;u={$jscomp$loop$prop$i$391:u.$jscomp$loop$prop$i$391},u.$jscomp$loop$prop$i$391++){var w=a.filter(function(v){return function(r){return r===v.$jscomp$loop$prop$i$391}}(u)).length;w&&(d.push(u.$jscomp$loop$prop$i$391),e.push((100*w/k).toFixed(1E5<=k?5:1E4<=k?4:1E3<=k?3:2)),g.push({slot:u.$jscomp$loop$prop$i$391,rate:w/
k}),t+=100*w/k,f.push(t.toFixed(1)),!m&&50<=t&&(m=u.$jscomp$loop$prop$i$391),!n&&90<=t&&(n=u.$jscomp$loop$prop$i$391),!q&&95<=t&&(q=u.$jscomp$loop$prop$i$391),!p&&99<=t&&(p=u.$jscomp$loop$prop$i$391))}$("#detail_max").text(h);$("#detail_min").text(l);$("#detail_50").text(m);$("#detail_90").text(n);$("#detail_95").text(q);$("#detail_99").text(p);chartInstance?(chartInstance.data.labels=d,chartInstance.data.datasets[0].data=e,chartInstance.data.datasets[1].data=f,chartInstance.options.scales.xAxes[0].scaleLabel.labelString=
...
function getItemTooltipContext(a,b,c,d,e){c=void 0===c?0:c;d=void 0===d?0:d;e=void 0===e?0:e;var f=null;f=(void 0===b?0:b)?new LandBaseItem(a,c,d,e):new ShipItem(a,c,d,e);if(!f.id)return"";var g=ITEM_DATA.find(function(z){return z.id===f.id}),h=g.type;b=f.bonusAntiAir;c=Item.getBonusFire(h,d);e=Item.getBonusScout(h,d);var l=Item.getBonusTorpedo(h,d),k=Item.getBonusAccuracy(a,h,d),m=Item.getBonusBomber(a,h,d);h=Item.getBonusASW(a,h,d,g.antiAir);var n=RANGES.find(function(z){return z.id===g.range2});
...
e.toFixed(2)+")</span>":"",x=0<g.avoid?AVOID_TYPE.find(function(z){return z.id===g.avoid}):null,y=f.selectRate.length?f.selectRate.map(function(z){return(100*z).toFixed(0)+"%"}):null,D=PLANE_TYPE.includes(g.type)?getRequiredgBattleCountString(g.grow):null;return('\n\t<div class="text-left m-1 item_tooltip">\n\t\t<div>\n\t\t\t<img src="../img/type/icon'+g.itype+'.png" alt="'+g.itype+'" class="img-size-25">\n\t\t\t<span>'+g.name+"</span>"+d+'\n\t\t</div>\n\t\t<div class="d-flex flex-wrap my-1">\n\t\t\t'+
...
(2<=f[k].length?p+" ~ "+q:q)+"</td>\n\t\t</tr>"}$("#antiair_input_table tbody").html(h);if(!d.innerHTML){b=document.createDocumentFragment();c={};a=$jscomp.makeIterator(a.allStage2);for(l=a.next();!l.done;c={$jscomp$loop$prop$stage2$278$395:c.$jscomp$loop$prop$stage2$278$395},l=a.next())c.$jscomp$loop$prop$stage2$278$395=l.value,h=ANTIAIR_CUTIN.find(function(w){return function(v){return v.id===w.$jscomp$loop$prop$stage2$278$395.cutin.id}}(c)),k=e.includes(h.id),f=document.createElement("div"),f.className=
