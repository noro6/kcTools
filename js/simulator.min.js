...
LandBaseItem.getFirePower=function(a,b,c,d,e,f,g){d=void 0===d?!1:d;e=void 0===e?1:e;f=void 0===f?1:f;g=void 0===g?1:g;var h=ITEM_DATA.find(function(r){return r.id===a});if(!h||0>=b)return 0;var l=Math.abs(h.type),k=0,m=0,n=1.8;switch(l){case 8:k=Item.getBonusTorpedo(l,c)+h.torpedo*g;m=1;break;case 7:case 11:k=Item.getBonusBomber(a,l,c)+h.bomber*g;m=1;break;case 57:k=Item.getBonusBomber(a,l,c)+h.bomber*g;m=.7071;break;case 47:k=Item.getBonusTorpedo(l,c)+h.torpedo*g;m=.8;break;case 53:k=Item.getBonusTorpedo(l,
c)+h.torpedo*g,n=m=1}b=Math.floor(m*(k*Math.sqrt(n*b)+25)*f);b=softCap(b,AS_CAP);d&&(b=Math.floor(1.5*b*e));return b*(47===l?1.8:1)};
...
$("#disp_equipped").closest("div").removeClass("d-none"),$("#disp_in_stock").prop("checked",!0)):($("#divide_stock").closest("div").addClass("d-none"),$("#disp_equipped").closest("div").addClass("d-none"),$("#disp_in_stock").prop("checked",!1));b=a.length;var u=0;c=0;d=-1;for(var q=0,w={},y=0;y<b;w={$jscomp$loop$prop$item$299:w.$jscomp$loop$prop$item$299},y++)if(w.$jscomp$loop$prop$item$299=a[y],!n||setting.favoritePlane.includes(w.$jscomp$loop$prop$item$299.id)){if(l&&h){var C=p.find(function(H){return function(I){return I.id===
H.$jscomp$loop$prop$item$299.id}}(w));if(k){if(-1===w.$jscomp$loop$prop$item$299.stock)continue;d=w.$jscomp$loop$prop$item$299.stock-(C?C.num[w.$jscomp$loop$prop$item$299.remodel]:0);if(!m&&1>d)continue;c=w.$jscomp$loop$prop$item$299.remodel}else{if(0<=w.$jscomp$loop$prop$item$299.stock)continue;var z=h.find(function(H){return function(I){return I.id===H.$jscomp$loop$prop$item$299.id}}(w)),A=C?getArraySum(C.num):0;q=z?getArraySum(z.num):0;if(0===q||!m&&A>=q)continue;d=q-A;for(q=10;0<=q;q--)if(C&&
(z.num[q]-=C.num[q]),0<z.num[q]){c=q;break}}}else if(0<w.$jscomp$loop$prop$item$299.remodel||0<=w.$jscomp$loop$prop$item$299.stock)continue;z="";z="multi"===g?"tr_multi px-1":"px-2";C=document.createElement("div");C.className="plane plane_tr general_tr d-flex py-2 py-lg-1 "+z;C.dataset.planeid=w.$jscomp$loop$prop$item$299.id;C.dataset.type=w.$jscomp$loop$prop$item$299.type;C.dataset.remodel=c;l&&m&&0>=d&&(C.classList.remove("plane_tr","plane","general_tr"),C.classList.add("plane_tr_disabled"));z=
...
C.appendChild(A);"single"===g&&(D.appendChild(E),D.appendChild(F),D.appendChild(G),D.appendChild(J),D.appendChild(M),C.appendChild(D));f.appendChild(C);u=w.$jscomp$loop$prop$item$299.type}f.childNodes.length||(a=document.createElement("div"),a.className="text-center",l&&!m&&(a.textContent+="\u88c5\u5099\u6240\u6301\u6570\u304c\u767b\u9332\u3055\u308c\u3066\u3044\u306a\u3044\u304b\u3001\u5168\u3066\u306e\u88c5\u5099\u304c\u914d\u5099\u6e08\u307f\u3067\u3059\u3002"),l&&!m&&(a.textContent+="\u88c5\u5099\u6240\u6301\u6570\u304c\u767b\u9332\u3055\u308c\u3066\u3044\u306a\u3044\u304b\u3001\u5168\u3066\u306e\u88c5\u5099\u304c\u914d\u5099\u6e08\u307f\u3067\u3059\u3002"));
...
v.includes(E.type)&&(d?0<E.final:!0)});if(n){var t=setting.favoriteShip;p=p.filter(function(E){return t.includes(E.id)})}if(g){n={};for(var x=$jscomp.makeIterator(r),u=x.next();!u.done;n={$jscomp$loop$prop$stock$302:n.$jscomp$loop$prop$stock$302,$jscomp$loop$prop$baseLv$303:n.$jscomp$loop$prop$baseLv$303,$jscomp$loop$prop$baseArea$304:n.$jscomp$loop$prop$baseArea$304},u=x.next())if(n.$jscomp$loop$prop$stock$302=u.value,u=m?n.$jscomp$loop$prop$stock$302.details.filter(function(E){return 1===E.ex||
...
setting.selectedHistory[1]){var D=setting.selectedHistory[1];p.sort(function(E,F){return D.filter(function(G){return G===F.id}).length-D.filter(function(G){return G===E.id}).length})}p.sort(function(E,F){return 7===E.type&&7!==F.type||7===F.type&&7!==E.type?F.type-E.type:6===E.type&&6!==F.type||6===F.type&&6!==E.type?F.type-E.type:10===E.type&&10!==F.type||10===F.type&&10!==E.type?F.type-E.type:E.type-F.type});m=document.createDocumentFragment();x=q=0;n={};p=$jscomp.makeIterator(p);for(u=p.next();!u.done;n=
{$jscomp$loop$prop$ship$313:n.$jscomp$loop$prop$ship$313},u=p.next())if(n.$jscomp$loop$prop$ship$313=u.value,!l||OK_DAIHATSU_TYPE.includes(n.$jscomp$loop$prop$ship$313.type)||OK_DAIHATSU_SHIP.includes(n.$jscomp$loop$prop$ship$313.api))if(!k||OK_NAIKATEI_TYPE.includes(n.$jscomp$loop$prop$ship$313.type)||OK_NAIKATEI_SHIP.includes(n.$jscomp$loop$prop$ship$313.api)){w=1;if(g&&r){if(!n.$jscomp$loop$prop$ship$313.lv)continue;n.$jscomp$loop$prop$ship$313.stock&&(w=n.$jscomp$loop$prop$ship$313.stock);u=usedShip.filter(function(E){return function(F){return F.id===
...
n=e[g],r=getAirStatusBorder(m);f.$jscomp$loop$prop$status$330=isDefMode?getAirStatusIndex(f.$jscomp$loop$prop$ap$328,m):n.indexOf(getArrayMax(n));var p=0,v=!1;4===f.$jscomp$loop$prop$status$330?p=f.$jscomp$loop$prop$ap$328/r[3]*10:3===f.$jscomp$loop$prop$status$330?p=f.$jscomp$loop$prop$ap$328/r[2]*20:2===f.$jscomp$loop$prop$status$330?p=f.$jscomp$loop$prop$ap$328/r[1]*45:1>=f.$jscomp$loop$prop$status$330&&(p=f.$jscomp$loop$prop$ap$328/r[0]*90);if(5===f.$jscomp$loop$prop$status$330&&7!==h)f.$jscomp$loop$prop$status$330=
0,p=100;else if(5===f.$jscomp$loop$prop$status$330){f.$jscomp$loop$prop$abbr$327=$("#shoot_down_table").find(".cond.battle"+(displayBattle+1)).text();var t=AIR_STATUS.find(function(u){return function(q){return q.abbr===u.$jscomp$loop$prop$abbr$327}}(f));t&&(f.$jscomp$loop$prop$status$330=t.id);0===f.$jscomp$loop$prop$status$330&&(p=100)}p=Math.min(100,p);var x=l.data("airstatus");t="bar_status"+f.$jscomp$loop$prop$status$330;l.removeClass("bar_status"+x).addClass(t).css({width:p+"%"}).data("airstatus",
f.$jscomp$loop$prop$status$330);k.find(".rate_td_ap").text(f.$jscomp$loop$prop$ap$328);x=k.find(".rate_td_eap");x.find(".avg_eap").text(m);x.find(".eap_border").html("( "+r.slice(0,4).map(function(u){return function(q){return q<=u.$jscomp$loop$prop$ap$328?"<b>"+q+"</b>":q.toString()}}(f)).join(" / ")+" )");x=100;for(m=0;m<n.length;m++)k.find(".rate_td_status"+m).text("-"),isDefMode?k.find(".rate_td_status"+f.$jscomp$loop$prop$status$330).text("100 %"):0<n[m]&&(v=Math.floor(1E3*n[m])/10,r=0,m+1<n.length&&
0<n[m+1]?(r=v,x-=v):r=x.toFixed(1),k.find(".rate_td_status"+m).text(r+" %"),v=!0);if(v||isDefMode&&8===h)k.removeClass("d-none disabled_tr"),l.closest(".progress_area").addClass("d-flex").removeClass("d-none disabled_bar");l="bar_ex_status"+f.$jscomp$loop$prop$status$330;isDefMode&&(k=$("#simple_lb_def_bar"),m=k.find(".result_bar"),x=m.data("airstatus"),m.removeClass("bar_status"+x+" bar_ex_status"+x).addClass(t+" "+l).css({width:p+"%"}).data("airstatus",f.$jscomp$loop$prop$status$330),k.find(".simple_label").text(AIR_STATUS.find(function(u){return function(q){return q.id===
u.$jscomp$loop$prop$status$330}}(f)).abbr),k.removeClass("d-none"));7===h&&v&&-1<f.$jscomp$loop$prop$status$330&&(h=$("#fleet_simple_bar"),v=h.find(".result_bar"),x=v.data("airstatus"),v.removeClass("bar_status"+x+" bar_ex_status"+x).addClass(t+" "+l).css({width:p+"%"}).data("airstatus",f.$jscomp$loop$prop$status$330),n=AIR_STATUS.find(function(u){return function(q){return q.id===u.$jscomp$loop$prop$status$330}}(f)).abbr+"("+Math.floor(100*n[f.$jscomp$loop$prop$status$330])+"%)",h.find(".simple_label").text(n),
...
function getEnemyApDistribution(a){a.sort(function(r,p){return r-p});for(var b=a.length,c=a[0],d=a[a.length-1],e=0,f=0,g=0,h=0,l=0,k=0,m={$jscomp$loop$prop$i$334:c};m.$jscomp$loop$prop$i$334<=d;m={$jscomp$loop$prop$i$334:m.$jscomp$loop$prop$i$334},m.$jscomp$loop$prop$i$334++){var n=a.findIndex(function(r){return function(p){return p>r.$jscomp$loop$prop$i$334}}(m));0!==n&&(-1===n?n=a.length:a=a.slice(n),k+=100*n/b,!e&&50<=k&&(e=m.$jscomp$loop$prop$i$334),!f&&75<=k&&(f=m.$jscomp$loop$prop$i$334),!g&&
...
function shootDownFleet(a,b,c,d,e){e=void 0===e?!0:e;var f=c.stage2[0][0].length;5===a&&(a=0);for(var g=c.enabledStage2,h=b.ships.length,l=0;l<h;l++){var k=b.ships[l];if(!k.ignoreSlot){for(var m=0,n=!c.isUnion&&k.isEscort||4===c.cellType,r=k.items.length,p=0;p<r;p++){var v=k.items[p];e&&(v.results[d]+=v.slot);if(!(n||!v.canBattle||0>=v.slot)&&f){var t=getShootDownSlotFF(a,v.slot);v.slot-=Math.floor(v.isJet?.6*t:t);if(v.isAttacker&&g){t=Math.floor(Math.random()*f);var x=c.stage2[v.avoid];.5<=Math.random()&&
(v.slot-=Math.floor(x[0][t]*v.slot));.5<=Math.random()&&(v.slot-=x[1][t])}v.canBattle&&0<v.slot?v.airPower=Math.floor(v.antiAir*Math.sqrt(v.slot)+v.bonusAirPower):(0>=v.slot&&(v.slot=0),v.airPower=0)}m+=v.airPower}k.airPower=m}}b.updateAirPower()}
...
var n=[];m&&(n=castInt($("#fleet_formation").val()),e.isUnion&&f.battles[k].cellType===CELL_TYPE.airRaid?e.updateStage2All(n,!0):e.updateStage2All(n),n=e.allStage2);for(var r=l.items[b],p=$jscomp.makeIterator(f.battles),v=p.next();!v.done;v=p.next())v=v.value,v.enemies=v.enemies.filter(function(y){return 0<y.slots.length});for(p=0;p<g;p++){for(v=0;v<=k;v++){var t=f.battles[v],x=t.enemies;calculateLandBase(d,t,v);doJetPhase(e,t);var u=t.cellType,q=t.isUnion?e.unionAirPower:e.airPower,w=t.getAirPower();
q=getAirStatusIndex(q,w);shootDownFleet(q,e,t,v);u===CELL_TYPE.aerialCombat&&(shootDownEnemy(q,x,m,n),q=getAirStatusIndex(e.airPower,t.getAirPower()),shootDownFleet(q,e,t,v,!1));t=$jscomp.makeIterator(x);for(x=t.next();!x.done;x=t.next())x=x.value,x.slots=x.fullSlots.concat(),x.airPower=x.fullAirPower,x.landBaseAirPower=x.fullLandBaseAirPower}for(v=0;3>v;v++){t=d.landBases[v];for(x=0;x<t.planes.length;x++)u=t.planes[x],u.slot=u.fullSlot,u.updateAirPower();t.updateAirPower()}for(v=0;v<e.ships.length;v++)for(t=
...
a={};k=$jscomp.makeIterator(l.items);for(h=k.next();!h.done;a={$jscomp$loop$prop$pl$350:a.$jscomp$loop$prop$pl$350},h=k.next()){a.$jscomp$loop$prop$pl$350=h.value;h=ITEM_DATA.find(function(y){return function(C){return C.id===y.$jscomp$loop$prop$pl$350.id}}(a));if(g===(e?e.slot.length:4))break;m=h?h.name:"-";n=PLANE_TYPE.includes(h?h.type:0);p="";n&&FIGHTERS.includes(h.type)?p=h.antiAir?'<span class="mx-1">\u5bfe\u7a7a: '+h.antiAir+"</span>":"":n&&RECONNAISSANCES.includes(h.type)?(p=h.antiAir?'<span class="mx-1">\u5bfe\u7a7a: '+
...
for(v=p.next();!v.done;v=p.next())v=v.value,v.slots=v.fullSlots.concat(),v.airPower=v.fullAirPower,v.landBaseAirPower=v.fullLandBaseAirPower}for(r=0;3>r;r++){p=d.landBases[r];for(t=v=0;t<p.planes.length;t++)x=p.planes[t],a+1===p.baseNo&&b===t&&g.push(x.slot),v+=x.slot,x.slot=x.fullSlot,x.updateAirPower();a+1===p.baseNo&&m.push(v);p.updateAirPower()}}var C=l[b].id,z=l[b].remodel,A=l.find(function(D){return 312===D.id})?1.15:l.find(function(D){return 311===D.id})?1.125:1,B=e.battles[h].isUnion?1.1:
1;chartSlotDistribution=updateDetailChart(g,"\u6b8b\u6a5f\u6570 [\u6a5f]",{mode:"index",callbacks:{title:function(D,E){D=D[0].xLabel;E="\u822a\u7a7a\u6226\u706b\u529b\uff1a"+(LandBaseItem.getFirePower(C,D,z)*A*B).toFixed(1);return D?"\u6b8b\u6a5f\u6570\uff1a"+D+" \u6a5f\n"+E:"\u6b8b\u6a5f\u6570\uff1a0 \u6a5f\n\u822a\u7a7a\u6226\u706b\u529b\uff1a0"},label:function(D,E){return[D.yLabel+" %"]}}});n=h=g=0;m=$jscomp.makeIterator(m);for(r=m.next();!r.done;r=m.next())r=r.value,p=r/k,0===r?n+=1:.25>p?h+=
...
m={};g=$jscomp.makeIterator(d.landBases[a].planes);for(h=g.next();!h.done;m={$jscomp$loop$prop$pl$352:m.$jscomp$loop$prop$pl$352},h=g.next())m.$jscomp$loop$prop$pl$352=h.value,n=(h=ITEM_DATA.find(function(D){return function(E){return E.id===D.$jscomp$loop$prop$pl$352.id}}(m)))?h.name:"-",r="",FIGHTERS.includes(h.type)?r=h.antiAir?'<span class="mx-1">\u5bfe\u7a7a: '+h.antiAir+"</span>":"":RECONNAISSANCES.includes(h.type)?(r=h.antiAir?'<span class="mx-1">\u5bfe\u7a7a: '+h.antiAir+"</span>":"",r+='<span class="mx-1">\u7d22\u6575: '+
...
u);var w=u.cellType,y=u.isUnion?e.unionAirPower:e.airPower,C=u.getAirPower();y=getAirStatusIndex(y,C);shootDownFleet(y,e,u,x);w===CELL_TYPE.aerialCombat&&(shootDownEnemy(y,q,r,v),y=getAirStatusIndex(e.airPower,u.getAirPower()),shootDownFleet(y,e,u,x,!1));x===h&&(shootDownEnemy(y,q,r,v),u=m.slots[b],k.push(u),c||(u=p.getFirePower(u),2===u.length?(l.push(u[0]),l.push(u[1])):l.push(u[0])));for(u=0;u<q.length;u++)w=q[u],w.onlyScout||(w.slots=w.fullSlots.concat(),w.airPower=w.fullAirPower,w.landBaseAirPower=
w.fullLandBaseAirPower)}for(x=0;3>x;x++){q=d.landBases[x];for(u=0;u<q.planes.length;u++)w=q.planes[u],w.slot=w.fullSlot,w.updateAirPower();q.updateAirPower()}for(x=0;x<e.ships.length;x++)for(q=e.ships[x],u=q.items.length,w=q.airPower=0;w<u;w++)y=q.items[w],y.slot=y.fullSlot,y.updateAirPower(),q.airPower+=y.airPower;e.updateAirPower()}chartSlotDistribution=updateDetailChart(c?k:l,c?"\u6b8b\u6a5f\u6570 [\u6a5f]":"\u822a\u7a7a\u6226\u706b\u529b",{mode:"index",callbacks:{title:function(z){z=z[0].xLabel;
...
z.$jscomp$loop$prop$id$356}}(e)),l=n.slot[h],c=PLANE_TYPE.includes(g?g.type:0),r="",c&&FIGHTERS.includes(g.type)?r=g.antiAir?'<span class="mx-1">\u5bfe\u7a7a: '+g.antiAir+"</span>":"":c&&(r=g.antiAir?'<span class="mx-1">\u5bfe\u7a7a: '+g.antiAir+"</span>":"",r+=g.torpedo?'<span class="mx-1">\u96f7\u88c5: '+g.torpedo+"</span>":"",r+=g.bomber?'<span class="mx-1">\u7206\u88c5: '+g.bomber+"</span>":""),a+='\n\t\t<div class="d-flex px-2 py-1 '+(b===d?"selected":"")+" "+(c?"general_tr btn_show_detail":
...
k=aerialSetting.isAllSlot,m="",n=chartSlotDistribution,r=0;r<a.length;r++){var p=a[r];if(!(0>=p.id)){var v=p.armor+p.sumItemArmor,t=[];d?p.type.includes(2)?t=getLandBaseAerialPowersLandBase(n,p):p.type.includes(18)&&f?t=getLandBaseASWPower(n):!e||86!==p.id&&120!==p.id?(p.type.includes(16)?224===b.id?t=getLandBaseAerialPowers(n,1,1,1,!0):405===b.id?t=getLandBaseAerialPowers(n,1,1,1.1):444===b.id&&(t=getLandBaseAerialPowers(n,1,1,1.15)):p.type.includes(13)?406===b.id?t=getLandBaseAerialPowers(n,1.35):
444===b.id&&(t=getLandBaseAerialPowers(n,1,1,1.15)):(p.type.includes(12)||p.type.includes(14)||p.type.includes(15)||p.type.includes(17))&&444===b.id&&(t=getLandBaseAerialPowers(n,1,1,1.15)),t.length||(t=getLandBaseAerialPowers(n))):t=getLandBaseAerialPowers(n,1,3.2):t=c?getFleetAerialPower(n,p,1,l):getEnemyAerialPowers(n,p);var x=p.hp,u=createDamageDistribution(t,v,h,c,x),q=u.map(function(B){return B.damage}),w=getArrayMin(q),y=getArrayMax(q);q=[{min:x,max:getArrayMax(u.map(function(B){return B.damage}))+
1,value:0},{min:Math.ceil(.75*x),max:x,value:0},{min:Math.ceil(.5*x),max:Math.ceil(.75*x),value:0}];t=t.map(function(B){return B.power}).some(function(B){return 0>=B});w=(1<=w?w:t?"0":"\u5272\u5408")+"~"+(1<=y?y:"\u5272\u5408");k||0!==g||(w="-");t="";y={};for(var C=0;C<q.length;y={$jscomp$loop$prop$borderMin$368:y.$jscomp$loop$prop$borderMin$368,$jscomp$loop$prop$borderMax$369:y.$jscomp$loop$prop$borderMax$369},C++){var z=q[C];y.$jscomp$loop$prop$borderMin$368=z.min;y.$jscomp$loop$prop$borderMax$369=
z.max;var A=u.filter(function(B){return function(D){return D.damage>=B.$jscomp$loop$prop$borderMin$368&&D.damage<B.$jscomp$loop$prop$borderMax$369}}(y)).map(function(B){return B.rate});A=A.length===u.length?1:getArraySum(A);z.value=A;if(b.isAttacker||!c||p.type.includes(18)&&f){if(c&&p.type.includes(18)&&!f||!c&&[13,14].includes(p.type)){t+='<td class="text-center" colspan="'+q.length+'">\u5bfe\u6f5c\u653b\u6483\u4e0d\u53ef</td>';w="";u=$jscomp.makeIterator(q);for(y=u.next();!y.done;y=u.next())y.value.value=
0;break}if(1!==A||0!==C||k)1===A?t+='<td>100 <span class="font_size_11 font_color_half">%</span></td>':(z=Math.floor(1E3*A)/10,t+="<td>"+(0===z&&0!==A?.1:z)+' <span class="font_size_11 font_color_half">%</span></td>');else{t+='<td colspan="'+q.length+'" class="text-center text_red">\u78ba\u6bba</td>';break}}else t+="<td>-</td>",w=""}u=Math.floor(1E3*(q[0].value+q[1].value))/10;y=Math.floor(1E3*(q[0].value+q[1].value+q[2].value))/10;m+='\n\t\t<tr class="stage3_calc_detail '+(90<=Math.floor(1E3*q[0].value)/
...
function getLandBaseAerialPowers(a,b,c,d,e){b=void 0===b?1:b;d=void 0===d?1:d;e=void 0===e?!1:e;var f=aerialSetting.item,g=aerialSetting.isCritical,h=aerialSetting.levelCriticalBonus,l=aerialSetting.isAllSlot,k=aerialSetting.manualSlot;c=aerialSetting.nishikiBonus*aerialSetting.contactBonus*aerialSetting.unionBonus*(void 0===c?1:c);var m=[],n={};a=$jscomp.makeIterator(a);for(var r=a.next();!r.done;n={$jscomp$loop$prop$a$371:n.$jscomp$loop$prop$a$371},r=a.next()){r=r.value;var p=l?r.slot:k;p=e?LandBaseItem.getFirePower_SP(f,
p,g,h):LandBaseItem.getFirePower(f.id,p,f.remodel,g,h,b,d);r=l?r.rate:1;n.$jscomp$loop$prop$a$371=p*c;(p=m.find(function(v){return function(t){return t.power===v.$jscomp$loop$prop$a$371}}(n)))?p.rate+=r:m.push({power:n.$jscomp$loop$prop$a$371,rate:r});if(!l)break}return m}
function getLandBaseAerialPowersLandBase(a,b,c){var d=aerialSetting.item,e=aerialSetting.isCritical,f=aerialSetting.levelCriticalBonus,g=aerialSetting.isAllSlot,h=aerialSetting.manualSlot;c=aerialSetting.nishikiBonus*aerialSetting.contactBonus*aerialSetting.unionBonus*(void 0===c?1:c);var l=[],k={};a=$jscomp.makeIterator(a);for(var m=a.next();!m.done;k={$jscomp$loop$prop$a$373:k.$jscomp$loop$prop$a$373},m=a.next()){var n=m.value;m=LandBaseItem.getFirePowerLandBase(d,g?n.slot:h,e,f,b);n=g?n.rate:1;
k.$jscomp$loop$prop$a$373=m*c;(m=l.find(function(r){return function(p){return p.power===r.$jscomp$loop$prop$a$373}}(k)))?m.rate+=n:l.push({power:k.$jscomp$loop$prop$a$373,rate:n});if(!g)break}return l}
function getLandBaseASWPower(a,b){var c=aerialSetting.item,d=aerialSetting.isCritical,e=aerialSetting.levelCriticalBonus,f=aerialSetting.isAllSlot,g=aerialSetting.manualSlot;b=aerialSetting.contactBonus*(void 0===b?1:b);var h=[];a=$jscomp.makeIterator(a);for(var l=a.next();!l.done;l=a.next()){l=l.value;var k=f?l.slot:g;k=0<k?c.asw*Math.sqrt(1.8*k)+25:0;for(var m=10<=c.asw?.7:.35,n=10<=c.asw?.3:.45,r=1/(100*n+1),p={},v=0;v<=100*n;p={$jscomp$loop$prop$power$375:p.$jscomp$loop$prop$power$375},v++){var t=
f?l.rate*r:r,x=Math.floor(softCap(k*(m+v/100),AS_CAP));d&&(x=Math.floor(1.5*x*e));p.$jscomp$loop$prop$power$375=x*(47===c.type?1.8:1)*b;RECONNAISSANCES.includes(c.type)&&(p.$jscomp$loop$prop$power$375=1);(x=h.find(function(u){return function(q){return q.power===u.$jscomp$loop$prop$power$375}}(p)))?x.rate+=t:h.push({power:p.$jscomp$loop$prop$power$375,rate:t})}if(!f)break}return h}
...
{$jscomp$loop$prop$a$377:p.$jscomp$loop$prop$a$377},v=r.next())p.$jscomp$loop$prop$a$377=v.value*c,p.$jscomp$loop$prop$a$377=f?Math.floor(1.5*p.$jscomp$loop$prop$a$377*g):p.$jscomp$loop$prop$a$377,(v=m.find(function(t){return function(x){return x.power===t.$jscomp$loop$prop$a$377}}(p)))?v.rate+=n:m.push({power:p.$jscomp$loop$prop$a$377,rate:n});if(!h)break}return m}
function getEnemyAerialPowers(a,b,c){var d=aerialSetting.item,e=aerialSetting.isCritical,f=aerialSetting.levelCriticalBonus,g=aerialSetting.isAllSlot,h=aerialSetting.manualSlot,l=aerialSetting.isUnion;c=aerialSetting.contactBonus*(void 0===c?1:c);var k=[];a=$jscomp.makeIterator(a);for(var m=a.next();!m.done;m=a.next()){m=m.value;var n=d.getFirePower(g?m.slot:h,l,b.isEscort),r=1/n.length;m=g?m.rate*r:r;r={};n=$jscomp.makeIterator(n);for(var p=n.next();!p.done;r={$jscomp$loop$prop$a$379:r.$jscomp$loop$prop$a$379},
p=n.next())r.$jscomp$loop$prop$a$379=p.value*c,r.$jscomp$loop$prop$a$379=e?Math.floor(1.5*r.$jscomp$loop$prop$a$379*f):r.$jscomp$loop$prop$a$379,(p=k.find(function(v){return function(t){return t.power===v.$jscomp$loop$prop$a$379}}(r)))?p.rate+=m:k.push({power:r.$jscomp$loop$prop$a$379,rate:m});if(!g)break}return k}
...
function updateDetailChart(a,b,c){for(var d=[],e=[],f=[],g=[],h=getArrayMax(a),l=getArrayMin(a),k=a.length,m=0,n=0,r=0,p=0,v=0,t={$jscomp$loop$prop$i$385:l};t.$jscomp$loop$prop$i$385<=h;t={$jscomp$loop$prop$i$385:t.$jscomp$loop$prop$i$385},t.$jscomp$loop$prop$i$385++){var x=a.filter(function(u){return function(q){return q===u.$jscomp$loop$prop$i$385}}(t)).length;x&&(d.push(t.$jscomp$loop$prop$i$385),e.push((100*x/k).toFixed(1E5<=k?5:1E4<=k?4:1E3<=k?3:2)),g.push({slot:t.$jscomp$loop$prop$i$385,rate:x/
k}),v+=100*x/k,f.push(v.toFixed(1)),!m&&50<=v&&(m=t.$jscomp$loop$prop$i$385),!n&&90<=v&&(n=t.$jscomp$loop$prop$i$385),!r&&95<=v&&(r=t.$jscomp$loop$prop$i$385),!p&&99<=v&&(p=t.$jscomp$loop$prop$i$385))}$("#detail_max").text(h);$("#detail_min").text(l);$("#detail_50").text(m);$("#detail_90").text(n);$("#detail_95").text(r);$("#detail_99").text(p);chartInstance?(chartInstance.data.labels=d,chartInstance.data.datasets[0].data=e,chartInstance.data.datasets[1].data=f,chartInstance.options.scales.xAxes[0].scaleLabel.labelString=
...
n.toFixed(2)+")</span>":"",u=m?'<span class="ml-1 text_remodel">(+'+m.toFixed(2)+")</span>":"",q=l?'<span class="ml-1 text_remodel">(+'+l.toFixed(2)+")</span>":"",w=e?'<span class="ml-1 text_remodel">(+'+e.toFixed(2)+")</span>":"",y=0<h.avoid?AVOID_TYPE.find(function(A){return A.id===h.avoid}):null,C=g.selectRate.length?g.selectRate.map(function(A){return(100*A).toFixed(0)+"%"}):null,z=PLANE_TYPE.includes(h.type)?getRequiredgBattleCountString(h.grow):null;return('\n\t<div class="text-left m-1 item_tooltip">\n\t\t<div class="d-flex">\n\t\t\t<img src="../img/type/icon'+
...
z+"</div>":"")+"\n\t</div>").trim()}
function showEnemyStatusToolTip(a){if(a.length&&a[0].dataset.enemyid){var b=ENEMY_DATA.find(function(k){return k.id===castInt(a[0].dataset.enemyid)});if(b){for(var c=new Enemy(b.id),d="",e=0,f={},g=0;g<b.eqp.length;f={$jscomp$loop$prop$itemId$387:f.$jscomp$loop$prop$itemId$387},g++){f.$jscomp$loop$prop$itemId$387=b.eqp[g];var h=b.slot[g],l=ENEMY_ITEM.find(function(k){return function(m){return m.id===k.$jscomp$loop$prop$itemId$387}}(f));l&&(e+=l.armor,d+='\n\t\t\t<div class="d-flex">\n\t\t\t\t<div class="align-self-center enemy_tool_slot">'+(0<
...
(2<=f[k].length?p+" ~ "+r:r)+"</td>\n\t\t</tr>"}$("#antiair_input_table tbody").html(h);if(!d.innerHTML){b=document.createDocumentFragment();c={};a=$jscomp.makeIterator(a.allStage2);for(l=a.next();!l.done;c={$jscomp$loop$prop$stage2$272$389:c.$jscomp$loop$prop$stage2$272$389},l=a.next())c.$jscomp$loop$prop$stage2$272$389=l.value,h=ANTIAIR_CUTIN.find(function(x){return function(u){return u.id===x.$jscomp$loop$prop$stage2$272$389.cutin.id}}(c)),k=e.includes(h.id),f=document.createElement("div"),f.className=
...
var k=EXPANDED_SPECIAL_ITEM.filter(function(q){return q.shipApiIds.includes(h.api)});e={};k=$jscomp.makeIterator(k);for(var m=k.next();!m.done;e={$jscomp$loop$prop$sp$391:e.$jscomp$loop$prop$sp$391},m=k.next())e.$jscomp$loop$prop$sp$391=m.value,(m=ITEM_LIST.find(function(q){return function(w){return w.id===q.$jscomp$loop$prop$sp$391.itemId}}(e)))&&!g.includes(m.type)&&g.push(m.type),a.push(m)}var n=castInt($target.index());if(0<=n){var r=FORBIDDEN_LINK_SHIP_ITEM.find(function(q){return q.shipId===
...
h.id}).itemIDs;e=e.filter(function(q){return!p.includes(q.id)})}if(l){e=e.filter(function(q){return 34!==q.id&&87!==q.id});var v=a.map(function(q){return q.id});l={};a=$jscomp.makeIterator(a);for(k=a.next();!k.done;l={$jscomp$loop$prop$spItem$273$393:l.$jscomp$loop$prop$spItem$273$393},k=a.next())l.$jscomp$loop$prop$spItem$273$393=k.value,e=e.filter(function(q){return function(w){return v.includes(w.id)||q.$jscomp$loop$prop$spItem$273$393.type!==w.type}}(l))}}else $target&&$target.hasClass("ship_plane")?
...
b=document.createElement("optgroup");var g=ITEM_API_TYPE.find(function(h){return function(l){return l.id===h.$jscomp$loop$prop$type$396}}(d));g?b.label=g.name:(g=OTHER_TYPE.find(function(h){return function(l){return l.id===h.$jscomp$loop$prop$type$396}}(d)),b.label=g?g.name:"\u672a\u5b9a\u7fa9")}g=document.createElement("option");g.textContent=f.id+": "+f.name;g.value=f.id;b.appendChild(g)}a.appendChild(b);b=$jscomp.makeIterator(document.getElementsByClassName("enemy_planes"));for(c=b.next();!c.done;c=
...
d.$jscomp$loop$prop$planeId$400=castInt(b.getElementsByClassName("enemy_planes")[e].value);var g=ENEMY_ITEM.find(function(h){return function(l){return l.id===h.$jscomp$loop$prop$planeId$400}}(d));g?(c.slot.push(PLANE_TYPE.includes(g.type)?f:0),c.eqp.push(g.id)):(c.slot.push(-1),c.eqp.push(-1))}b=loadLocalStorage("manual_enemies")||[];d=b.findIndex(function(h){return h.id===c.id});0>d?b.push(c):b[d]=c;d=ENEMY_DATA.findIndex(function(h){return h.id===c.id});ENEMY_DATA[d]=c;saveLocalStorage("manual_enemies",
...
document.createDocumentFragment();b=1;c=[];for(e={$jscomp$loop$prop$ap$406:getArrayMax(d.map(function(m){return m.airPower}))};0<e.$jscomp$loop$prop$ap$406;e={$jscomp$loop$prop$ap$406:e.$jscomp$loop$prop$ap$406},e.$jscomp$loop$prop$ap$406--)f=d.filter(function(m){return function(n){return n.airPower===m.$jscomp$loop$prop$ap$406}}(e)).length,0<f&&c.push({rank:b++,airPower:e.$jscomp$loop$prop$ap$406,count:f});b=1;e={};c=$jscomp.makeIterator(c);for(f=c.next();!f.done;e={$jscomp$loop$prop$obj$408:e.$jscomp$loop$prop$obj$408},
f=c.next())for(e.$jscomp$loop$prop$obj$408=f.value,f=d.filter(function(m){return function(n){return n.airPower===m.$jscomp$loop$prop$obj$408.airPower}}(e)),g=0;g<f.length;g++){h=f[g];var l='\n\t\t\t\t<div class="d-flex">\n\t\t\t\t<img class="align-self-center plane_img_sm" src="../img/type/icon'+h.itype+'.png">\n\t\t\t\t<div class="align-self-center ml-1">'+h.name+"</div>\n\t\t\t\t\t"+(h.remodel?'<div class="align-self-center text_remodel font_size_12 ml-1"><i class="fas fa-star"></i>+'+h.remodel+
...
b.sort(function(h,l){return h.grow===l.grow?h.type-l.type:h.grow-l.grow});for(var c=[],d={$jscomp$loop$prop$c$416:15};0<d.$jscomp$loop$prop$c$416;d={$jscomp$loop$prop$c$416:d.$jscomp$loop$prop$c$416},d.$jscomp$loop$prop$c$416--){var e=b.filter(function(h){return function(l){return l.grow===h.$jscomp$loop$prop$c$416}}(d));e.length&&c.push({c:d.$jscomp$loop$prop$c$416,planes:e})}b=$jscomp.makeIterator(c);for(c=b.next();!c.done;c=b.next())for(c=c.value,d=0;d<c.planes.length;d++){e=c.planes[d];var f=
