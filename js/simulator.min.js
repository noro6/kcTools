...
m.$jscomp$loop$prop$baseArea$304;w.upLuck=y;w.stock=u.filter(function(E){return function(F){return F.lv===E.$jscomp$loop$prop$baseLv$303&&(F.area===E.$jscomp$loop$prop$baseArea$304||1>E.$jscomp$loop$prop$baseArea$304&&1>F.area)}}(m)).length;w.ex=u[0].ex;y=[{lv:m.$jscomp$loop$prop$baseLv$303,area:m.$jscomp$loop$prop$baseArea$304}];if(2<=u.length)for(var C={},z=1;z<u.length;C={$jscomp$loop$prop$lv$308:C.$jscomp$loop$prop$lv$308,$jscomp$loop$prop$area$309:C.$jscomp$loop$prop$area$309},z++){C.$jscomp$loop$prop$lv$308=
u[z].lv;var A=u[z].st[4];C.$jscomp$loop$prop$area$309=u[z].area<=MAX_AREA&&0<u[z].area?u[z].area:-1;if(!y.find(function(E){return function(F){return F.lv===E.$jscomp$loop$prop$lv$308&&F.area===E.$jscomp$loop$prop$area$309}}(C))){var B=Object.assign({},w);B.lv=C.$jscomp$loop$prop$lv$308;B.area=C.$jscomp$loop$prop$area$309;B.stock=u.filter(function(E){return function(F){return F.lv===E.$jscomp$loop$prop$lv$308&&(F.area===E.$jscomp$loop$prop$area$309||1>E.$jscomp$loop$prop$area$309&&1>F.area)}}(C)).length;
B.upLuck=A;B.ex=u[z].ex;q.splice(r,0,B);y.push({lv:C.$jscomp$loop$prop$lv$308,area:C.$jscomp$loop$prop$area$309})}}}}}if(f&&setting.selectedHistory[1]){var D=setting.selectedHistory[1];q.sort(function(E,F){return D.filter(function(G){return G===F.id}).length-D.filter(function(G){return G===E.id}).length})}q.sort(function(E,F){return 7===E.type&&7!==F.type||7===F.type&&7!==E.type?F.type-E.type:6===E.type&&6!==F.type||6===F.type&&6!==E.type?F.type-E.type:10===E.type&&10!==F.type||10===F.type&&10!==
E.type?F.type-E.type:E.type-F.type});n=document.createDocumentFragment();x=r=0;m={};q=$jscomp.makeIterator(q);for(u=q.next();!u.done;m={$jscomp$loop$prop$ship$313:m.$jscomp$loop$prop$ship$313},u=q.next())if(m.$jscomp$loop$prop$ship$313=u.value,!l||OK_DAIHATSU_TYPE.includes(m.$jscomp$loop$prop$ship$313.type)||OK_DAIHATSU_SHIP.includes(m.$jscomp$loop$prop$ship$313.api))if(!k||OK_NAIKATEI_TYPE.includes(m.$jscomp$loop$prop$ship$313.type)||OK_NAIKATEI_SHIP.includes(m.$jscomp$loop$prop$ship$313.api)){w=
1;if(g&&p){if(!m.$jscomp$loop$prop$ship$313.lv)continue;m.$jscomp$loop$prop$ship$313.stock&&(w=m.$jscomp$loop$prop$ship$313.stock);u=usedShip.filter(function(E){return function(F){return F.id===E.$jscomp$loop$prop$ship$313.id&&F.lv===E.$jscomp$loop$prop$ship$313.lv&&F.area===E.$jscomp$loop$prop$ship$313.area}}(m)).length;w-=u;if(0>=w&&!h)continue}u=document.createElement("div");u.className=g&&h&&!w?"ship_tr ship_tr_disabled d-flex "+("multi"===c?"tr_multi":""):"ship_tr general_tr d-flex "+("multi"===
c?"tr_multi":"");u.dataset.shipid=m.$jscomp$loop$prop$ship$313.id;u.dataset.level=m.$jscomp$loop$prop$ship$313.lv?m.$jscomp$loop$prop$ship$313.lv:99;u.dataset.area=0<m.$jscomp$loop$prop$ship$313.area?m.$jscomp$loop$prop$ship$313.area:0;u.dataset.luck=m.$jscomp$loop$prop$ship$313.luck+m.$jscomp$loop$prop$ship$313.upLuck;u.id="ship_tr_"+m.$jscomp$loop$prop$ship$313.id;y=document.createElement("div");y.className="ml-1 align-self-center pt-1";C=document.createElement("img");C.width=120;C.height=30;C.src=
"../img/ship/"+m.$jscomp$loop$prop$ship$313.id+".png";y.appendChild(C);g&&0<m.$jscomp$loop$prop$ship$313.area&&(y.classList.add("exist_area"),C=document.createElement("img"),C.className="area_banner",C.src="../img/util/area"+m.$jscomp$loop$prop$ship$313.area+".png",y.appendChild(C));C=document.createElement("div");C.className="ml-1 align-self-center";z=document.createElement("div");z.className="text-primary font_size_11";z.textContent=g?"Lv : "+m.$jscomp$loop$prop$ship$313.lv:"ID : "+m.$jscomp$loop$prop$ship$313.id;
A=document.createElement("div");A.className="d-flex";A.textContent=m.$jscomp$loop$prop$ship$313.name;B=document.createElement("div");B.className="ml-1 ship_td_stock align-self-center "+(g?"":"d-none");B.textContent="\u00d7"+w;A.appendChild(B);C.appendChild(z);C.appendChild(A);u.appendChild(y);u.appendChild(C);if("multi"!==c)for(w=0;5>w;w++)y=document.createElement("div"),y.className="ship_td_slot font_size_12 align-self-center "+(0===w?"ml-auto":""),y.textContent=w<m.$jscomp$loop$prop$ship$313.slot.length?
m.$jscomp$loop$prop$ship$313.slot[w]:"",u.appendChild(y);r!==m.$jscomp$loop$prop$ship$313.type&&(r=document.createElement("div"),r.className="type_divider mt-4",w=document.createElement("div"),w.className="align-self-center font_size_16",w.textContent=API_SHIP_TYPE.find(function(E){return function(F){return F.id===E.$jscomp$loop$prop$ship$313.type}}(m)).name,y=document.createElement("div"),y.className="flex-grow-1 border-bottom align-self-center mx-2",r.appendChild(w),r.appendChild(y),n.appendChild(r));
f||x===m.$jscomp$loop$prop$ship$313.type2||(x=document.createElement("div"),x.className="type_divider mt-2 ml-1",r=document.createElement("div"),r.className="font_size_12 font_color_half align-self-center",w=API_CTYPE.find(function(E){return function(F){return F.id===E.$jscomp$loop$prop$ship$313.type2}}(m))||{name:""},r.textContent=w.name,x.appendChild(r),n.appendChild(x));r=m.$jscomp$loop$prop$ship$313.type;x=m.$jscomp$loop$prop$ship$313.type2;n.appendChild(u)}"multi"===c?(a.classList.add("modal-xl"),
