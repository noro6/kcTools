...
g.callWhenSettled_(h.resolve,h.reject)};e.prototype.settleSameAsThenable_=function(g,h){var l=this.createResolveAndReject_();try{g.call(h,l.resolve,l.reject)}catch(k){l.reject(k)}};e.prototype.then=function(g,h){function l(r,p){return"function"==typeof r?function(v){try{k(r(v))}catch(u){m(u)}}:p}var k,m,n=new e(function(r,p){k=r;m=p});this.callWhenSettled_(l(g,k),l(h,m));return n};e.prototype.catch=function(g){return this.then(void 0,g)};e.prototype.callWhenSettled_=function(g,h){function l(){switch(k.state_){case 1:g(k.result_);
...
m){function n(v){return function(u){r[v]=u;p--;0==p&&k(r)}}var r=[],p=0;do r.push(void 0),p++,c(l.value).callWhenSettled_(n(r.length-1),m),l=h.next();while(!l.done)})};return e},"es6","es3");$jscomp.findInternal=function(a,b,c){a instanceof String&&(a=String(a));for(var d=a.length,e=0;e<d;e++){var f=a[e];if(b.call(c,f,e,a))return{i:e,v:f}}return{i:-1,v:void 0}};$jscomp.polyfill("Array.prototype.find",function(a){return a?a:function(b,c){return $jscomp.findInternal(this,b,c).v}},"es6","es3");
...
$("#main");var g=[];d=[];var h=[];f=$("#main_header_info");e=$("#footer_info");c.find(".contents").each(function(m,n){g.push($(n).attr("id"));h.push($(n))});c.empty();c.append(f);var l={},k=$jscomp.makeIterator(setting.contentsOrder);for(f=k.next();!f.done;l={$jscomp$loop$prop$id$160$293:l.$jscomp$loop$prop$id$160$293},f=k.next())l.$jscomp$loop$prop$id$160$293=f.value,g.includes(l.$jscomp$loop$prop$id$160$293)&&(f=h.find(function(m){return function(n){return n.attr("id")===m.$jscomp$loop$prop$id$160$293}}(l)),
c.append(f),d.push(l.$jscomp$loop$prop$id$160$293));c.append(e);if(g.length!==d.length){e={};l=$jscomp.makeIterator(g);for(f=l.next();!f.done;e={$jscomp$loop$prop$id$161$295:e.$jscomp$loop$prop$id$161$295},f=l.next())e.$jscomp$loop$prop$id$161$295=f.value,d.includes(e.$jscomp$loop$prop$id$161$295)||(f=h.find(function(m){return function(n){return n.attr("id")===m.$jscomp$loop$prop$id$161$295}}(e)),c.append(f),d.push(e.$jscomp$loop$prop$id$161$295));setting.contentsOrder=d.concat();saveSetting()}}$("#stage2_detail_slot").val(18);
...
[14,15].includes(b)?u=["asw","fire","accuracy","avoid2","armor"]:[5,22,32].includes(b)?u=["torpedo","fire","accuracy","avoid2","armor"]:21===b?u=["antiAir","antiAirWeight","antiAirBonus","fire","torpedo"]:LB_ATTACKERS.includes(b)?u=["antiAir","radius","torpedo","avoid","cost"]:48===b&&(u=["antiAir","radius","battleAntiAir","defenseAntiAir","cost"]);$target&&!$target.hasClass("ship_plane")&&(u[1]="radius",u[4]="cost",0===b&&(u=["antiAir","radius","battleAntiAir","cost","avoid"]));var x=0;$("#plane_table_thead").find(".plane_td_basic").each(function(H,
I){$(I).text(convertHeaderText(u[x]));$(I)[0].dataset.sortkey=u[x++];r===$(I)[0].dataset.sortkey?$(I).addClass("active"):$(I).removeClass("active")});"multi"===g?(c.addClass("modal-xl"),c.removeClass("modal-lg"),d.addClass("multi_mode"),c.find(".scroll_thead").addClass("d-none").removeClass("d-flex")):(c.addClass("modal-lg"),c.removeClass("modal-xl"),d.removeClass("multi_mode"),c.find(".scroll_thead").addClass("d-flex").removeClass("d-none"));l?($("#divide_stock").closest("div").removeClass("d-none"),
$("#disp_equipped").closest("div").removeClass("d-none"),$("#disp_in_stock").prop("checked",!0)):($("#divide_stock").closest("div").addClass("d-none"),$("#disp_equipped").closest("div").addClass("d-none"),$("#disp_in_stock").prop("checked",!1));b=a.length;var t=0;c=0;d=-1;for(var q=0,w={},z=0;z<b;w={$jscomp$loop$prop$item$301:w.$jscomp$loop$prop$item$301},z++)if(w.$jscomp$loop$prop$item$301=a[z],!n||setting.favoritePlane.includes(w.$jscomp$loop$prop$item$301.id)){if(l&&h){var D=p.find(function(H){return function(I){return I.id===
H.$jscomp$loop$prop$item$301.id}}(w));if(k){if(-1===w.$jscomp$loop$prop$item$301.stock)continue;d=w.$jscomp$loop$prop$item$301.stock-(D?D.num[w.$jscomp$loop$prop$item$301.remodel]:0);if(!m&&1>d)continue;c=w.$jscomp$loop$prop$item$301.remodel}else{if(0<=w.$jscomp$loop$prop$item$301.stock)continue;var y=h.find(function(H){return function(I){return I.id===H.$jscomp$loop$prop$item$301.id}}(w)),A=D?getArraySum(D.num):0;q=y?getArraySum(y.num):0;if(0===q||!m&&A>=q)continue;d=q-A;for(q=10;0<=q;q--)if(D&&
(y.num[q]-=D.num[q]),0<y.num[q]){c=q;break}}}else if(0<w.$jscomp$loop$prop$item$301.remodel||0<=w.$jscomp$loop$prop$item$301.stock)continue;y="";y="multi"===g?"tr_multi px-1":"px-2";D=document.createElement("div");D.className="plane plane_tr general_tr d-flex py-2 py-lg-1 "+y;D.dataset.planeid=w.$jscomp$loop$prop$item$301.id;D.dataset.type=w.$jscomp$loop$prop$item$301.type;D.dataset.remodel=c;l&&m&&0>=d&&(D.classList.remove("plane_tr","plane","general_tr"),D.classList.add("plane_tr_disabled"));y=
document.createElement("div");y.className="align-self-center size-25 relative";q=document.createElement("canvas");A=q.getContext("2d");q.width=25;q.height=25;A.drawImage(IMAGES["type"+w.$jscomp$loop$prop$item$301.itype],0,0,25,25);if(specialOperator.enabled){A=!1;for(var B=$jscomp.makeIterator(specialOperator.specialInfo),E=B.next();!E.done;E=B.next())if(E=E.value,E.items.includes(w.$jscomp$loop$prop$item$301.id)){A=document.createElement("div");A.className="item_special flash";A.innerHTML=E.name+
'<span class="font_size_12">'+E.remarks+"</span>";y.appendChild(A);A=!0;break}if(v&&!A)continue}A=document.createElement("div");A.className="pl-1 d-flex align-self-center flex-grow-1";B=!1;if(16===w.$jscomp$loop$prop$item$301.itype&&8<=w.$jscomp$loop$prop$item$301.antiAir)B=!0;else if(21===w.$jscomp$loop$prop$item$301.type&&9<=w.$jscomp$loop$prop$item$301.antiAir)B=!0;else if(350===w.$jscomp$loop$prop$item$301.id||351===w.$jscomp$loop$prop$item$301.id||352===w.$jscomp$loop$prop$item$301.id)B=!0;E=
document.createElement("div");E.className="pl-1 plane_td_name align-self-center"+(B?" special_item":"");E.textContent=w.$jscomp$loop$prop$item$301.name;A.appendChild(E);B=document.createElement("div");B.className="ml-2 plane_td_stock align-self-center";B.textContent="\u00d7"+(0<d?d:0);E=document.createDocumentFragment();var C=document.createElement("div");C.className="ml-auto plane_td_basic align-self-center";var F=document.createElement("div");F.className="plane_td_basic align-self-center";var G=
document.createElement("div");G.className="plane_td_basic align-self-center d-none d-lg-block";var J=document.createElement("div");J.className="plane_td_basic align-self-center d-none d-lg-block";var M=document.createElement("div");M.className="plane_td_basic align-self-center d-none d-lg-block";C.textContent=sFormat(w.$jscomp$loop$prop$item$301[u[0]],u[0]);F.textContent=sFormat(w.$jscomp$loop$prop$item$301[u[1]],u[1]);G.textContent=sFormat(w.$jscomp$loop$prop$item$301[u[2]],u[2]);J.textContent=sFormat(w.$jscomp$loop$prop$item$301[u[3]],
u[3]);M.textContent=sFormat(w.$jscomp$loop$prop$item$301[u[4]],u[4]);if("multi"===g&&t!==w.$jscomp$loop$prop$item$301.type&&"default"===r){t=document.createElement("div");t.className="type_divider mt-3 mb-1";var K=document.createElement("div");K.className="font_size_12 font_color_half align-self-center";K.textContent=ITEM_API_TYPE.find(function(H){return function(I){return I.id===H.$jscomp$loop$prop$item$301.type}}(w)).name;var L=document.createElement("div");L.className="flex-grow-1 border-bottom align-self-center mx-2";
t.appendChild(K);t.appendChild(L);f.appendChild(t)}y.appendChild(q);D.appendChild(y);k&&0<w.$jscomp$loop$prop$item$301.remodel&&(t=document.createElement("div"),t.className="plane_td_remodel text_remodel align-self-center",t.dataset.remodel=w.$jscomp$loop$prop$item$301.remodel,y="",y="multi"===g?"\u2605"+w.$jscomp$loop$prop$item$301.remodel:10>w.$jscomp$loop$prop$item$301.remodel?"\u2605+"+w.$jscomp$loop$prop$item$301.remodel:"\u2605MAX",t.textContent=y,A.appendChild(t),A.appendChild(B));0<d&&A.appendChild(B);
D.appendChild(A);"single"===g&&(E.appendChild(C),E.appendChild(F),E.appendChild(G),E.appendChild(J),E.appendChild(M),D.appendChild(E));f.appendChild(D);t=w.$jscomp$loop$prop$item$301.type}f.childNodes.length||(a=document.createElement("div"),a.className="text-center",l&&!m&&(a.textContent+="\u88c5\u5099\u6240\u6301\u6570\u304c\u767b\u9332\u3055\u308c\u3066\u3044\u306a\u3044\u304b\u3001\u5168\u3066\u306e\u88c5\u5099\u304c\u914d\u5099\u6e08\u307f\u3067\u3059\u3002"),l&&!m&&(a.textContent+="\u88c5\u5099\u6240\u6301\u6570\u304c\u767b\u9332\u3055\u308c\u3066\u3044\u306a\u3044\u304b\u3001\u5168\u3066\u306e\u88c5\u5099\u304c\u914d\u5099\u6e08\u307f\u3067\u3059\u3002"));
...
k=document.getElementById("disp_kamisha_ship").checked,m=document.getElementById("disp_slot_ex_ship").checked,n=document.getElementById("fav_only_ship").checked,r=loadShipStock(),p=0;p=$("#ship_type_select .ship_type.active");p=p.length?castInt(p[0].dataset.type):111;var v=[];switch(p){case 103:v=[3,4];break;case 105:v=[5,6];break;case 108:v=[8,9,10];break;case 111:v=[7,11,18];break;case 114:v=[13,14];break;case 116:v=[1,16,17,19,20,21,22];break;case 11:v=[11,18];break;case 8:v=[8,9];break;case 117:v=
...
v.includes(C.type)&&(d?0<C.final:!0)});if(n){var u=setting.favoriteShip;p=p.filter(function(C){return u.includes(C.id)})}if(g){n={};for(var x=$jscomp.makeIterator(r),t=x.next();!t.done;n={$jscomp$loop$prop$stock$304:n.$jscomp$loop$prop$stock$304,$jscomp$loop$prop$baseLv$305:n.$jscomp$loop$prop$baseLv$305,$jscomp$loop$prop$baseArea$306:n.$jscomp$loop$prop$baseArea$306},t=x.next())if(n.$jscomp$loop$prop$stock$304=t.value,t=m?n.$jscomp$loop$prop$stock$304.details.filter(function(C){return 1===C.ex||
-1===C.ex}):n.$jscomp$loop$prop$stock$304.details,0>=t.length)p=p.filter(function(C){return function(F){return F.id!==C.$jscomp$loop$prop$stock$304.id}}(n));else{t.sort(function(C,F){return C.lv-F.lv});var q=p.findIndex(function(C){return function(F){return F.id===C.$jscomp$loop$prop$stock$304.id}}(n));if(!(0>q)){var w=p[q];n.$jscomp$loop$prop$baseLv$305=t[0].lv;var z=t[0].st[4];n.$jscomp$loop$prop$baseArea$306=t[0].area<=MAX_AREA&&0<t[0].area?t[0].area:-1;w.lv=n.$jscomp$loop$prop$baseLv$305;w.area=
n.$jscomp$loop$prop$baseArea$306;w.upLuck=z;w.stock=t.filter(function(C){return function(F){return F.lv===C.$jscomp$loop$prop$baseLv$305&&F.area===C.$jscomp$loop$prop$baseArea$306}}(n)).length;w.ex=t[0].ex;z=[{lv:n.$jscomp$loop$prop$baseLv$305,area:n.$jscomp$loop$prop$baseArea$306}];if(2<=t.length)for(var D={},y=1;y<t.length;D={$jscomp$loop$prop$lv$310:D.$jscomp$loop$prop$lv$310,$jscomp$loop$prop$area$311:D.$jscomp$loop$prop$area$311},y++){D.$jscomp$loop$prop$lv$310=t[y].lv;var A=t[y].st[4];D.$jscomp$loop$prop$area$311=
t[y].area<=MAX_AREA&&0<t[y].area?t[y].area:-1;if(!z.find(function(C){return function(F){return F.lv===C.$jscomp$loop$prop$lv$310&&F.area===C.$jscomp$loop$prop$area$311}}(D))){var B=Object.assign({},w);B.lv=D.$jscomp$loop$prop$lv$310;B.area=D.$jscomp$loop$prop$area$311;B.stock=t.filter(function(C){return function(F){return F.lv===C.$jscomp$loop$prop$lv$310&&F.area===C.$jscomp$loop$prop$area$311}}(D)).length;B.upLuck=A;B.ex=t[y].ex;p.splice(q,0,B);z.push({lv:D.$jscomp$loop$prop$lv$310,area:D.$jscomp$loop$prop$area$311})}}}}}if(f&&
setting.selectedHistory[1]){var E=setting.selectedHistory[1];p.sort(function(C,F){return E.filter(function(G){return G===F.id}).length-E.filter(function(G){return G===C.id}).length})}p.sort(function(C,F){return 7===C.type&&7!==F.type||7===F.type&&7!==C.type?F.type-C.type:6===C.type&&6!==F.type||6===F.type&&6!==C.type?F.type-C.type:10===C.type&&10!==F.type||10===F.type&&10!==C.type?F.type-C.type:C.type-F.type});m=document.createDocumentFragment();x=q=0;n={};p=$jscomp.makeIterator(p);for(t=p.next();!t.done;n=
{$jscomp$loop$prop$ship$315:n.$jscomp$loop$prop$ship$315},t=p.next())if(n.$jscomp$loop$prop$ship$315=t.value,!l||OK_DAIHATSU_TYPE.includes(n.$jscomp$loop$prop$ship$315.type)||OK_DAIHATSU_SHIP.includes(n.$jscomp$loop$prop$ship$315.api))if(!k||OK_NAIKATEI_TYPE.includes(n.$jscomp$loop$prop$ship$315.type)||OK_NAIKATEI_SHIP.includes(n.$jscomp$loop$prop$ship$315.api)){w=1;if(g&&r){if(!n.$jscomp$loop$prop$ship$315.lv)continue;n.$jscomp$loop$prop$ship$315.stock&&(w=n.$jscomp$loop$prop$ship$315.stock);t=usedShip.filter(function(C){return function(F){return F.id===
C.$jscomp$loop$prop$ship$315.id&&F.lv===C.$jscomp$loop$prop$ship$315.lv&&F.area===C.$jscomp$loop$prop$ship$315.area}}(n)).length;w-=t;if(0>=w&&!h)continue}t=document.createElement("div");t.className=g&&h&&!w?"ship_tr ship_tr_disabled d-flex "+("multi"===c?"tr_multi":""):"ship_tr general_tr d-flex "+("multi"===c?"tr_multi":"");t.dataset.shipid=n.$jscomp$loop$prop$ship$315.id;t.dataset.level=n.$jscomp$loop$prop$ship$315.lv?n.$jscomp$loop$prop$ship$315.lv:99;t.dataset.area=0<n.$jscomp$loop$prop$ship$315.area?
n.$jscomp$loop$prop$ship$315.area:0;t.dataset.luck=n.$jscomp$loop$prop$ship$315.luck+n.$jscomp$loop$prop$ship$315.upLuck;t.id="ship_tr_"+n.$jscomp$loop$prop$ship$315.id;z=document.createElement("div");z.className="ml-1 align-self-center pt-1";D=document.createElement("img");D.width=120;D.height=30;D.src="../img/ship/"+n.$jscomp$loop$prop$ship$315.id+".png";z.appendChild(D);g&&0<n.$jscomp$loop$prop$ship$315.area&&(z.classList.add("exist_area"),D=document.createElement("img"),D.className="area_banner",
D.src="../img/util/area"+n.$jscomp$loop$prop$ship$315.area+".png",z.appendChild(D));D=document.createElement("div");D.className="ml-1 align-self-center";y=document.createElement("div");y.className="text-primary font_size_11";y.textContent=g?"Lv : "+n.$jscomp$loop$prop$ship$315.lv:"ID : "+n.$jscomp$loop$prop$ship$315.id;A=document.createElement("div");A.className="d-flex";A.textContent=n.$jscomp$loop$prop$ship$315.name;B=document.createElement("div");B.className="ml-1 ship_td_stock align-self-center "+
(g?"":"d-none");B.textContent="\u00d7"+w;A.appendChild(B);D.appendChild(y);D.appendChild(A);t.appendChild(z);t.appendChild(D);if("multi"!==c)for(w=0;5>w;w++)z=document.createElement("div"),z.className="ship_td_slot font_size_12 align-self-center "+(0===w?"ml-auto":""),z.textContent=w<n.$jscomp$loop$prop$ship$315.slot.length?n.$jscomp$loop$prop$ship$315.slot[w]:"",t.appendChild(z);q!==n.$jscomp$loop$prop$ship$315.type&&(q=document.createElement("div"),q.className="type_divider mt-4",w=document.createElement("div"),
w.className="align-self-center font_size_16",w.textContent=API_SHIP_TYPE.find(function(C){return function(F){return F.id===C.$jscomp$loop$prop$ship$315.type}}(n)).name,z=document.createElement("div"),z.className="flex-grow-1 border-bottom align-self-center mx-2",q.appendChild(w),q.appendChild(z),m.appendChild(q));f||x===n.$jscomp$loop$prop$ship$315.type2||(x=document.createElement("div"),x.className="type_divider mt-2 ml-1",q=document.createElement("div"),q.className="font_size_12 font_color_half align-self-center",
w=API_CTYPE.find(function(C){return function(F){return F.id===C.$jscomp$loop$prop$ship$315.type2}}(n))||{name:""},q.textContent=w.name,x.appendChild(q),m.appendChild(x));q=n.$jscomp$loop$prop$ship$315.type;x=n.$jscomp$loop$prop$ship$315.type2;m.appendChild(t)}"multi"===c?(a.classList.add("modal-xl"),b.classList.add("multi_mode"),a=a.getElementsByClassName("scroll_thead")[0],a.classList.add("d-none"),a.classList.remove("d-flex")):(a.classList.remove("modal-xl"),b.classList.remove("multi_mode"),a=a.getElementsByClassName("scroll_thead")[0],
...
function initializeEnemyTable(){for(var a=document.createDocumentFragment(),b=[],c=0,d={},e=$jscomp.makeIterator(ENEMY_TYPE),f=e.next();!f.done;d={$jscomp$loop$prop$typeObject$317:d.$jscomp$loop$prop$typeObject$317},f=e.next())d.$jscomp$loop$prop$typeObject$317=f.value,1!==d.$jscomp$loop$prop$typeObject$317.id&&(f=ENEMY_DATA.filter(function(k){return function(m){return m.type[0]===k.$jscomp$loop$prop$typeObject$317.id}}(d)),b=b.concat(f.sort(function(k,m){return k.orig>m.orig?1:k.orig<m.orig?-1:k.id-
m.id})));d=ENEMY_DATA.filter(function(k){return 1===k.type[0]});b=b.concat(d.sort(function(k,m){return k.id>m.id?1:-1}));d={};b=$jscomp.makeIterator(b);for(e=b.next();!e.done;d={$jscomp$loop$prop$enemy$319:d.$jscomp$loop$prop$enemy$319},e=b.next()){d.$jscomp$loop$prop$enemy$319=new Enemy(e.value.id);e=document.createElement("div");e.className="enemy enemy_tr general_tr d-flex";e.dataset.enemyid=d.$jscomp$loop$prop$enemy$319.id;e.id="enemy_tr_"+d.$jscomp$loop$prop$enemy$319.id;f=document.createElement("div");
...
function createEnemyPattern(a){a=void 0===a?0:a;var b=castInt($("#map_select").val()),c=$(".node_selected").data("node"),d=0;100>b?$("#select_difficulty_div").addClass("d-none"):($("#select_difficulty_div").removeClass("d-none"),d=castInt($("#select_difficulty").val()));for(var e="",f=0,g=0,h=ENEMY_PATTERN.filter(function(v){return v.a===b&&v.n===c&&v.l===d}),l=h[a],k=l.e,m=k.length,n={$jscomp$loop$prop$index$327:0};n.$jscomp$loop$prop$index$327<m;n={$jscomp$loop$prop$index$327:n.$jscomp$loop$prop$index$327},
n.$jscomp$loop$prop$index$327++){var r=ENEMY_DATA.find(function(v){return function(u){return u.id===k[v.$jscomp$loop$prop$index$327]}}(n));if(r){var p=new Enemy(r.id);f+=p.airPower;g+=p.antiAirBonus;e+='\n\t\t<div class="enemy_pattern_tr mx-1 d-flex border-bottom" data-enemyid="'+r.id+'">\n\t\t\t<div class="enemy_pattern_tr_image mr-1">\n\t\t\t\t<img src="../img/enemy/'+r.id+'.png" class="enemy_img">\n\t\t\t</div>\n\t\t\t<div class="enemy_pattern_tr_text">\n\t\t\t\t<div class="font_size_11 text-primary">ID: '+
...
function expandMainPreset(a,b,c,d){b=void 0===b?!0:b;c=void 0===c?!0:c;d=void 0===d?!0:d;if(a)try{var e=a[0],f=!1;$(".lb_plane").each(function(y,A){if(e&&0!==e.length){var B=e[0].find(function(E){return E[4]===y});B&&0!==B.length?(B={id:B[0],prof:B[1],remodel:B[2],slot:B[3]},setLBPlaneDiv($(A),B),f=!0):b&&setLBPlaneDiv($(A))}});$(".ohuda_select").each(function(y,A){$(A).find("option").prop("disabled",!1);f&&e&&2<=e.length?(y=castInt(e[1][y],-1),$(A).val(1===y?2:y)):b&&$(A).val(-1)});if(e&&3<=e.length)for(var g=
0;2>=g;g++)document.getElementById("lb"+(g+1)+"_target_1").value=e[2][2*g],document.getElementById("lb"+(g+1)+"_target_2").value=e[2][2*g+1];5<=a.length?toggleDefenseMode(a[4]):toggleDefenseMode(!1);if(c){var h=6;a[1].length&&a[1][0]&&6<=a[1][0].length&&(h=2===a[1][0][5]?7:6,document.getElementById("union_fleet").checked=1===a[1][0][5],document.getElementById("yugeki_fleet").checked=2===a[1][0][5]);clearShipDivAll(h);var l=0,k=0;$(".ship_tab:not(.d-none)").each(function(y,A){var B=a[1].find(function(C){return C[2]===
y});if(B){A=$(A);setShipDiv(A,B[0],99,8<=B.length&&B[7]?B[7]:0);A.find(".ship_plane").each(function(C,F){F=$(F);var G=B[1].find(function(J){return J[4]===C});!G&&F.hasClass("expanded_slot")&&(G=B[1].find(function(J){return-1===J[4]}));G&&!F.hasClass("d-none")&&(setPlaneDiv(F,{id:G[0],prof:G[1],remodel:G[2],slot:G[3]},!0),6<=G.length&&G[5]&&plane_unlock_Clicked(F.find(".plane_unlock")))});if(4<=B.length){var E=A.find(".ship_disabled");B[3]?(E.addClass("disabled"),E.children().addClass("fa-eye-slash").removeClass("fa-eye no_capture"),
A.addClass("opacity4")):(E.removeClass("disabled"),E.children().removeClass("fa-eye-slash").addClass("fa-eye no_capture"),A.removeClass("opacity4"))}5<=B.length&&(B[4]?A.find(".ship_level").text(B[4]):A.find(".ship_level").text(99));7<=B.length&&0<B[6]&&A.find(".ship_luck").text(B[6]);y<h?l+=1:k+=1}});display_ship_count_Changed($("#friendFleet_item1"),Math.max(l,1),!0);display_ship_count_Changed($("#friendFleet_item2"),Math.max(k,1),!0)}document.getElementById("fleet_formation").value=1;if(4<=a.length&&
a[3]){document.getElementById("adapt_stage2").checked=!0;try{c=1;selectedFormations=[];for(var m=$jscomp.makeIterator(a[3]),n=m.next();!n.done;n=m.next()){var r=castInt(n.value);if(0>=r){document.getElementById("adapt_stage2").checked=!1;selectedFormations=[];c=1;break}else selectedFormations.push(r),c=r}document.getElementById("fleet_formation").value=c}catch(y){var p=castInt(a[3]);if(p){selectedFormations=[];for(m=0;10>m;m++)selectedFormations.push(p);document.getElementById("adapt_stage2").checked=
!0;document.getElementById("fleet_formation").value=p}}}else document.getElementById("adapt_stage2").checked=!1,selectedFormations=[];p=1;for(m=0;m<a[2].length;m++)p<a[2][m][0]+1&&(p=a[2][m][0]+1);p=Math.min(p,10);if(0!==a[2].length||d)clearEnemyDivAll(p),$("#battle_count").val(p);var v=isDefMode&&6>a.length;$(v?"#air_raid_enemies":".battle_content").each(function(y,A){var B=a[2].find(function(G){return G[0]===y});if(B){3<=B.length?$(A)[0].dataset.celldata=B[2]:$(A)[0].dataset.celldata="";if(4<=B.length){var E=
castInt(B[3]);v?$(A).find(".cell_type").val([0,5].includes(E)?5:3):$(A).find(".cell_type").val(E);cell_type_Changed($(A).find(".cell_type"),!1)}else $(A).find(".cell_type").val(1);5<=B.length?$(A).find(".formation").val(B[4]):$(A).find(".formation").val(1);6<=B.length?$(A).find(".enemy_range").text(B[5]):$(A).find(".enemy_range").text(0);E=0;B=$jscomp.makeIterator(B[1]);for(var C=B.next();!C.done;C=B.next()){C=C.value;var F=$(A).find(".enemy_content").eq(E++);0<C?setEnemyDiv(F,C):0>C?setEnemyDiv(F,
-1,-C):clearEnemyDiv(F);F.addClass("d-flex").removeClass("d-none")}}});if(6<=a.length){var u=a[5];if(u&&3===u.length){var x=$("#air_raid_enemies"),t=castInt(u[1]);x.find(".cell_type").val([0,5].includes(t)?5:3);cell_type_Changed(x.find(".cell_type"),!1);x.find(".formation").val(u[2]);d=0;for(var q=$jscomp.makeIterator(u[0]),w=q.next();!w.done;w=q.next()){var z=w.value,D=x.find(".enemy_content").eq(d++);0<z?setEnemyDiv(D,z):0>z?setEnemyDiv(D,-1,-z):clearEnemyDiv(D);D.addClass("d-flex").removeClass("d-none")}}}7<=
a.length?$("#admin_lv").val(a[6]):$("#admin_lv").val(120)}catch(y){$(".ohuda_select").val(-1),$(".lb_plane").each(function(A,B){setLBPlaneDiv($(B))}),clearShipDivAll(6),clearEnemyDivAll(1),$("#battle_count").val(1),sendErrorLog(y)}}
...
d.push(resultData.enemyAirPowers[6])):(c=resultData.landBaseAirPowers,c.push(resultData.fleetAirPower),d=resultData.enemyAirPowers,e=resultData.landBaseAirStatus);e.push(resultData.fleetAirStatus);for(var f={},g=0;g<=b;f={$jscomp$loop$prop$abbr$329:f.$jscomp$loop$prop$abbr$329,$jscomp$loop$prop$ap$330:f.$jscomp$loop$prop$ap$330,$jscomp$loop$prop$status$332:f.$jscomp$loop$prop$status$332},g++){var h=isDefMode?8:g+1,l=$("#result_bar_"+h),k=$("#rate_row_"+h);f.$jscomp$loop$prop$ap$330=c[g];var m=d[g],
n=e[g],r=getAirStatusBorder(m);f.$jscomp$loop$prop$status$332=isDefMode?getAirStatusIndex(f.$jscomp$loop$prop$ap$330,m):n.indexOf(getArrayMax(n));var p=0,v=!1;4===f.$jscomp$loop$prop$status$332?p=f.$jscomp$loop$prop$ap$330/r[3]*10:3===f.$jscomp$loop$prop$status$332?p=f.$jscomp$loop$prop$ap$330/r[2]*20:2===f.$jscomp$loop$prop$status$332?p=f.$jscomp$loop$prop$ap$330/r[1]*45:1>=f.$jscomp$loop$prop$status$332&&(p=f.$jscomp$loop$prop$ap$330/r[0]*90);if(5===f.$jscomp$loop$prop$status$332&&7!==h)f.$jscomp$loop$prop$status$332=
0,p=100;else if(5===f.$jscomp$loop$prop$status$332){f.$jscomp$loop$prop$abbr$329=$("#shoot_down_table").find(".cond.battle"+(displayBattle+1)).text();var u=AIR_STATUS.find(function(t){return function(q){return q.abbr===t.$jscomp$loop$prop$abbr$329}}(f));u&&(f.$jscomp$loop$prop$status$332=u.id);0===f.$jscomp$loop$prop$status$332&&(p=100)}p=Math.min(100,p);var x=l.data("airstatus");u="bar_status"+f.$jscomp$loop$prop$status$332;l.removeClass("bar_status"+x).addClass(u).css({width:p+"%"}).data("airstatus",
f.$jscomp$loop$prop$status$332);k.find(".rate_td_ap").text(f.$jscomp$loop$prop$ap$330);x=k.find(".rate_td_eap");x.find(".avg_eap").text(m);x.find(".eap_border").html("( "+r.slice(0,4).map(function(t){return function(q){return q<=t.$jscomp$loop$prop$ap$330?"<b>"+q+"</b>":q.toString()}}(f)).join(" / ")+" )");x=100;for(m=0;m<n.length;m++)k.find(".rate_td_status"+m).text("-"),isDefMode?k.find(".rate_td_status"+f.$jscomp$loop$prop$status$332).text("100 %"):0<n[m]&&(v=Math.floor(1E3*n[m])/10,r=0,m+1<n.length&&
0<n[m+1]?(r=v,x-=v):r=x.toFixed(1),k.find(".rate_td_status"+m).text(r+" %"),v=!0);if(v||isDefMode&&8===h)k.removeClass("d-none disabled_tr"),l.closest(".progress_area").addClass("d-flex").removeClass("d-none disabled_bar");l="bar_ex_status"+f.$jscomp$loop$prop$status$332;isDefMode&&(k=$("#simple_lb_def_bar"),m=k.find(".result_bar"),x=m.data("airstatus"),m.removeClass("bar_status"+x+" bar_ex_status"+x).addClass(u+" "+l).css({width:p+"%"}).data("airstatus",f.$jscomp$loop$prop$status$332),k.find(".simple_label").text(AIR_STATUS.find(function(t){return function(q){return q.id===
t.$jscomp$loop$prop$status$332}}(f)).abbr),k.removeClass("d-none"));7===h&&v&&-1<f.$jscomp$loop$prop$status$332&&(h=$("#fleet_simple_bar"),v=h.find(".result_bar"),x=v.data("airstatus"),v.removeClass("bar_status"+x+" bar_ex_status"+x).addClass(u+" "+l).css({width:p+"%"}).data("airstatus",f.$jscomp$loop$prop$status$332),n=AIR_STATUS.find(function(t){return function(q){return q.id===t.$jscomp$loop$prop$status$332}}(f)).abbr+"("+Math.floor(100*n[f.$jscomp$loop$prop$status$332])+"%)",h.find(".simple_label").text(n),
...
e<=f?[e,f]:[f,e],e=e<=f?[0,1]:[1,0],f={},g=0;1>=g;f={$jscomp$loop$prop$status$189$334:f.$jscomp$loop$prop$status$189$334},g++)n=c.results[d[g]].airStatusIndex[e[g]],u=c.results[d[g]].mainAirPower[e[g]]/a,h=c.results[d[g]].enemyAirPower[e[g]]/a,f.$jscomp$loop$prop$status$189$334=n.indexOf(getArrayMax(n)),p=0,h=getAirStatusBorder(h),4===f.$jscomp$loop$prop$status$189$334?p=u/h[3]*10:3===f.$jscomp$loop$prop$status$189$334?p=u/h[2]*20:2===f.$jscomp$loop$prop$status$189$334?p=u/h[1]*45:1>=f.$jscomp$loop$prop$status$189$334&&
(p=u/h[0]*90),5===f.$jscomp$loop$prop$status$189$334&&(f.$jscomp$loop$prop$status$189$334=0,p=100),h="bar_status"+f.$jscomp$loop$prop$status$189$334,v="bar_ex_status"+f.$jscomp$loop$prop$status$189$334,u=$("#simple_lb_bar_"+c.baseNo+"_"+(g+1)),l=u.find(".result_bar"),k=l.data("airstatus"),l.removeClass("bar_status"+k+" bar_ex_status"+k).addClass(h+" "+v).css({width:(100<p?100:p)+"%"}).data("airstatus",f.$jscomp$loop$prop$status$189$334),p=AIR_STATUS.find(function(t){return function(q){return q.id===
t.$jscomp$loop$prop$status$189$334}}(f)).abbr,n=Math.floor(getArrayMax(n)/a*100),n=p+"("+n+"%)"+(100===n?"":10<=n?'<span class="opacity0">1</span>':'<span class="opacity0">11</span>'),u.find(".simple_label").html(n),u.removeClass("d-none");display_result_Changed();resultData.enemyAirPowerResults=null;resultData.fleetSlots=null}
function getEnemyApDistribution(a){a.sort(function(r,p){return r-p});for(var b=a.length,c=a[0],d=a[a.length-1],e=0,f=0,g=0,h=0,l=0,k=0,m={$jscomp$loop$prop$i$336:c};m.$jscomp$loop$prop$i$336<=d;m={$jscomp$loop$prop$i$336:m.$jscomp$loop$prop$i$336},m.$jscomp$loop$prop$i$336++){var n=a.findIndex(function(r){return function(p){return p>r.$jscomp$loop$prop$i$336}}(m));0!==n&&(-1===n?n=a.length:a=a.slice(n),k+=100*n/b,!e&&50<=k&&(e=m.$jscomp$loop$prop$i$336),!f&&75<=k&&(f=m.$jscomp$loop$prop$i$336),!g&&
90<=k&&(g=m.$jscomp$loop$prop$i$336),!h&&95<=k&&(h=m.$jscomp$loop$prop$i$336),!l&&99<=k&&(l=m.$jscomp$loop$prop$i$336))}return[c,e?e:d,f?f:d,g?g:d,h?h:d,l?l:d,d]}function getAirStatusIndex(a,b){if(1E3>=a)return b<AIR_STATUS_TABLE[a].length-1?AIR_STATUS_TABLE[a][b]:4;b=getAirStatusBorder(b);for(var c=b.length,d=0;d<c;d++)if(a>=b[d])return 0!==a?d:4}function getAirStatusBorder(a){return 0===a?[0,0,0,0,0]:[3*a,Math.ceil(1.5*a),Math.floor(a/1.5)+1,Math.floor(a/3)+1,0]}
...
p=n.getElementsByClassName("ap_detail")[0],v=n.getElementsByClassName("ship_range")[0],u=n.getElementsByClassName("can_attack_lb")[0],x=n.getElementsByClassName("rate_down")[0],t=n.getElementsByClassName("fix_down")[0],q=n.getElementsByClassName("hunshin")[0],w=n.getElementsByClassName("hunshin_rate")[0],z=n.getElementsByClassName("has_warning")[0];n=0;for(var D=$jscomp.makeIterator(k.$jscomp$loop$prop$ship$339.items),y=D.next();!y.done;y=D.next())y=y.value,y.isPlane&&0<y.slot&&(n+=1);drawChangeValue(r,
castInt(r.textContent),k.$jscomp$loop$prop$ship$339.airPower);if(k.$jscomp$loop$prop$ship$339.items.length&&k.$jscomp$loop$prop$ship$339.airPower){r=[];D=$jscomp.makeIterator(k.$jscomp$loop$prop$ship$339.items);for(y=D.next();!y.done;y=D.next())y=y.value,y.isExpanded||r.push(y.airPower);p.classList.remove("d-none");p.textContent="( "+r.join(" / ")+" )"}else p.classList.add("d-none"),p.textContent="";x.textContent=Math.floor(1E3*k.$jscomp$loop$prop$ship$339.rateDown)/10;t.textContent=k.$jscomp$loop$prop$ship$339.fixDown;
0<k.$jscomp$loop$prop$ship$339.hunshinRate?(w.textContent=(100*k.$jscomp$loop$prop$ship$339.hunshinRate).toFixed(1),q.classList.remove("d-none")):q.classList.add("d-none");k.$jscomp$loop$prop$ship$339.warningText?(z.classList.remove("d-none"),z.dataset.originalTitle=k.$jscomp$loop$prop$ship$339.warningText):z.classList.add("d-none");k.$jscomp$loop$prop$rawShip$340=k.$jscomp$loop$prop$ship$339.id?SHIP_DATA.find(function(A){return function(B){return B.id===A.$jscomp$loop$prop$ship$339.id}}(k)):null;
p=RANGES.find(function(A){return function(B){return B.id===Math.max(A.$jscomp$loop$prop$ship$339.range,A.$jscomp$loop$prop$rawShip$340?A.$jscomp$loop$prop$rawShip$340.range:0)}}(k));v.textContent=p?p.name:"\u77ed";u&&(k.$jscomp$loop$prop$rawShip$340&&[7,11,18].includes(k.$jscomp$loop$prop$rawShip$340.type)&&!k.$jscomp$loop$prop$ship$339.items.some(function(A){return TAICHI.includes(A.id)&&0<A.slot})&&k.$jscomp$loop$prop$ship$339.items.some(function(A){return[7,57].includes(A.type)&&0<A.slot})?u.classList.remove("d-none"):
u.classList.add("d-none"));if(0<n){v=document.createDocumentFragment();q=!0;u=document.getElementById("empty_slot_invisible").checked;k.$jscomp$loop$prop$rawShip$340&&!u&&(n=k.$jscomp$loop$prop$rawShip$340.slot.length);p=document.createElement("tr");for(x=0;x<k.$jscomp$loop$prop$ship$339.items.length;x++)if(w=k.$jscomp$loop$prop$ship$339.items[x],t=w.name,k.$jscomp$loop$prop$rawShip$340||w.isPlane&&0!==w.slot){if(k.$jscomp$loop$prop$rawShip$340&&x===k.$jscomp$loop$prop$rawShip$340.slot.length)break;
if(!k.$jscomp$loop$prop$rawShip$340||!u||w.isPlane&&0!==w.slot){w=getItemCss(w.itype).replace("css","shoot_table");if(q){q=document.createElement("tr");q.id="s"+k.$jscomp$loop$prop$ship$339.shipNo+"sl"+x;q.dataset.shipid=k.$jscomp$loop$prop$rawShip$340?k.$jscomp$loop$prop$rawShip$340.id:0;q.dataset.si=d;q.dataset.slot=x;q.dataset.css=w+"_hover";z=document.createElement("td");z.rowSpan=n;z.className="td_name align-middle";z.textContent=k.$jscomp$loop$prop$rawShip$340?k.$jscomp$loop$prop$rawShip$340.name:
"\u672a\u6307\u5b9a";q.appendChild(z);z=document.createElement("td");z.className="pl-1 td_plane_name align-middle "+w;z.textContent=t;q.appendChild(z);p.appendChild(z.cloneNode(!1));for(t=1;10>=t;t++)w=document.createElement("td"),w.className="td_battle battle"+t+" align-middle",q.appendChild(w),p.appendChild(w.cloneNode(!1));t=document.createElement("td");t.className="td_battle battle_end align-middle";q.appendChild(t);p.appendChild(t.cloneNode(!1));t=document.createElement("td");t.className="td_battle battle_death align-middle";
q.appendChild(t);p.appendChild(t.cloneNode(!1));v.appendChild(q)}else q=p.cloneNode(!0),q.id="s"+k.$jscomp$loop$prop$ship$339.shipNo+"sl"+x,q.dataset.shipid=k.$jscomp$loop$prop$rawShip$340?k.$jscomp$loop$prop$rawShip$340.id:0,q.dataset.si=d,q.dataset.slot=x,q.dataset.css=w+"_hover",z=q.getElementsByClassName("td_plane_name")[0],z.className="pl-1 td_plane_name align-middle "+w,z.textContent=t,v.appendChild(q);q=!1}}c.appendChild(v)}}d=[];k=$jscomp.makeIterator(a.ships);for(n=k.next();!n.done;n=k.next())d=
d.concat(n.value.items);for(k=1;4>=k;k++)m=document.getElementsByClassName("fleet_scout"+k)[0],n=document.getElementsByClassName("fleet_scout"+k)[1],m.textContent=a.scoutScores[k-1],n.textContent=a.scoutScores[k-1];d=createContactTable(d)[0][4];k=Math.floor(1E3*a.nightContactRate())/10;a.isUnion?(b.textContent=""+a.airPower,f.textContent=d.toFixed(2)+"%",h.textContent=k+"%",e.textContent=""+a.escortAirPower,g.textContent=d.toFixed(2)+"%",l.textContent=k+"%"):(b=$(".friendFleet_tab.show.active")[0],
...
function updateEnemyView(){var a=inputItems.battleInfo,b=0,c=0,d=!1,e=!1,f="",g=[],h=[];document.getElementById("enemy_shoot_down_table").getElementsByTagName("tbody")[0].innerHTML="";for(var l=isDefMode?0:displayBattle,k={},m=0;m<a.battles.length;k={$jscomp$loop$prop$battle$346:k.$jscomp$loop$prop$battle$346},m++){k.$jscomp$loop$prop$battle$346=a.battles[m];for(var n=b=0,r={},p=$jscomp.makeIterator(k.$jscomp$loop$prop$battle$346.enemies),v=p.next();!v.done;r={$jscomp$loop$prop$enemy$342:r.$jscomp$loop$prop$enemy$342},
v=p.next())if(r.$jscomp$loop$prop$enemy$342=v.value,b+=r.$jscomp$loop$prop$enemy$342.antiAirBonus,!d&&k.$jscomp$loop$prop$battle$346.hasAntiAirCI&&(d=!0),!e&&k.$jscomp$loop$prop$battle$346.containUnknown&&(e=!0),m===l&&!r.$jscomp$loop$prop$enemy$342.onlyScout&&r.$jscomp$loop$prop$enemy$342.slots.length){for(var u=v="",x=!0,t=-1,q={$jscomp$loop$prop$j$344:0};q.$jscomp$loop$prop$j$344<r.$jscomp$loop$prop$enemy$342.equipments.length;q={$jscomp$loop$prop$j$344:q.$jscomp$loop$prop$j$344},q.$jscomp$loop$prop$j$344++){var w=
ENEMY_ITEM.find(function(C,F){return function(G){return G.id===C.$jscomp$loop$prop$enemy$342.equipments[F.$jscomp$loop$prop$j$344].id}}(r,q));if(w&&PLANE_TYPE.includes(w.type)){t+=1;var z=r.$jscomp$loop$prop$enemy$342.slots[t],D=getItemCss(w.itype).replace("css","shoot_table"),y=t===r.$jscomp$loop$prop$enemy$342.slots.length-1?" last_slot":"",A="",B="",E="";v+='<img src="../img/plane/'+w.id+'.png" class="img-size-36" data-planeid="'+w.id+'">';x&&(A='\n\t\t\t\t\t<td class="td_name align-middle last_slot" rowspan="'+
r.$jscomp$loop$prop$enemy$342.slots.length+'">\n\t\t\t\t\t\t<div>'+drawEnemyGradeColor(r.$jscomp$loop$prop$enemy$342.name)+'</div>\n\t\t\t\t\t\t<div class="d-none d-md-block">xxPxx</div>\n\t\t\t\t\t</td>',E='<td class="td_all_dead align-middle last_slot" rowspan="'+r.$jscomp$loop$prop$enemy$342.slots.length+'"></td>',B='<td class="td_detail_slot align-middle last_slot" rowspan="'+r.$jscomp$loop$prop$enemy$342.slots.length+'"><i class="fas fa-file-text"></i></td>',x=!1);u+='\n\t\t\t\t<tr class="enemy_no_'+
n+" slot_"+t+'" data-rowindex="'+n+'" data-slot="'+t+'" data-css="'+D+'_hover">\n\t\t\t\t\t'+A+'\n\t\t\t\t\t<td class="pl-1 td_plane_name align-middle '+(D+y)+'">'+w.name+'</td>\n\t\t\t\t\t<td class="td_init_slot align-middle'+y+'">'+z+'</td>\n\t\t\t\t\t<td class="td_avg_slot align-middle'+y+'">'+z+'</td>\n\t\t\t\t\t<td class="td_max_slot align-middle'+y+'">'+z+'</td>\n\t\t\t\t\t<td class="td_min_slot align-middle'+y+'">'+z+"</td>\n\t\t\t\t\t"+(isDefMode?"":E)+"\n\t\t\t\t\t"+(isDefMode?"":B)+"\n\t\t\t\t</tr>"}}h.push(u.replace("xxPxx",
v));n+=1}n=document.getElementsByClassName("battle_content")[c++];n.getElementsByClassName("enemy_sum_ap")[0].textContent=k.$jscomp$loop$prop$battle$346.getAirPower();n.getElementsByClassName("enemy_sum_lbap")[0].textContent=k.$jscomp$loop$prop$battle$346.getLandBaseAirPower();r=n.getElementsByClassName("enemy_range")[0];castInt(r.textContent)?r.parentNode.classList.remove("d-none"):r.parentNode.classList.add("d-none");r=(r=FORMATION.find(function(C){return function(F){return F.id===C.$jscomp$loop$prop$battle$346.formation}}(k)))?
r.correction:1;n.getElementsByClassName("fleet_AA")[0].textContent=2*Math.floor(r*b);b=(b=n.dataset.celldata)?b.split("_"):["",""];b.length&&(f?f!==b[0]&&(f="\u6d77\u57df\u6df7\u5728"):f=b[0],1<b.length&&g.push(b[1]))}""!==f||"\u6d77\u57df\u6df7\u5728"!==f?(a=40<f.slice(0,-1)?"E-":f.slice(0,-1)+"-",document.getElementById("route").textContent=a+f.slice(-1)+" : "+g.join(" \u2192 ")):document.getElementById("route").textContent=f;!isDefMode&&needAirRaidAlert&&AIR_RAID_MAP.includes(castInt(f))?document.getElementById("air_raid_alert").classList.remove("d-none"):
...
function shootDownEnemy(a,b,c,d){c=void 0===c?!1:c;d=void 0===d?[]:d;var e=0,f=0;f=null;var g=0;c&&(e=Math.random(),f=d.findIndex(function(v){return v.border>e}),f=0<=f?d[f].table:[],g=f.length);d=b.length;for(var h=0;h<d;h++){var l=b[h],k=l.slots.length;l.airPower=0;for(var m=l.landBaseAirPower=0,n=0;n<k;n++){var r=l.slots[n];l.slots[n]-=getShootDownSlot(a,r);if(l.attackers[n]&&c&&0<g){r=l.slots[n];var p=f[Math.floor(Math.random()*g)];.5<=Math.random()&&(r-=Math.floor(p.rateDown*r));.5<=Math.random()&&
(r-=p.fixDown);r-=p.minimumDown;l.slots[n]=0<r?r:0}m+=Math.floor(l.antiAirs[n]*Math.sqrt(l.slots[n]))}l.landBaseAirPower=m;l.onlyScout||(l.airPower=m)}}function getShootDownSlot(a,b){return SHOOT_DOWN_TABLE_ENEMY[b][a][Math.floor(Math.random()*[121,81,49,25,4,1][a])]}function getShootDownSlotFF(a,b){a=[1,3,5,7,10][a];return b*(Math.floor(Math.random()*(a/3*1E3+1))/1E3+a/4)/10}
...
function doJetPhase(a,b){var c=b.stage2[0][0].length;if(!a.hasJet||!b.enabledStage2||b.isAllSubmarine||!c)return 0;for(var d=0,e=a.ships.length,f=0;f<e;f++){var g=a.ships[f],h=g.items.length;if(!g.ignoreSlot)for(var l=0;l<h;l++){var k=g.items[l];if(k.isJet){d+=Math.round(k.slot*k.cost*.2);k.slot-=Math.floor(.6*getShootDownSlotFF(0,k.slot));var m=b.stage2[k.avoid],n=Math.floor(Math.random()*c);.5<=Math.random()&&(k.slot-=Math.floor(m[0][n]*k.slot));.5<=Math.random()&&(k.slot-=m[1][n]);m=k.airPower;
k.updateAirPower();a.airPower-=m-k.airPower;a.unionAirPower-=m-k.airPower;0>a.airPower&&(a.airPower=0);0>a.unionAirPower&&(a.unionAirPower=0)}}}return d}
function shootDownFleet(a,b,c,d,e){e=void 0===e?!0:e;var f=c.stage2[0][0].length;5===a&&(a=0);for(var g=c.enabledStage2,h=b.ships.length,l=0;l<h;l++){var k=b.ships[l];if(!k.ignoreSlot){for(var m=0,n=!c.isUnion&&k.isEscort||4===c.cellType,r=k.items.length,p=0;p<r;p++){var v=k.items[p];e&&(v.results[d]+=v.slot);if(!(n||!v.canBattle||0>=v.slot)&&f){var u=getShootDownSlotFF(a,v.slot);v.slot-=Math.floor(v.isJet?.6*u:u);if(v.isAttacker&&g){u=Math.floor(Math.random()*f);var x=c.stage2[v.avoid];.5<=Math.random()&&
(v.slot-=Math.floor(x[0][u]*v.slot));.5<=Math.random()&&(v.slot-=x[1][u])}v.canBattle&&0<v.slot?v.airPower=Math.floor(v.antiAir*Math.sqrt(v.slot)+v.bonusAirPower):(0>=v.slot&&(v.slot=0),v.airPower=0)}m+=v.airPower}k.airPower=m}}b.updateAirPower()}
...
function rateCalculate(){var a=inputItems.landBase,b=inputItems.fleet,c=inputItems.battleInfo,d=castInt($("#calculate_count").val());d=0>=d?1:d;$("#calculate_count").val(d);for(var e=b.ships.length,f=c.battles,g=isDefMode?0:displayBattle,h=[0,0,0,0,0,0],l=[],k=[],m=[],n=[],r=[[],[]],p=isDefMode?1:battleCount,v=0,u=CELL_TYPE.aerialCombat,x=[],t=$jscomp.makeIterator(f),q=t.next();!q.done;q=t.next())q=q.value,q.enemies=q.enemies.filter(function(H){return-1===H.id||0<H.slots.length});g=g<c.battles.length?
g:c.battles.length-1;for(c=0;c<p;c++)l.push(0),k.push(0);for(c=0;c<e;c++)if(t=b.ships[c],!t.ignoreSlot)for(q=0;q<t.items.length;q++)t.items[q].isPlane&&m.push(Array(d));for(c=0;c<f[g].enemies.length;c++)if(t=f[g].enemies[c],!(t.onlyScout||0>t.id)){q=0===n.length?0:n[n.length-1][0]+1;for(var w=0;w<t.slots.length;w++)n.push([q,w,0,0,999]);x.push(0)}c=f[0].cellType===CELL_TYPE.highAirRaid?a.defense2AirPower:a.defenseAirPower;resultData.defenseAirPower=c;isDefMode&&(b.fullAirPower=c,b.airPower=c,b.fullUnionAirPower=
c,b.unionAirPower=c);c=0;if(isDefMode||f[0])c=f[0].getAirPower();t=!isDefMode&&document.getElementById("adapt_stage2").checked;q=[];t&&(q=castInt($("#fleet_formation").val()),b.isUnion&&f[g].cellType===CELL_TYPE.airRaid?b.updateStage2All(q,!0):b.updateStage2All(q),q=b.allStage2);for(w=0;w<d;w++){for(var z=0;z<p;z++){var D=f[z],y=D.enemies,A=!1;A=calculateLandBase(a,D,z);v+=doJetPhase(b,D);var B=D.isUnion?b.unionAirPower:b.airPower,E=D.getAirPower(),C=getAirStatusIndex(B,E);z===g&&(h[C]+=1);l[z]+=
B;k[z]+=E;shootDownFleet(C,b,D,z);D.cellType===u&&(shootDownEnemy(C,y,t,q),A=!0,C=getAirStatusIndex(b.airPower,D.getAirPower()),shootDownFleet(C,b,D,z,!1));if(z===g){shootDownEnemy(C,y,t,q);for(C=B=A=D=0;C<y.length;C++){var F=y[C];if(!F.onlyScout&&F.id){for(var G=F.slots,J=F.attackers.concat(),M=0;M<G.length;M++){var K=G[M],L=n[D];D+=1;L[2]+=K;L[3]<K&&(L[3]=K);L[4]>K&&(L[4]=K);0===K&&(J[M]=!1)}0>J.indexOf(!0)&&(x[A]+=1);A+=1;B+=F.airPower}F.slots=F.fullSlots.concat();F.airPower=F.fullAirPower;F.landBaseAirPower=
F.fullLandBaseAirPower}r[0].push(E);r[1].push(B);A=!1}if(A)for(y=$jscomp.makeIterator(y),E=y.next();!E.done;E=y.next())E=E.value,E.slots=E.fullSlots.concat(),E.airPower=E.fullAirPower,E.landBaseAirPower=E.fullLandBaseAirPower}for(z=0;3>z;z++)if(y=a.landBases[z],0!==y.mode){for(E=0;E<y.planes.length;E++)D=y.planes[E],D.slot=D.fullSlot,D.airPower=D.fullAirPower;y.airPower=y.fullAirPower}for(y=z=0;y<e;y++)if(E=b.ships[y],!E.ignoreSlot){D=E.items.length;for(A=0;A<D;A++)B=E.items[A],B.isPlane&&(m[z++][w]=
B.slot,B.slot=B.fullSlot,B.airPower=B.fullAirPower);E.airPower=E.fullAirPower}b.airPower=b.fullAirPower;b.escortAirPower=b.fullEscortAirPower;b.unionAirPower=b.fullUnionAirPower}for(u=f=0;u<e;u++)if(t=b.ships[u],!t.ignoreSlot)for(q=0;q<t.items.length;q++)t.items[q].isPlane&&(w=m[f],z={shipNo:t.shipNo,slot:t.items[q].slotNo,max:getArrayMax(w),min:getArrayMin(w),avg:w.reduce(function(H,I){return H+I})/d,death:w.filter(function(H){return 0===H}).length,deathRate:0},z.deathRate=z.death/w.length,resultData.fleetSlots.push(z),
f+=1);e=$("#shoot_down_table");for(m=0;m<p;m++)for(f=Math.round(l[m]/d),u=Math.round(k[m]/d),t=getAirStatusIndex(f,u),e.find(".fap.battle"+(m+1)).text(f),e.find(".eap.battle"+(m+1)).text(u),e.find(".cond.battle"+(m+1)).html("<span>"+AIR_STATUS[t].abbr+"</span>").removeClass("airStatus0 airStatus1 airStatus2 airStatus3 airStatus4").addClass("airStatus"+t),f=$jscomp.makeIterator(b.ships),u=f.next();!u.done;u=f.next())if(u=u.value,!u.ignoreSlot)for(t=$jscomp.makeIterator(u.items),q=t.next();!q.done;q=
t.next())q=q.value,q.isPlane&&(w=q.results[m],$("#s"+u.shipNo+"sl"+q.slotNo).find(".battle"+(m+1)).text(Math.round(w/d)));e.find("td").removeClass("d-none");for(b=battleCount+1;10>=b;b++)e.find(".battle"+b).addClass("d-none");isDefMode||(resultData.fleetAirPower=Math.round(l[g]/d));l=[];b=$jscomp.makeIterator(a.landBases);for(p=b.next();!p.done;p=b.next())for(p=p.value,e=0;2>e;e++)l.push(p.results[displayBattle].airStatusIndex[e].map(function(H){return H/d}));a=$jscomp.makeIterator(a.landBases);for(p=
...
var n=[];m&&(n=castInt($("#fleet_formation").val()),e.isUnion&&f.battles[k].cellType===CELL_TYPE.airRaid?e.updateStage2All(n,!0):e.updateStage2All(n),n=e.allStage2);for(var r=l.items[b],p=$jscomp.makeIterator(f.battles),v=p.next();!v.done;v=p.next())v=v.value,v.enemies=v.enemies.filter(function(z){return 0<z.slots.length});for(p=0;p<g;p++){for(v=0;v<=k;v++){var u=f.battles[v],x=u.enemies;calculateLandBase(d,u,v);doJetPhase(e,u);var t=u.cellType,q=u.isUnion?e.unionAirPower:e.airPower,w=u.getAirPower();
q=getAirStatusIndex(q,w);shootDownFleet(q,e,u,v);t===CELL_TYPE.aerialCombat&&(shootDownEnemy(q,x,m,n),q=getAirStatusIndex(e.airPower,u.getAirPower()),shootDownFleet(q,e,u,v,!1));u=$jscomp.makeIterator(x);for(x=u.next();!x.done;x=u.next())x=x.value,x.slots=x.fullSlots.concat(),x.airPower=x.fullAirPower,x.landBaseAirPower=x.fullLandBaseAirPower}for(v=0;3>v;v++){u=d.landBases[v];for(x=0;x<u.planes.length;x++)t=u.planes[x],t.slot=t.fullSlot,t.updateAirPower();u.updateAirPower()}for(v=0;v<e.ships.length;v++)for(u=
e.ships[v],x=u.items.length,t=u.airPower=0;t<x;t++)q=u.items[t],v===a&&q.slotNo===b&&h.push(q.slot),q.slot=q.fullSlot,q.updateAirPower(),u.airPower+=q.airPower;e.updateAirPower()}chartSlotDistribution=updateDetailChart(h,"\u6b8b\u6a5f\u6570 [\u6a5f]",{mode:"index",callbacks:{title:function(z,D){z=castInt(z[0].xLabel);return"\u6b8b\u6a5f\u6570\uff1a"+z+" \u6a5f\n\u822a\u7a7a\u6226\u706b\u529b\uff1a"+ShipItem.getFirePower(r,z).join(" or ")},label:function(z,D){return[z.yLabel+" %"]}}});e=SHIP_DATA.find(function(z){return z.id===
...
function landBaseDetailCalculate(a,b,c){c=void 0===c?!1:c;setPreCalculateTable();var d=createLandBaseInstance(),e=updateEnemyFleetInfo(!1),f=castInt($("#detail_calculate_count").val()),g=[],h=isDefMode?0:displayBattle,l=d.landBases[a].planes,k=0;c&&0===b&&!ATTACKERS.includes(l[b].type)&&l.some(function(E){return ATTACKERS.includes(E.type)})&&(b=l.findIndex(function(E){return ATTACKERS.includes(E.type)}));for(var m=0;m<l.length;m++){var n=l[m];0===l[b].id&&0!==n.id&&(b=m);k+=n.fullSlot}m=[];for(n=
0;n<f;n++){for(var r=0;r<=h;r++){for(var p=e.battles[r],v=p.enemies,u=0;3>u;u++){var x=d.landBases[u],t=x.target[0],q=x.target[1];if(t===r||q===r){if(t===r){doLandBaseJetPhase(x,p);var w=x.airPower,z=p.getLandBaseAirPower();w=0===w&&0===z?0:getAirStatusIndex(w,z);shootDownEnemy(w,v);t!==q&&shootDownLandBase(w,x,p)}q===r&&(t!==q&&doLandBaseJetPhase(x,p),t=x.airPower,q=p.getLandBaseAirPower(),t=0===t&&0===q?0:getAirStatusIndex(t,q),shootDownEnemy(t,v),shootDownLandBase(t,x,p))}}p=$jscomp.makeIterator(v);
for(v=p.next();!v.done;v=p.next())v=v.value,v.slots=v.fullSlots.concat(),v.airPower=v.fullAirPower,v.landBaseAirPower=v.fullLandBaseAirPower}for(r=0;3>r;r++){p=d.landBases[r];for(u=v=0;u<p.planes.length;u++)x=p.planes[u],a+1===p.baseNo&&b===u&&g.push(x.slot),v+=x.slot,x.slot=x.fullSlot,x.updateAirPower();a+1===p.baseNo&&m.push(v);p.updateAirPower()}}var D=l[b].id,y=l[b].remodel,A=l.find(function(E){return 312===E.id})?1.15:l.find(function(E){return 311===E.id})?1.125:1,B=e.battles[h].isUnion?1.1:
1;chartSlotDistribution=updateDetailChart(g,"\u6b8b\u6a5f\u6570 [\u6a5f]",{mode:"index",callbacks:{title:function(E,C){E=E[0].xLabel;C="\u822a\u7a7a\u6226\u706b\u529b\uff1a"+(LandBaseItem.getFirePower(D,E,y)*A*B).toFixed(1);return E?"\u6b8b\u6a5f\u6570\uff1a"+E+" \u6a5f\n"+C:"\u6b8b\u6a5f\u6570\uff1a0 \u6a5f\n\u822a\u7a7a\u6226\u706b\u529b\uff1a0"},label:function(E,C){return[E.yLabel+" %"]}}});n=h=g=0;m=$jscomp.makeIterator(m);for(r=m.next();!r.done;r=m.next())r=r.value,p=r/k,0===r?n+=1:.25>p?h+=
...
m={};g=$jscomp.makeIterator(d.landBases[a].planes);for(h=g.next();!h.done;m={$jscomp$loop$prop$pl$354:m.$jscomp$loop$prop$pl$354},h=g.next())m.$jscomp$loop$prop$pl$354=h.value,n=(h=ITEM_DATA.find(function(E){return function(C){return C.id===E.$jscomp$loop$prop$pl$354.id}}(m)))?h.name:"-",r="",FIGHTERS.includes(h.type)?r=h.antiAir?'<span class="mx-1">\u5bfe\u7a7a: '+h.antiAir+"</span>":"":RECONNAISSANCES.includes(h.type)?(r=h.antiAir?'<span class="mx-1">\u5bfe\u7a7a: '+h.antiAir+"</span>":"",r+='<span class="mx-1">\u7d22\u6575: '+
...
'" data-prof="'+m.$jscomp$loop$prop$pl$354.level+'" src="../img/util/prof'+m.$jscomp$loop$prop$pl$354.level+'.png">':"")+'\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t\t<div class="w_40 font_size_11 align-self-center">('+r+")</div>\n\t\t</div>",k+=1;$("#detail_legend").html("<span>\u7b2c"+(a+1)+"\u57fa\u5730\u822a\u7a7a\u968a</span>");$("#detail_info").html(f);b=chartSlotDistribution.map(function(E){return E.slot});f=getArrayMax(b);document.getElementById("stage3_all_slot").checked&&(document.getElementById("stage3_slot").value=
f);document.getElementById("stage3_all_slot_label").textContent="\u6b8b\u6a5f\u6570\u5206\u5e03\u306e\u7d50\u679c\u3092\u5229\u7528\uff08"+getArrayMin(b)+"\u6a5f ~ "+f+"\u6a5f\uff09";document.getElementById("stage3_remodel").value=y?y:0;l.some(function(E){return 311===E.id})&&(document.getElementById("enabled_rikutei").checked=!0);l.some(function(E){return 312===E.id})&&(document.getElementById("enabled_rikutei_z").checked=!0);l='<option value="99">\u4efb\u610f</option>';e=e.battles.length-1;b=castInt(document.getElementById("target_enemy").value,
...
function enemySlotDetailCalculate(a,b,c){c=void 0===c?!1:c;setPreCalculateTable();var d=createLandBaseInstance(),e=createFleetInstance(),f=updateEnemyFleetInfo(!1),g=castInt($("#detail_calculate_count").val()),h=isDefMode?0:displayBattle;h=h<f.battles.length?h:f.battles.length-1;var l=[],k=[],m=f.battles[h].enemies.filter(function(y){return 0<y.slots.length&&!y.onlyScout})[a],n=ENEMY_DATA.find(function(y){return y.id===m.id}),r=n.eqp.map(function(y){return ENEMY_ITEM.find(function(A){return A.id===
y})});r=r.filter(function(y){return FIGHTERS.includes(y.type)||ATTACKERS.includes(y.type)});c&&!ATTACKERS.includes(r[b].type)&&r.some(function(y){return ATTACKERS.includes(y.type)})&&(b=r.findIndex(function(y){return ATTACKERS.includes(y.type)}));var p=new EnemyItem(r[b].id);c=$("#slot_detail").prop("checked");var v=[];if(r=document.getElementById("enabled_manual_stage2").checked){v=castInt($("#fleet_formation").val());e.isUnion&&f.battles[h].cellType===CELL_TYPE.airRaid?e.updateStage2All(v,!0):e.updateStage2All(v);
var u=document.getElementById("aa_cutin_miss").checked;document.getElementById("aa_cutin_miss").parentElement.classList.remove("d-none");v=e.allStage2;u&&(v=[v[v.length-1]])}else document.getElementById("aa_cutin_miss").parentElement.classList.add("d-none");u=$jscomp.makeIterator(f.battles);for(var x=u.next();!x.done;x=u.next())x=x.value,x.enemies=x.enemies.filter(function(y){return 0<y.slots.length});for(u=0;u<g;u++){for(x=0;x<=h;x++){var t=f.battles[x],q=t.enemies;calculateLandBase(d,t,x);doJetPhase(e,
t);var w=t.cellType,z=t.isUnion?e.unionAirPower:e.airPower,D=t.getAirPower();z=getAirStatusIndex(z,D);shootDownFleet(z,e,t,x);w===CELL_TYPE.aerialCombat&&(shootDownEnemy(z,q,r,v),z=getAirStatusIndex(e.airPower,t.getAirPower()),shootDownFleet(z,e,t,x,!1));x===h&&(shootDownEnemy(z,q,r,v),t=m.slots[b],k.push(t),c||(t=p.getFirePower(t),2===t.length?(l.push(t[0]),l.push(t[1])):l.push(t[0])));for(t=0;t<q.length;t++)w=q[t],w.onlyScout||(w.slots=w.fullSlots.concat(),w.airPower=w.fullAirPower,w.landBaseAirPower=
w.fullLandBaseAirPower)}for(x=0;3>x;x++){q=d.landBases[x];for(t=0;t<q.planes.length;t++)w=q.planes[t],w.slot=w.fullSlot,w.updateAirPower();q.updateAirPower()}for(x=0;x<e.ships.length;x++)for(q=e.ships[x],t=q.items.length,w=q.airPower=0;w<t;w++)z=q.items[w],z.slot=z.fullSlot,z.updateAirPower(),q.airPower+=z.airPower;e.updateAirPower()}chartSlotDistribution=updateDetailChart(c?k:l,c?"\u6b8b\u6a5f\u6570 [\u6a5f]":"\u822a\u7a7a\u6226\u706b\u529b",{mode:"index",callbacks:{title:function(y){y=y[0].xLabel;
if($("#slot_detail").prop("checked")){if(!y)return"\u6b8b\u6a5f\u6570\uff1a"+y+" \u6a5f\n\u822a\u7a7a\u6226\u706b\u529b\uff1a0";var A="\u822a\u7a7a\u6226\u706b\u529b\uff1a"+p.getFirePower(y).join(" or ");return"\u6b8b\u6a5f\u6570\uff1a"+y+" \u6a5f\n"+A}return"\u822a\u7a7a\u6226\u706b\u529b\uff1a"+y},label:function(y){return[y.yLabel+" %"]}}});if(!c)for(chartSlotDistribution=[],d=getArrayMax(k),f=getArrayMin(k),e=k.length,f={$jscomp$loop$prop$i$266$356:f};f.$jscomp$loop$prop$i$266$356<=d;f={$jscomp$loop$prop$i$266$356:f.$jscomp$loop$prop$i$266$356},
f.$jscomp$loop$prop$i$266$356++)(g=k.filter(function(y){return function(A){return A===y.$jscomp$loop$prop$i$266$356}}(f)).length)&&chartSlotDistribution.push({slot:f.$jscomp$loop$prop$i$266$356,rate:g/e});$("#land_base_detail_table").addClass("d-none");$(".detail_fire").removeClass("d-none").addClass("d-flex");$(".detail_wave").addClass("d-none").removeClass("d-flex");$("#detail_info").data("mode","enemy_slot_detail");$("#detail_info").data("base_no",a);$("#detail_info").data("slot_no",b);$("#detail_info").data("battle_no",
h);$("#detail_warning").text("\u203b \u30b0\u30e9\u30d5\u5185\u306e\u822a\u7a7a\u6226\u706b\u529b\u306f\u30ad\u30e3\u30c3\u30d7\u524d\u3067\u30af\u30ea\u30c6\u30a3\u30ab\u30eb\u3001\u89e6\u63a5\u88dc\u6b63\u306a\u3057\u3002\u5c0f\u6570\u5207\u6368\u3066");a=document.getElementById("graph_title").textContent="";d=h=0;e={};f=$jscomp.makeIterator(n.eqp);for(g=f.next();!g.done;e={$jscomp$loop$prop$id$358:e.$jscomp$loop$prop$id$358},g=f.next())e.$jscomp$loop$prop$id$358=g.value,g=ENEMY_ITEM.find(function(y){return function(A){return A.id===
y.$jscomp$loop$prop$id$358}}(e)),l=n.slot[h],c=PLANE_TYPE.includes(g?g.type:0),r="",c&&FIGHTERS.includes(g.type)?r=g.antiAir?'<span class="mx-1">\u5bfe\u7a7a: '+g.antiAir+"</span>":"":c&&(r=g.antiAir?'<span class="mx-1">\u5bfe\u7a7a: '+g.antiAir+"</span>":"",r+=g.torpedo?'<span class="mx-1">\u96f7\u88c5: '+g.torpedo+"</span>":"",r+=g.bomber?'<span class="mx-1">\u7206\u88c5: '+g.bomber+"</span>":""),a+='\n\t\t<div class="d-flex px-2 py-1 '+(b===d?"selected":"")+" "+(c?"general_tr btn_show_detail":
...
document.getElementById("jet_phase").checked,n=aerialSetting.isAllSlot,r="",p=chartSlotDistribution,v=0;v<a.length;v++){var u=a[v];if(!(0>=u.id)){var x=u.armor+u.sumItemArmor,t=[];t=d?f&&u.type.includes(16)?getLandBaseAerialPowersMod(p):g&&u.type.includes(13)?getLandBaseAerialPowersMod2(p):u.type.includes(2)?getLandBaseAerialPowersLandBase(p,u):u.type.includes(18)&&h?getLandBaseASWPower(p):!e||86!==u.id&&120!==u.id?getLandBaseAerialPowers(p):getLandBaseAerialPowers(p,3.2):c?getFleetAerialPower(p,
u,1,m):getEnemyAerialPowers(p,u);var q=u.hp,w=createDamageDistribution(t,x,k,c,q),z=w.map(function(C){return C.damage}),D=getArrayMin(z),y=getArrayMax(z);z=[{min:q,max:getArrayMax(w.map(function(C){return C.damage}))+1,value:0},{min:Math.ceil(.75*q),max:q,value:0},{min:Math.ceil(.5*q),max:Math.ceil(.75*q),value:0}];t=t.map(function(C){return C.power}).some(function(C){return 0>=C});D=(1<=D?D:t?"0":"\u5272\u5408")+"~"+(1<=y?y:"\u5272\u5408");n||0!==l||(D="-");t="";y={};for(var A=0;A<z.length;y={$jscomp$loop$prop$borderMin$370:y.$jscomp$loop$prop$borderMin$370,
$jscomp$loop$prop$borderMax$371:y.$jscomp$loop$prop$borderMax$371},A++){var B=z[A];y.$jscomp$loop$prop$borderMin$370=B.min;y.$jscomp$loop$prop$borderMax$371=B.max;var E=w.filter(function(C){return function(F){return F.damage>=C.$jscomp$loop$prop$borderMin$370&&F.damage<C.$jscomp$loop$prop$borderMax$371}}(y)).map(function(C){return C.rate});E=E.length===w.length?1:getArraySum(E);B.value=E;if(b.isAttacker||!c||u.type.includes(18)&&h){if(c&&u.type.includes(18)&&!h||!c&&[13,14].includes(u.type)){t+='<td class="text-center" colspan="'+
z.length+'">\u5bfe\u6f5c\u653b\u6483\u4e0d\u53ef</td>';D="";w=$jscomp.makeIterator(z);for(y=w.next();!y.done;y=w.next())y.value.value=0;break}if(1!==E||0!==A||n)1===E?t+='<td>100 <span class="font_size_11 font_color_half">%</span></td>':(B=Math.floor(1E3*E)/10,t+="<td>"+(0===B&&0!==E?.1:B)+' <span class="font_size_11 font_color_half">%</span></td>');else{t+='<td colspan="'+z.length+'" class="text-center text_red">\u78ba\u6bba</td>';break}}else t+="<td>-</td>",D=""}w=Math.floor(1E3*(z[0].value+z[1].value))/
10;y=Math.floor(1E3*(z[0].value+z[1].value+z[2].value))/10;r+='\n\t\t<tr class="stage3_calc_detail '+(90<=Math.floor(1E3*z[0].value)/10?"tr_death":70<=w?"tr_damaged":50<=y?"tr_half_damaged":"")+'"\n\t\t\tdata-toggle="tooltip" data-html="true" title="\n\t\t<div class=\'text-left\'>\n\t\t\t<div>'+(u.name+"</div>\n\t\t\t<div class='mt-1 ml-3'>\u5927\u7834\u4ee5\u4e0a: "+w+" %</div>\n\t\t\t<div class='ml-3'>\u4e2d\u7834\u4ee5\u4e0a: "+y+' %</div>\n\t\t</div>">\n\t\t\t<td class="px-0">\n\t\t\t\t<img class="enemy_img_sm" src="../img/')+
...
k*b;(k=h.find(function(n){return function(r){return r.power===n.$jscomp$loop$prop$a$373}}(l)))?k.rate+=m:h.push({power:l.$jscomp$loop$prop$a$373,rate:m});if(!f)break}return h}
...
k*b;(k=h.find(function(n){return function(r){return r.power===n.$jscomp$loop$prop$a$375}}(l)))?k.rate+=m:h.push({power:l.$jscomp$loop$prop$a$375,rate:m});if(!f)break}return h}
...
k*b;(k=h.find(function(n){return function(r){return r.power===n.$jscomp$loop$prop$a$377}}(l)))?k.rate+=m:h.push({power:l.$jscomp$loop$prop$a$377,rate:m});if(!f)break}return h}
...
k.$jscomp$loop$prop$a$379=m*c;(m=l.find(function(r){return function(p){return p.power===r.$jscomp$loop$prop$a$379}}(k)))?m.rate+=n:l.push({power:k.$jscomp$loop$prop$a$379,rate:n});if(!g)break}return l}
function getLandBaseASWPower(a,b){var c=aerialSetting.item,d=aerialSetting.isCritical,e=aerialSetting.levelCriticalBonus,f=aerialSetting.isAllSlot,g=aerialSetting.manualSlot;b=aerialSetting.contactBonus*(void 0===b?1:b);var h=[];a=$jscomp.makeIterator(a);for(var l=a.next();!l.done;l=a.next()){l=l.value;var k=f?l.slot:g;k=0<k?c.asw*Math.sqrt(1.8*k)+25:0;for(var m=10<=c.asw?.7:.35,n=10<=c.asw?.3:.45,r=1/(100*n+1),p={},v=0;v<=100*n;p={$jscomp$loop$prop$power$381:p.$jscomp$loop$prop$power$381},v++){var u=
f?l.rate*r:r,x=Math.floor(softCap(k*(m+v/100),AS_CAP));d&&(x=Math.floor(1.5*x*e));p.$jscomp$loop$prop$power$381=x*(47===c.type?1.8:1)*b;RECONNAISSANCES.includes(c.type)&&(p.$jscomp$loop$prop$power$381=1);(x=h.find(function(t){return function(q){return q.power===t.$jscomp$loop$prop$power$381}}(p)))?x.rate+=u:h.push({power:p.$jscomp$loop$prop$power$381,rate:u})}if(!f)break}return h}
function getFleetAerialPower(a,b,c,d){d=void 0===d?!1:d;var e=aerialSetting.item,f=aerialSetting.isCritical,g=aerialSetting.levelCriticalBonus,h=aerialSetting.isAllSlot,l=aerialSetting.manualSlot,k=aerialSetting.isUnion;c=aerialSetting.contactBonus*aerialSetting.a11*(void 0===c?1:c);var m=[];a=$jscomp.makeIterator(a);for(var n=a.next();!n.done;n=a.next()){n=n.value;var r=ShipItem.getFirePower(e,h?n.slot:l,k,b.isEscort,d),p=1/r.length;n=h?n.rate*p:p;p={};r=$jscomp.makeIterator(r);for(var v=r.next();!v.done;p=
{$jscomp$loop$prop$a$383:p.$jscomp$loop$prop$a$383},v=r.next())p.$jscomp$loop$prop$a$383=v.value*c,p.$jscomp$loop$prop$a$383=f?Math.floor(1.5*p.$jscomp$loop$prop$a$383*g):p.$jscomp$loop$prop$a$383,(v=m.find(function(u){return function(x){return x.power===u.$jscomp$loop$prop$a$383}}(p)))?v.rate+=n:m.push({power:p.$jscomp$loop$prop$a$383,rate:n});if(!h)break}return m}
function getEnemyAerialPowers(a,b,c){var d=aerialSetting.item,e=aerialSetting.isCritical,f=aerialSetting.levelCriticalBonus,g=aerialSetting.isAllSlot,h=aerialSetting.manualSlot,l=aerialSetting.isUnion;c=aerialSetting.contactBonus*(void 0===c?1:c);var k=[];a=$jscomp.makeIterator(a);for(var m=a.next();!m.done;m=a.next()){m=m.value;var n=d.getFirePower(g?m.slot:h,l,b.isEscort),r=1/n.length;m=g?m.rate*r:r;r={};n=$jscomp.makeIterator(n);for(var p=n.next();!p.done;r={$jscomp$loop$prop$a$385:r.$jscomp$loop$prop$a$385},
p=n.next())r.$jscomp$loop$prop$a$385=p.value*c,r.$jscomp$loop$prop$a$385=e?Math.floor(1.5*r.$jscomp$loop$prop$a$385*f):r.$jscomp$loop$prop$a$385,(p=k.find(function(v){return function(u){return u.power===v.$jscomp$loop$prop$a$385}}(r)))?p.rate+=m:k.push({power:r.$jscomp$loop$prop$a$385,rate:m});if(!g)break}return k}
...
function createDamageDistribution(a,b,c,d,e){for(var f=[],g=1/b,h=0;h<b;h++)for(var l=.7*b+.6*h,k={},m=$jscomp.makeIterator(a),n=m.next();!n.done;k={$jscomp$loop$prop$damage$389:k.$jscomp$loop$prop$damage$389},n=m.next())if(n=n.value,k.$jscomp$loop$prop$damage$389=0<n.power-l?Math.floor((n.power-l)*c):0,k.$jscomp$loop$prop$damage$389>=e&&!d)for(var r=1/e,p={},v=0;v<e;p={$jscomp$loop$prop$damage2$387:p.$jscomp$loop$prop$damage2$387},v++){p.$jscomp$loop$prop$damage2$387=Math.floor(.5*e+.3*v);var u=
g*n.rate*r,x=f.find(function(t){return function(q){return q.damage===t.$jscomp$loop$prop$damage2$387}}(p));x?x.rate+=u:f.push({damage:p.$jscomp$loop$prop$damage2$387,rate:u})}else n=g*n.rate,(r=f.find(function(t){return function(q){return q.damage===t.$jscomp$loop$prop$damage$389}}(k)))?r.rate+=n:f.push({damage:k.$jscomp$loop$prop$damage$389,rate:n});return f}
function updateDetailChart(a,b,c){for(var d=[],e=[],f=[],g=[],h=getArrayMax(a),l=getArrayMin(a),k=a.length,m=0,n=0,r=0,p=0,v=0,u={$jscomp$loop$prop$i$391:l};u.$jscomp$loop$prop$i$391<=h;u={$jscomp$loop$prop$i$391:u.$jscomp$loop$prop$i$391},u.$jscomp$loop$prop$i$391++){var x=a.filter(function(t){return function(q){return q===t.$jscomp$loop$prop$i$391}}(u)).length;x&&(d.push(u.$jscomp$loop$prop$i$391),e.push((100*x/k).toFixed(1E5<=k?5:1E4<=k?4:1E3<=k?3:2)),g.push({slot:u.$jscomp$loop$prop$i$391,rate:x/
k}),v+=100*x/k,f.push(v.toFixed(1)),!m&&50<=v&&(m=u.$jscomp$loop$prop$i$391),!n&&90<=v&&(n=u.$jscomp$loop$prop$i$391),!r&&95<=v&&(r=u.$jscomp$loop$prop$i$391),!p&&99<=v&&(p=u.$jscomp$loop$prop$i$391))}$("#detail_max").text(h);$("#detail_min").text(l);$("#detail_50").text(m);$("#detail_90").text(n);$("#detail_95").text(r);$("#detail_99").text(p);chartInstance?(chartInstance.data.labels=d,chartInstance.data.datasets[0].data=e,chartInstance.data.datasets[1].data=f,chartInstance.options.scales.xAxes[0].scaleLabel.labelString=
...
function getItemTooltipContext(a,b,c,d,e,f){c=void 0===c?0:c;d=void 0===d?0:d;e=void 0===e?0:e;f=void 0===f?0:f;var g=null;g=(void 0===b?0:b)?new LandBaseItem(a,c,d,e):new ShipItem(a,c,d,e);if(!g.id)return"";var h=ITEM_DATA.find(function(A){return A.id===g.id}),l=h.type;b=g.bonusAntiAir;c=Item.getBonusFire(l,d);e=Item.getBonusScout(l,d);var k=Item.getBonusTorpedo(l,d);if(f){var m=SHIP_DATA.find(function(A){return A.id===f});if(m){var n=new Ship;n.id=m.id;n.name=m.name;n.type=m.type;n.type2=m.type2;
k+=ShipItem.getAttackerBonus(g,n)}}m=Item.getBonusAccuracy(a,l,d);n=Item.getBonusBomber(a,l,d);l=Item.getBonusASW(a,l,d,h.antiAir);var r=RANGES.find(function(A){return A.id===h.range2});r=h.range2&&r?r.name:"";d=d?'<span class="text_remodel">\u2605'+d+"</span>":"";var p=b?'<span class="ml-1 text_remodel">(+'+b.toFixed(2)+")</span>":"",v=c?'<span class="ml-1 text_remodel">(+'+c.toFixed(2)+")</span>":"",u=k?'<span class="ml-1 text_remodel">(+'+k.toFixed(2)+")</span>":"",x=n?'<span class="ml-1 text_remodel">(+'+
n.toFixed(2)+")</span>":"",t=m?'<span class="ml-1 text_remodel">(+'+m.toFixed(2)+")</span>":"",q=l?'<span class="ml-1 text_remodel">(+'+l.toFixed(2)+")</span>":"",w=e?'<span class="ml-1 text_remodel">(+'+e.toFixed(2)+")</span>":"",z=0<h.avoid?AVOID_TYPE.find(function(A){return A.id===h.avoid}):null,D=g.selectRate.length?g.selectRate.map(function(A){return(100*A).toFixed(0)+"%"}):null,y=PLANE_TYPE.includes(h.type)?getRequiredgBattleCountString(h.grow):null;return('\n\t<div class="text-left m-1 item_tooltip">\n\t\t<div class="d-flex">\n\t\t\t<img src="../img/type/icon'+
...
var r=getArrayMax(f[k]),p=getArrayMin(f[k]),v=getArrayMax(g[k]),u=getArrayMin(g[k]);h+='\n\t\t<tr class="'+(m.isEscort?"escort_fleet":"main_fleet")+'">\n\t\t\t<td class="text-left text-truncate">\n\t\t\t\t<span class="font_size_11 '+(m.isEscort?"text-primary":"text-success")+'">'+(0<n?n:l)+".</span>\n\t\t\t\t<span>"+m.name+'</span>\n\t\t\t</td>\n\t\t\t<td class="rate_shoot_down">'+Math.floor(1E4*m.rateDown)/100+' %</td>\n\t\t\t<td class="fixed_shoot_down">'+(2<=g[k].length?u+" ~ "+v:v)+'</td>\n\t\t\t<td class="minimum_shoot_down">'+
(2<=f[k].length?p+" ~ "+r:r)+"</td>\n\t\t</tr>"}$("#antiair_input_table tbody").html(h);if(!d.innerHTML){b=document.createDocumentFragment();c={};a=$jscomp.makeIterator(a.allStage2);for(l=a.next();!l.done;c={$jscomp$loop$prop$stage2$274$395:c.$jscomp$loop$prop$stage2$274$395},l=a.next())c.$jscomp$loop$prop$stage2$274$395=l.value,h=ANTIAIR_CUTIN.find(function(x){return function(t){return t.id===x.$jscomp$loop$prop$stage2$274$395.cutin.id}}(c)),k=e.includes(h.id),f=document.createElement("div"),f.className=
...
w[b]});break;case "name":ITEM_LIST.sort(function(q,w){return q.name>w.name?1:-1});break;case "land_base_power":ITEM_LIST.sort(function(q,w){return LandBaseItem.getFirePower(w.id,18,0)-LandBaseItem.getFirePower(q.id,18,0)});break;case "history":if(setting.selectedHistory[0]){var c=setting.selectedHistory[0];ITEM_LIST.sort(function(q,w){return c.filter(function(z){return z===w.id}).length-c.filter(function(z){return z===q.id}).length})}break;default:ITEM_LIST.sort(function(q,w){return w[b]-q[b]})}var d=
castInt(a.length?a[0].dataset.type:0),e=[],f=$("#plane_word").val().trim(),g=[];if($target&&$target.hasClass("ship_plane")&&$target.closest(".ship_tab")[0].dataset.shipid){var h=SHIP_DATA.find(function(q){return q.id===castInt($target.closest(".ship_tab")[0].dataset.shipid)});g=(a=SPECIAL_LINK_SHIP_ITEM.find(function(q){return q.apiShip===h.api}))?a.itemType.concat():LINK_SHIP_ITEM.find(function(q){return q.type===h.type}).e_type;var l=$target.hasClass("expanded_slot");a=[];if(l){g=g.filter(function(q){return EXPANDED_ITEM_TYPE.includes(q)});
var k=EXPANDED_SPECIAL_ITEM.filter(function(q){return q.shipApiIds.includes(h.api)});e={};k=$jscomp.makeIterator(k);for(var m=k.next();!m.done;e={$jscomp$loop$prop$sp$397:e.$jscomp$loop$prop$sp$397},m=k.next())e.$jscomp$loop$prop$sp$397=m.value,(m=ITEM_LIST.find(function(q){return function(w){return w.id===q.$jscomp$loop$prop$sp$397.itemId}}(e)))&&!g.includes(m.type)&&g.push(m.type),a.push(m)}var n=castInt($target.index());if(0<=n){var r=FORBIDDEN_LINK_SHIP_ITEM.find(function(q){return q.shipId===
...
h.id}).itemIDs;e=e.filter(function(q){return!p.includes(q.id)})}if(l){e=e.filter(function(q){return 34!==q.id&&87!==q.id});var v=a.map(function(q){return q.id});l={};a=$jscomp.makeIterator(a);for(k=a.next();!k.done;l={$jscomp$loop$prop$spItem$275$399:l.$jscomp$loop$prop$spItem$275$399},k=a.next())l.$jscomp$loop$prop$spItem$275$399=k.value,e=e.filter(function(q){return function(w){return v.includes(w.id)||q.$jscomp$loop$prop$spItem$275$399.type!==w.type}}(l))}}else $target&&$target.hasClass("ship_plane")?
(g=CB_PLANE_TYPE.concat(SP_PLANE_TYPE),g.includes(d)||(d=0),e=getItemsForIcon(d),e=e.filter(function(q){return g.includes(q.type)})):(g=PLANE_TYPE,g.includes(d)||(d=0),e=getItemsForIcon(d),e=e.filter(function(q){return g.includes(q.type)}));var u=g.map(function(q){return convertItemType(q)});$("#plane_type_select").find(".item_type").each(function(q,w){q=castInt($(w)[0].dataset.type);q===d?$(w).addClass("active"):$(w).removeClass("active");0<q&&!u.includes(q)&&$(w).addClass("disabled d-none")});f&&
(f=replaceKnji(f),e=e.filter(function(q){return q.name.includes(f)||q.id==f}));var x=$("#plane_filter_key_select").val(),t=castInt($("#plane_filter_value").val());1<=e.length&&e[0].hasOwnProperty(x)&&(e=e.filter(function(q){return q[x]>=t}));createItemTable(e,d)}function plane_word_TextChanged(){!1!==timer&&clearTimeout(timer);timer=setTimeout(function(){plane_type_select_Changed()},250)}
