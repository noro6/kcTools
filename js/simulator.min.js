...
'<span class="font_size_12">'+D.remarks+"</span>";z.appendChild(A);A=!0;break}if(v&&!A)continue}A=document.createElement("div");A.className="pl-1 d-flex align-self-center flex-grow-1";B=!1;16===w.$jscomp$loop$prop$item$299.itype&&8<=w.$jscomp$loop$prop$item$299.antiAir?B=!0:21===w.$jscomp$loop$prop$item$299.type&&9<=w.$jscomp$loop$prop$item$299.antiAir?B=!0:350===w.$jscomp$loop$prop$item$299.id||351===w.$jscomp$loop$prop$item$299.id||352===w.$jscomp$loop$prop$item$299.id?B=!0:TAICHI.includes(w.$jscomp$loop$prop$item$299.id)&&
(B=!0);D=document.createElement("div");D.className="pl-1 plane_td_name align-self-center"+(B?" special_item":"");D.textContent=w.$jscomp$loop$prop$item$299.name;A.appendChild(D);B=document.createElement("div");B.className="ml-2 plane_td_stock align-self-center";B.textContent="\u00d7"+(0<d?d:0);D=document.createDocumentFragment();var E=document.createElement("div");E.className="ml-auto plane_td_basic align-self-center";var F=document.createElement("div");F.className="plane_td_basic align-self-center";
var G=document.createElement("div");G.className="plane_td_basic align-self-center d-none d-lg-block";var J=document.createElement("div");J.className="plane_td_basic align-self-center d-none d-lg-block";var M=document.createElement("div");M.className="plane_td_basic align-self-center d-none d-lg-block";E.textContent=sFormat(w.$jscomp$loop$prop$item$299[t[0]],t[0]);F.textContent=sFormat(w.$jscomp$loop$prop$item$299[t[1]],t[1]);G.textContent=sFormat(w.$jscomp$loop$prop$item$299[t[2]],t[2]);J.textContent=
sFormat(w.$jscomp$loop$prop$item$299[t[3]],t[3]);M.textContent=sFormat(w.$jscomp$loop$prop$item$299[t[4]],t[4]);if("multi"===g&&u!==w.$jscomp$loop$prop$item$299.type&&"default"===p){u=document.createElement("div");u.className="type_divider mt-3 mb-1";var K=document.createElement("div");K.className="font_size_12 font_color_half align-self-center";K.textContent=ITEM_API_TYPE.find(function(H){return function(I){return I.id===H.$jscomp$loop$prop$item$299.type}}(w)).name;var L=document.createElement("div");
L.className="flex-grow-1 border-bottom align-self-center mx-2";u.appendChild(K);u.appendChild(L);f.appendChild(u)}z.appendChild(r);C.appendChild(z);k&&0<w.$jscomp$loop$prop$item$299.remodel&&(u=document.createElement("div"),u.className="plane_td_remodel text_remodel align-self-center",u.dataset.remodel=w.$jscomp$loop$prop$item$299.remodel,z="",z="multi"===g?"\u2605"+w.$jscomp$loop$prop$item$299.remodel:10>w.$jscomp$loop$prop$item$299.remodel?"\u2605+"+w.$jscomp$loop$prop$item$299.remodel:"\u2605MAX",
u.textContent=z,A.appendChild(u),A.appendChild(B));0<d&&A.appendChild(B);C.appendChild(A);"single"===g&&(D.appendChild(E),D.appendChild(F),D.appendChild(G),D.appendChild(J),D.appendChild(M),C.appendChild(D));f.appendChild(C);u=w.$jscomp$loop$prop$item$299.type}f.childNodes.length||(a=document.createElement("div"),a.className="text-center",l&&!n&&(a.textContent+="\u88c5\u5099\u6240\u6301\u6570\u304c\u767b\u9332\u3055\u308c\u3066\u3044\u306a\u3044\u304b\u3001\u5168\u3066\u306e\u88c5\u5099\u304c\u914d\u5099\u6e08\u307f\u3067\u3059\u3002"),
l&&!n&&(a.textContent+="\u88c5\u5099\u6240\u6301\u6570\u304c\u767b\u9332\u3055\u308c\u3066\u3044\u306a\u3044\u304b\u3001\u5168\u3066\u306e\u88c5\u5099\u304c\u914d\u5099\u6e08\u307f\u3067\u3059\u3002"));e.innerHTML="";e.appendChild(f)}
