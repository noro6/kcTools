...
$("#main");var g=[];d=[];var h=[];f=$("#main_header_info");e=$("#footer_info");c.find(".contents").each(function(n,m){g.push($(m).attr("id"));h.push($(m))});c.empty();c.append(f);var l={},k=$jscomp.makeIterator(setting.contentsOrder);for(f=k.next();!f.done;l={$jscomp$loop$prop$id$160$293:l.$jscomp$loop$prop$id$160$293},f=k.next())l.$jscomp$loop$prop$id$160$293=f.value,g.includes(l.$jscomp$loop$prop$id$160$293)&&(f=h.find(function(n){return function(m){return m.attr("id")===n.$jscomp$loop$prop$id$160$293}}(l)),
c.append(f),d.push(l.$jscomp$loop$prop$id$160$293));c.append(e);if(g.length!==d.length){e={};l=$jscomp.makeIterator(g);for(f=l.next();!f.done;e={$jscomp$loop$prop$id$161$295:e.$jscomp$loop$prop$id$161$295},f=l.next())e.$jscomp$loop$prop$id$161$295=f.value,d.includes(e.$jscomp$loop$prop$id$161$295)||(f=h.find(function(n){return function(m){return m.attr("id")===n.$jscomp$loop$prop$id$161$295}}(e)),c.append(f),d.push(e.$jscomp$loop$prop$id$161$295));setting.contentsOrder=d.concat();saveSetting()}}$("#stage2_detail_slot").val(18);
