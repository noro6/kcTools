...
n){function m(u){return function(t){p[u]=t;q--;0==q&&k(p)}}var p=[],q=0;do p.push(void 0),q++,c(l.value).callWhenSettled_(m(p.length-1),n),l=h.next();while(!l.done)})};return e},"es6","es3");$jscomp.findInternal=function(a,b,c){a instanceof String&&(a=String(a));for(var d=a.length,e=0;e<d;e++){var f=a[e];if(b.call(c,f,e,a))return{i:e,v:f}}return{i:-1,v:void 0}};$jscomp.polyfill("Array.prototype.find",function(a){return a?a:function(b,c){return $jscomp.findInternal(this,b,c).v}},"es6","es3");
...
var AntiAirCutIn=function(){this.fixCorr=this.id=0;this.rateCorr=1;this.rate=0},FleetStage2=function(){this.cutin=null;this.border=this.rate=0;this.table=[]},ShootDownStatus=function(){this.minimumDown=this.fixDown=this.rateDown=0},LandBaseAll=function(){this.landBases=[];this.rocketBonus=this.defense2AirPower=this.defenseAirPower=0;this.manualCorr=1;this.superDefenseCorrC=this.superDefenseCorrB=this.superDefenseCorrA=0;this.superRocketCorr1=1;this.superRocketCorr2=0;this.sumSuperCorr=1;this.fullDefense3AirPower=
this.defense3AirPower=0};
LandBaseAll.prototype.updateDefenseAirPower=function(){for(var a=0,b=0,c=0,d=0,e=$jscomp.makeIterator(this.landBases),f=e.next();!f.done;f=e.next())if(f=f.value,0===f.mode){b+=f.defenseAirPower;f=$jscomp.makeIterator(f.planes);for(var g=f.next();!g.done;g=f.next())g=g.value,ROCKETS.includes(g.id)&&(a+=1),[445,175,177,333].includes(g.id)&&(this.superDefenseCorrA+=.07),[263,354].includes(g.id)&&(c+=1),[334,452,446].includes(g.id)&&(d+=1)}this.rocketBonus=0===a?.5:1===a?.8:2===a?1.1:1.2;this.defenseAirPower=
Math.floor(this.manualCorr*b);this.defense2AirPower=Math.floor(this.rocketBonus*b);switch(c){case 0:this.superDefenseCorrB=0;break;case 1:this.superDefenseCorrB=.11;break;case 2:this.superDefenseCorrB=.14;break;default:this.superDefenseCorrB=.287}switch(d){case 0:this.superDefenseCorrC=0;break;case 1:this.superDefenseCorrC=.177;break;case 2:this.superDefenseCorrC=.287;break;default:this.superDefenseCorrC=.397}switch(a){case 0:this.superRocketCorr1=.5;this.superRocketCorr2=.3;break;case 1:this.superRocketCorr1=
.95;this.superRocketCorr2=.55;break;case 2:this.superRocketCorr1=1;this.superRocketCorr2=.85;break;case 3:this.superRocketCorr2=this.superRocketCorr1=1;break;case 4:this.superRocketCorr1=1;this.superRocketCorr2=1.07;break;default:this.superRocketCorr1=1,this.superRocketCorr2=1.11}this.sumSuperCorr=(this.superDefenseCorrA+this.superDefenseCorrB+this.superDefenseCorrC)*this.superRocketCorr1+this.superRocketCorr2;this.fullDefense3AirPower=this.defense3AirPower=Math.floor(b*this.sumSuperCorr)};
LandBaseAll.prototype.clearResult=function(){for(var a=$jscomp.makeIterator(this.landBases),b=a.next();!b.done;b=a.next()){b=b.value;b.results=[];for(var c=0;c<battleCount;c++)b.results.push(new AirStatusResult)}};var LandBase=function(a,b){this.baseNo=a;this.planes=[];this.mode=b;this.target=[-1,-1];this.defenseAirPower=this.fullAirPower=this.airPower=0;this.defenseCorr=this.reconCorr=1;this.results=[];this.isSeparate=this.hasJet=!1;for(a=0;a<battleCount;a++)this.results.push(new AirStatusResult)};
...
[14,15].includes(b)?t=["asw","fire","accuracy","avoid2","armor"]:[5,22,32].includes(b)?t=["torpedo","fire","accuracy","avoid2","armor"]:21===b?t=["antiAir","antiAirWeight","antiAirBonus","fire","torpedo"]:LB_ATTACKERS.includes(b)?t=["antiAir","radius","torpedo","avoid","cost"]:48===b&&(t=["antiAir","radius","battleAntiAir","defenseAntiAir","cost"]);$target&&!$target.hasClass("ship_plane")&&(t[1]="radius",t[4]="cost",0===b&&(t=["antiAir","radius","battleAntiAir","cost","avoid"]));var x=0;$("#plane_table_thead").find(".plane_td_basic").each(function(I,
H){$(H).text(convertHeaderText(t[x]));$(H)[0].dataset.sortkey=t[x++];p===$(H)[0].dataset.sortkey?$(H).addClass("active"):$(H).removeClass("active")});"multi"===g?(c.addClass("modal-xl"),c.removeClass("modal-lg"),d.addClass("multi_mode"),c.find(".scroll_thead").addClass("d-none").removeClass("d-flex")):(c.addClass("modal-lg"),c.removeClass("modal-xl"),d.removeClass("multi_mode"),c.find(".scroll_thead").addClass("d-flex").removeClass("d-none"));l?($("#divide_stock").closest("div").removeClass("d-none"),
$("#disp_equipped").closest("div").removeClass("d-none"),$("#disp_in_stock").prop("checked",!0)):($("#divide_stock").closest("div").addClass("d-none"),$("#disp_equipped").closest("div").addClass("d-none"),$("#disp_in_stock").prop("checked",!1));b=a.length;var v=0;c=0;d=-1;for(var r=0,w={},A=0;A<b;w={$jscomp$loop$prop$item$301:w.$jscomp$loop$prop$item$301},A++)if(w.$jscomp$loop$prop$item$301=a[A],!m||setting.favoritePlane.includes(w.$jscomp$loop$prop$item$301.id)){if(l&&h){var D=q.find(function(I){return function(H){return H.id===
I.$jscomp$loop$prop$item$301.id}}(w));if(k){if(-1===w.$jscomp$loop$prop$item$301.stock)continue;d=w.$jscomp$loop$prop$item$301.stock-(D?D.num[w.$jscomp$loop$prop$item$301.remodel]:0);if(!n&&1>d)continue;c=w.$jscomp$loop$prop$item$301.remodel}else{if(0<=w.$jscomp$loop$prop$item$301.stock)continue;var y=h.find(function(I){return function(H){return H.id===I.$jscomp$loop$prop$item$301.id}}(w)),z=D?getArraySum(D.num):0;r=y?getArraySum(y.num):0;if(0===r||!n&&z>=r)continue;d=r-z;for(r=10;0<=r;r--)if(D&&
(y.num[r]-=D.num[r]),0<y.num[r]){c=r;break}}}else if(0<w.$jscomp$loop$prop$item$301.remodel||0<=w.$jscomp$loop$prop$item$301.stock)continue;y="";y="multi"===g?"tr_multi px-1":"px-2";D=document.createElement("div");D.className="plane plane_tr general_tr d-flex py-2 py-lg-1 "+y;D.dataset.planeid=w.$jscomp$loop$prop$item$301.id;D.dataset.type=w.$jscomp$loop$prop$item$301.type;D.dataset.remodel=c;l&&n&&0>=d&&(D.classList.remove("plane_tr","plane","general_tr"),D.classList.add("plane_tr_disabled"));y=
document.createElement("div");y.className="align-self-center size-25 relative";r=document.createElement("canvas");z=r.getContext("2d");r.width=25;r.height=25;z.drawImage(IMAGES["type"+w.$jscomp$loop$prop$item$301.itype],0,0,25,25);if(specialOperator.enabled){z=!1;for(var B=$jscomp.makeIterator(specialOperator.specialInfo),E=B.next();!E.done;E=B.next())if(E=E.value,E.items.includes(w.$jscomp$loop$prop$item$301.id)){z=document.createElement("div");z.className="item_special flash";z.innerHTML=E.name+
'<span class="font_size_12">'+E.remarks+"</span>";y.appendChild(z);z=!0;break}if(u&&!z)continue}z=document.createElement("div");z.className="pl-1 d-flex align-self-center flex-grow-1";B=!1;16===w.$jscomp$loop$prop$item$301.itype&&8<=w.$jscomp$loop$prop$item$301.antiAir?B=!0:21===w.$jscomp$loop$prop$item$301.type&&9<=w.$jscomp$loop$prop$item$301.antiAir?B=!0:ROCKETS.includes(w.$jscomp$loop$prop$item$301.id)?B=!0:TAICHI.includes(w.$jscomp$loop$prop$item$301.id)&&(B=!0);E=document.createElement("div");
E.className="pl-1 plane_td_name align-self-center"+(B?" special_item":"");E.textContent=w.$jscomp$loop$prop$item$301.name;z.appendChild(E);B=document.createElement("div");B.className="ml-2 plane_td_stock align-self-center";B.textContent="\u00d7"+(0<d?d:0);E=document.createDocumentFragment();var C=document.createElement("div");C.className="ml-auto plane_td_basic align-self-center";var F=document.createElement("div");F.className="plane_td_basic align-self-center";var G=document.createElement("div");
G.className="plane_td_basic align-self-center d-none d-lg-block";var J=document.createElement("div");J.className="plane_td_basic align-self-center d-none d-lg-block";var M=document.createElement("div");M.className="plane_td_basic align-self-center d-none d-lg-block";C.textContent=sFormat(w.$jscomp$loop$prop$item$301[t[0]],t[0]);F.textContent=sFormat(w.$jscomp$loop$prop$item$301[t[1]],t[1]);G.textContent=sFormat(w.$jscomp$loop$prop$item$301[t[2]],t[2]);J.textContent=sFormat(w.$jscomp$loop$prop$item$301[t[3]],
t[3]);M.textContent=sFormat(w.$jscomp$loop$prop$item$301[t[4]],t[4]);if("multi"===g&&v!==w.$jscomp$loop$prop$item$301.type&&"default"===p){v=document.createElement("div");v.className="type_divider mt-3 mb-1";var L=document.createElement("div");L.className="font_size_12 font_color_half align-self-center";L.textContent=ITEM_API_TYPE.find(function(I){return function(H){return H.id===I.$jscomp$loop$prop$item$301.type}}(w)).name;var K=document.createElement("div");K.className="flex-grow-1 border-bottom align-self-center mx-2";
v.appendChild(L);v.appendChild(K);f.appendChild(v)}y.appendChild(r);D.appendChild(y);k&&0<w.$jscomp$loop$prop$item$301.remodel&&(v=document.createElement("div"),v.className="plane_td_remodel text_remodel align-self-center",v.dataset.remodel=w.$jscomp$loop$prop$item$301.remodel,y="",y="multi"===g?"\u2605"+w.$jscomp$loop$prop$item$301.remodel:10>w.$jscomp$loop$prop$item$301.remodel?"\u2605+"+w.$jscomp$loop$prop$item$301.remodel:"\u2605MAX",v.textContent=y,z.appendChild(v),z.appendChild(B));0<d&&z.appendChild(B);
D.appendChild(z);"single"===g&&(E.appendChild(C),E.appendChild(F),E.appendChild(G),E.appendChild(J),E.appendChild(M),D.appendChild(E));f.appendChild(D);v=w.$jscomp$loop$prop$item$301.type}f.childNodes.length||(a=document.createElement("div"),a.className="text-center",l&&!n&&(a.textContent+="\u88c5\u5099\u6240\u6301\u6570\u304c\u767b\u9332\u3055\u308c\u3066\u3044\u306a\u3044\u304b\u3001\u5168\u3066\u306e\u88c5\u5099\u304c\u914d\u5099\u6e08\u307f\u3067\u3059\u3002"),l&&!n&&(a.textContent+="\u88c5\u5099\u6240\u6301\u6570\u304c\u767b\u9332\u3055\u308c\u3066\u3044\u306a\u3044\u304b\u3001\u5168\u3066\u306e\u88c5\u5099\u304c\u914d\u5099\u6e08\u307f\u3067\u3059\u3002"));
...
k=document.getElementById("disp_kamisha_ship").checked,n=document.getElementById("disp_slot_ex_ship").checked,m=document.getElementById("fav_only_ship").checked,p=loadShipStock(),q=0;q=$("#ship_type_select .ship_type.active");q=q.length?castInt(q[0].dataset.type):111;var u=[];switch(q){case 103:u=[3,4];break;case 105:u=[5,6];break;case 108:u=[8,9,10];break;case 111:u=[7,11,18];break;case 114:u=[13,14];break;case 116:u=[1,16,17,19,20,21,22];break;case 11:u=[11,18];break;case 8:u=[8,9];break;case 117:u=
[1,17,19,20,21,22];break;default:u.push(q)}setting.visibleFinal=d;setting.orderByFrequency=f;setting.inStockOnlyShip=g;setting.visibleEquippedShip=h;setting.favoriteOnlyShip=m;saveSetting();g?($("#disp_equipped_ship").closest("div").removeClass("d-none"),$("#disp_slot_ex_ship").closest("div").removeClass("d-none")):($("#disp_equipped_ship").closest("div").addClass("d-none"),$("#disp_slot_ex_ship").closest("div").addClass("d-none"));q=SHIP_DATA.filter(function(C){return e?C.id==e||C.name.includes(e):
u.includes(C.type)&&(d?0<C.final:!0)});if(m){var t=setting.favoriteShip;q=q.filter(function(C){return t.includes(C.id)})}if(g){m={};for(var x=$jscomp.makeIterator(p),v=x.next();!v.done;m={$jscomp$loop$prop$stock$304:m.$jscomp$loop$prop$stock$304,$jscomp$loop$prop$baseLv$305:m.$jscomp$loop$prop$baseLv$305,$jscomp$loop$prop$baseArea$306:m.$jscomp$loop$prop$baseArea$306},v=x.next())if(m.$jscomp$loop$prop$stock$304=v.value,v=n?m.$jscomp$loop$prop$stock$304.details.filter(function(C){return 1===C.ex||
-1===C.ex}):m.$jscomp$loop$prop$stock$304.details,0>=v.length)q=q.filter(function(C){return function(F){return F.id!==C.$jscomp$loop$prop$stock$304.id}}(m));else{v.sort(function(C,F){return C.lv-F.lv});var r=q.findIndex(function(C){return function(F){return F.id===C.$jscomp$loop$prop$stock$304.id}}(m));if(!(0>r)){var w=q[r];m.$jscomp$loop$prop$baseLv$305=v[0].lv;var A=v[0].st[4];m.$jscomp$loop$prop$baseArea$306=v[0].area<=MAX_AREA&&0<v[0].area?v[0].area:-1;w.lv=m.$jscomp$loop$prop$baseLv$305;w.area=
m.$jscomp$loop$prop$baseArea$306;w.upLuck=A;w.stock=v.filter(function(C){return function(F){return F.lv===C.$jscomp$loop$prop$baseLv$305&&(F.area===C.$jscomp$loop$prop$baseArea$306||1>C.$jscomp$loop$prop$baseArea$306&&1>F.area)}}(m)).length;w.ex=v[0].ex;A=[{lv:m.$jscomp$loop$prop$baseLv$305,area:m.$jscomp$loop$prop$baseArea$306}];if(2<=v.length)for(var D={},y=1;y<v.length;D={$jscomp$loop$prop$lv$310:D.$jscomp$loop$prop$lv$310,$jscomp$loop$prop$area$311:D.$jscomp$loop$prop$area$311},y++){D.$jscomp$loop$prop$lv$310=
v[y].lv;var z=v[y].st[4];D.$jscomp$loop$prop$area$311=v[y].area<=MAX_AREA&&0<v[y].area?v[y].area:-1;if(!A.find(function(C){return function(F){return F.lv===C.$jscomp$loop$prop$lv$310&&F.area===C.$jscomp$loop$prop$area$311}}(D))){var B=Object.assign({},w);B.lv=D.$jscomp$loop$prop$lv$310;B.area=D.$jscomp$loop$prop$area$311;B.stock=v.filter(function(C){return function(F){return F.lv===C.$jscomp$loop$prop$lv$310&&(F.area===C.$jscomp$loop$prop$area$311||1>C.$jscomp$loop$prop$area$311&&1>F.area)}}(D)).length;
B.upLuck=z;B.ex=v[y].ex;q.splice(r,0,B);A.push({lv:D.$jscomp$loop$prop$lv$310,area:D.$jscomp$loop$prop$area$311})}}}}}if(f&&setting.selectedHistory[1]){var E=setting.selectedHistory[1];q.sort(function(C,F){return E.filter(function(G){return G===F.id}).length-E.filter(function(G){return G===C.id}).length})}q.sort(function(C,F){return 7===C.type&&7!==F.type||7===F.type&&7!==C.type?F.type-C.type:6===C.type&&6!==F.type||6===F.type&&6!==C.type?F.type-C.type:10===C.type&&10!==F.type||10===F.type&&10!==
C.type?F.type-C.type:C.type-F.type});n=document.createDocumentFragment();x=r=0;m={};q=$jscomp.makeIterator(q);for(v=q.next();!v.done;m={$jscomp$loop$prop$ship$315:m.$jscomp$loop$prop$ship$315},v=q.next())if(m.$jscomp$loop$prop$ship$315=v.value,!l||OK_DAIHATSU_TYPE.includes(m.$jscomp$loop$prop$ship$315.type)||OK_DAIHATSU_SHIP.includes(m.$jscomp$loop$prop$ship$315.api))if(!k||OK_NAIKATEI_TYPE.includes(m.$jscomp$loop$prop$ship$315.type)||OK_NAIKATEI_SHIP.includes(m.$jscomp$loop$prop$ship$315.api)){w=
1;if(g&&p){if(!m.$jscomp$loop$prop$ship$315.lv)continue;m.$jscomp$loop$prop$ship$315.stock&&(w=m.$jscomp$loop$prop$ship$315.stock);v=usedShip.filter(function(C){return function(F){return F.id===C.$jscomp$loop$prop$ship$315.id&&F.lv===C.$jscomp$loop$prop$ship$315.lv&&F.area===C.$jscomp$loop$prop$ship$315.area}}(m)).length;w-=v;if(0>=w&&!h)continue}v=document.createElement("div");v.className=g&&h&&!w?"ship_tr ship_tr_disabled d-flex "+("multi"===c?"tr_multi":""):"ship_tr general_tr d-flex "+("multi"===
c?"tr_multi":"");v.dataset.shipid=m.$jscomp$loop$prop$ship$315.id;v.dataset.level=m.$jscomp$loop$prop$ship$315.lv?m.$jscomp$loop$prop$ship$315.lv:99;v.dataset.area=0<m.$jscomp$loop$prop$ship$315.area?m.$jscomp$loop$prop$ship$315.area:0;v.dataset.luck=m.$jscomp$loop$prop$ship$315.luck+m.$jscomp$loop$prop$ship$315.upLuck;v.id="ship_tr_"+m.$jscomp$loop$prop$ship$315.id;A=document.createElement("div");A.className="ml-1 align-self-center pt-1";D=document.createElement("img");D.width=120;D.height=30;D.src=
"../img/ship/"+m.$jscomp$loop$prop$ship$315.id+".png";A.appendChild(D);g&&0<m.$jscomp$loop$prop$ship$315.area&&(A.classList.add("exist_area"),D=document.createElement("img"),D.className="area_banner",D.src="../img/util/area"+m.$jscomp$loop$prop$ship$315.area+".png",A.appendChild(D));D=document.createElement("div");D.className="ml-1 align-self-center";y=document.createElement("div");y.className="text-primary font_size_11";y.textContent=g?"Lv : "+m.$jscomp$loop$prop$ship$315.lv:"ID : "+m.$jscomp$loop$prop$ship$315.id;
z=document.createElement("div");z.className="d-flex";z.textContent=m.$jscomp$loop$prop$ship$315.name;B=document.createElement("div");B.className="ml-1 ship_td_stock align-self-center "+(g?"":"d-none");B.textContent="\u00d7"+w;z.appendChild(B);D.appendChild(y);D.appendChild(z);v.appendChild(A);v.appendChild(D);if("multi"!==c)for(w=0;5>w;w++)A=document.createElement("div"),A.className="ship_td_slot font_size_12 align-self-center "+(0===w?"ml-auto":""),A.textContent=w<m.$jscomp$loop$prop$ship$315.slot.length?
m.$jscomp$loop$prop$ship$315.slot[w]:"",v.appendChild(A);r!==m.$jscomp$loop$prop$ship$315.type&&(r=document.createElement("div"),r.className="type_divider mt-4",w=document.createElement("div"),w.className="align-self-center font_size_16",w.textContent=API_SHIP_TYPE.find(function(C){return function(F){return F.id===C.$jscomp$loop$prop$ship$315.type}}(m)).name,A=document.createElement("div"),A.className="flex-grow-1 border-bottom align-self-center mx-2",r.appendChild(w),r.appendChild(A),n.appendChild(r));
f||x===m.$jscomp$loop$prop$ship$315.type2||(x=document.createElement("div"),x.className="type_divider mt-2 ml-1",r=document.createElement("div"),r.className="font_size_12 font_color_half align-self-center",w=API_CTYPE.find(function(C){return function(F){return F.id===C.$jscomp$loop$prop$ship$315.type2}}(m))||{name:""},r.textContent=w.name,x.appendChild(r),n.appendChild(x));r=m.$jscomp$loop$prop$ship$315.type;x=m.$jscomp$loop$prop$ship$315.type2;n.appendChild(v)}"multi"===c?(a.classList.add("modal-xl"),
...
(toggleDefenseMode(!0),$(".ohuda_select").each(function(f,g){$(g).val(0)}),$target=$("#air_raid_enemies"));c=e.t;isDefMode&&[CELL_TYPE.highAirRaid,CELL_TYPE.superHighAirRaid].includes(e.t)?c=e.t:isDefMode&&(c=CELL_TYPE.airRaid);$target.find(".cell_type").val(c);cell_type_Changed($target.find(".cell_type"),!1);$target.find(".formation").val(e.f);$target.find(".enemy_content").each(function(f,g){f<e.e.length?setEnemyDiv($(g),e.e[f]):clearEnemyDiv($(g))});$target.find(".enemy_range").text(e.r);$target[0].dataset.celldata=
a+"_"+e.n+(e.d?"("+e.d+")":"")}function modal_main_preset_Shown(){if(!$("#select_preset_category").html()){$("#select_preset_category").html('<option value="1">\u6d77\u57df\u30c7\u30fc\u30bf\u8aad\u8fbc\u4e2d</option>');for(var a='<option value="0">\u6307\u5b9a\u306a\u3057</option>',b=$jscomp.makeIterator(setting.presetFolders),c=b.next();!c.done;c=b.next())c=c.value,a+='<option value="'+c.id+'">'+c.name+"</option>";$("#preset_folder").html(a);loadMapData()}}
...
function expandMainPreset(a,b,c,d){b=void 0===b?!0:b;c=void 0===c?!0:c;d=void 0===d?!0:d;if(a)try{var e=a[0],f=!1;$(".lb_plane").each(function(y,z){if(e&&0!==e.length){var B=e[0].find(function(E){return E[4]===y});B&&0!==B.length?(B={id:B[0],prof:B[1],remodel:B[2],slot:B[3]},setLBPlaneDiv($(z),B),f=!0):b&&setLBPlaneDiv($(z))}});$(".ohuda_select").each(function(y,z){$(z).find("option").prop("disabled",!1);f&&e&&2<=e.length?(y=castInt(e[1][y],-1),$(z).val(1===y?2:y)):b&&$(z).val(-1)});if(e&&3<=e.length)for(var g=
0;2>=g;g++)document.getElementById("lb"+(g+1)+"_target_1").value=e[2][2*g],document.getElementById("lb"+(g+1)+"_target_2").value=e[2][2*g+1];5<=a.length?toggleDefenseMode(a[4]):toggleDefenseMode(!1);if(c){var h=6;a[1].length&&a[1][0]&&6<=a[1][0].length&&(h=2===a[1][0][5]?7:6,document.getElementById("union_fleet").checked=1===a[1][0][5],document.getElementById("yugeki_fleet").checked=2===a[1][0][5]);clearShipDivAll(h);var l=0,k=0;$(".ship_tab:not(.d-none)").each(function(y,z){var B=a[1].find(function(C){return C[2]===
y});if(B){z=$(z);setShipDiv(z,B[0],99,8<=B.length&&B[7]?B[7]:0);z.find(".ship_plane").each(function(C,F){F=$(F);var G=B[1].find(function(J){return J[4]===C});!G&&F.hasClass("expanded_slot")&&(G=B[1].find(function(J){return-1===J[4]}));G&&!F.hasClass("d-none")&&(setPlaneDiv(F,{id:G[0],prof:G[1],remodel:G[2],slot:G[3]},!0),6<=G.length&&G[5]&&plane_unlock_Clicked(F.find(".plane_unlock")))});if(4<=B.length){var E=z.find(".ship_disabled");B[3]?(E.addClass("disabled"),E.children().addClass("fa-eye-slash").removeClass("fa-eye no_capture"),
z.addClass("opacity4")):(E.removeClass("disabled"),E.children().removeClass("fa-eye-slash").addClass("fa-eye no_capture"),z.removeClass("opacity4"))}5<=B.length&&(B[4]?z.find(".ship_level").text(B[4]):z.find(".ship_level").text(99));7<=B.length&&0<B[6]&&z.find(".ship_luck").text(B[6]);y<h?l+=1:k+=1}});display_ship_count_Changed($("#friendFleet_item1"),Math.max(l,1),!0);display_ship_count_Changed($("#friendFleet_item2"),Math.max(k,1),!0)}document.getElementById("fleet_formation").value=1;if(4<=a.length&&
a[3]){document.getElementById("adapt_stage2").checked=!0;try{c=1;selectedFormations=[];for(var n=$jscomp.makeIterator(a[3]),m=n.next();!m.done;m=n.next()){var p=castInt(m.value);if(0>=p){document.getElementById("adapt_stage2").checked=!1;selectedFormations=[];c=1;break}else selectedFormations.push(p),c=p}document.getElementById("fleet_formation").value=c}catch(y){var q=castInt(a[3]);if(q){selectedFormations=[];for(n=0;10>n;n++)selectedFormations.push(q);document.getElementById("adapt_stage2").checked=
!0;document.getElementById("fleet_formation").value=q}}}else document.getElementById("adapt_stage2").checked=!1,selectedFormations=[];q=1;for(n=0;n<a[2].length;n++)q<a[2][n][0]+1&&(q=a[2][n][0]+1);q=Math.min(q,10);if(0!==a[2].length||d)clearEnemyDivAll(q),$("#battle_count").val(q);var u=isDefMode&&6>a.length;$(u?"#air_raid_enemies":".battle_content").each(function(y,z){var B=a[2].find(function(G){return G[0]===y});if(B){3<=B.length?$(z)[0].dataset.celldata=B[2]:$(z)[0].dataset.celldata="";if(4<=B.length){var E=
castInt(B[3]);u?$(z).find(".cell_type").val([0,5].includes(E)?5:3):$(z).find(".cell_type").val(E);cell_type_Changed($(z).find(".cell_type"),!1)}else $(z).find(".cell_type").val(1);5<=B.length?$(z).find(".formation").val(B[4]):$(z).find(".formation").val(1);6<=B.length?$(z).find(".enemy_range").text(B[5]):$(z).find(".enemy_range").text(0);E=0;B=$jscomp.makeIterator(B[1]);for(var C=B.next();!C.done;C=B.next()){C=C.value;var F=$(z).find(".enemy_content").eq(E++);0<C?setEnemyDiv(F,C):0>C?setEnemyDiv(F,
-1,-C):clearEnemyDiv(F);F.addClass("d-flex").removeClass("d-none")}}});if(6<=a.length){var t=a[5];if(t&&3===t.length){var x=$("#air_raid_enemies"),v=castInt(t[1]);x.find(".cell_type").val([0,5].includes(v)?5:7===v?7:3);cell_type_Changed(x.find(".cell_type"),!1);x.find(".formation").val(t[2]);d=0;for(var r=$jscomp.makeIterator(t[0]),w=r.next();!w.done;w=r.next()){var A=w.value,D=x.find(".enemy_content").eq(d++);0<A?setEnemyDiv(D,A):0>A?setEnemyDiv(D,-1,-A):clearEnemyDiv(D);D.addClass("d-flex").removeClass("d-none")}}}7<=
a.length?$("#admin_lv").val(a[6]):$("#admin_lv").val(120)}catch(y){$(".ohuda_select").val(-1),$(".lb_plane").each(function(z,B){setLBPlaneDiv($(B))}),clearShipDivAll(6),clearEnemyDivAll(1),$("#battle_count").val(1),sendErrorLog(y)}}
...
m=e[g],p=getAirStatusBorder(n);f.$jscomp$loop$prop$status$332=m.indexOf(getArrayMax(m));var q=0,u=!1;4===f.$jscomp$loop$prop$status$332?q=f.$jscomp$loop$prop$ap$330/p[3]*10:3===f.$jscomp$loop$prop$status$332?q=f.$jscomp$loop$prop$ap$330/p[2]*20:2===f.$jscomp$loop$prop$status$332?q=f.$jscomp$loop$prop$ap$330/p[1]*45:1>=f.$jscomp$loop$prop$status$332&&(q=f.$jscomp$loop$prop$ap$330/p[0]*90);if(5===f.$jscomp$loop$prop$status$332&&7!==h)f.$jscomp$loop$prop$status$332=0,q=100;else if(5===f.$jscomp$loop$prop$status$332){f.$jscomp$loop$prop$abbr$329=
$("#shoot_down_table").find(".cond.battle"+(displayBattle+1)).text();var t=AIR_STATUS.find(function(v){return function(r){return r.abbr===v.$jscomp$loop$prop$abbr$329}}(f));t&&(f.$jscomp$loop$prop$status$332=t.id);0===f.$jscomp$loop$prop$status$332&&(q=100)}q=Math.min(100,q);var x=l.data("airstatus");t="bar_status"+f.$jscomp$loop$prop$status$332;l.removeClass("bar_status"+x).addClass(t).css({width:q+"%"}).data("airstatus",f.$jscomp$loop$prop$status$332);k.find(".rate_td_ap").text(f.$jscomp$loop$prop$ap$330);
x=k.find(".rate_td_eap");x.find(".avg_eap").text(n);x.find(".eap_border").html("( "+p.slice(0,4).map(function(v){return function(r){return r<=v.$jscomp$loop$prop$ap$330?"<b>"+r+"</b>":r.toString()}}(f)).join(" / ")+" )");x=100;for(n=0;n<m.length;n++)k.find(".rate_td_status"+n).text("-"),0<m[n]&&(u=Math.floor(1E3*m[n])/10,p=0,n+1<m.length&&0<m[n+1]?(p=u,x-=u):p=x.toFixed(1),k.find(".rate_td_status"+n).text(p+" %"),u=!0);if(u||isDefMode&&8===h)k.removeClass("d-none disabled_tr"),l.closest(".progress_area").addClass("d-flex").removeClass("d-none disabled_bar");
l="bar_ex_status"+f.$jscomp$loop$prop$status$332;isDefMode&&(k=$("#simple_lb_def_bar"),n=k.find(".result_bar"),x=n.data("airstatus"),n.removeClass("bar_status"+x+" bar_ex_status"+x).addClass(t+" "+l).css({width:q+"%"}).data("airstatus",f.$jscomp$loop$prop$status$332),x=AIR_STATUS.find(function(v){return function(r){return r.id===v.$jscomp$loop$prop$status$332}}(f)).abbr+("("+Math.floor(1E3*m[f.$jscomp$loop$prop$status$332])/10+"%)"),m.filter(function(v){return 0<v}).length&&(x=m.map(function(v,r){return r<
AIR_STATUS.length&&0<v?AIR_STATUS[r].abbr+("("+Math.floor(1E3*v)/10+"%)"):""}).filter(function(v){return!!v}).join(" / ")),k.find(".simple_label").text(x),k.removeClass("d-none"));7===h&&u&&-1<f.$jscomp$loop$prop$status$332&&(h=$("#fleet_simple_bar"),u=h.find(".result_bar"),x=u.data("airstatus"),u.removeClass("bar_status"+x+" bar_ex_status"+x).addClass(t+" "+l).css({width:q+"%"}).data("airstatus",f.$jscomp$loop$prop$status$332),m=AIR_STATUS.find(function(v){return function(r){return r.id===v.$jscomp$loop$prop$status$332}}(f)).abbr+
"("+Math.floor(100*m[f.$jscomp$loop$prop$status$332])+"%)",h.find(".simple_label").text(m),h.removeClass("d-none"));if(isDefMode)break}for(e=d=c=b=0;e<resultData.fleetSlots.length;e++)if(f=resultData.fleetSlots[e],g=100*f.deathRate,m=document.getElementById("s"+f.shipNo+"sl"+f.slot))q=castInt(m.getElementsByClassName("battle1")[0].textContent),m.getElementsByClassName("battle_end")[0].textContent=Math.round(f.avg),m.getElementsByClassName("battle_death")[0].textContent=0===f.deathRate?"-":10<=g?g.toFixed(1)+
" %":Math.ceil(10*g)/10+" %",0<q&&(b+=5*(q-f.avg),c+=5*(q-f.max),d+=5*(q-f.min));resultData.usedSteels?(c=resultData.usedSteels/a,$(".battle_end.fap").html()||$(".battle_end.fap").html("\u6d88\u8cbb\u4e88\u6e2c"),$(".battle_end.eap").html('\n\t\t<div><img src="../img/util/bauxite.png" class="img-size-18" alt="\u30dc\u30fc\u30ad\u30b5\u30a4\u30c8">: '+b.toFixed(1)+'</div>\n\t\t<div><img src="../img/util/steel.png" class="img-size-18" alt="\u92fc\u6750">: '+c.toFixed(1)+"</div>\n\t\t")):($(".battle_end.fap").html()||
$(".battle_end.fap").html('<img src="../img/util/bauxite.png" class="img-size-18" alt="\u30dc\u30fc\u30ad\u30b5\u30a4\u30c8">\u6d88\u8cbb\u4e88\u6e2c'),$(".battle_end.eap").html(c+" ~ "+d+" ( "+b.toFixed(1)+" )"));for(b=0;b<resultData.enemySlots.length;b++)c=resultData.enemySlots[b],d=document.getElementsByClassName("enemy_no_"+c[0]+" slot_"+c[1])[0],e=Math.floor(c[2]/a*10),d.getElementsByClassName("td_avg_slot")[0].textContent=0===e?"0":e/10,d.getElementsByClassName("td_max_slot")[0].textContent=
c[3],d.getElementsByClassName("td_min_slot")[0].textContent=c[4];if(!isDefMode&&document.getElementById("adapt_stage2").checked){for(b=0;b<resultData.enemySlotAllDead.length;b++)c=Math.round(resultData.enemySlotAllDead[b]/a*1E3)/10,document.getElementsByClassName("enemy_no_"+b+" slot_0")[0].getElementsByClassName("td_all_dead")[0].textContent=Math.floor(c)+"%";document.getElementById("enemy_slot_result_mode").textContent="\uff08\u822a\u7a7a\u6226 stage2 \u5f8c\uff09"}else document.getElementById("enemy_slot_result_mode").textContent=
"\uff08\u822a\u7a7a\u6226 stage1 \u5f8c\uff09";c=resultData.enemyAirPowerResults[0];b=resultData.enemyAirPowerResults[1];if(c.length)for(c=getEnemyApDistribution(c),d=document.getElementById("enemy_ap_bf_dist_min"),e=$jscomp.makeIterator(c),c=e.next();!c.done;c=e.next())d.textContent=c.value,d=d.nextElementSibling;if(b.length)for(c=getEnemyApDistribution(b),b=document.getElementById("enemy_ap_af_dist_min"),d=$jscomp.makeIterator(c),c=d.next();!c.done;c=d.next())b.textContent=c.value,b=b.nextElementSibling;
b=$jscomp.makeIterator(inputItems.landBase.landBases);for(c=b.next();!c.done;c=b.next())if(c=c.value,e=c.target[0],f=c.target[1],-1!==e&&-1!==f&&!isDefMode)for(d=e<=f?[e,f]:[f,e],e=e<=f?[0,1]:[1,0],f={},g=0;1>=g;f={$jscomp$loop$prop$status$189$334:f.$jscomp$loop$prop$status$189$334},g++)m=c.results[d[g]].airStatusIndex[e[g]],t=c.results[d[g]].mainAirPower[e[g]]/a,h=c.results[d[g]].enemyAirPower[e[g]]/a,f.$jscomp$loop$prop$status$189$334=m.indexOf(getArrayMax(m)),q=0,h=getAirStatusBorder(h),4===f.$jscomp$loop$prop$status$189$334?
q=t/h[3]*10:3===f.$jscomp$loop$prop$status$189$334?q=t/h[2]*20:2===f.$jscomp$loop$prop$status$189$334?q=t/h[1]*45:1>=f.$jscomp$loop$prop$status$189$334&&(q=t/h[0]*90),5===f.$jscomp$loop$prop$status$189$334&&(f.$jscomp$loop$prop$status$189$334=0,q=100),h="bar_status"+f.$jscomp$loop$prop$status$189$334,u="bar_ex_status"+f.$jscomp$loop$prop$status$189$334,t=$("#simple_lb_bar_"+c.baseNo+"_"+(g+1)),l=t.find(".result_bar"),k=l.data("airstatus"),l.removeClass("bar_status"+k+" bar_ex_status"+k).addClass(h+
" "+u).css({width:(100<q?100:q)+"%"}).data("airstatus",f.$jscomp$loop$prop$status$189$334),q=AIR_STATUS.find(function(v){return function(r){return r.id===v.$jscomp$loop$prop$status$189$334}}(f)).abbr,m=Math.floor(getArrayMax(m)/a*100),m=q+"("+m+"%)"+(100===m?"":10<=m?'<span class="opacity0">1</span>':'<span class="opacity0">11</span>'),t.find(".simple_label").html(m),t.removeClass("d-none");display_result_Changed();resultData.enemyAirPowerResults=null;resultData.fleetSlots=null}
...
f=p[f].dataset.celldata,e.hasJet&&"64_N"===f&&(g=2),g=g>m),!g&&0<=n&&p.length>=n&&(f=castInt(p[n].getElementsByClassName("enemy_range")[0].textContent),p=p[n].dataset.celldata,e.hasJet&&"64_N"===p&&(f=2),g=f>m),g&&b.push(e.baseNo));2===e.mode&&0<e.planes.length&&c.push(e.planes[0])}needAirRaidAlert=!1;if(a.landBases.some(function(q){return-1!==q.mode})||isDefMode){if(isDefMode&&(d=document.getElementById("def_sum_ap_all"),e=document.getElementById("def_sum_ex_ap_all"),p=document.getElementById("def_sum_ex2_ap_all"),
m=document.getElementById("rocket_c"),n=document.getElementById("rocket_c_sum"),a.updateDefenseAirPower(),f=a.defenseAirPower,g=a.defense2AirPower,h=a.defense3AirPower,drawChangeValue(d,castInt(d.textContent),f),drawChangeValue(e,castInt(e.textContent),g),drawChangeValue(p,castInt(p.textContent),h),m.textContent=a.rocketBonus.toString(),n.textContent=Math.floor(1E3*a.sumSuperCorr)/1E3,$("#super_defense_container").tooltip("dispose"),document.getElementById("super_defense_container").title='\n\t\t\t<div class="py-2 px-2">\n\t\t\t\t<div class="mb-2 text-left">\u88dc\u6b63 = (A + B + C) &times; D1 + D2</div>\n\t\t\t\t<div class="container text-left">\n\t\t\t\t\t<div class="row">\n\t\t\t\t\t\t<div class="col">\u88dc\u6b63A</div>\n\t\t\t\t\t\t<div class="col text-right" id="superCorrA">'+
a.superDefenseCorrA+'</div>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class="row">\n\t\t\t\t\t\t<div class="col">\u88dc\u6b63B</div>\n\t\t\t\t\t\t<div class="col text-right" id="superCorrB">'+a.superDefenseCorrB+'</div>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class="row">\n\t\t\t\t\t\t<div class="col">\u88dc\u6b63C</div>\n\t\t\t\t\t\t<div class="col text-right" id="superCorrC">'+a.superDefenseCorrC+'</div>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class="row">\n\t\t\t\t\t\t<div class="col">\u88dc\u6b63D1</div>\n\t\t\t\t\t\t<div class="col text-right" id="superCorrD1">'+
a.superRocketCorr1+'</div>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class="row">\n\t\t\t\t\t\t<div class="col">\u88dc\u6b63D2</div>\n\t\t\t\t\t\t<div class="col text-right" id="superCorrD2">'+a.superRocketCorr2+"</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t</div>",$("#super_defense_container").tooltip()),document.getElementsByClassName("ng_range")[0].textContent=b.join(", "),document.getElementsByClassName("ng_range")[1].textContent=b.join(", "),b.length?(document.getElementsByClassName("lb_range_warning")[0].classList.remove("d-none"),
...
function updateFleetView(){var a=inputItems.fleet,b=document.getElementById("shoot_down_table"),c=document.getElementById("shoot_down_table_tbody"),d=-1;b.getElementsByTagName("tbody")[0].innerHTML="";b=$jscomp.makeIterator(b.getElementsByTagName("tfoot")[0].getElementsByClassName("td_battle"));for(var e=b.next();!e.done;e=b.next())e.value.innerHTML="";$("#fleet_formation").find("option").each(function(z,B){z=castInt($(B).val());a.isUnion&&10<z?$(B).removeClass("d-none"):!a.isUnion&&10<z&&$(B).addClass("d-none")});
$("#fleet_antiair_formation").find("option").each(function(z,B){z=castInt($(B).val());a.isUnion&&10<z?$(B).removeClass("d-none"):!a.isUnion&&10<z&&$(B).addClass("d-none")});setting.visibleAntiAirStatus?($(".anti_air_status").removeClass("d-none"),$(".anti_air_status").addClass("d-flex")):($(".anti_air_status").addClass("d-none"),$(".anti_air_status").removeClass("d-flex"));b=document.getElementsByClassName("fleet_ap")[0];e=document.getElementsByClassName("fleet_ap")[1];for(var f=document.getElementsByClassName("contact_start_rate")[0],
...
q=m.getElementsByClassName("ap_detail")[0],u=m.getElementsByClassName("ship_range")[0],t=m.getElementsByClassName("can_attack_lb")[0],x=m.getElementsByClassName("rate_down")[0],v=m.getElementsByClassName("fix_down")[0],r=m.getElementsByClassName("hunshin")[0],w=m.getElementsByClassName("hunshin_rate")[0],A=m.getElementsByClassName("has_warning")[0];m=0;for(var D=$jscomp.makeIterator(k.$jscomp$loop$prop$ship$339.items),y=D.next();!y.done;y=D.next())y=y.value,y.isPlane&&0<y.slot&&(m+=1);drawChangeValue(p,
castInt(p.textContent),k.$jscomp$loop$prop$ship$339.airPower);if(k.$jscomp$loop$prop$ship$339.items.length&&k.$jscomp$loop$prop$ship$339.airPower){p=[];D=$jscomp.makeIterator(k.$jscomp$loop$prop$ship$339.items);for(y=D.next();!y.done;y=D.next())y=y.value,y.isExpanded||p.push(y.airPower);q.classList.remove("d-none");q.textContent="( "+p.join(" / ")+" )"}else q.classList.add("d-none"),q.textContent="";x.textContent=Math.floor(1E3*k.$jscomp$loop$prop$ship$339.rateDown)/10;v.textContent=k.$jscomp$loop$prop$ship$339.fixDown;
0<k.$jscomp$loop$prop$ship$339.hunshinRate?(w.textContent=(100*k.$jscomp$loop$prop$ship$339.hunshinRate).toFixed(1),r.classList.remove("d-none")):r.classList.add("d-none");k.$jscomp$loop$prop$ship$339.warningText?(A.classList.remove("d-none"),A.dataset.originalTitle=k.$jscomp$loop$prop$ship$339.warningText):A.classList.add("d-none");k.$jscomp$loop$prop$rawShip$340=k.$jscomp$loop$prop$ship$339.id?SHIP_DATA.find(function(z){return function(B){return B.id===z.$jscomp$loop$prop$ship$339.id}}(k)):null;
q=RANGES.find(function(z){return function(B){return B.id===Math.max(z.$jscomp$loop$prop$ship$339.range,z.$jscomp$loop$prop$rawShip$340?z.$jscomp$loop$prop$rawShip$340.range:0)}}(k));u.textContent=q?q.name:"\u77ed";t&&(k.$jscomp$loop$prop$rawShip$340&&[7,11,18].includes(k.$jscomp$loop$prop$rawShip$340.type)&&!k.$jscomp$loop$prop$ship$339.items.some(function(z){return TAICHI.includes(z.id)&&0<z.slot})&&k.$jscomp$loop$prop$ship$339.items.some(function(z){return[7,57].includes(z.type)&&0<z.slot})?t.classList.remove("d-none"):
t.classList.add("d-none"));if(0<m){u=document.createDocumentFragment();r=!0;t=document.getElementById("empty_slot_invisible").checked;k.$jscomp$loop$prop$rawShip$340&&!t&&(m=k.$jscomp$loop$prop$rawShip$340.slot.length);q=document.createElement("tr");for(x=0;x<k.$jscomp$loop$prop$ship$339.items.length;x++)if(w=k.$jscomp$loop$prop$ship$339.items[x],v=w.name,k.$jscomp$loop$prop$rawShip$340||w.isPlane&&0!==w.slot){if(k.$jscomp$loop$prop$rawShip$340&&x===k.$jscomp$loop$prop$rawShip$340.slot.length)break;
if(!k.$jscomp$loop$prop$rawShip$340||!t||w.isPlane&&0!==w.slot){w=getItemCss(w.itype).replace("css","shoot_table");if(r){r=document.createElement("tr");r.id="s"+k.$jscomp$loop$prop$ship$339.shipNo+"sl"+x;r.dataset.shipid=k.$jscomp$loop$prop$rawShip$340?k.$jscomp$loop$prop$rawShip$340.id:0;r.dataset.si=d;r.dataset.slot=x;r.dataset.css=w+"_hover";A=document.createElement("td");A.rowSpan=m;A.className="td_name align-middle";A.textContent=k.$jscomp$loop$prop$rawShip$340?k.$jscomp$loop$prop$rawShip$340.name:
"\u672a\u6307\u5b9a";r.appendChild(A);A=document.createElement("td");A.className="pl-1 td_plane_name align-middle "+w;A.textContent=v;r.appendChild(A);q.appendChild(A.cloneNode(!1));for(v=1;10>=v;v++)w=document.createElement("td"),w.className="td_battle battle"+v+" align-middle",r.appendChild(w),q.appendChild(w.cloneNode(!1));v=document.createElement("td");v.className="td_battle battle_end align-middle";r.appendChild(v);q.appendChild(v.cloneNode(!1));v=document.createElement("td");v.className="td_battle battle_death align-middle";
r.appendChild(v);q.appendChild(v.cloneNode(!1));u.appendChild(r)}else r=q.cloneNode(!0),r.id="s"+k.$jscomp$loop$prop$ship$339.shipNo+"sl"+x,r.dataset.shipid=k.$jscomp$loop$prop$rawShip$340?k.$jscomp$loop$prop$rawShip$340.id:0,r.dataset.si=d,r.dataset.slot=x,r.dataset.css=w+"_hover",A=r.getElementsByClassName("td_plane_name")[0],A.className="pl-1 td_plane_name align-middle "+w,A.textContent=v,u.appendChild(r);r=!1}}c.appendChild(u)}}d=[];k=$jscomp.makeIterator(a.ships);for(m=k.next();!m.done;m=k.next())d=
...
function updateEnemyView(){var a=inputItems.battleInfo,b=0,c=0,d=!1,e=!1,f="",g=[],h=[];document.getElementById("enemy_shoot_down_table").getElementsByTagName("tbody")[0].innerHTML="";for(var l=isDefMode?0:displayBattle,k={},n=0;n<a.battles.length;k={$jscomp$loop$prop$battle$346:k.$jscomp$loop$prop$battle$346},n++){k.$jscomp$loop$prop$battle$346=a.battles[n];for(var m=b=0,p={},q=$jscomp.makeIterator(k.$jscomp$loop$prop$battle$346.enemies),u=q.next();!u.done;p={$jscomp$loop$prop$enemy$342:p.$jscomp$loop$prop$enemy$342},
u=q.next())if(p.$jscomp$loop$prop$enemy$342=u.value,b+=p.$jscomp$loop$prop$enemy$342.antiAirBonus,!d&&k.$jscomp$loop$prop$battle$346.hasAntiAirCI&&(d=!0),!e&&k.$jscomp$loop$prop$battle$346.containUnknown&&(e=!0),n===l&&!p.$jscomp$loop$prop$enemy$342.onlyScout&&p.$jscomp$loop$prop$enemy$342.slots.length){for(var t=u="",x=!0,v=-1,r={$jscomp$loop$prop$j$344:0};r.$jscomp$loop$prop$j$344<p.$jscomp$loop$prop$enemy$342.equipments.length;r={$jscomp$loop$prop$j$344:r.$jscomp$loop$prop$j$344},r.$jscomp$loop$prop$j$344++){var w=
ENEMY_ITEM.find(function(C,F){return function(G){return G.id===C.$jscomp$loop$prop$enemy$342.equipments[F.$jscomp$loop$prop$j$344].id}}(p,r));if(w&&PLANE_TYPE.includes(w.type)){v+=1;var A=p.$jscomp$loop$prop$enemy$342.slots[v],D=getItemCss(w.itype).replace("css","shoot_table"),y=v===p.$jscomp$loop$prop$enemy$342.slots.length-1?" last_slot":"",z="",B="",E="";u+='<img src="../img/plane/'+w.id+'.png" class="img-size-36" data-planeid="'+w.id+'">';x&&(z='\n\t\t\t\t\t<td class="td_name align-middle last_slot" rowspan="'+
p.$jscomp$loop$prop$enemy$342.slots.length+'">\n\t\t\t\t\t\t<div>'+drawEnemyGradeColor(p.$jscomp$loop$prop$enemy$342.name)+'</div>\n\t\t\t\t\t\t<div class="d-none d-md-block">xxPxx</div>\n\t\t\t\t\t</td>',E='<td class="td_all_dead align-middle last_slot" rowspan="'+p.$jscomp$loop$prop$enemy$342.slots.length+'"></td>',B='<td class="td_detail_slot align-middle last_slot" rowspan="'+p.$jscomp$loop$prop$enemy$342.slots.length+'"><i class="fas fa-file-text"></i></td>',x=!1);t+='\n\t\t\t\t<tr class="enemy_no_'+
m+" slot_"+v+'" data-rowindex="'+m+'" data-slot="'+v+'" data-css="'+D+'_hover">\n\t\t\t\t\t'+z+'\n\t\t\t\t\t<td class="pl-1 td_plane_name align-middle '+(D+y)+'">'+w.name+'</td>\n\t\t\t\t\t<td class="td_init_slot align-middle'+y+'">'+A+'</td>\n\t\t\t\t\t<td class="td_avg_slot align-middle'+y+'">'+A+'</td>\n\t\t\t\t\t<td class="td_max_slot align-middle'+y+'">'+A+'</td>\n\t\t\t\t\t<td class="td_min_slot align-middle'+y+'">'+A+"</td>\n\t\t\t\t\t"+(isDefMode?"":E)+"\n\t\t\t\t\t"+(isDefMode?"":B)+"\n\t\t\t\t</tr>"}}h.push(t.replace("xxPxx",
u));m+=1}m=isDefMode?document.getElementById("battle_content_def_mode"):document.getElementsByClassName("battle_content")[c++];m.getElementsByClassName("enemy_sum_ap")[0].textContent=k.$jscomp$loop$prop$battle$346.getAirPower();m.getElementsByClassName("enemy_sum_lbap")[0].textContent=k.$jscomp$loop$prop$battle$346.getLandBaseAirPower();p=m.getElementsByClassName("enemy_range")[0];castInt(p.textContent)?p.parentNode.classList.remove("d-none"):p.parentNode.classList.add("d-none");p=(p=FORMATION.find(function(C){return function(F){return F.id===
C.$jscomp$loop$prop$battle$346.formation}}(k)))?p.correction:1;m.getElementsByClassName("fleet_AA")[0].textContent=2*Math.floor(p*b);b=(b=m.dataset.celldata)?b.split("_"):["",""];b.length&&(f?f!==b[0]&&(f="\u6d77\u57df\u6df7\u5728"):f=b[0],1<b.length&&g.push(b[1]))}""!==f||"\u6d77\u57df\u6df7\u5728"!==f?(a=40<f.slice(0,-1)?"E-":f.slice(0,-1)+"-",document.getElementById("route").textContent=a+f.slice(-1)+" : "+g.join(" \u2192 ")):document.getElementById("route").textContent=f;!isDefMode&&needAirRaidAlert&&
...
function shootDownEnemy(a,b,c,d){c=void 0===c?!1:c;d=void 0===d?[]:d;var e=0,f=0;f=null;var g=0;c&&(e=Math.random(),f=d.findIndex(function(u){return u.border>e}),f=0<=f?d[f].table:[],g=f.length);d=b.length;for(var h=0;h<d;h++){var l=b[h],k=l.slots.length;l.airPower=0;for(var n=l.landBaseAirPower=0,m=0;m<k;m++){var p=l.slots[m];l.slots[m]-=getShootDownSlot(a,p);if(l.attackers[m]&&c&&0<g){p=l.slots[m];var q=f[Math.floor(Math.random()*g)];.5<=Math.random()&&(p-=Math.floor(q.rateDown*p));.5<=Math.random()&&
...
function shootDownFleet(a,b,c,d,e){e=void 0===e?!0:e;var f=c.stage2[0][0].length;5===a&&(a=0);for(var g=c.enabledStage2,h=b.ships.length,l=0;l<h;l++){var k=b.ships[l];if(!k.ignoreSlot){for(var n=0,m=!c.isUnion&&k.isEscort||4===c.cellType,p=k.items.length,q=0;q<p;q++){var u=k.items[q];e&&(u.results[d]+=u.slot);if(!(m||!u.canBattle||0>=u.slot)&&f){var t=getShootDownSlotFF(a,u.slot);u.slot-=Math.floor(u.isJet?.6*t:t);if(u.isAttacker&&g){t=Math.floor(Math.random()*f);var x=c.stage2[u.avoid];.5<=Math.random()&&
(u.slot-=Math.floor(x[0][t]*u.slot));.5<=Math.random()&&(u.slot-=x[1][t])}u.canBattle&&0<u.slot?u.airPower=Math.floor(u.antiAir*Math.sqrt(u.slot)+u.bonusAirPower):(0>=u.slot&&(u.slot=0),u.airPower=0)}n+=u.airPower}k.airPower=n}}b.updateAirPower()}
function shootDownLandBase(a,b,c,d){d=void 0===d?!1:d;var e=c.stage2[0][0].length;if(e){5===a&&(a=0);for(var f=0,g=b.planes.length,h=0;h<g;h++){var l=b.planes[h];if(!(0>=l.slot)){var k=getShootDownSlotFF(a,l.slot);l.slot-=Math.floor(l.isJet?.6*k:k);if(!d&&l.isAttacker){k=Math.floor(Math.random()*e);var n=c.stage2[l.avoid];.5<=Math.random()&&(l.slot-=Math.floor(n[0][k]*l.slot));.5<=Math.random()&&(l.slot-=n[1][k])}d?(l.updateDefenseAirPower(),f+=l.defenseAirPower):(l.updateAirPower(),f+=l.airPower)}}d?
b.defenseAirPower=Math.floor(f*b.reconCorr):b.airPower=Math.floor(f*b.reconCorr)}}
function rateCalculate(){var a=inputItems.landBase,b=inputItems.fleet,c=inputItems.battleInfo,d=castInt($("#calculate_count").val());d=0>=d?1:d;$("#calculate_count").val(d);for(var e=b.ships.length,f=c.battles,g=isDefMode?0:displayBattle,h=[0,0,0,0,0,0],l=[],k=[],n=[],m=[],p=[[],[]],q=isDefMode?1:battleCount,u=0,t=CELL_TYPE.aerialCombat,x=[],v=$jscomp.makeIterator(f),r=v.next();!r.done;r=v.next())r=r.value,r.enemies=r.enemies.filter(function(H){return-1===H.id||0<H.slots.length});g=g<c.battles.length?
g:c.battles.length-1;for(c=0;c<q;c++)l.push(0),k.push(0);for(c=0;c<e;c++)if(v=b.ships[c],!v.ignoreSlot)for(r=0;r<v.items.length;r++)v.items[r].isPlane&&n.push(Array(d));for(c=0;c<f[g].enemies.length;c++)if(v=f[g].enemies[c],!(v.onlyScout||0>v.id)){r=0===m.length?0:m[m.length-1][0]+1;for(var w=0;w<v.slots.length;w++)m.push([r,w,0,0,999]);x.push(0)}c=a.defenseAirPower;f[0].cellType===CELL_TYPE.highAirRaid?c=a.defense2AirPower:f[0].cellType===CELL_TYPE.superHighAirRaid&&(c=a.defense3AirPower);resultData.defenseAirPower=
c;isDefMode&&(b.fullAirPower=c,b.airPower=c,b.fullUnionAirPower=c,b.unionAirPower=c);c=0;v=!1;if(isDefMode||f[0])v=f[0].cellType===CELL_TYPE.superHighAirRaid,c=f[0].getAirPower();r=!isDefMode&&document.getElementById("adapt_stage2").checked;w=[];r&&(w=castInt($("#fleet_formation").val()),b.isUnion&&f[g].cellType===CELL_TYPE.airRaid?b.updateStage2All(w,!0):b.updateStage2All(w),w=b.allStage2);for(var A=0;A<d;A++){for(var D=0;D<q;D++){var y=f[D],z=y.enemies,B=!1;B=calculateLandBase(a,y,D);v&&(a.defense3AirPower=
a.fullDefense3AirPower,calculateSuperDefense(a,y),b.unionAirPower=a.defense3AirPower,b.airPower=a.defense3AirPower,B=!0);u+=doJetPhase(b,y);var E=y.isUnion?b.unionAirPower:b.airPower,C=y.getAirPower(),F=getAirStatusIndex(E,C);D===g&&(h[F]+=1);l[D]+=E;k[D]+=C;shootDownFleet(F,b,y,D);y.cellType===t&&(shootDownEnemy(F,z,r,w),B=!0,F=getAirStatusIndex(b.airPower,y.getAirPower()),shootDownFleet(F,b,y,D,!1));if(D===g){shootDownEnemy(F,z,r,w);for(F=E=B=y=0;F<z.length;F++){var G=z[F];if(!G.onlyScout&&G.id){for(var J=
G.slots,M=G.attackers.concat(),L=0;L<J.length;L++){var K=J[L],I=m[y];y+=1;I[2]+=K;I[3]<K&&(I[3]=K);I[4]>K&&(I[4]=K);0===K&&(M[L]=!1)}0>M.indexOf(!0)&&(x[B]+=1);B+=1;E+=G.airPower}G.slots=G.fullSlots.concat();G.airPower=G.fullAirPower;G.landBaseAirPower=G.fullLandBaseAirPower}p[0].push(C);p[1].push(E);B=!1}if(B)for(z=$jscomp.makeIterator(z),C=z.next();!C.done;C=z.next())C=C.value,C.slots=C.fullSlots.concat(),C.airPower=C.fullAirPower,C.landBaseAirPower=C.fullLandBaseAirPower}for(D=0;3>D;D++){z=a.landBases[D];
for(C=0;C<z.planes.length;C++)y=z.planes[C],y.slot=y.fullSlot,y.airPower=y.fullAirPower;z.airPower=z.fullAirPower}for(z=D=0;z<e;z++)if(C=b.ships[z],!C.ignoreSlot){y=C.items.length;for(B=0;B<y;B++)E=C.items[B],E.isPlane&&(n[D++][A]=E.slot,E.slot=E.fullSlot,E.airPower=E.fullAirPower);C.airPower=C.fullAirPower}b.airPower=b.fullAirPower;b.escortAirPower=b.fullEscortAirPower;b.unionAirPower=b.fullUnionAirPower}for(t=f=0;t<e;t++)if(r=b.ships[t],!r.ignoreSlot)for(w=0;w<r.items.length;w++)r.items[w].isPlane&&
(A=n[f],D={shipNo:r.shipNo,slot:r.items[w].slotNo,max:getArrayMax(A),min:getArrayMin(A),avg:A.reduce(function(H,N){return H+N})/d,death:A.filter(function(H){return 0===H}).length,deathRate:0},D.deathRate=D.death/A.length,resultData.fleetSlots.push(D),f+=1);e=$("#shoot_down_table");for(n=0;n<q;n++)for(f=Math.round(l[n]/d),t=Math.round(k[n]/d),r=getAirStatusIndex(f,t),e.find(".fap.battle"+(n+1)).text(f),e.find(".eap.battle"+(n+1)).text(t),e.find(".cond.battle"+(n+1)).html("<span>"+AIR_STATUS[r].abbr+
"</span>").removeClass("airStatus0 airStatus1 airStatus2 airStatus3 airStatus4").addClass("airStatus"+r),f=$jscomp.makeIterator(b.ships),t=f.next();!t.done;t=f.next())if(t=t.value,!t.ignoreSlot)for(r=$jscomp.makeIterator(t.items),w=r.next();!w.done;w=r.next())w=w.value,w.isPlane&&(A=w.results[n],$("#s"+t.shipNo+"sl"+w.slotNo).find(".battle"+(n+1)).text(Math.round(A/d)));e.find("td").removeClass("d-none");for(b=battleCount+1;10>=b;b++)e.find(".battle"+b).addClass("d-none");isDefMode?v&&(resultData.defenseAirPower=
Math.round(l[0]/d)):resultData.fleetAirPower=Math.round(l[g]/d);l=[];b=$jscomp.makeIterator(a.landBases);for(q=b.next();!q.done;q=b.next())for(q=q.value,e=0;2>e;e++)l.push(q.results[displayBattle].airStatusIndex[e].map(function(H){return H/d}));a=$jscomp.makeIterator(a.landBases);for(q=a.next();!q.done;q=a.next())b=q.value,resultData.landBaseAirPowers.push(Math.round(b.results[g].mainAirPower[0]/d)),resultData.landBaseAirPowers.push(Math.round(b.results[g].mainAirPower[1]/d)),resultData.enemyAirPowers.push(Math.round(b.results[g].enemyAirPower[0]/
d)),resultData.enemyAirPowers.push(Math.round(b.results[g].enemyAirPower[1]/d));isDefMode?resultData.enemyAirPowers.push(c):resultData.enemyAirPowers.push(Math.round(k[g]/d));resultData.landBaseAirStatus=l;resultData.fleetAirStatus=h.map(function(H){return H/d});resultData.enemySlots=m;resultData.enemyAirPowerResults=p;resultData.enemySlotAllDead=x;resultData.usedSteels=u}
...
h),k.airStatusIndex[1][l]+=1,k.mainAirPower[1]+=e,k.enemyAirPower[1]+=h,shootDownEnemy(l,d),e=!0,g.isSeparate&&shootDownLandBase(l,g,b))}}return e}function calculateSuperDefense(a,b){for(var c=b.getLandBaseAirPower(),d=0;2>d;d++){for(var e=0,f=0;3>f;f++){var g=a.landBases[f];if(0===g.mode){var h=0===c?0:getAirStatusIndex(a.defense3AirPower,c);shootDownLandBase(h,g,b,!0);e+=g.defenseAirPower}}a.defense3AirPower=Math.floor(e*a.sumSuperCorr)}}
...
function fleetSlotDetailCalculate(a,b,c){c=void 0===c?0:c;setPreCalculateTable();var d=createLandBaseInstance(),e=createFleetInstance(),f=updateEnemyFleetInfo(!1),g=castInt($("#detail_calculate_count").val()),h=[],l=e.ships[a];if(!ITEM_DATA.find(function(A){return A.id===l.items[b].id&&PLANE_TYPE.includes(A.type)}))return!1;var k=isDefMode?0:f.battles.length-1,n=castInt(document.getElementById("target_enemy").value,-1);0<=n&&n<f.battles.length&&(k=n);n=document.getElementById("adapt_stage2").checked;
var m=[];n&&(m=castInt($("#fleet_formation").val()),e.isUnion&&f.battles[k].cellType===CELL_TYPE.airRaid?e.updateStage2All(m,!0):e.updateStage2All(m),m=e.allStage2);for(var p=l.items[b],q=$jscomp.makeIterator(f.battles),u=q.next();!u.done;u=q.next())u=u.value,u.enemies=u.enemies.filter(function(A){return 0<A.slots.length});for(q=0;q<g;q++){for(u=0;u<=k;u++){var t=f.battles[u],x=t.enemies;calculateLandBase(d,t,u);doJetPhase(e,t);var v=t.cellType,r=t.isUnion?e.unionAirPower:e.airPower,w=t.getAirPower();
r=getAirStatusIndex(r,w);shootDownFleet(r,e,t,u);v===CELL_TYPE.aerialCombat&&(shootDownEnemy(r,x,n,m),r=getAirStatusIndex(e.airPower,t.getAirPower()),shootDownFleet(r,e,t,u,!1));t=$jscomp.makeIterator(x);for(x=t.next();!x.done;x=t.next())x=x.value,x.slots=x.fullSlots.concat(),x.airPower=x.fullAirPower,x.landBaseAirPower=x.fullLandBaseAirPower}for(u=0;3>u;u++){t=d.landBases[u];for(x=0;x<t.planes.length;x++)v=t.planes[x],v.slot=v.fullSlot,v.updateAirPower();t.updateAirPower()}for(u=0;u<e.ships.length;u++)for(t=
e.ships[u],x=t.items.length,v=t.airPower=0;v<x;v++)r=t.items[v],u===a&&r.slotNo===b&&h.push(r.slot),r.slot=r.fullSlot,r.updateAirPower(),t.airPower+=r.airPower;e.updateAirPower()}chartSlotDistribution=updateDetailChart(h,"\u6b8b\u6a5f\u6570 [\u6a5f]",{mode:"index",callbacks:{title:function(A,D){A=castInt(A[0].xLabel);return"\u6b8b\u6a5f\u6570\uff1a"+A+" \u6a5f\n\u822a\u7a7a\u6226\u706b\u529b\uff1a"+ShipItem.getFirePower(p,A).join(" or ")},label:function(A,D){return[A.yLabel+" %"]}}});e=SHIP_DATA.find(function(A){return A.id===
...
a={};k=$jscomp.makeIterator(l.items);for(h=k.next();!h.done;a={$jscomp$loop$prop$pl$352:a.$jscomp$loop$prop$pl$352},h=k.next()){a.$jscomp$loop$prop$pl$352=h.value;h=ITEM_DATA.find(function(A){return function(D){return D.id===A.$jscomp$loop$prop$pl$352.id}}(a));if(g===(e?e.slot.length:4))break;n=h?h.name:"-";m=PLANE_TYPE.includes(h?h.type:0);q="";m&&FIGHTERS.includes(h.type)?q=h.antiAir?'<span class="mx-1">\u5bfe\u7a7a: '+h.antiAir+"</span>":"":m&&RECONNAISSANCES.includes(h.type)?(q=h.antiAir?'<span class="mx-1">\u5bfe\u7a7a: '+
...
function landBaseDetailCalculate(a,b,c){c=void 0===c?!1:c;setPreCalculateTable();var d=createLandBaseInstance(),e=updateEnemyFleetInfo(!1),f=castInt($("#detail_calculate_count").val()),g=[],h=isDefMode?0:displayBattle,l=d.landBases[a].planes,k=0;c&&0===b&&!ATTACKERS.includes(l[b].type)&&l.some(function(E){return ATTACKERS.includes(E.type)})&&(b=l.findIndex(function(E){return ATTACKERS.includes(E.type)}));for(var n=0;n<l.length;n++){var m=l[n];0===l[b].id&&0!==m.id&&(b=n);k+=m.fullSlot}n=[];for(m=
0;m<f;m++){for(var p=0;p<=h;p++){for(var q=e.battles[p],u=q.enemies,t=0;3>t;t++){var x=d.landBases[t],v=x.target[0],r=x.target[1];if(v===p||r===p){if(v===p){doLandBaseJetPhase(x,q);var w=x.airPower,A=q.getLandBaseAirPower();w=0===w&&0===A?0:getAirStatusIndex(w,A);shootDownEnemy(w,u);v!==r&&shootDownLandBase(w,x,q)}r===p&&(v!==r&&doLandBaseJetPhase(x,q),v=x.airPower,r=q.getLandBaseAirPower(),v=0===v&&0===r?0:getAirStatusIndex(v,r),shootDownEnemy(v,u),shootDownLandBase(v,x,q))}}q=$jscomp.makeIterator(u);
for(u=q.next();!u.done;u=q.next())u=u.value,u.slots=u.fullSlots.concat(),u.airPower=u.fullAirPower,u.landBaseAirPower=u.fullLandBaseAirPower}for(p=0;3>p;p++){q=d.landBases[p];for(t=u=0;t<q.planes.length;t++)x=q.planes[t],a+1===q.baseNo&&b===t&&g.push(x.slot),u+=x.slot,x.slot=x.fullSlot,x.updateAirPower();a+1===q.baseNo&&n.push(u);q.updateAirPower()}}var D=l[b].id,y=l[b].remodel,z=l.find(function(E){return 312===E.id})?1.15:l.find(function(E){return 311===E.id})?1.125:1,B=e.battles[h].isUnion?1.1:
1;chartSlotDistribution=updateDetailChart(g,"\u6b8b\u6a5f\u6570 [\u6a5f]",{mode:"index",callbacks:{title:function(E,C){E=E[0].xLabel;C="\u822a\u7a7a\u6226\u706b\u529b\uff1a"+(LandBaseItem.getFirePower(D,E,y)*z*B).toFixed(1);return E?"\u6b8b\u6a5f\u6570\uff1a"+E+" \u6a5f\n"+C:"\u6b8b\u6a5f\u6570\uff1a0 \u6a5f\n\u822a\u7a7a\u6226\u706b\u529b\uff1a0"},label:function(E,C){return[E.yLabel+" %"]}}});m=h=g=0;n=$jscomp.makeIterator(n);for(p=n.next();!p.done;p=n.next())p=p.value,q=p/k,0===p?m+=1:.25>q?h+=
...
n={};g=$jscomp.makeIterator(d.landBases[a].planes);for(h=g.next();!h.done;n={$jscomp$loop$prop$pl$354:n.$jscomp$loop$prop$pl$354},h=g.next())n.$jscomp$loop$prop$pl$354=h.value,m=(h=ITEM_DATA.find(function(E){return function(C){return C.id===E.$jscomp$loop$prop$pl$354.id}}(n)))?h.name:"-",p="",FIGHTERS.includes(h.type)?p=h.antiAir?'<span class="mx-1">\u5bfe\u7a7a: '+h.antiAir+"</span>":"":RECONNAISSANCES.includes(h.type)?(p=h.antiAir?'<span class="mx-1">\u5bfe\u7a7a: '+h.antiAir+"</span>":"",p+='<span class="mx-1">\u7d22\u6575: '+
...
function enemySlotDetailCalculate(a,b,c){c=void 0===c?!1:c;setPreCalculateTable();var d=createLandBaseInstance(),e=createFleetInstance(),f=updateEnemyFleetInfo(!1),g=castInt($("#detail_calculate_count").val()),h=isDefMode?0:displayBattle;h=h<f.battles.length?h:f.battles.length-1;var l=[],k=[],n=f.battles[h].enemies.filter(function(y){return 0<y.slots.length&&!y.onlyScout})[a],m=ENEMY_DATA.find(function(y){return y.id===n.id}),p=m.eqp.map(function(y){return ENEMY_ITEM.find(function(z){return z.id===
y})});p=p.filter(function(y){return FIGHTERS.includes(y.type)||ATTACKERS.includes(y.type)});c&&!ATTACKERS.includes(p[b].type)&&p.some(function(y){return ATTACKERS.includes(y.type)})&&(b=p.findIndex(function(y){return ATTACKERS.includes(y.type)}));var q=new EnemyItem(p[b].id);c=$("#slot_detail").prop("checked");var u=[];if(p=document.getElementById("enabled_manual_stage2").checked){u=castInt($("#fleet_formation").val());e.isUnion&&f.battles[h].cellType===CELL_TYPE.airRaid?e.updateStage2All(u,!0):e.updateStage2All(u);
...
v);var w=v.cellType,A=v.isUnion?e.unionAirPower:e.airPower,D=v.getAirPower();A=getAirStatusIndex(A,D);shootDownFleet(A,e,v,x);w===CELL_TYPE.aerialCombat&&(shootDownEnemy(A,r,p,u),A=getAirStatusIndex(e.airPower,v.getAirPower()),shootDownFleet(A,e,v,x,!1));x===h&&(shootDownEnemy(A,r,p,u),v=n.slots[b],k.push(v),c||(v=q.getFirePower(v),2===v.length?(l.push(v[0]),l.push(v[1])):l.push(v[0])));for(v=0;v<r.length;v++)w=r[v],w.onlyScout||(w.slots=w.fullSlots.concat(),w.airPower=w.fullAirPower,w.landBaseAirPower=
w.fullLandBaseAirPower)}for(x=0;3>x;x++){r=d.landBases[x];for(v=0;v<r.planes.length;v++)w=r.planes[v],w.slot=w.fullSlot,w.updateAirPower();r.updateAirPower()}for(x=0;x<e.ships.length;x++)for(r=e.ships[x],v=r.items.length,w=r.airPower=0;w<v;w++)A=r.items[w],A.slot=A.fullSlot,A.updateAirPower(),r.airPower+=A.airPower;e.updateAirPower()}chartSlotDistribution=updateDetailChart(c?k:l,c?"\u6b8b\u6a5f\u6570 [\u6a5f]":"\u822a\u7a7a\u6226\u706b\u529b",{mode:"index",callbacks:{title:function(y){y=y[0].xLabel;
if($("#slot_detail").prop("checked")){if(!y)return"\u6b8b\u6a5f\u6570\uff1a"+y+" \u6a5f\n\u822a\u7a7a\u6226\u706b\u529b\uff1a0";var z="\u822a\u7a7a\u6226\u706b\u529b\uff1a"+q.getFirePower(y).join(" or ");return"\u6b8b\u6a5f\u6570\uff1a"+y+" \u6a5f\n"+z}return"\u822a\u7a7a\u6226\u706b\u529b\uff1a"+y},label:function(y){return[y.yLabel+" %"]}}});if(!c)for(chartSlotDistribution=[],d=getArrayMax(k),f=getArrayMin(k),e=k.length,f={$jscomp$loop$prop$i$266$356:f};f.$jscomp$loop$prop$i$266$356<=d;f={$jscomp$loop$prop$i$266$356:f.$jscomp$loop$prop$i$266$356},
f.$jscomp$loop$prop$i$266$356++)(g=k.filter(function(y){return function(z){return z===y.$jscomp$loop$prop$i$266$356}}(f)).length)&&chartSlotDistribution.push({slot:f.$jscomp$loop$prop$i$266$356,rate:g/e});$("#land_base_detail_table").addClass("d-none");$(".detail_fire").removeClass("d-none").addClass("d-flex");$(".detail_wave").addClass("d-none").removeClass("d-flex");$("#detail_info").data("mode","enemy_slot_detail");$("#detail_info").data("base_no",a);$("#detail_info").data("slot_no",b);$("#detail_info").data("battle_no",
h);$("#detail_warning").text("\u203b \u30b0\u30e9\u30d5\u5185\u306e\u822a\u7a7a\u6226\u706b\u529b\u306f\u30ad\u30e3\u30c3\u30d7\u524d\u3067\u30af\u30ea\u30c6\u30a3\u30ab\u30eb\u3001\u89e6\u63a5\u88dc\u6b63\u306a\u3057\u3002\u5c0f\u6570\u5207\u6368\u3066");a=document.getElementById("graph_title").textContent="";d=h=0;e={};f=$jscomp.makeIterator(m.eqp);for(g=f.next();!g.done;e={$jscomp$loop$prop$id$358:e.$jscomp$loop$prop$id$358},g=f.next())e.$jscomp$loop$prop$id$358=g.value,g=ENEMY_ITEM.find(function(y){return function(z){return z.id===
y.$jscomp$loop$prop$id$358}}(e)),l=m.slot[h],c=PLANE_TYPE.includes(g?g.type:0),p="",c&&FIGHTERS.includes(g.type)?p=g.antiAir?'<span class="mx-1">\u5bfe\u7a7a: '+g.antiAir+"</span>":"":c&&(p=g.antiAir?'<span class="mx-1">\u5bfe\u7a7a: '+g.antiAir+"</span>":"",p+=g.torpedo?'<span class="mx-1">\u96f7\u88c5: '+g.torpedo+"</span>":"",p+=g.bomber?'<span class="mx-1">\u7206\u88c5: '+g.bomber+"</span>":""),a+='\n\t\t<div class="d-flex px-2 py-1 '+(b===d?"selected":"")+" "+(c?"general_tr btn_show_detail":
...
k=aerialSetting.isAllSlot,n="",m=chartSlotDistribution,p=0;p<a.length;p++){var q=a[p];if(!(0>=q.id)){var u=q.armor+q.sumItemArmor,t=[];d?q.type.includes(2)?t=getLandBaseAerialPowersLandBase(m,q):q.type.includes(18)&&f?t=getLandBaseASWPower(m):!e||86!==q.id&&120!==q.id?(q.type.includes(16)?224===b.id?t=getLandBaseAerialPowers(m,1,1,1,!0):405===b.id?t=getLandBaseAerialPowers(m,1,1,1.1):444===b.id&&(t=getLandBaseAerialPowers(m,1,1,1.15)):q.type.includes(13)?406===b.id?t=getLandBaseAerialPowers(m,1.35):
444===b.id&&(t=getLandBaseAerialPowers(m,1,1,1.15)):(q.type.includes(12)||q.type.includes(14)||q.type.includes(15)||q.type.includes(17))&&444===b.id&&(t=getLandBaseAerialPowers(m,1,1,1.15)),t.length||(t=getLandBaseAerialPowers(m))):t=getLandBaseAerialPowers(m,1,3.2):t=c?getFleetAerialPower(m,q,1,l):getEnemyAerialPowers(m,q);var x=q.hp,v=createDamageDistribution(t,u,h,c,x),r=v.map(function(B){return B.damage}),w=getArrayMin(r),A=getArrayMax(r);r=[{min:x,max:getArrayMax(v.map(function(B){return B.damage}))+
1,value:0},{min:Math.ceil(.75*x),max:x,value:0},{min:Math.ceil(.5*x),max:Math.ceil(.75*x),value:0}];t=t.map(function(B){return B.power}).some(function(B){return 0>=B});w=(1<=w?w:t?"0":"\u5272\u5408")+"~"+(1<=A?A:"\u5272\u5408");k||0!==g||(w="-");t="";A={};for(var D=0;D<r.length;A={$jscomp$loop$prop$borderMin$370:A.$jscomp$loop$prop$borderMin$370,$jscomp$loop$prop$borderMax$371:A.$jscomp$loop$prop$borderMax$371},D++){var y=r[D];A.$jscomp$loop$prop$borderMin$370=y.min;A.$jscomp$loop$prop$borderMax$371=
y.max;var z=v.filter(function(B){return function(E){return E.damage>=B.$jscomp$loop$prop$borderMin$370&&E.damage<B.$jscomp$loop$prop$borderMax$371}}(A)).map(function(B){return B.rate});z=z.length===v.length?1:getArraySum(z);y.value=z;if(b.isAttacker||!c||q.type.includes(18)&&f){if(c&&q.type.includes(18)&&!f||!c&&[13,14].includes(q.type)){t+='<td class="text-center" colspan="'+r.length+'">\u5bfe\u6f5c\u653b\u6483\u4e0d\u53ef</td>';w="";v=$jscomp.makeIterator(r);for(A=v.next();!A.done;A=v.next())A.value.value=
0;break}if(1!==z||0!==D||k)1===z?t+='<td>100 <span class="font_size_11 font_color_half">%</span></td>':(y=Math.floor(1E3*z)/10,t+="<td>"+(0===y&&0!==z?.1:y)+' <span class="font_size_11 font_color_half">%</span></td>');else{t+='<td colspan="'+r.length+'" class="text-center text_red">\u78ba\u6bba</td>';break}}else t+="<td>-</td>",w=""}v=Math.floor(1E3*(r[0].value+r[1].value))/10;A=Math.floor(1E3*(r[0].value+r[1].value+r[2].value))/10;n+='\n\t\t<tr class="stage3_calc_detail '+(90<=Math.floor(1E3*r[0].value)/
10?"tr_death":70<=v?"tr_damaged":50<=A?"tr_half_damaged":"")+'"\n\t\t\tdata-toggle="tooltip" data-html="true" title="\n\t\t<div class=\'text-left\'>\n\t\t\t<div>'+(q.name+"</div>\n\t\t\t<div class='mt-1 ml-3'>\u5927\u7834\u4ee5\u4e0a: "+v+" %</div>\n\t\t\t<div class='ml-3'>\u4e2d\u7834\u4ee5\u4e0a: "+A+' %</div>\n\t\t</div>">\n\t\t\t<td class="px-0">\n\t\t\t\t<img class="enemy_img_sm" src="../img/')+(c?"enemy":"ship")+"/"+q.id+'.png">\n\t\t\t</td>\n\t\t\t<td>'+x+"</td>\n\t\t\t<td>"+u+"</td>\n\t\t\t<td>"+
...
q,g,h):LandBaseItem.getFirePower(f.id,q,f.remodel,g,h,b,d);p=l?p.rate:1;m.$jscomp$loop$prop$a$373=q*c;(q=n.find(function(u){return function(t){return t.power===u.$jscomp$loop$prop$a$373}}(m)))?q.rate+=p:n.push({power:m.$jscomp$loop$prop$a$373,rate:p});if(!l)break}return n}
...
function getLandBaseASWPower(a,b){var c=aerialSetting.item,d=aerialSetting.isCritical,e=aerialSetting.levelCriticalBonus,f=aerialSetting.isAllSlot,g=aerialSetting.manualSlot;b=aerialSetting.contactBonus*(void 0===b?1:b);var h=[];a=$jscomp.makeIterator(a);for(var l=a.next();!l.done;l=a.next()){l=l.value;var k=f?l.slot:g;k=0<k?c.asw*Math.sqrt(1.8*k)+25:0;for(var n=10<=c.asw?.7:.35,m=10<=c.asw?.3:.45,p=1/(100*m+1),q={},u=0;u<=100*m;q={$jscomp$loop$prop$power$377:q.$jscomp$loop$prop$power$377},u++){var t=
f?l.rate*p:p,x=Math.floor(softCap(k*(n+u/100),AS_CAP));d&&(x=Math.floor(1.5*x*e));q.$jscomp$loop$prop$power$377=x*(47===c.type?1.8:1)*b;RECONNAISSANCES.includes(c.type)&&(q.$jscomp$loop$prop$power$377=1);(x=h.find(function(v){return function(r){return r.power===v.$jscomp$loop$prop$power$377}}(q)))?x.rate+=t:h.push({power:q.$jscomp$loop$prop$power$377,rate:t})}if(!f)break}return h}
function getFleetAerialPower(a,b,c,d){d=void 0===d?!1:d;var e=aerialSetting.item,f=aerialSetting.isCritical,g=aerialSetting.levelCriticalBonus,h=aerialSetting.isAllSlot,l=aerialSetting.manualSlot,k=aerialSetting.isUnion;c=aerialSetting.contactBonus*aerialSetting.a11*(void 0===c?1:c);var n=[];a=$jscomp.makeIterator(a);for(var m=a.next();!m.done;m=a.next()){m=m.value;var p=ShipItem.getFirePower(e,h?m.slot:l,k,b.isEscort,d),q=1/p.length;m=h?m.rate*q:q;q={};p=$jscomp.makeIterator(p);for(var u=p.next();!u.done;q=
{$jscomp$loop$prop$a$379:q.$jscomp$loop$prop$a$379},u=p.next())q.$jscomp$loop$prop$a$379=u.value*c,q.$jscomp$loop$prop$a$379=f?Math.floor(1.5*q.$jscomp$loop$prop$a$379*g):q.$jscomp$loop$prop$a$379,(u=n.find(function(t){return function(x){return x.power===t.$jscomp$loop$prop$a$379}}(q)))?u.rate+=m:n.push({power:q.$jscomp$loop$prop$a$379,rate:m});if(!h)break}return n}
...
q=m.next())p.$jscomp$loop$prop$a$381=q.value*c,p.$jscomp$loop$prop$a$381=e?Math.floor(1.5*p.$jscomp$loop$prop$a$381*f):p.$jscomp$loop$prop$a$381,(q=k.find(function(u){return function(t){return t.power===u.$jscomp$loop$prop$a$381}}(p)))?q.rate+=n:k.push({power:p.$jscomp$loop$prop$a$381,rate:n});if(!g)break}return k}
...
function createDamageDistribution(a,b,c,d,e){for(var f=[],g=1/b,h=0;h<b;h++)for(var l=.7*b+.6*h,k={},n=$jscomp.makeIterator(a),m=n.next();!m.done;k={$jscomp$loop$prop$damage$385:k.$jscomp$loop$prop$damage$385},m=n.next())if(m=m.value,k.$jscomp$loop$prop$damage$385=0<m.power-l?Math.floor((m.power-l)*c):0,k.$jscomp$loop$prop$damage$385>=e&&!d)for(var p=1/e,q={},u=0;u<e;q={$jscomp$loop$prop$damage2$383:q.$jscomp$loop$prop$damage2$383},u++){q.$jscomp$loop$prop$damage2$383=Math.floor(.5*e+.3*u);var t=
g*m.rate*p,x=f.find(function(v){return function(r){return r.damage===v.$jscomp$loop$prop$damage2$383}}(q));x?x.rate+=t:f.push({damage:q.$jscomp$loop$prop$damage2$383,rate:t})}else m=g*m.rate,(p=f.find(function(v){return function(r){return r.damage===v.$jscomp$loop$prop$damage$385}}(k)))?p.rate+=m:f.push({damage:k.$jscomp$loop$prop$damage$385,rate:m});return f}
function updateDetailChart(a,b,c){for(var d=[],e=[],f=[],g=[],h=getArrayMax(a),l=getArrayMin(a),k=a.length,n=0,m=0,p=0,q=0,u=0,t={$jscomp$loop$prop$i$387:l};t.$jscomp$loop$prop$i$387<=h;t={$jscomp$loop$prop$i$387:t.$jscomp$loop$prop$i$387},t.$jscomp$loop$prop$i$387++){var x=a.filter(function(v){return function(r){return r===v.$jscomp$loop$prop$i$387}}(t)).length;x&&(d.push(t.$jscomp$loop$prop$i$387),e.push((100*x/k).toFixed(1E5<=k?5:1E4<=k?4:1E3<=k?3:2)),g.push({slot:t.$jscomp$loop$prop$i$387,rate:x/
k}),u+=100*x/k,f.push(u.toFixed(1)),!n&&50<=u&&(n=t.$jscomp$loop$prop$i$387),!m&&90<=u&&(m=t.$jscomp$loop$prop$i$387),!p&&95<=u&&(p=t.$jscomp$loop$prop$i$387),!q&&99<=u&&(q=t.$jscomp$loop$prop$i$387))}$("#detail_max").text(h);$("#detail_min").text(l);$("#detail_50").text(n);$("#detail_90").text(m);$("#detail_95").text(p);$("#detail_99").text(q);chartInstance?(chartInstance.data.labels=d,chartInstance.data.datasets[0].data=e,chartInstance.data.datasets[1].data=f,chartInstance.options.scales.xAxes[0].scaleLabel.labelString=
...
function getItemTooltipContext(a,b,c,d,e,f){c=void 0===c?0:c;d=void 0===d?0:d;e=void 0===e?0:e;f=void 0===f?0:f;var g=null;g=(void 0===b?0:b)?new LandBaseItem(a,c,d,e):new ShipItem(a,c,d,e);if(!g.id)return"";var h=ITEM_DATA.find(function(z){return z.id===g.id}),l=h.type;b=g.bonusAntiAir;c=Item.getBonusFire(g.id,l,d);e=Item.getBonusScout(l,d);var k=Item.getBonusTorpedo(l,d);if(f){var n=SHIP_DATA.find(function(z){return z.id===f});if(n){var m=new Ship;m.id=n.id;m.name=n.name;m.type=n.type;m.type2=n.type2;
k+=ShipItem.getAttackerBonus(g,m)}}n=Item.getBonusAccuracy(a,l,d);m=Item.getBonusBomber(a,l,d);l=Item.getBonusASW(a,l,d,h.antiAir);var p=RANGES.find(function(z){return z.id===h.range2});p=h.range2&&p?p.name:"";d=d?'<span class="text_remodel">\u2605'+d+"</span>":"";var q=b?'<span class="ml-1 text_remodel">(+'+b.toFixed(2)+")</span>":"",u=c?'<span class="ml-1 text_remodel">(+'+c.toFixed(2)+")</span>":"",t=k?'<span class="ml-1 text_remodel">(+'+k.toFixed(2)+")</span>":"",x=m?'<span class="ml-1 text_remodel">(+'+
m.toFixed(2)+")</span>":"",v=n?'<span class="ml-1 text_remodel">(+'+n.toFixed(2)+")</span>":"",r=l?'<span class="ml-1 text_remodel">(+'+l.toFixed(2)+")</span>":"",w=e?'<span class="ml-1 text_remodel">(+'+e.toFixed(2)+")</span>":"",A=0<h.avoid?AVOID_TYPE.find(function(z){return z.id===h.avoid}):null,D=g.selectRate.length?g.selectRate.map(function(z){return(100*z).toFixed(0)+"%"}):null,y=PLANE_TYPE.includes(h.type)?getRequiredgBattleCountString(h.grow):null;return('\n\t<div class="text-left m-1 item_tooltip">\n\t\t<div class="d-flex">\n\t\t\t<img src="../img/type/icon'+
...
function createFuckingEnemiesRanking(){if(!document.getElementById("fucking_enemie_table_tbody").innerHTML){var a=ENEMY_DATA.map(function(p){var q=new Battle;q.enemies=[new Enemy(p.id)];q.createStage2Table();return q});a.sort(function(p,q){var u=p.stage2[0][1][0],t=q.stage2[0][1][0];if(u!==t)return t-u;u=p.enemies[0].antiAirBonus;t=q.enemies[0].antiAirBonus;if(u!==t)return t-u;u=p.stage2[0][0][0];t=q.stage2[0][0][0];return u!==t?t-u:q.enemies[0].id-p.enemies[0].id});var b=document.createDocumentFragment(),
