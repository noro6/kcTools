...
$("#union_fleet").prop("checked",!1);$("#yugeki_fleet").prop("checked",!1);$("#visible_anti_air_status").prop("checked",setting.visibleAntiAirStatus);$("#clipboard_mode").prop("checked",setting.copyToClipboard);$("#empty_slot_invisible").prop("checked",setting.emptySlotInvisible);$("#has_slot_only").prop("checked",setting.hasSlotOnly);$("#fav_only").prop("checked",setting.favoriteOnly);$("#fav_only_ship").prop("checked",setting.favoriteOnlyShip);$("#disp_in_stock").prop("checked",setting.inStockOnly);
...
l.$jscomp$loop$prop$stock$306.details[0].area<=MAX_AREA&&0<=l.$jscomp$loop$prop$stock$306.details[0].area?l.$jscomp$loop$prop$stock$306.details[0].area:0;t.lv=l.$jscomp$loop$prop$baseLv$307;t.area=l.$jscomp$loop$prop$baseArea$308;t.stock=l.$jscomp$loop$prop$stock$306.details.filter(function(A){return function(C){return C.lv===A.$jscomp$loop$prop$baseLv$307&&C.area===A.$jscomp$loop$prop$baseArea$308}}(l)).length;var w=[{lv:l.$jscomp$loop$prop$baseLv$307,area:l.$jscomp$loop$prop$baseArea$308}];if(2<=
l.$jscomp$loop$prop$stock$306.details.length)for(var v={},r=1;r<l.$jscomp$loop$prop$stock$306.details.length;v={$jscomp$loop$prop$lv$312:v.$jscomp$loop$prop$lv$312,$jscomp$loop$prop$area$313:v.$jscomp$loop$prop$area$313},r++)if(v.$jscomp$loop$prop$lv$312=l.$jscomp$loop$prop$stock$306.details[r].lv,v.$jscomp$loop$prop$area$313=l.$jscomp$loop$prop$stock$306.details[r].area<=MAX_AREA&&0<=l.$jscomp$loop$prop$stock$306.details[r].area?l.$jscomp$loop$prop$stock$306.details[r].area:0,!w.find(function(A){return function(C){return C.lv===
A.$jscomp$loop$prop$lv$312&&C.area===A.$jscomp$loop$prop$area$313}}(v))){var x=Object.assign({},t);x.lv=v.$jscomp$loop$prop$lv$312;x.area=v.$jscomp$loop$prop$area$313;x.stock=l.$jscomp$loop$prop$stock$306.details.filter(function(A){return function(C){return C.lv===A.$jscomp$loop$prop$lv$312&&C.area===A.$jscomp$loop$prop$area$313}}(v)).length;q.splice(u,0,x);w.push({lv:v.$jscomp$loop$prop$lv$312,area:v.$jscomp$loop$prop$area$313})}}}if(f&&setting.selectedHistory[1]){var z=setting.selectedHistory[1];
q.sort(function(A,C){return z.filter(function(E){return E===C.id}).length-z.filter(function(E){return E===A.id}).length})}q.sort(function(A,C){return 7===A.type&&7!==C.type||7===C.type&&7!==A.type?C.type-A.type:6===A.type&&6!==C.type||6===C.type&&6!==A.type?C.type-A.type:10===A.type&&10!==C.type||10===C.type&&10!==A.type?C.type-A.type:A.type-C.type});l=document.createDocumentFragment();u=w=0;m={};q=$jscomp.makeIterator(q);for(t=q.next();!t.done;m={$jscomp$loop$prop$ship$317:m.$jscomp$loop$prop$ship$317},
t=q.next()){m.$jscomp$loop$prop$ship$317=t.value;v=1;if(g&&k){if(!m.$jscomp$loop$prop$ship$317.lv)continue;m.$jscomp$loop$prop$ship$317.stock&&(v=m.$jscomp$loop$prop$ship$317.stock);t=usedShip.filter(function(A){return function(C){return C.id===A.$jscomp$loop$prop$ship$317.id&&C.lv===A.$jscomp$loop$prop$ship$317.lv&&C.area===A.$jscomp$loop$prop$ship$317.area}}(m)).length;v-=t;if(0>=v&&!h)continue}t=document.createElement("div");t.className=g&&h&&!v?"ship_tr ship_tr_disabled d-flex "+("multi"===c?
"tr_multi":""):"ship_tr general_tr d-flex "+("multi"===c?"tr_multi":"");t.dataset.shipid=m.$jscomp$loop$prop$ship$317.id;t.dataset.level=m.$jscomp$loop$prop$ship$317.lv?m.$jscomp$loop$prop$ship$317.lv:99;t.dataset.area=0<m.$jscomp$loop$prop$ship$317.area?m.$jscomp$loop$prop$ship$317.area:0;t.id="ship_tr_"+m.$jscomp$loop$prop$ship$317.id;r=document.createElement("div");r.className="ml-1 align-self-center pt-1";x=document.createElement("img");x.width=120;x.height=30;x.src="../img/ship/"+m.$jscomp$loop$prop$ship$317.id+
".png";r.appendChild(x);g&&0<m.$jscomp$loop$prop$ship$317.area&&(r.classList.add("exist_area"),x=document.createElement("img"),x.className="area_banner",x.src="../img/util/area"+m.$jscomp$loop$prop$ship$317.area+".png",r.appendChild(x));x=document.createElement("div");x.className="ml-1 align-self-center";var D=document.createElement("div");D.className="text-primary font_size_11";D.textContent=g?"Lv : "+m.$jscomp$loop$prop$ship$317.lv:"ID : "+m.$jscomp$loop$prop$ship$317.id;var y=document.createElement("div");
y.className="d-flex";y.textContent=m.$jscomp$loop$prop$ship$317.name;var B=document.createElement("div");B.className="ml-1 ship_td_stock align-self-center "+(g?"":"d-none");B.textContent="\u00d7"+v;y.appendChild(B);x.appendChild(D);x.appendChild(y);t.appendChild(r);t.appendChild(x);if("multi"!==c)for(v=0;5>v;v++)r=document.createElement("div"),r.className="ship_td_slot font_size_12 align-self-center "+(0===v?"ml-auto":""),r.textContent=v<m.$jscomp$loop$prop$ship$317.slot.length?m.$jscomp$loop$prop$ship$317.slot[v]:
"",t.appendChild(r);w!==m.$jscomp$loop$prop$ship$317.type&&(w=document.createElement("div"),w.className="type_divider mt-4",v=document.createElement("div"),v.className="align-self-center font_size_16",v.textContent=API_SHIP_TYPE.find(function(A){return function(C){return C.id===A.$jscomp$loop$prop$ship$317.type}}(m)).name,r=document.createElement("div"),r.className="flex-grow-1 border-bottom align-self-center mx-2",w.appendChild(v),w.appendChild(r),l.appendChild(w));f||u===m.$jscomp$loop$prop$ship$317.type2||
(u=document.createElement("div"),u.className="type_divider mt-2 ml-1",w=document.createElement("div"),w.className="font_size_12 font_color_half align-self-center",v=API_CTYPE.find(function(A){return function(C){return C.id===A.$jscomp$loop$prop$ship$317.type2}}(m))||{name:""},w.textContent=v.name,u.appendChild(w),l.appendChild(u));w=m.$jscomp$loop$prop$ship$317.type;u=m.$jscomp$loop$prop$ship$317.type2;l.appendChild(t)}"multi"===c?(a.classList.add("modal-xl"),b.classList.add("multi_mode"),a=a.getElementsByClassName("scroll_thead")[0],
...
function(){modal_enemy_Selected($(this))});$("#modal_enemy_select").on("click",".btn_remove",function(){modal_enemy_select_btn_remove($(this))});$("#modal_enemy_select").on("click",".toggle_display_type",createEnemyTable);$("#modal_enemy_select").on("change","#enemy_type_select",createEnemyTable);$("#modal_enemy_select").on("input","#enemy_word",enemy_word_TextChanged);$("#modal_enemy_pattern").on("show.bs.modal",modal_enemy_pattern_Shown);$("#modal_enemy_pattern").on("click",".node_tr",function(){node_tr_Clicked($(this))});
$("#modal_enemy_pattern").on("click","#btn_zoom_map",btn_zoom_map_Clicked);$("#modal_enemy_pattern").on("change","#map_select",createNodeSelect);$("#modal_enemy_pattern").on("change","#node_select",createEnemyPattern);$("#modal_enemy_pattern").on("change","#select_difficulty",createNodeSelect);$("#modal_enemy_pattern").on("click","#btn_expand_enemies",btn_expand_enemies);$("#modal_enemy_pattern").on("click","#btn_continue_expand",btn_continue_expand_Clicked);$("#modal_enemy_pattern").on("click",".node",
function(){node_Clicked($(this))});$("#modal_enemy_pattern").on("click","#enemy_pattern_select .nav-link:not(.active)",function(){pattern_Changed($(this))});$("#modal_enemy_pattern").on("click",'input[name="enemy_display_mode"]',function(){enemy_display_mode_Changed($(this))});$("#modal_enemy_pattern").on("dblclick",".node",node_DoubleClicked);$("#modal_enemy_pattern").on("dblclick",".node_tr",node_DoubleClicked);$("#modal_enemy_pattern").on("dblclick","#enemy_pattern_select .nav-link.active",node_DoubleClicked);
$("#modal_big_map").on("hidden.bs.modal",function(){$(document.body).addClass("modal-open")});$("#modal_main_preset").on("show.bs.modal",modal_main_preset_Shown);$("#modal_main_preset").on("change","#select_preset_category",select_preset_category_Changed);$("#modal_main_preset").on("click",".btn_commit_preset",btn_commit_main_preset_Clicked);$("#modal_main_preset").on("click","#allow_upload_preset",allow_upload_preset_Clicked);$("#modal_main_preset").on("click","#btn_upload_preset",btn_upload_preset_Clicked);
$("#modal_main_preset").on("input","#input_preset_name",function(){preset_name_Changed($(this))});$("#modal_main_preset").on("input","#preset_remarks",function(){preset_remarks_Changed($(this))});$("#modal_share").on("click",".btn_load_deck",btn_load_deck_Clicked);$("#modal_share").on("input","#input_deck",function(){input_deck_Changed($(this))});$("#modal_share").on("focus","#input_deck",function(){$(this).select()});$("#modal_share").on("click",".btn_output_url",btn_output_url_Clicked);$("#modal_share").on("click",
".btn_output_deck",btn_output_deck_Clicked);$("#modal_share").on("focus","#output_url",function(){$(this).select()});$("#modal_share").on("focus","#output_deck",function(){$(this).select()});$("#modal_share").on("input","#output_url",function(){output_data_Changed($(this))});$("#modal_share").on("input","#output_deck",function(){output_data_Changed($(this))});$("#modal_share").on("click","#output_url",function(){output_data_Clicked($(this))});$("#modal_share").on("click","#output_deck",function(){output_data_Clicked($(this))});
