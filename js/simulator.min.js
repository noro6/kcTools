...
p.type&&8>=p.antiAir}).length,m=0<e+f,n=hasTypeItem(d,36),q=d.some(function(p){return 307===p.id});[221,222,223,332,1422,1426,1437,337].includes(c)&&m?2<=e+f&&0<h?a.push(1):m&&0<h?a.push(2):2<=e+f&&a.push(3):(397===c||1496===c?(2<=d.filter(function(p){return 363===p.id}).length&&(a.push(38),q&&a.push(40),a.push(41)),d.some(function(p){return 363===p.id})&&d.some(function(p){return 362===p.id})&&(a.push(39),q&&!a.includes(40)&&a.push(40),a.includes(41)||a.push(41)),2<=d.filter(function(p){return 362===
p.id}).length&&(q&&!a.includes(40)&&a.push(40),a.includes(41)||a.push(41))):[362,396,428,429,1489,1492].includes(c)?(2<=d.filter(function(p){return 308===p.id}).length&&a.push(34),d.some(function(p){return 308===p.id})&&d.some(function(p){return 284===p.id||313===p.id})&&a.push(35),2<=d.filter(function(p){return 284===p.id||313===p.id}).length&&q&&a.push(36),2<=d.filter(function(p){return 313===p.id}).length&&a.push(37)):228===c?(m&&0<l&&0<g&&a.push(10),m&&0<l&&a.push(11)):141===c?(m&&0<k&&0<g&&a.push(14),
m&&0<k&&a.push(15)):270===c||422===c?(m&&0<k&&0<g&&a.push(16),m&&0<k&&a.push(17)):287===c?0<f&&0<l&&a.push(19):288===c?m&&0<g&&a.push(21):[102,103,353,354].includes(c)&&0<g&&hasTypeItem(d,18)&&d.some(function(p){return 274===p.id})&&a.push(25),hasTypeItem(d,3)&&hasTypeItem(d,18)&&n&&0<g&&a.push(4),2<=e&&0<g&&a.push(5),hasTypeItem(d,3)&&hasTypeItem(d,18)&&n&&a.push(6),1<=e&&0<g&&a.push(8),m&&n&&0<g&&a.push(7),148===c||346===c?(346===c&&0<g&&d.some(function(p){return 275===p.id})&&a.push(26),0<g&&d.some(function(p){return 274===
p.id})&&a.push(28)):[102,103,353,354].includes(c)?0<g&&d.some(function(p){return 274===p.id})&&a.push(28):(357===c||358===c)&&m&&0<g&&a.push(29),m&&n&&a.push(9),(379===c||430===c)&&m&&0<k&&a.push(33),0<l&&2<=d.filter(function(p){return 21===p.type&&3<=p.antiAir}).length&&0<g&&a.push(12),218===c?0<l&&a.push(18):287===c?0<l&&a.push(20):348===c?0<l&&a.push(22):329===c||330===c?0<k&&a.push(23):278===c?0<f&&0<k&&a.push(24):277===c?(0<f&&0<k&&a.push(24),3<=e+f&&a.push(30),2<=e+f&&a.push(31)):379===c||430===
c?3<=e+f&&a.push(30):b.includes(c)&&(d.some(function(p){return 300===p.id})&&d.some(function(p){return 191===p.id})?a.push(32):d.some(function(p){return 301===p.id})&&d.some(function(p){return 191===p.id})?a.push(32):2<=d.filter(function(p){return 301===p.id}).length&&a.push(32)));b=0;c={};a=$jscomp.makeIterator(a);for(d=a.next();!d.done;c={$jscomp$loop$prop$id$295:c.$jscomp$loop$prop$id$295},d=a.next())if(c.$jscomp$loop$prop$id$295=d.value,d=ANTIAIR_CUTIN.find(function(p){return function(t){return t.id===
