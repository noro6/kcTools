...
usedSteels:0},inputAntiAirWeights=[],fleetStage2Table=[],ENEMY_PATTERN=[],Fleet=function(){this.ships=[];this.fullEscortAirPower=this.escortAirPower=this.fullUnionAirPower=this.unionAirPower=this.fullAirPower=this.airPower=0;this.hasJet=!1};
...
$("#btn_upload_preset").addClass("d-none");break;case "modal_confirm":"Error"===confirmType&&(window.location.href="../list/"),confirmType=null}}
