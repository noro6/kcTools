...
a.find(".sortable_handle").removeClass("d-none"),a.find(".ship_name_span").text(f.name),a.find(".ship_plane").each(function(g,h){var l=$(h),k={id:castInt(l[0].dataset.planeid),remodel:castInt(l.find(".remodel_value").text()),prof:castInt(l.find(".prof_select")[0].dataset.prof)};a[0].dataset.shipid&&setPlaneDiv(l,k);g<f.slot.length?(l.removeClass("d-none").addClass("d-flex"),l.find(".slot").text(f.slot[g]),l.find(".slot_select_parent").data("ini",f.slot[g])):(clearPlaneDiv(l),l.removeClass("d-flex").addClass("d-none"),
l.find(".slot").text(0),l.find(".slot_select_parent").data("ini",0))}),a.find(".ship_level").text(c),a.find(".expanded_slot").removeClass("d-none"),a.find(".aa").text(f.max_aa),0<f.max_scout?(a.find(".max_scout").text(f.max_scout),a.find(".min_scout").text(f.scout)):(a.find(".max_scout").text(-1),a.find(".min_scout").text(-1)),a.find(".scout").text(0),0<e?a.find(".ship_luck").text(e):a.find(".ship_luck").text(f.luck),[6,7,10,11,16,18].includes(f.type)?a.find(".hunshin").removeClass("disabled"):a.find(".hunshin").addClass("disabled"),
...
L){$(L).text(convertHeaderText(t[w]));$(L)[0].dataset.sortkey=t[w++];q===$(L)[0].dataset.sortkey?$(L).addClass("active"):$(L).removeClass("active")});"multi"===g?(c.addClass("modal-xl"),c.removeClass("modal-lg"),d.addClass("multi_mode"),c.find(".scroll_thead").addClass("d-none").removeClass("d-flex")):(c.addClass("modal-lg"),c.removeClass("modal-xl"),d.removeClass("multi_mode"),c.find(".scroll_thead").addClass("d-flex").removeClass("d-none"));l?($("#divide_stock").closest("div").removeClass("d-none"),
$("#disp_equipped").closest("div").removeClass("d-none"),$("#disp_in_stock").prop("checked",!0)):($("#divide_stock").closest("div").addClass("d-none"),$("#disp_equipped").closest("div").addClass("d-none"),$("#disp_in_stock").prop("checked",!1));c=a.length;var v=0;d=0;for(var r=-1,x=0,z={},D=0;D<c;z={$jscomp$loop$prop$item$304:z.$jscomp$loop$prop$item$304},D++)if(z.$jscomp$loop$prop$item$304=a[D],!n||setting.favoritePlane.includes(z.$jscomp$loop$prop$item$304.id)){if(l&&h){var A=p.find(function(M){return function(L){return L.id===
M.$jscomp$loop$prop$item$304.id}}(z));if(k){if(-1===z.$jscomp$loop$prop$item$304.stock)continue;r=z.$jscomp$loop$prop$item$304.stock-(A?A.num[z.$jscomp$loop$prop$item$304.remodel]:0);if(!m&&1>r)continue;d=z.$jscomp$loop$prop$item$304.remodel}else{if(0<=z.$jscomp$loop$prop$item$304.stock)continue;var C=h.find(function(M){return function(L){return L.id===M.$jscomp$loop$prop$item$304.id}}(z)),y=A?getArraySum(A.num):0;x=C?getArraySum(C.num):0;if(0===x||!m&&y>=x)continue;r=x-y;for(x=10;0<=x;x--)if(A&&
(C.num[x]-=A.num[x]),0<C.num[x]){d=x;break}}}else if(0<z.$jscomp$loop$prop$item$304.remodel||0<=z.$jscomp$loop$prop$item$304.stock)continue;C="";C="multi"===g?"tr_multi px-1":"px-2";A=document.createElement("div");A.className="plane plane_tr general_tr d-flex py-2 py-lg-1 "+C;A.dataset.planeid=z.$jscomp$loop$prop$item$304.id;A.dataset.type=z.$jscomp$loop$prop$item$304.type;A.dataset.remodel=d;l&&m&&0>=r&&(A.classList.remove("plane_tr","plane","general_tr"),A.classList.add("plane_tr_disabled"));C=
document.createElement("div");C.className="align-self-center size-25 relative";x=document.createElement("canvas");y=x.getContext("2d");x.width=25;x.height=25;y.drawImage(IMAGES["type"+z.$jscomp$loop$prop$item$304.itype],0,0,25,25);if(specialOperator.enabled){y=!1;for(var B=$jscomp.makeIterator(specialOperator.specialInfo),E=B.next();!E.done;E=B.next())if(E=E.value,E.items.includes(z.$jscomp$loop$prop$item$304.id)){y=document.createElement("div");y.className="item_special flash";y.innerHTML=E.name+
'<span class="font_size_12">'+E.remarks+"</span>";C.appendChild(y);y=!0;break}if(u&&!y)continue}y=document.createElement("div");y.className="pl-1 d-flex align-self-center flex-grow-1";B=!1;if(16===z.$jscomp$loop$prop$item$304.itype&&8<=z.$jscomp$loop$prop$item$304.antiAir)B=!0;else if(21===z.$jscomp$loop$prop$item$304.type&&9<=z.$jscomp$loop$prop$item$304.antiAir)B=!0;else if(350===z.$jscomp$loop$prop$item$304.id||351===z.$jscomp$loop$prop$item$304.id||352===z.$jscomp$loop$prop$item$304.id)B=!0;E=
document.createElement("div");E.className="pl-1 plane_td_name align-self-center"+(B?" special_item":"");E.textContent=z.$jscomp$loop$prop$item$304.name;y.appendChild(E);B=document.createElement("div");B.className="ml-2 plane_td_stock align-self-center";B.textContent="\u00d7"+(0<r?r:0);E=document.createDocumentFragment();var F=document.createElement("div");F.className="ml-auto plane_td_basic align-self-center";var H=document.createElement("div");H.className="plane_td_basic align-self-center";var K=
document.createElement("div");K.className="plane_td_basic align-self-center d-none d-lg-block";var G=document.createElement("div");G.className="plane_td_basic align-self-center d-none d-lg-block";var I=document.createElement("div");I.className="plane_td_basic align-self-center d-none d-lg-block";F.textContent=sFormat(z.$jscomp$loop$prop$item$304[t[0]],t[0]);H.textContent=sFormat(z.$jscomp$loop$prop$item$304[t[1]],t[1]);K.textContent=sFormat(z.$jscomp$loop$prop$item$304[t[2]],t[2]);G.textContent=sFormat(z.$jscomp$loop$prop$item$304[t[3]],
t[3]);I.textContent=sFormat(z.$jscomp$loop$prop$item$304[t[4]],t[4]);if("multi"===g&&v!==z.$jscomp$loop$prop$item$304.type&&"default"===q){v=document.createElement("div");v.className="type_divider mt-3 mb-1";var J=document.createElement("div");J.className="font_size_12 font_color_half align-self-center";J.textContent=ITEM_API_TYPE.find(function(M){return function(L){return L.id===M.$jscomp$loop$prop$item$304.type}}(z)).name;var N=document.createElement("div");N.className="flex-grow-1 border-bottom align-self-center mx-2";
v.appendChild(J);v.appendChild(N);f.appendChild(v)}C.appendChild(x);A.appendChild(C);k&&0<z.$jscomp$loop$prop$item$304.remodel&&(v=document.createElement("div"),v.className="plane_td_remodel text_remodel align-self-center",v.dataset.remodel=z.$jscomp$loop$prop$item$304.remodel,C="",C="multi"===g?"\u2605"+z.$jscomp$loop$prop$item$304.remodel:10>z.$jscomp$loop$prop$item$304.remodel?"\u2605+"+z.$jscomp$loop$prop$item$304.remodel:"\u2605MAX",v.textContent=C,y.appendChild(v),y.appendChild(B));0<r&&y.appendChild(B);
A.appendChild(y);"single"===g&&(E.appendChild(F),E.appendChild(H),E.appendChild(K),E.appendChild(G),E.appendChild(I),A.appendChild(E));f.appendChild(A);v=z.$jscomp$loop$prop$item$304.type}f.childNodes.length||(g=document.createElement("div"),g.className="text-center",l&&!m&&(g.textContent+="\u88c5\u5099\u6240\u6301\u6570\u304c\u767b\u9332\u3055\u308c\u3066\u3044\u306a\u3044\u304b\u3001\u5168\u3066\u306e\u88c5\u5099\u304c\u914d\u5099\u6e08\u307f\u3067\u3059\u3002"),l&&!m&&(g.textContent+="\u88c5\u5099\u6240\u6301\u6570\u304c\u767b\u9332\u3055\u308c\u3066\u3044\u306a\u3044\u304b\u3001\u5168\u3066\u306e\u88c5\u5099\u304c\u914d\u5099\u6e08\u307f\u3067\u3059\u3002"));
...
l;saveSetting();g?$("#disp_equipped_ship").closest("div").removeClass("d-none"):$("#disp_equipped_ship").closest("div").addClass("d-none");var q=SHIP_DATA.filter(function(y){return e?y.name.includes(e):n.includes(y.type)&&(d?0<y["final"]:!0)});if(l){var p=setting.favoriteShip;q=q.filter(function(y){return p.includes(y.id)})}if(g){l={};m=$jscomp.makeIterator(k);for(var u=m.next();!u.done;l={$jscomp$loop$prop$stock$306:l.$jscomp$loop$prop$stock$306,$jscomp$loop$prop$baseLv$307:l.$jscomp$loop$prop$baseLv$307,
$jscomp$loop$prop$baseArea$308:l.$jscomp$loop$prop$baseArea$308},u=m.next())if(l.$jscomp$loop$prop$stock$306=u.value,!(0>=l.$jscomp$loop$prop$stock$306.details.length||(l.$jscomp$loop$prop$stock$306.details.sort(function(y,B){return y.lv-B.lv}),u=q.findIndex(function(y){return function(B){return B.id===y.$jscomp$loop$prop$stock$306.id}}(l)),0>u))){var t=q[u];l.$jscomp$loop$prop$baseLv$307=l.$jscomp$loop$prop$stock$306.details[0].lv;var w=l.$jscomp$loop$prop$stock$306.details[0].st[4];l.$jscomp$loop$prop$baseArea$308=
l.$jscomp$loop$prop$stock$306.details[0].area<=MAX_AREA&&0<l.$jscomp$loop$prop$stock$306.details[0].area?l.$jscomp$loop$prop$stock$306.details[0].area:-1;t.lv=l.$jscomp$loop$prop$baseLv$307;t.area=l.$jscomp$loop$prop$baseArea$308;t.upLuck=w;t.stock=l.$jscomp$loop$prop$stock$306.details.filter(function(y){return function(B){return B.lv===y.$jscomp$loop$prop$baseLv$307&&B.area===y.$jscomp$loop$prop$baseArea$308}}(l)).length;w=[{lv:l.$jscomp$loop$prop$baseLv$307,area:l.$jscomp$loop$prop$baseArea$308}];
if(2<=l.$jscomp$loop$prop$stock$306.details.length)for(var v={},r=1;r<l.$jscomp$loop$prop$stock$306.details.length;v={$jscomp$loop$prop$lv$312:v.$jscomp$loop$prop$lv$312,$jscomp$loop$prop$area$313:v.$jscomp$loop$prop$area$313},r++){v.$jscomp$loop$prop$lv$312=l.$jscomp$loop$prop$stock$306.details[r].lv;var x=l.$jscomp$loop$prop$stock$306.details[r].st[4];v.$jscomp$loop$prop$area$313=l.$jscomp$loop$prop$stock$306.details[r].area<=MAX_AREA&&0<l.$jscomp$loop$prop$stock$306.details[r].area?l.$jscomp$loop$prop$stock$306.details[r].area:
-1;if(!w.find(function(y){return function(B){return B.lv===y.$jscomp$loop$prop$lv$312&&B.area===y.$jscomp$loop$prop$area$313}}(v))){var z=Object.assign({},t);z.lv=v.$jscomp$loop$prop$lv$312;z.area=v.$jscomp$loop$prop$area$313;z.stock=l.$jscomp$loop$prop$stock$306.details.filter(function(y){return function(B){return B.lv===y.$jscomp$loop$prop$lv$312&&B.area===y.$jscomp$loop$prop$area$313}}(v)).length;z.upLuck=x;q.splice(u,0,z);w.push({lv:v.$jscomp$loop$prop$lv$312,area:v.$jscomp$loop$prop$area$313})}}}}if(f&&
setting.selectedHistory[1]){var D=setting.selectedHistory[1];q.sort(function(y,B){return D.filter(function(E){return E===B.id}).length-D.filter(function(E){return E===y.id}).length})}q.sort(function(y,B){return 7===y.type&&7!==B.type||7===B.type&&7!==y.type?B.type-y.type:6===y.type&&6!==B.type||6===B.type&&6!==y.type?B.type-y.type:10===y.type&&10!==B.type||10===B.type&&10!==y.type?B.type-y.type:y.type-B.type});l=document.createDocumentFragment();u=w=0;m={};q=$jscomp.makeIterator(q);for(t=q.next();!t.done;m=
{$jscomp$loop$prop$ship$317:m.$jscomp$loop$prop$ship$317},t=q.next()){m.$jscomp$loop$prop$ship$317=t.value;v=1;if(g&&k){if(!m.$jscomp$loop$prop$ship$317.lv)continue;m.$jscomp$loop$prop$ship$317.stock&&(v=m.$jscomp$loop$prop$ship$317.stock);t=usedShip.filter(function(y){return function(B){return B.id===y.$jscomp$loop$prop$ship$317.id&&B.lv===y.$jscomp$loop$prop$ship$317.lv&&B.area===y.$jscomp$loop$prop$ship$317.area}}(m)).length;v-=t;if(0>=v&&!h)continue}t=document.createElement("div");t.className=
g&&h&&!v?"ship_tr ship_tr_disabled d-flex "+("multi"===c?"tr_multi":""):"ship_tr general_tr d-flex "+("multi"===c?"tr_multi":"");t.dataset.shipid=m.$jscomp$loop$prop$ship$317.id;t.dataset.level=m.$jscomp$loop$prop$ship$317.lv?m.$jscomp$loop$prop$ship$317.lv:99;t.dataset.area=0<m.$jscomp$loop$prop$ship$317.area?m.$jscomp$loop$prop$ship$317.area:0;t.dataset.luck=m.$jscomp$loop$prop$ship$317.luck+m.$jscomp$loop$prop$ship$317.upLuck;t.id="ship_tr_"+m.$jscomp$loop$prop$ship$317.id;r=document.createElement("div");
r.className="ml-1 align-self-center pt-1";x=document.createElement("img");x.width=120;x.height=30;x.src="../img/ship/"+m.$jscomp$loop$prop$ship$317.id+".png";r.appendChild(x);g&&0<m.$jscomp$loop$prop$ship$317.area&&(r.classList.add("exist_area"),x=document.createElement("img"),x.className="area_banner",x.src="../img/util/area"+m.$jscomp$loop$prop$ship$317.area+".png",r.appendChild(x));x=document.createElement("div");x.className="ml-1 align-self-center";z=document.createElement("div");z.className=
"text-primary font_size_11";z.textContent=g?"Lv : "+m.$jscomp$loop$prop$ship$317.lv:"ID : "+m.$jscomp$loop$prop$ship$317.id;var A=document.createElement("div");A.className="d-flex";A.textContent=m.$jscomp$loop$prop$ship$317.name;var C=document.createElement("div");C.className="ml-1 ship_td_stock align-self-center "+(g?"":"d-none");C.textContent="\u00d7"+v;A.appendChild(C);x.appendChild(z);x.appendChild(A);t.appendChild(r);t.appendChild(x);if("multi"!==c)for(v=0;5>v;v++)r=document.createElement("div"),
r.className="ship_td_slot font_size_12 align-self-center "+(0===v?"ml-auto":""),r.textContent=v<m.$jscomp$loop$prop$ship$317.slot.length?m.$jscomp$loop$prop$ship$317.slot[v]:"",t.appendChild(r);w!==m.$jscomp$loop$prop$ship$317.type&&(w=document.createElement("div"),w.className="type_divider mt-4",v=document.createElement("div"),v.className="align-self-center font_size_16",v.textContent=API_SHIP_TYPE.find(function(y){return function(B){return B.id===y.$jscomp$loop$prop$ship$317.type}}(m)).name,r=document.createElement("div"),
r.className="flex-grow-1 border-bottom align-self-center mx-2",w.appendChild(v),w.appendChild(r),l.appendChild(w));f||u===m.$jscomp$loop$prop$ship$317.type2||(u=document.createElement("div"),u.className="type_divider mt-2 ml-1",w=document.createElement("div"),w.className="font_size_12 font_color_half align-self-center",v=API_CTYPE.find(function(y){return function(B){return B.id===y.$jscomp$loop$prop$ship$317.type2}}(m))||{name:""},w.textContent=v.name,u.appendChild(w),l.appendChild(u));w=m.$jscomp$loop$prop$ship$317.type;
u=m.$jscomp$loop$prop$ship$317.type2;l.appendChild(t)}"multi"===c?(a.classList.add("modal-xl"),b.classList.add("multi_mode"),a=a.getElementsByClassName("scroll_thead")[0],a.classList.add("d-none"),a.classList.remove("d-flex")):(a.classList.remove("modal-xl"),b.classList.remove("multi_mode"),a=a.getElementsByClassName("scroll_thead")[0],a.classList.add("d-flex"),a.classList.remove("d-none"));b.innerHTML="";b.appendChild(l)}
...
function expandMainPreset(a,b,c,d){b=void 0===b?!0:b;c=void 0===c?!0:c;d=void 0===d?!0:d;if(a)try{var e=a[0],f=!1;$(".lb_plane").each(function(A,C){if(e&&0!==e.length){var y=e[0].find(function(B){return B[4]===A});y&&0!==y.length?(y={id:y[0],prof:y[1],remodel:y[2],slot:y[3]},setLBPlaneDiv($(C),y),f=!0):b&&setLBPlaneDiv($(C))}});$(".ohuda_select").each(function(A,C){$(C).find("option").prop("disabled",!1);if(f&&e&&2<=e.length){var y=castInt(e[1][A],-1);$(C).val(1===y?2:y)}else b&&$(C).val(-1)});if(e&&
3<=e.length)for(var g=0;2>=g;g++)document.getElementById("lb"+(g+1)+"_target_1").value=e[2][2*g],document.getElementById("lb"+(g+1)+"_target_2").value=e[2][2*g+1];5<=a.length?toggleDefenseMode(a[4]):toggleDefenseMode(!1);if(c){var h=6;a[1].length&&a[1][0]&&6<=a[1][0].length&&(h=2===a[1][0][5]?7:6,document.getElementById("union_fleet").checked=1===a[1][0][5],document.getElementById("yugeki_fleet").checked=2===a[1][0][5]);clearShipDivAll(h);var l=0,k=0;$(".ship_tab:not(.d-none)").each(function(A,C){var y=
a[1].find(function(F){return F[2]===A});if(y){var B=$(C);setShipDiv(B,y[0],99,8<=y.length&&y[7]?y[7]:0);B.find(".ship_plane").each(function(F,H){var K=$(H),G=y[1].find(function(I){return I[4]===F});!G&&K.hasClass("expanded_slot")&&(G=y[1].find(function(I){return-1===I[4]}));G&&!K.hasClass("d-none")&&(setPlaneDiv(K,{id:G[0],prof:G[1],remodel:G[2],slot:G[3]},!0),6<=G.length&&G[5]&&plane_unlock_Clicked(K.find(".plane_unlock")))});if(4<=y.length){var E=B.find(".ship_disabled");y[3]?(E.addClass("disabled"),
E.children().addClass("fa-eye-slash").removeClass("fa-eye no_capture"),B.addClass("opacity4")):(E.removeClass("disabled"),E.children().removeClass("fa-eye-slash").addClass("fa-eye no_capture"),B.removeClass("opacity4"))}5<=y.length&&(y[4]?B.find(".ship_level").text(y[4]):B.find(".ship_level").text(99));7<=y.length&&0<y[6]&&B.find(".ship_luck").text(y[6]);A<h?l+=1:k+=1}});display_ship_count_Changed($("#friendFleet_item1"),Math.max(l,1),!0);display_ship_count_Changed($("#friendFleet_item2"),Math.max(k,
1),!0)}document.getElementById("fleet_formation").value=1;if(4<=a.length&&a[3]){document.getElementById("adapt_stage2").checked=!0;try{c=1;selectedFormations=[];for(var m=$jscomp.makeIterator(a[3]),n=m.next();!n.done;n=m.next()){var q=castInt(n.value);if(0>=q){document.getElementById("adapt_stage2").checked=!1;selectedFormations=[];c=1;break}else selectedFormations.push(q),c=q}document.getElementById("fleet_formation").value=c}catch(A){var p=castInt(a[3]);if(p){selectedFormations=[];for(m=0;10>m;m++)selectedFormations.push(p);
document.getElementById("adapt_stage2").checked=!0;document.getElementById("fleet_formation").value=p}}}else document.getElementById("adapt_stage2").checked=!1,selectedFormations=[];p=1;for(m=0;m<a[2].length;m++)p<a[2][m][0]+1&&(p=a[2][m][0]+1);p=Math.min(p,10);if(0!==a[2].length||d)clearEnemyDivAll(p),$("#battle_count").val(p);var u=isDefMode&&6>a.length;$(u?"#air_raid_enemies":".battle_content").each(function(A,C){var y=a[2].find(function(H){return H[0]===A});if(y){3<=y.length?$(C)[0].dataset.celldata=
y[2]:$(C)[0].dataset.celldata="";if(4<=y.length){var B=castInt(y[3]);u?$(C).find(".cell_type").val([0,5].includes(B)?5:3):$(C).find(".cell_type").val(B);cell_type_Changed($(C).find(".cell_type"),!1)}else $(C).find(".cell_type").val(1);5<=y.length?$(C).find(".formation").val(y[4]):$(C).find(".formation").val(1);6<=y.length?$(C).find(".enemy_range").text(y[5]):$(C).find(".enemy_range").text(0);B=0;y=$jscomp.makeIterator(y[1]);for(var E=y.next();!E.done;E=y.next()){E=E.value;var F=$(C).find(".enemy_content").eq(B++);
0<E?setEnemyDiv(F,E):0>E?setEnemyDiv(F,-1,-E):clearEnemyDiv(F);F.addClass("d-flex").removeClass("d-none")}}});if(6<=a.length){var t=a[5];if(t&&3===t.length){var w=$("#air_raid_enemies"),v=castInt(t[1]);w.find(".cell_type").val([0,5].includes(v)?5:3);cell_type_Changed(w.find(".cell_type"),!1);w.find(".formation").val(t[2]);d=0;for(var r=$jscomp.makeIterator(t[0]),x=r.next();!x.done;x=r.next()){var z=x.value,D=w.find(".enemy_content").eq(d++);0<z?setEnemyDiv(D,z):0>z?setEnemyDiv(D,-1,-z):clearEnemyDiv(D);
D.addClass("d-flex").removeClass("d-none")}}}7<=a.length?$("#admin_lv").val(a[6]):$("#admin_lv").val(120)}catch(A){$(".ohuda_select").val(-1),$(".lb_plane").each(function(C,y){setLBPlaneDiv($(y))}),clearShipDivAll(6),clearEnemyDivAll(1),$("#battle_count").val(1),sendErrorLog(A)}}
...
function updateFleetView(){var a=inputItems.fleet,b=document.getElementById("shoot_down_table"),c=document.getElementById("shoot_down_table_tbody"),d=-1;b.getElementsByTagName("tbody")[0].innerHTML="";b=$jscomp.makeIterator(b.getElementsByTagName("tfoot")[0].getElementsByClassName("td_battle"));for(var e=b.next();!e.done;e=b.next())e.value.innerHTML="";$("#fleet_formation").find("option").each(function(A,C){var y=castInt($(C).val());a.isUnion&&10<y?$(C).removeClass("d-none"):!a.isUnion&&10<y&&$(C).addClass("d-none")});
$("#fleet_antiair_formation").find("option").each(function(A,C){var y=castInt($(C).val());a.isUnion&&10<y?$(C).removeClass("d-none"):!a.isUnion&&10<y&&$(C).addClass("d-none")});setting.visibleAntiAirStatus?($(".anti_air_status").removeClass("d-none"),$(".anti_air_status").addClass("d-flex")):($(".anti_air_status").addClass("d-none"),$(".anti_air_status").removeClass("d-flex"));b=document.getElementsByClassName("fleet_ap")[0];e=document.getElementsByClassName("fleet_ap")[1];for(var f=document.getElementsByClassName("contact_start_rate")[0],
...
(x.textContent=(100*k.$jscomp$loop$prop$ship$339.hunshinRate).toFixed(1),r.classList.remove("d-none")):r.classList.add("d-none");k.$jscomp$loop$prop$rawShip$340=k.$jscomp$loop$prop$ship$339.id?SHIP_DATA.find(function(A){return function(C){return C.id===A.$jscomp$loop$prop$ship$339.id}}(k)):null;p=RANGES.find(function(A){return function(C){return C.id===Math.max(A.$jscomp$loop$prop$ship$339.range,A.$jscomp$loop$prop$rawShip$340?A.$jscomp$loop$prop$rawShip$340.range:0)}}(k));u.textContent=p?p.name:
...
c);c=0;if(isDefMode||f[0])c=f[0].getAirPower();w=!isDefMode&&document.getElementById("adapt_stage2").checked;v=[];w&&(v=castInt($("#fleet_formation").val()),b.isUnion&&f[g].cellType===CELL_TYPE.airRaid?b.updateStage2All(v,!0):b.updateStage2All(v),v=b.allStage2);for(r=0;r<d;r++){for(var x=0;x<p;x++){var z=f[x],D=z.enemies,A=!1;A=calculateLandBase(a,z,x);u+=doJetPhase(b,z);var C=z.isUnion?b.unionAirPower:b.airPower,y=z.getAirPower(),B=getAirStatusIndex(C,y);x===g&&(h[B]+=1);l[x]+=C;k[x]+=y;shootDownFleet(B,
b,z,x);z.cellType===CELL_TYPE.aerialCombat&&(shootDownEnemy(B,D,w,v),A=!0,B=getAirStatusIndex(b.airPower,z.getAirPower()),shootDownFleet(B,b,z,x,!1));if(x===g){shootDownEnemy(B,D,w,v);for(B=C=A=z=0;B<D.length;B++){var E=D[B];if(!E.onlyScout&&E.id){for(var F=E.slots,H=E.attackers.concat(),K=0;K<F.length;K++){var G=F[K],I=n[z];z+=1;I[2]+=G;I[3]<G&&(I[3]=G);I[4]>G&&(I[4]=G);0===G&&(H[K]=!1)}0>H.indexOf(!0)&&(t[A]+=1);A+=1;C+=E.airPower}E.slots=E.fullSlots.concat();E.airPower=E.fullAirPower;E.landBaseAirPower=
E.fullLandBaseAirPower}q[0].push(y);q[1].push(C);A=!1}if(A)for(D=$jscomp.makeIterator(D),y=D.next();!y.done;y=D.next())y=y.value,y.slots=y.fullSlots.concat(),y.airPower=y.fullAirPower,y.landBaseAirPower=y.fullLandBaseAirPower}for(x=0;3>x;x++)if(D=a.landBases[x],0!==D.mode){for(y=0;y<D.planes.length;y++)z=D.planes[y],z.slot=z.fullSlot,z.airPower=z.fullAirPower;D.airPower=D.fullAirPower}for(D=x=0;D<e;D++)if(y=b.ships[D],!y.ignoreSlot){z=y.items.length;for(A=0;A<z;A++)C=y.items[A],C.isPlane&&(m[x++][r]=
C.slot,C.slot=C.fullSlot,C.airPower=C.fullAirPower);y.airPower=y.fullAirPower}b.airPower=b.fullAirPower;b.escortAirPower=b.fullEscortAirPower;b.unionAirPower=b.fullUnionAirPower}for(w=f=0;w<e;w++)if(v=b.ships[w],!v.ignoreSlot)for(r=0;r<v.items.length;r++)v.items[r].isPlane&&(x=m[f],D={shipNo:v.shipNo,slot:v.items[r].slotNo,max:getArrayMax(x),min:getArrayMin(x),avg:x.reduce(function(J,N){return J+N})/d,death:x.filter(function(J){return 0===J}).length,deathRate:0},D.deathRate=D.death/x.length,resultData.fleetSlots.push(D),
...
e.ships[u],w=t.items.length,v=t.airPower=0;v<w;v++)r=t.items[v],u===a&&r.slotNo===b&&h.push(r.slot),r.slot=r.fullSlot,r.updateAirPower(),t.airPower+=r.airPower;e.updateAirPower()}chartSlotDistribution=updateDetailChart(h,"\u6b8b\u6a5f\u6570 [\u6a5f]",{mode:"index",callbacks:{title:function(z,D){var A=castInt(z[0].xLabel);return"\u6b8b\u6a5f\u6570\uff1a"+A+" \u6a5f\n\u822a\u7a7a\u6226\u706b\u529b\uff1a"+ShipItem.getFirePower(q,A).join(" or ")},label:function(z,D){return[z.yLabel+" %"]}}});e=SHIP_DATA.find(function(z){return z.id===
...
function landBaseDetailCalculate(a,b,c){c=void 0===c?!1:c;setPreCalculateTable();var d=createLandBaseInstance(),e=updateEnemyFleetInfo(!1),f=castInt($("#detail_calculate_count").val()),g=[],h=isDefMode?0:displayBattle,l=d.landBases[a].planes,k=0;c&&0===b&&!ATTACKERS.includes(l[b].type)&&l.some(function(B){return ATTACKERS.includes(B.type)})&&(b=l.findIndex(function(B){return ATTACKERS.includes(B.type)}));for(var m=0;m<l.length;m++){var n=l[m];0===l[b].id&&0!==n.id&&(b=m);k+=n.fullSlot}m=[];for(n=
...
for(u=p.next();!u.done;u=p.next())u=u.value,u.slots=u.fullSlots.concat(),u.airPower=u.fullAirPower,u.landBaseAirPower=u.fullLandBaseAirPower}for(q=0;3>q;q++){p=d.landBases[q];for(t=u=0;t<p.planes.length;t++)w=p.planes[t],a+1===p.baseNo&&b===t&&g.push(w.slot),u+=w.slot,w.slot=w.fullSlot,w.updateAirPower();a+1===p.baseNo&&m.push(u);p.updateAirPower()}}var D=l[b].id,A=l[b].remodel,C=l.find(function(B){return 312===B.id})?1.15:l.find(function(B){return 311===B.id})?1.125:1,y=e.battles[h].isUnion?1.1:
1;chartSlotDistribution=updateDetailChart(g,"\u6b8b\u6a5f\u6570 [\u6a5f]",{mode:"index",callbacks:{title:function(B,E){var F=B[0].xLabel,H="\u822a\u7a7a\u6226\u706b\u529b\uff1a"+(LandBaseItem.getFirePower(D,F,A)*C*y).toFixed(1);return F?"\u6b8b\u6a5f\u6570\uff1a"+F+" \u6a5f\n"+H:"\u6b8b\u6a5f\u6570\uff1a0 \u6a5f\n\u822a\u7a7a\u6226\u706b\u529b\uff1a0"},label:function(B,E){return[B.yLabel+" %"]}}});n=h=g=0;m=$jscomp.makeIterator(m);for(q=m.next();!q.done;q=m.next())q=q.value,p=q/k,0===q?n+=1:.25>p?
...
m={};g=$jscomp.makeIterator(d.landBases[a].planes);for(h=g.next();!h.done;m={$jscomp$loop$prop$pl$354:m.$jscomp$loop$prop$pl$354},h=g.next())m.$jscomp$loop$prop$pl$354=h.value,n=(h=ITEM_DATA.find(function(B){return function(E){return E.id===B.$jscomp$loop$prop$pl$354.id}}(m)))?h.name:"-",q="",FIGHTERS.includes(h.type)?q=h.antiAir?'<span class="mx-1">\u5bfe\u7a7a: '+h.antiAir+"</span>":"":RECONNAISSANCES.includes(h.type)?(q=h.antiAir?'<span class="mx-1">\u5bfe\u7a7a: '+h.antiAir+"</span>":"",q+='<span class="mx-1">\u7d22\u6575: '+
...
f);document.getElementById("stage3_all_slot_label").textContent="\u6b8b\u6a5f\u6570\u5206\u5e03\u306e\u7d50\u679c\u3092\u5229\u7528\uff08"+getArrayMin(b)+"\u6a5f ~ "+f+"\u6a5f\uff09";document.getElementById("stage3_remodel").value=A?A:0;l.some(function(B){return 311===B.id})&&(document.getElementById("enabled_rikutei").checked=!0);l.some(function(B){return 312===B.id})&&(document.getElementById("enabled_rikutei_z").checked=!0);l='<option value="99">\u4efb\u610f</option>';e=e.battles.length-1;b=castInt(document.getElementById("target_enemy").value,
...
var t=document.getElementById("aa_cutin_miss").checked;document.getElementById("aa_cutin_miss").parentElement.classList.remove("d-none");u=e.allStage2;t&&(u=[u[u.length-1]])}else document.getElementById("aa_cutin_miss").parentElement.classList.add("d-none");t=$jscomp.makeIterator(f.battles);for(var w=t.next();!w.done;w=t.next())w=w.value,w.enemies=w.enemies.filter(function(A){return 0<A.slots.length});for(t=0;t<g;t++){for(w=0;w<=h;w++){var v=f.battles[w],r=v.enemies;calculateLandBase(d,v,w);doJetPhase(e,
...
if($("#slot_detail").prop("checked")){if(!A)return"\u6b8b\u6a5f\u6570\uff1a"+A+" \u6a5f\n\u822a\u7a7a\u6226\u706b\u529b\uff1a0";var C="\u822a\u7a7a\u6226\u706b\u529b\uff1a"+p.getFirePower(A).join(" or ");return"\u6b8b\u6a5f\u6570\uff1a"+A+" \u6a5f\n"+C}return"\u822a\u7a7a\u6226\u706b\u529b\uff1a"+A},label:function(A){return[A.yLabel+" %"]}}});if(!c)for(chartSlotDistribution=[],d=getArrayMax(k),f=getArrayMin(k),e=k.length,f={$jscomp$loop$prop$i$269$356:f};f.$jscomp$loop$prop$i$269$356<=d;f={$jscomp$loop$prop$i$269$356:f.$jscomp$loop$prop$i$269$356},
f.$jscomp$loop$prop$i$269$356++)(g=k.filter(function(A){return function(C){return C===A.$jscomp$loop$prop$i$269$356}}(f)).length)&&chartSlotDistribution.push({slot:f.$jscomp$loop$prop$i$269$356,rate:g/e});$("#land_base_detail_table").addClass("d-none");$(".detail_fire").removeClass("d-none").addClass("d-flex");$(".detail_wave").addClass("d-none").removeClass("d-flex");$("#detail_info").data("mode","enemy_slot_detail");$("#detail_info").data("base_no",a);$("#detail_info").data("slot_no",b);$("#detail_info").data("battle_no",
h);$("#detail_warning").text("\u203b \u30b0\u30e9\u30d5\u5185\u306e\u822a\u7a7a\u6226\u706b\u529b\u306f\u30ad\u30e3\u30c3\u30d7\u524d\u3067\u30af\u30ea\u30c6\u30a3\u30ab\u30eb\u3001\u89e6\u63a5\u88dc\u6b63\u306a\u3057\u3002\u5c0f\u6570\u5207\u6368\u3066");a=document.getElementById("graph_title").textContent="";d=h=0;e={};f=$jscomp.makeIterator(n.eqp);for(g=f.next();!g.done;e={$jscomp$loop$prop$id$358:e.$jscomp$loop$prop$id$358},g=f.next())e.$jscomp$loop$prop$id$358=g.value,g=ENEMY_ITEM.find(function(A){return function(C){return C.id===
A.$jscomp$loop$prop$id$358}}(e)),l=n.slot[h],c=PLANE_TYPE.includes(g?g.type:0),q="",c&&FIGHTERS.includes(g.type)?q=g.antiAir?'<span class="mx-1">\u5bfe\u7a7a: '+g.antiAir+"</span>":"":c&&(q=g.antiAir?'<span class="mx-1">\u5bfe\u7a7a: '+g.antiAir+"</span>":"",q+=g.torpedo?'<span class="mx-1">\u96f7\u88c5: '+g.torpedo+"</span>":"",q+=g.bomber?'<span class="mx-1">\u7206\u88c5: '+g.bomber+"</span>":""),a+='\n\t\t<div class="d-flex px-2 py-1 '+(b===d?"selected":"")+" "+(c?"general_tr btn_show_detail":
...
t,1,m):getEnemyAerialPowers(p,t);var r=t.hp,x=createDamageDistribution(v,w,k,c,r),z=x.map(function(E){return E.damage}),D=getArrayMin(z),A=getArrayMax(z);z=[{min:r,max:getArrayMax(x.map(function(E){return E.damage}))+1,value:0},{min:Math.ceil(.75*r),max:r,value:0},{min:Math.ceil(.5*r),max:Math.ceil(.75*r),value:0}];v=v.map(function(E){return E.power}).some(function(E){return 0>=E});D=(1<=D?D:v?"0":"\u5272\u5408")+"~"+(1<=A?A:"\u5272\u5408");n||0!==l||(D="-");v="";A={};for(var C=0;C<z.length;A={$jscomp$loop$prop$borderMin$370:A.$jscomp$loop$prop$borderMin$370,
$jscomp$loop$prop$borderMax$371:A.$jscomp$loop$prop$borderMax$371},C++){var y=z[C];A.$jscomp$loop$prop$borderMin$370=y.min;A.$jscomp$loop$prop$borderMax$371=y.max;var B=x.filter(function(E){return function(F){return F.damage>=E.$jscomp$loop$prop$borderMin$370&&F.damage<E.$jscomp$loop$prop$borderMax$371}}(A)).map(function(E){return E.rate});B=B.length===x.length?1:getArraySum(B);y.value=B;if(b.isAttacker||!c||t.type.includes(18)&&h){if(c&&t.type.includes(18)&&!h||!c&&[13,14].includes(t.type)){v+='<td class="text-center" colspan="'+
z.length+'">\u5bfe\u6f5c\u653b\u6483\u4e0d\u53ef</td>';D="";x=$jscomp.makeIterator(z);for(A=x.next();!A.done;A=x.next())A.value.value=0;break}if(1!==B||0!==C||n)1===B?v+='<td>100 <span class="font_size_11 font_color_half">%</span></td>':(y=Math.floor(1E3*B)/10,v+="<td>"+(0===y&&0!==B?.1:y)+' <span class="font_size_11 font_color_half">%</span></td>');else{v+='<td colspan="'+z.length+'" class="text-center text_red">\u78ba\u6bba</td>';break}}else v+="<td>-</td>",D=""}x=Math.floor(1E3*(z[0].value+z[1].value))/
...
".btn_capture",function(){btn_capture_Clicked($(this))});$("#main").on("click",".btn_reset_content",function(){btn_reset_content_Clicked($(this))});$("#main").on("click",".btn_content_trade",function(){btn_content_trade_Clicked($(this))});$("#main").on("click",".btn_commit_trade",commit_content_order);$("#main").on("click",".btn_ex_setting",function(){btn_ex_setting_Clicked($(this))});$("#main_header_info").on("click","input",function(){display_special_Changed($(this))});$("#site_warning").on("click",
".cur_pointer",function(){$("#site_warning").removeClass("d-flex").addClass("d-none")});$("#landBase").on("click",".btn_air_raid",btn_air_raid_Clicked);$("#landBase").on("click","#alert_air_raid_button",btn_air_raid_Clicked);$("#landBase").on("click",".btn_supply",btn_supply_Clicked);$("#landBase_content").on("change",".ohuda_select",function(){calculate(!0,!1,!1)});$("#landBase_content").on("click",".btn_remove_plane",function(){btn_remove_lb_plane_Clicked($(this))});$("#landBase_content").on("click",
...
$("#modal_ship_select").on("click","#fav_only_ship",createShipTable);$("#modal_ship_select").on("click","#disp_in_stock_ship",createShipTable);$("#modal_ship_select").on("click","#disp_equipped_ship",createShipTable);$("#modal_ship_select").on("click","#ship_type_select .ship_type",function(){ship_type_select_Changed($(this))});$("#modal_ship_select").on("click",".toggle_display_type",createShipTable);$("#modal_ship_select").on("input","#ship_word",ship_word_TextChanged);$("#modal_enemy_select").on("click",
".modal-body .enemy",function(){modal_enemy_Selected($(this))});$("#modal_enemy_select").on("click",".btn_remove",function(){modal_enemy_select_btn_remove($(this))});$("#modal_enemy_select").on("click",".toggle_display_type",createEnemyTable);$("#modal_enemy_select").on("change","#enemy_type_select",createEnemyTable);$("#modal_enemy_select").on("input","#enemy_word",enemy_word_TextChanged);$("#modal_enemy_pattern").on("show.bs.modal",modal_enemy_pattern_Shown);$("#modal_enemy_pattern").on("click",
