...
g++){b.$jscomp$loop$prop$ship$351=a[g];var h=SHIP_DATA.find(function(p){return function(u){return u.id===p.$jscomp$loop$prop$ship$351[0]}}(b));if(h){d={i1:null,i2:null,i3:null,i4:null,i5:null};var m=$jscomp.makeIterator(b.$jscomp$loop$prop$ship$351[1]);for(e=m.next();!e.done;e=m.next()){var k=e.value,n={id:k[0],rf:k[2],mas:k[1]};d["i"+castInt(k[4]+1)]=n}var l={id:""+h.api,lv:99,luck:-1,items:d},r=b.$jscomp$loop$prop$ship$351[2];6>r?c.f1["s"+(r%6+1)]=l:c.f2["s"+(r%6+1)]=l}}return JSON.stringify(c)}catch(p){return""}}
...
c=!1;if(-1===a.landBases.findIndex(function(w){return 0===w.mode}))for(e=$jscomp.makeIterator(e),d=e.next();!d.done;d=e.next())if(d=d.value,d.isRecon&&4===d.slot||!d.isRecon&&18===d.slot)c=!0;!isDefMode&&c?document.getElementById("air_raid_alert").classList.remove("d-none"):document.getElementById("air_raid_alert").classList.add("d-none")}}
