		...
		id: "1.10.0", changes: [
			{
				...
				content: "直感的に分かるように考慮していますが、もし操作方法等が分からなくなった場合は気軽に質問してください。"
			},
			{
				type: 0, title: "タブ機能を追加しました。",
				content: "編成をタブ化し、瞬時に切り替えられるようになりました。まずは一覧画面から編成を選択してください。一覧画面とは、常にページ最左上のボタンから遷移できるページです。"
			},
			{
...
const LAST_UPDATE_DATE = "2020/10/14";
