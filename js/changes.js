...
let CHANGE_LOG = [
		...
		id: "1.5.0", changes: [
			{
				...
				content: "サイト下部「在籍艦娘 / 装備」欄から入力可能です。特に入力しなくても本サイトは従来通り利用可能ですが、自分がゲームで所持している機体に合わせて所持数を入力すると、後述する新機能をより便利に活用できます。"
			},
			{
				type: 0, title: "所持機体から機体を選択する機能を追加しました。",
				content: "「在籍艦娘 / 装備」で設定した機体のみ選択できる機能です。改修値が設定されている場合、改修値が多いものから順に配備します。なお、保存した編成の読み込みや、プリセット展開などは、所持機体に関わらず従来通り利用可能です。"
			},
			{
				type: 0, title: "艦載機のおまかせ自動配備機能(仮)を実装しました。",
				content: "「在籍艦娘 / 装備」で設定した機体から艦載機を一気に自動で配備してくれる機能です。現段階では単純なアルゴリズムで配備を行うため、必ずしも最適な配置になるとは限りません。制空調整初期のたたき台などに利用してみてください。"
			},
			{
		...
		id: "1.7.3", changes: [
			{
				...
				content: "お気に入りに登録した機体のみを一覧から選択できるようになりました。「在籍艦娘 / 装備欄」で機体のお気に入り登録が可能です。機体一覧にて「お気に入りのみ」モードが実装されておりますので、そちらをクリックしご活用ください。"
			},
			{
				type: 2, title: "不具合の修正を行いました。",
	...
	},
	{
		id: "1.8.0", changes: [
			{
				type: 0, title: "在籍艦娘入力機能を追加しました。",
				content: "サイト下部「在籍艦娘 / 装備」欄から入力可能です。特に入力しなくても本サイトは従来通り利用可能ですが、自分がゲームで所持している艦娘に合わせて所持数を入力するとより便利にサイトを活用できます。"
			},
			{
				type: 0, title: "在籍艦娘から艦娘を選択する機能を追加しました。",
				content: "「在籍艦娘 / 装備」で設定した艦娘のみ選択できる機能です。なお、保存した編成の読み込みや、プリセット展開などは、所持数に関わらず従来通り利用可能です。"
			},
			{
				type: 0, title: "艦娘のお気に入り機能を追加しました。",
				content: "お気に入りに登録した艦娘のみを一覧から選択できるようになりました。「在籍艦娘 / 装備」欄で機体のお気に入り登録が可能です。艦娘一覧にて「お気に入りのみ」が実装されておりますので、そちらをクリックしご活用ください。"
			},
			{
	...
	},
	{
		id: "1.12.3.5", changes: [
			{
				type: 0, title: "在籍艦娘にLv情報を登録できるようになりました。",
				content: "艦隊情報入力サイト『<a href='https://kancolle-fleetanalysis.firebaseapp.com/' target='_blank'>艦隊分析</a>』様で紹介されている「艦隊反映」機能と同様の手順で出力された文字列を用いて本サイトの在籍艦娘を更新した場合、艦娘のLvの情報も登録されるようになりました。"
			},
			{
				type: 1, title: "艦娘選択欄の表示を更新しました。",
				content: "Lv情報が登録できるようになったことに伴い、艦娘一覧画面では「在籍艦娘から選択」にチェックを入れるとLv毎に艦娘が表示されるようになります。"
			},
		],
	},
	{
	...
	},
	{
		id: "1.12.9", changes: [
			{
				type: 0, title: "在籍艦娘 装備管理ページを新設しました。",
	...
	},
	{
		id: "1.12.10", changes: [
			...
			},
			{
				...
				content: "在籍艦娘ページに新しく『経験値』タブを追加し、各艦種毎の経験値配分をチェックできるようになりました。また、いくつかのグラフや表を追加しました。"
			},
			{
				type: 0, title: "在籍艦娘一覧ソート機能を追加しました。",
	...
	},
	{
		id: "1.12.10.1", changes: [
			{
				type: 0, title: "在籍艦娘ページに新しいフィルタを追加しました。",
				content: "フィルタ条件に「大発搭載可」「内火艇搭載可」の項目を追加しました。また、海外艦を国別でフィルタリングできるようにしました。"
			},
			{
				type: 0, title: "在籍艦娘情報のURL発行履歴を追加しました。",
	...
	},
	{
		id: "1.12.10.2", changes: [
			...
			{
				type: 2, title: "不具合の修正を行いました。",
				content: "51cm砲が誰でも積めるようになっていた件を修正しました。また、特定のデッキビルダー形式データを取り込むと装備情報がリセットされる問題を修正しました。"
			},
		],
	},
	{
		id: "1.12.11", changes: [
			...
			{
				type: 0, title: "艦娘選択一覧において札情報を反映するようにしました。",
				content: "艦隊管理ページにて設定された札情報が、制空計算ページにおいても反映されるようになりました。"
			}
		],
	},
	{
		id: "1.12.12", changes: [
			...
			{
				type: 0, title: "2021夏イベント 艦載機特効カテゴリの表示を追加しました。",
				content: "該当機体は暫定です。それぞれの詳しい倍率は別途攻略サイトや、Twitter等でご確認ください。"
			},
			{
				type: 0, title: "敵艦隊欄にて、敵艦ホバー時の表示情報を追加しました。",
				content: "該当の敵艦隊の耐久、装甲を表示するようにしました。"
			},
			{
				type: 0, title: "装備プリセット機能を拡張しました。",
				content: "補強増設枠まで記録できるようになりました。操作方法はいままでと同様です。"
			},
		],
	},
	{
		id: "1.12.13", changes: [
			...
			{
				type: 0, title: "第1艦隊と第2艦隊を入れ替えられるようになりました。",
				content: "『第1艦隊』『第2艦隊』のタブをドラッグ & ドロップで入れ替えられます。"
			},
			{
				type: 0, title: "所持数管理ページにて装備ステータス表示を追加しました。",
	...
	},
	{
		id: "1.12.14", changes: [
			{
				type: 0, title: "未保存の編成タブ名が変更できるようになりました。",
				content: "制空計算画面にて、変更したいタブ名をクリックすると変更できるようになります。無題1とか無題2とか外部データとか増えまくってどれがどれだかわからなくなる事態とオサラバ！"
			},
			{
				type: 0, title: "夜戦マスの敵編成を確認できるようになりました。",
				content: "敵編成入力欄より、夜戦マスの敵編成も確認できるようになりました。なお、夜戦マスは制空権争いに関与しないため計算画面への敵編成の展開はできません。仕様です。"
			},
			{
				type: 0, title: "海域マップの拡大表示機能を追加しました。",
				content: "まだ対応していない海域マップは拡大できません。主に2021夏以降の期間限定海域マップでの対応を予定しています。拡大できる場合は海域マップ画像左下に拡大ボタンが表示されます。"
			},
			{
				type: 0, title: "海域選択画面から敵の装備が確認できるようになりました。",
				content: "海域選択画面で戦闘マスを選択したあと、敵艦にマウスカーソルを合わせるとその敵艦個別の装備構成やHP、制空値がチェックできます。"
			},
			{
				type: 0, title: "所持数管理ページにて、フィルタ条件を追加しました。",
				content: "『未在籍艦娘のみ』『未所持装備のみ』『耐久値4nの艦娘』条件で新しくフィルタ出来るようになりました。"
			},
			{
				type: 0, title: "経験値取得艦娘ランキングを50位まで拡張しました。",
				content: "所持数管理ページ > 艦娘 > 経験値タブより閲覧できるランキングです。表示を10位までから50位までに拡張しました。"
			}
		],
	},
	{
		id: "1.12.14.1", changes: [
			{
				type: 0, title: "編成タブ欄の区切りを追加しました。",
				content: "編成タブを複数作成している場合、各タブ間の区切りが表示されるようにしました。"
			},
			{
				type: 1, title: "運改修設定値を艦娘選択時に反映するようにしました。",
				content: "艦娘一覧で『在籍艦娘反映』にチェックが入っている場合、所持数管理ページにて設定された運改修値が配備時に適用されるようにしました。"
			},
			{
				type: 1, title: "2021夏イベント 札情報をクリアしました。",
				content: "該当の機能は次回の札情報解禁までしばらくおやすみです。"
			},
			{
				type: 1, title: "艦娘一覧「搭載のある艦娘のみ表示」オプションを削除しました。",
				content: "今後は搭載の有無を問わず表示されるようになります。ご了承ください。"
			},
			{
				type: 1, title: "装備一覧「航空機のみチェック」オプションを削除しました。",
				content: "今後は全ての装備が表示されるようになります。ご了承ください。"
			},
			{
				type: 2, title: "不具合の修正を行いました。",
				content: "所持数反映時、艦娘の配備済みの判定がなされず、配備されていてもさらに同じ艦を配備可能になる現象を修正しました。"
			},
		],
	},
	{
		id: "1.12.15", changes: [
			{
				type: 0, title: "夜戦マスを計算画面に展開できるようになりました。",
				content: "2021/10時点での仕様では、夜戦マスは制空権争いには一切関係ないため、いままでのように展開しなくても計算結果に差異がでることはありません。"
			},
			{
				type: 0, title: "基地派遣設定ボタンを基地航空隊編成欄にも追加しました。",
				content: "同時に、半径が足りない場合の警告表示も基地航空隊編成欄に追加しています。"
			},
			{
				type: 0, title: "所持装備管理ページの表示形式を追加しました。",
				content: "装備毎の総所持数の表示を切り替えられるようにしました。なお、改修値で表示装備をフィルタリングしている際は自動的に総所持数は非表示になります。"
			},
			{
				type: 0, title: "秋刀魚漁支援装備表示を仮実装しました。",
				content: "秋刀魚漁に効果のある装備について、秋刀魚漁特効表示を追加してみました。本年度の秋刀魚漁に効果があるかは分かりません。"
			},
			{
				type: 0, title: "データを更新しました。",
				content: "親潮改二、初霜改二について、データ更新しました。"
			},
		],
	},
	{
		id: "1.12.16", changes: [
			{
				type: 0, title: "在籍艦娘の補強増設情報の取り込みに対応しました。",
				content: "在籍艦娘管理ページに記載の反映方法より読み込まれた艦隊データについて、補強増設の有無も読み込めるようになりました。また、この補強増設の有無で表示を制御できるようなフィルタも追加しました。"
			},
			{
				type: 0, title: "所持管理ページに艦隊データの比較機能を追加しました。",
				content: "過去に作成した自分の艦隊データや、他の人の艦隊データを閲覧している際、『比較』タブを表示すると、閲覧中の艦隊データと登録されている自分の艦隊データの比較が表示されます。"
			},
		],
	},
	{
		id: "1.12.17", changes: [
			{
				type: 0, title: "制空計算ページの艦娘選択画面のフィルタを追加しました。",
				content: "新しく「大発搭載可能」「内火艇搭載可能」「補強増設解放済み」の3項目でフィルタリングできるようになりました。"
			},
			{
				type: 0, title: "在籍艦娘の手動での補強増設設定に対応しました。",
				content: "ステータス更新画面に新しく補強増設の設定項目が追加されていますので、手動で設定する場合はこちらをご利用ください。"
			},
			{
				type: 1, title: "改修不可装備の挙動を更新しました。",
				content: "改修不可装備について、★の表示自体を非表示にしました。また、改修不可の装備でも改修値を設定できるようにしました。この場合、改修値の表示は赤色で表示されます。"
			},
			{
				type: 2, title: "不具合の修正を行いました。",
				content: "手動で敵艦を選択した際に、制空値が正しく更新されない現象がある問題を修正しました。"
			},
		],
	},
	{
		id: "1.12.17.1", changes: [
			{
				type: 0, title: "艦娘　装備　敵艦選択時の検索機能を調整しました。",
				content: "id検索、名称検索に対応しました。なお、艦娘一覧画面での文字列検索についてははある程度の画面の大きさが必要です。"
			},
			{
				type: 0, title: "2021秋イベント 対応",
				content: "確認できた敵編成から順次追加していきます。今後、強編成等が確認された場合は編成が変わる可能性があります。"
			}
		],
	},
	{
		id: "1.12.17.2", changes: [
			{
				type: 1, title: "在籍艦娘一覧ページの表示調整を行いました。",
				content: "艦娘にカーソルを乗せると、運改修や耐久改修値が表示されるようになりました。また、挙動が一部重くなっていたため、一覧表示形式にしている場合100行毎にページングするように変更しました。"
			},
			{
				type: 1, title: "所持装備一覧ページの表示調整を行いました。 ",
				content: "「総所持数を表示」にチェックを入れていない場合、★0の装備については改修値を表示しないように調整しました。"
			}
		],
	},
	{
		id: "1.12.18", changes: [
			...
			{
				type: 0, title: "航空戦雷装ボーナスに一部対応",
				content: "雷装ボーナスが下がるような艦載機構成にすると、警告アイコンを表示するようにしました。また、艦載機にカーソルを合わせた際にポップアップする情報でもボーナス値を確認できるようになりました。"
			},
			{
				type: 1, title: "秋刀魚イベント用のあれこれを撤去しました。",
				content: "また来年。"
			},
			{
				type: 2, title: "不具合の修正を行いました。",
				content: "夜戦マスを選択した際に展開ボタンが押せないケースがある問題を修正しました。基地空襲時、敵偵察機の制空値が加算されていない現象を修正しました。"
			}
		],
	},
	{
		id: "1.12.18.1", changes: [
			{
				type: 0, title: "2021秋イベント 対応",
				content: "確認できた敵編成から順次追加していきます。今後、強編成等が確認された場合は編成が変わる可能性があります。"
			},
			{
				type: 0, title: "潜水艦後部魚雷に対応しました。",
				content: "潜水艦後部魚雷の補強増設搭載に対応しました。"
			},
			{
				type: 2, title: "不具合の修正を行いました。",
				content: "五十鈴の対空CI条件の不具合を修正しました。Victoriousが対空CI 32種の判定対象にならない現象を修正しました。"
			}
		],
	},
	{
		id: "1.12.19", changes: [
			{
				type: 0, title: "輸送量(TP)の表示を追加しました。",
				content: "S勝利、A勝利時それぞれの輸送量が表示されるようになっています。"
			},
			{
				type: 0, title: "2022冬イベント 対応",
				content: "確認できた敵編成から順次追加していきます。今後、強編成等が確認された場合は編成が変わる可能性があります。"
			},
			{
				type: 1, title: "作戦室へのリンク先を更新しました。",
				content: "艦隊編成サイト「作戦室」様へ展開できる機能について、新サイトの方にリンクするよう変更しました。"
			},
			{
				type: 2, title: "不具合の修正を行いました。",
				content: "特定条件で所持数反映で設定した艦娘が表示されない不具合に対処を入れました。また、二式艦偵装備時の伊勢、日向の射程表示を修正しました。"
			}
		],
	},
	{
		id: "1.12.19.1", changes: [
			{
				type: 0, title: "防空時制空値に任意の補正を掛けられるようにしました。",
				content: "2022冬イベントで実装された新しい防空戦闘の詳しい補正値が機体毎に多岐にわたるため、とりあえずの応急処置としての対応です。"
			},
			{
				type: 0, title: "2022冬イベント 対応",
				content: "確認できた敵編成から順次追加していきます。今後、強編成等が確認された場合は編成が変わる可能性があります。"
			...
			{
				type: 2, title: "不具合の修正を行いました。",
				content: "手動で未判明の敵艦の装備や搭載数を更新した場合にHPや装甲値の表示がおかしくなる現象を修正しました。"
			}
		],
	}
];

const LAST_UPDATE_DATE = "2022/3/19";
