	...
	},
	{
		id: "1.12.0", changes: [
			...
			},
			{
				...
				content: "艦隊入力欄で設定した装備や編成から、加重対空値、艦隊防空値、対空CIなどの撃墜性能を自動で算出するようになりました。今後、対空砲火情報の直接入力は不要になりますが、敵の棒立ち率を計算したい場合には、艦娘欄は全ての装備を配置するようにしてください。"
			},
			{
...
const LAST_UPDATE_DATE = "2021/1/31";
