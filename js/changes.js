...
let CHANGE_LOG = [
	...
	},
	{
		id: "1.12.14", changes: [
			...
			},
			{
				...
				content: "『未所持艦娘のみ』『未所持装備のみ』『耐久値4nの艦娘』条件で新しくフィルタ出来るようになりました。"
			},
			{
	...
	},
	{
		id: "1.12.14.1", changes: [
			...
			},
			{
				...
				content: "艦娘一覧で『所持艦娘反映』にチェックが入っている場合、所持数管理ページにて設定された運改修値が配備時に適用されるようにしました。"
			},
			{
	...
	},
	{
		id: "1.12.16", changes: [
			{
				type: 0, title: "所持艦娘の補強増設情報の取り込みに対応しました。",
				content: "所持艦娘管理ページに記載の反映方法より読み込まれた艦隊データについて、補強増設の有無も読み込めるようになりました。また、この補強増設の有無で表示を制御できるようなフィルタも追加しました。"
			},
			{
	...
	},
	{
		id: "1.12.17", changes: [
			...
			{
				type: 0, title: "所持艦娘の手動での補強増設設定に対応しました。",
	...
	},
	{
		id: "1.12.17.2", changes: [
			{
				type: 1, title: "所持艦娘一覧ページの表示調整を行いました。",
...
const LAST_UPDATE_DATE = "2021/12/24";
