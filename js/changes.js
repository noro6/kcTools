		...
		id: "1.9.1", changes: [
			{
				...
				content: "複数の対空CIを設定できるようになりました。それぞれの対空CIの発動率を入力することで、より正確な敵艦載機の撃墜シミュレーションが可能になります。例によって、対空CIの発動率等はお手数ですが外部サイト等にて計算を行ったうえで入力してください。"
			},
			{
				type: 2, title: "細かい修正を行いました。",
...
const LAST_UPDATE_DATE = "2020/08/27";
