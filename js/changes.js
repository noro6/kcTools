...
let CHANGE_LOG = [
	...
	},
	{
		id: "1.11.0", changes: [
			{
				type: 0, title: "基地航空隊の分散機能に対応しました。",
				content: "各基地航空隊それぞれ独立して好きな戦闘マスに飛ばせるようになりました。派遣先は、「敵艦隊」欄にて敵編成を入力後、「基地派遣設定」ボタンから設定を行ってください。"
			},
			{
				type: 1, title: "防空計算と通常出撃を明確に切り替えられるようにしました。",
				content: "新しく「防空計算モード」というボタンを追加し、これをONにすることで防空時の計算を行うようにしました。"
			},
			{
				type: 2, title: "不具合の修正を行いました。",
				content: ""
...
const LAST_UPDATE_DATE = "2020/12/18";
