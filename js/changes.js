		...
		id: "1.10.1", changes: [
			{
				...
				content: "ただちに無題の空の編成を開けるボタンです。機能としては、編成一覧画面にて「新規作成」を押した時とほぼ同じ機能です。"
			},
			{
				type: 0, title: "ホイールクリックでタブを閉じられる機能を追加しました。",
				content: "一般的なブラウザのように、閉じたいタブの上にカーソルを持っていき、マウスホイールをクリックすると、該当のタブを閉じられます。ホイールクリックや、マウス自体がない環境は未対応です。"
			},
			{
				type: 1, title: "機体プリセット機能で改修値も扱えるよう変更しました",
				content: "保存時に入力されていた機体の改修値も保存、復帰ができるようになりました。なお、この機能で呼び出した装備は、登録装備の上限を超えて展開される場合があります。"
			},
		],
	},
];

const LAST_UPDATE_DATE = "2020/10/17";
