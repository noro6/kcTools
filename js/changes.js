	...
	},
	{
		id: "1.12.7", changes: [
			...
			},
			{
				...
				content: "(仮)機能として提供しておりましたが、さらなるブラッシュアップを図るため、一時的にこの機能を凍結します。"
			}
		],
	},
	{
		id: "1.12.8", changes: [
			{
				type: 0, title: "艦娘トグル機能を追加しました。",
				content: "各艦娘毎に、別枠で1隻ずつ艦娘情報を保持できるようになりました。どちらを編成すべきか比較・調整する際に、他の艦娘の編成装備を崩さず瞬時に編成の比較ができるようになります。"
			},
			{
				type: 0, title: "艦載機の熟練度上昇度を閲覧できるようになりました。",
				content: "装備一覧で熟練度が上昇する機体にカーソルを合わせた際に、熟練度なしからMAXまでの所要戦闘数が表示されるようになりました。また、装備のソート項目に熟練度の上昇しやすさソートを追加しました。"
			},
			{
				type: 1, title: "レイアウトの調整を行いました。",
				content: "計算結果欄の表示を若干調整し、各セクションの境界が分かるように調整しました。その他、ダークモード時のリンクテキストの表示調整等を行いました。"
			}
		],
	}
];
