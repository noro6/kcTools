...
let CHANGE_LOG = [
	...
	},
	{
		id: "1.11.3.4", changes: [
			{
				type: 1, title: "機体一覧画面を更新しました。",
				content: "判別しやすいよう、機体カテゴリの表示を拡大しました。また、「一列」表示時は対空射撃回避性能、機体配備コストを表示するようにしました。"
			},
			{
				type: 2, title: "不具合の修正を行いました。",
				content: "基地航空隊に出撃札と防空札を混在させた状態で、防空計算モードを選択するとエラーとなる現象を修正しました。"
			}
		],
	}
];
