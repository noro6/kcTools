...
let CHANGE_LOG = [
	...
	},
	{
		id: "1.12.9.1", changes: [
			{
				type: 0, title: "所持艦娘 装備共有機能を追加しました。",
				content: "<a href='../manager/'>所持情報管理ページ</a>に登録されている艦隊情報を他の人と共有できるURLが生成できるようになりました。"
			},
			{
				type: 0, title: "経験値分析機能を追加しました。",
				content: "所持艦娘ページに新しく『経験値』タブを追加し、各艦種毎の経験値配分をチェックできるようになりました。"
			},
			{
