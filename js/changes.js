...
let CHANGE_LOG = [
	...
	},
	{
		id: "1.12.0", changes: [
			...
			{
				type: 0, title: "自軍対空砲火性能を自動で算出するようになりました。",
				content: "艦隊入力欄で設定した装備や編成から、加重対空値、艦隊防空値、対空CIなどの撃墜性能を自動で算出するようになりました。今後、敵の棒立ち率を計算したい場合には、対空砲火情報の直接入力は不要になりますが艦娘欄は全ての装備を配置するようにしてください。"
			},
			{
			...
			},
			{
				...
				content: "全ての装備に対応しました。艦娘の装備選択時は、実際に搭載できる装備のみ表示するようになっています。一部レイアウトの調整を行いました。ソート項目に加重対空値、艦隊防空ボーナスを追加しました。装備カテゴリやソート項目にそれとなく応じてたステータス表示を行うようにしました。"
			},
			{
				type: 1, title: "艦娘一覧画面を更新しました。",
				content: "全ての艦娘に対応しました。艦種選択の方法を変更し、タブ式に変更しました。また、一部レイアウトの調整を行い、一覧構築処理を見直し、高速化を行いました。"
			},
			{
				type: 1, title: "「対空砲火情報」欄を更新しました。",
				content: "前述の通り、対空砲火性能は自動で計算されるようになったため、これまで対空砲火性能を手入力していた画面は専ら閲覧のみの機能に制限されます。加重対空値一括入力機能、対空CI表示設定機能など入力補佐機能は全て廃止しました。"
			},
			{
			...
			{
				type: 1, title: "6-4ボスマス基地派遣時の半径緩和仕様を実装しました。",
