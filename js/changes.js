		...
		id: "1.9.0", changes: [
			{
				...
				content: "艦隊欄の「対空砲火設定」ボタンから設定可能です。ただし、本サイトでは全ての艦娘や装備データを扱っていないため、外部編成サイト等で計算するか、自分で計算した値を入力していく形式になります。"
			},
			{
				type: 0, title: "敵艦の棒立ち率の計算が可能になりました。",
				content: "上記「対空砲火設定」を入力すると、敵の「攻撃機が全て0機になる」つまり棒立ち率を算出、表示するようになります。なお厳密には敵艦が空母系でない場合、普通に砲撃してくるので棒立ちにはなりません。"
			},
		],
	},
];
