...
let CHANGE_LOG = [
	...
	},
	{
		id: "1.12.6.2", changes: [
			...
			{
				type: 1, title: "残数詳細計算画面展開時の挙動を更新しました。",
				content: "基地、敵艦隊の場合は自動で攻撃機スロットを選択するように更新しました。また、基地の場合は自動的に火力計算対象を派遣先の敵艦隊が選ばれるよう変更しました。"
			},
			{
			...
			{
				type: 2, title: "不具合の修正を行いました。",
				content: "水上偵察機の対潜攻撃力計算を修正しました。"
			}
		],
	}
];

const LAST_UPDATE_DATE = "2021/6/6";
