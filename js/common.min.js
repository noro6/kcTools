...
10>=b||3>c||3===c&&3>=a)){setting.defaultProf=[];c=PLANE_TYPE.filter(function(l){return 0<l&&49!==l});b=[6,9,10,41,45,48];c=$jscomp.makeIterator(c);for(a=c.next();!a.done;a=c.next())a=a.value,a={id:a,prof:b.includes(a)?7:0},setting.defaultProf.push(a);setting.initialProf120=[]}setting.adaptedVersion=LATEST_VERSION}}function saveSetting(){saveLocalStorage("setting",setting)}
...
n.$jscomp$loop$prop$planeId$27}}(a));l&&l.num[k]++}c.sort(function(n,q){return n.id-q.id});saveLocalStorage("planeStock",c);setting.inStockOnly=!0;saveSetting()}catch(n){return!1}return!0}function decodePreset(a){try{var b=b64_to_utf8(a);return JSON.parse(b)}catch(c){return[[],[],[]]}}
