...
k=document.createElement("div");k.className="align-self-center fleet_name ml-2 flex-grow-1";k.textContent=h?h[1]:d.$jscomp$loop$prop$tabData$33.name?d.$jscomp$loop$prop$tabData$33.name:"\u7121\u984c";h=document.createElement("input");h.type="text";h.maxLength=50;h.className=" ml-2 d-none fleet_name_input flex-grow-1";h.value=k.textContent;var m=document.createElement("div");m.className="align-self-center btn_close_tab ml-auto";m.innerHTML="&times;";f.appendChild(g);f.appendChild(k);f.appendChild(h);
...
e=d.next();!e.done;c={$jscomp$loop$prop$tab$35:c.$jscomp$loop$prop$tab$35},e=d.next())c.$jscomp$loop$prop$tab$35=e.value,(e=a.presets.find(function(f){return function(h){return h.id===f.$jscomp$loop$prop$tab$35.dataset.presetid}}(c)))&&b.presets.push(e);b.activeId=a.activeId;saveLocalStorage("activePresets",b)}}})});