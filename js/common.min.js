...
{landBase:["radius",0],friendFleet:["antiAir",0]});if(!setting.hasOwnProperty("presetFolders")){setting.presetFolders=[];for(b=1;20>b;b++)setting.presetFolders.push({id:b,name:"\u30d5\u30a9\u30eb\u30c0\u30fc"+b,isOpen:!1});setting.presetFolders.push({id:99,name:"\u30b4\u30df\u7bb1",isOpen:!1})}adaptUpdater();saveSetting();setting.reducedDisplay&&reduced_display_Clicked()}
