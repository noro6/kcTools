...
function readShipJson(a){try{var b=JSON.parse(a);a=[];if(!b.length)return!1;for(var c=1,d={},e=$jscomp.makeIterator(b),g=e.next();!g.done;d={$jscomp$loop$prop$id$31:d.$jscomp$loop$prop$id$31,$jscomp$loop$prop$ship$32:d.$jscomp$loop$prop$ship$32},g=e.next()){var f=g.value;d.$jscomp$loop$prop$id$31=0;var h={id:c++,lv:0,exp:0,st:[],ex:0,area:-1};if(f.hasOwnProperty("api_ship_id")&&f.hasOwnProperty("api_lv")&&f.hasOwnProperty("api_exp")&&f.hasOwnProperty("api_kyouka"))d.$jscomp$loop$prop$id$31=castInt(f.api_ship_id),
h.lv=castInt(f.api_lv),h.exp=f.api_exp[0],h.st=f.api_kyouka;else if(f.hasOwnProperty("id")&&f.hasOwnProperty("lv")&&f.hasOwnProperty("st")&&f.hasOwnProperty("exp"))d.$jscomp$loop$prop$id$31=castInt(f.id),h.lv=castInt(f.lv),h.exp=f.exp[0],h.st=f.st;else return!1;f.hasOwnProperty("api_slot_ex")?h.ex=f.api_slot_ex?1:0:f.hasOwnProperty("ex")&&(h.ex=f.ex?1:0);f.hasOwnProperty("api_sally_area")?h.area=f.api_sally_area:f.hasOwnProperty("area")&&(h.area=f.area);d.$jscomp$loop$prop$ship$32=SHIP_DATA.find(function(k){return function(n){return n.api===
k.$jscomp$loop$prop$id$31}}(d));if(d.$jscomp$loop$prop$ship$32){var m=a.find(function(k){return function(n){return n.id===k.$jscomp$loop$prop$ship$32.id}}(d));m?m.details.push(h):a.push({id:d.$jscomp$loop$prop$ship$32.id,details:[h]})}}a.sort(function(k,n){return k.id-n.id});saveLocalStorage("shipStock",a);setting.inStockOnlyShip=!0;saveSetting();return!0}catch(k){return!1}}
