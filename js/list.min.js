...
(k.$jscomp$loop$prop$preset$34[3]?"":"d-none"),"");h.innerHTML=AutoLink(k.$jscomp$loop$prop$preset$34[3]);q.appendChild(h);h=document.createElement("textarea");h.className="form-control preset_memo mt-1 w-100 d-none";h.value=k.$jscomp$loop$prop$preset$34[3]?k.$jscomp$loop$prop$preset$34[3]:"";p=h.value.match(/\n/g);h.rows=p&&p.length?p.length+2:2;q.appendChild(h);v.appendChild(q);q=createDiv("d-flex ml-auto pt-2 btns_container");b?(h=createDiv("ml-auto r_btn btn_commit d-none"),h.dataset.toggle="tooltip",
h.dataset.offset="-50%",h.title="\u7de8\u96c6\u5185\u5bb9\u3092\u78ba\u5b9a\u3057\u307e\u3059\u3002",h.innerHTML='<i class="fas fa-save"></i>',q.appendChild(h),h=createDiv("ml-2 r_btn btn_rollback d-none"),h.dataset.toggle="tooltip",h.dataset.offset="-50%",h.title="\u7de8\u96c6\u5185\u5bb9\u3092\u53d6\u308a\u6d88\u3057\u307e\u3059\u3002",h.innerHTML='<i class="fas fa-undo"></i>',q.appendChild(h),h=createDiv("ml-auto r_btn btn_edit_start"),h.dataset.toggle="tooltip",h.dataset.offset="-50%",h.title=
"\u7de8\u6210\u540d\u3084\u7de8\u6210\u30e1\u30e2\u306e\u5909\u66f4\u3092\u884c\u3044\u307e\u3059\u3002",h.innerHTML='<i class="fas fa-pencil"></i>',q.appendChild(h),h=createDiv("ml-2 r_btn btn_share"),h.dataset.toggle="tooltip",h.dataset.offset="-50%",h.title="\u7de8\u6210\u306e\u5171\u6709\u3092\u884c\u3044\u307e\u3059\u3002",h.innerHTML='<i class="fas fa-share-alt"></i>',q.appendChild(h),h=createDiv("ml-2 r_btn btn_copy"),h.dataset.toggle="tooltip",h.dataset.offset="-50%",h.title="\u7de8\u6210\u3092\u8907\u88fd\u3057\u3066\u65b0\u3057\u3044\u7de8\u6210\u30bf\u30d6\u3092\u4f5c\u6210\u3057\u307e\u3059\u3002",
...
window.location.href="../simulator/?predeck="+c:readEquipmentJson(c)?inform_success("\u6240\u6301\u88c5\u5099\u306e\u53cd\u6620\u306b\u6210\u529f\u3057\u307e\u3057\u305f\u3002"):readShipJson(c)?inform_success("\u6240\u6301\u8266\u5a18\u306e\u53cd\u6620\u306b\u6210\u529f\u3057\u307e\u3057\u305f\u3002"):readKantaiBunsekiJson(c)?inform_success("\u6240\u6301\u8266\u5a18\u306e\u53cd\u6620\u306b\u6210\u529f\u3057\u307e\u3057\u305f\u3002"):inform_danger("\u5165\u529b\u5024\u306e\u8aad\u307f\u8fbc\u307f\u306b\u5931\u6557\u3057\u307e\u3057\u305f\u3002"),
e.jumpTo(2)):(b.value="",inform_warning("URL\u3084\u30c7\u30c3\u30ad\u30d3\u30eb\u30c0\u30fc\u5f62\u5f0f\u306e\u6587\u5b57\u5217\u3092\u5165\u529b\u3057\u3066\u304f\u3060\u3055\u3044\u3002"),e.jumpTo(2))}a.textContent="URL\u77ed\u7e2e";a.classList.remove("shortening");e.jumpToEnd()})}
