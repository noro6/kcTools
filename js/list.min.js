...
g=createDiv("d-flex ships flex-wrap");p=$jscomp.makeIterator(p);for(m=p.next();!m.done;m=p.next()){m=m.value;if(5<g.childNodes.length)break;if(!(0>=m[0])){var B=document.createElement("img");B.className="ship_image";B.width=100;B.height=25;B.src="../img/ship/"+m[0]+".png";g.appendChild(B)}}u.appendChild(g);g=createDiv("preset_memo_view border mt-1 px-1 py-1 "+(k.$jscomp$loop$prop$preset$33[3]?"":"d-none"),"");g.innerHTML=AutoLink(k.$jscomp$loop$prop$preset$33[3]);u.appendChild(g);g=document.createElement("textarea");
g.className="form-control preset_memo mt-1 w-100 d-none";g.value=k.$jscomp$loop$prop$preset$33[3]?k.$jscomp$loop$prop$preset$33[3]:"";p=g.value.match(/\n/g);g.rows=p&&p.length?p.length+2:2;u.appendChild(g);v.appendChild(u);u=createDiv("d-flex ml-auto pt-2 btns_container");c?(g=createDiv("ml-auto r_btn btn_commit d-none"),g.dataset.toggle="tooltip",g.dataset.offset="-50%",g.title="\u7de8\u96c6\u5185\u5bb9\u3092\u78ba\u5b9a\u3057\u307e\u3059\u3002",g.innerHTML='<i class="fas fa-save"></i>',u.appendChild(g),
g=createDiv("ml-2 r_btn btn_rollback d-none"),g.dataset.toggle="tooltip",g.dataset.offset="-50%",g.title="\u7de8\u96c6\u5185\u5bb9\u3092\u53d6\u308a\u6d88\u3057\u307e\u3059\u3002",g.innerHTML='<i class="fas fa-undo"></i>',u.appendChild(g),g=createDiv("ml-auto r_btn btn_edit_start"),g.dataset.toggle="tooltip",g.dataset.offset="-50%",g.title="\u7de8\u6210\u540d\u3084\u7de8\u6210\u30e1\u30e2\u306e\u5909\u66f4\u3092\u884c\u3044\u307e\u3059\u3002",g.innerHTML='<i class="fas fa-pencil"></i>',u.appendChild(g),
g=createDiv("ml-2 r_btn btn_copy"),g.dataset.toggle="tooltip",g.dataset.offset="-50%",g.title="\u7de8\u6210\u3092\u8907\u88fd\u3057\u3066\u65b0\u3057\u3044\u7de8\u6210\u30bf\u30d6\u3092\u4f5c\u6210\u3057\u307e\u3059\u3002",g.innerHTML='<i class="fas fa-copy"></i>',u.appendChild(g),g=createDiv("ml-2 r_btn btn_move_folder"),g.dataset.toggle="tooltip",g.dataset.offset="-50%",g.title="\u6240\u5c5e\u30d5\u30a9\u30eb\u30c0\u30fc\u3092\u5909\u66f4\u3057\u307e\u3059\u3002",g.innerHTML='<i class="fas fa-folder-upload"></i>',
...
y.container.appendChild(r):f.appendChild(r):f.appendChild(r)}n.appendChild(f);if(c){h=createDiv("","foldersParent");l=$jscomp.makeIterator(l);for(f=l.next();!f.done;f=l.next())f=f.value,k=createDiv(),k.appendChild(f.header),k.appendChild(f.container),h.appendChild(k);n.appendChild(h)}!c&&prevSnapShot&&(h=createDiv("d-flex preset_container more_load"),l=createDiv("mx-auto my-auto","","\u3082\u3063\u3068\u8aad\u307f\u8fbc\u3080"),h.appendChild(l),n.appendChild(h));document.getElementById(b).innerHTML=
"";document.getElementById(b).appendChild(n);$("#"+b+" .r_btn").tooltip();if(0===d&&!e&&c)for(Sortable.create(document.getElementById("preset_sortable_container"),{animation:200,handle:".sortable_handle",onEnd:function(){for(var w=loadLocalStorage("presets"),q=[],z={},A=$jscomp.makeIterator(document.getElementsByClassName("preset_container")),x=A.next();!x.done;z={$jscomp$loop$prop$c$35:z.$jscomp$loop$prop$c$35},x=A.next())z.$jscomp$loop$prop$c$35=x.value,(x=w.find(function(C){return function(D){return D[0]===
C.$jscomp$loop$prop$c$35.dataset.presetid}}(z)))&&q.push(x);q.length&&(saveLocalStorage("presets",q),inform_success("\u7de8\u6210\u30c7\u30fc\u30bf\u306e\u9806\u5e8f\u304c\u66f4\u65b0\u3055\u308c\u307e\u3057\u305f\u3002"))}}),b=setting.presetFolders,d=0;d<b.length;d++)Sortable.create(document.getElementById("folder"+b[d].id),{animation:200,handle:".sortable_handle",onEnd:function(){for(var w=loadLocalStorage("presets"),q=[],z={},A=$jscomp.makeIterator(document.getElementsByClassName("preset_container")),
x=A.next();!x.done;z={$jscomp$loop$prop$c$37:z.$jscomp$loop$prop$c$37},x=A.next())z.$jscomp$loop$prop$c$37=x.value,(x=w.find(function(C){return function(D){return D[0]===C.$jscomp$loop$prop$c$37.dataset.presetid}}(z)))&&q.push(x);q.length&&(saveLocalStorage("presets",q),inform_success("\u7de8\u6210\u30c7\u30fc\u30bf\u306e\u9806\u5e8f\u304c\u66f4\u65b0\u3055\u308c\u307e\u3057\u305f\u3002"))}});c&&document.getElementById("foldersParent")&&Sortable.create(document.getElementById("foldersParent"),{animation:200,
handle:".handle",onEnd:function(){for(var w=setting.presetFolders,q=[],z={},A=$jscomp.makeIterator(document.getElementsByClassName("folder_header")),x=A.next();!x.done;z={$jscomp$loop$prop$c$39:z.$jscomp$loop$prop$c$39},x=A.next())z.$jscomp$loop$prop$c$39=x.value,(x=w.find(function(C){return function(D){return D.id===castInt(C.$jscomp$loop$prop$c$39.dataset.folderid)}}(z)))&&q.push(x);q.length&&(setting.presetFolders=q,saveSetting(),inform_success("\u30d5\u30a9\u30eb\u30c0\u30fc\u306e\u9806\u5e8f\u304c\u66f4\u65b0\u3055\u308c\u307e\u3057\u305f\u3002"))}})}
