...
"-50%";n.title="\u30d5\u30a9\u30eb\u30c0\u30fc\u540d\u306e\u5909\u66f4\u3092\u884c\u3044\u307e\u3059\u3002";n.innerHTML='<i class="fas fa-pencil"></i>';g.appendChild(n);p.appendChild(g);u.appendChild(p);p=document.createElement("div");v&&(p.id="folder"+k.$jscomp$loop$prop$folder$31.id,p.className="folder_content collapse pl-5 "+(k.$jscomp$loop$prop$folder$31.isOpen?"show":""),p.dataset.folderid=k.$jscomp$loop$prop$folder$31.id);r.appendChild(p);m.push({id:k.$jscomp$loop$prop$folder$31.id,header:u,
