...
function btn_output_url_Clicked(){var a,b,c,d,e;return $jscomp.asyncExecutePromiseGeneratorProgram(function(f){if(1==f.nextAddress)return f.setCatchFinallyBlocks(2),a=getModalSharePreset(),b=$("#output_url"),d=c=MYURL+"?d="+a[2],e=!1,f.yield(postURLData(c).then(function(g){g.error||!g.shortLink?console.log(g):(e=!0,d=g.shortLink)})["catch"](function(g){return console.error(g)}),4);if(2!=f.nextAddress)return e?(b.val(d),b.nextAll(".valid-feedback").text("\u751f\u6210\u3057\u307e\u3057\u305f\u3002\u4e0a\u8a18URL\u3092\u30af\u30ea\u30c3\u30af\u3059\u308b\u3068\u30af\u30ea\u30c3\u30d7\u30dc\u30fc\u30c9\u306b\u30b3\u30d4\u30fc\u3055\u308c\u307e\u3059\u3002"),
