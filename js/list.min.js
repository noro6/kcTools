...
$jscomp.polyfillIsolated=function(a,c,b,d){var e=a.split(".");a=1===e.length;d=e[0];d=!a&&d in $jscomp.polyfills?$jscomp.polyfills:$jscomp.global;for(var f=0;f<e.length-1;f++){var h=e[f];if(!(h in d))return;d=d[h]}e=e[e.length-1];b=$jscomp.IS_SYMBOL_NATIVE&&"es6"===b?d[e]:null;c=c(b);null!=c&&(a?$jscomp.defineProperty($jscomp.polyfills,e,{configurable:!0,writable:!0,value:c}):c!==b&&(void 0===$jscomp.propertyToPolyfillSymbol[e]&&($jscomp.propertyToPolyfillSymbol[e]=$jscomp.IS_SYMBOL_NATIVE?$jscomp.global.Symbol(e):
$jscomp.POLYFILL_PREFIX+e),e=$jscomp.propertyToPolyfillSymbol[e],$jscomp.defineProperty(d,e,{configurable:!0,writable:!0,value:c})))};$jscomp.underscoreProtoCanBeSet=function(){var a={a:!0},c={};try{return c.__proto__=a,c.a}catch(b){}return!1};$jscomp.setPrototypeOf=$jscomp.TRUST_ES6_POLYFILLS&&"function"==typeof Object.setPrototypeOf?Object.setPrototypeOf:$jscomp.underscoreProtoCanBeSet()?function(a,c){a.__proto__=c;if(a.__proto__!==c)throw new TypeError(a+" is not extensible");return a}:null;
...
function setPresets(a,c){var b=(c=void 0===c?!0:c)?"presets_container":"public_presets_container",d=castInt(document.getElementById("presets_order").value),e=document.getElementById("search_preset").value.trim();c&&e&&(a=a.filter(function(t){return 0<=t[1].indexOf(e)}));if(c)switch(d){case 1:a.sort(function(t,q){return t[4]<q[4]?1:-1});break;case 2:a.sort(function(t,q){return t[4]>q[4]?1:-1});break;case 3:a.sort(function(t,q){return t[1]<q[1]?1:-1});break;case 4:a.sort(function(t,q){return t[1]>q[1]?
1:-1})}setting.presetsOrder=d;saveSetting();var f=0===d&&!e&&c,h=document.createDocumentFragment();if(c){var m=createDiv("preset_container new d-flex "+(a.length?"":"border_delete")),l=createDiv("new_body mx-auto my-auto","",a.length?"\u65b0\u898f\u4f5c\u6210":"\u7de8\u6210\u3092\u65b0\u898f\u4f5c\u6210");m.appendChild(l);h.appendChild(m)}else c||0!==a.length||(m=createDiv("d-flex empty_container"),l=createDiv("mx-auto my-auto","","\u30c7\u30fc\u30bf\u304c\u898b\u3064\u304b\u308a\u307e\u305b\u3093\u3067\u3057\u305f\u3002"),
m.appendChild(l),h.appendChild(m));l=setting.presetFolders;m=[];for(var k={},x=0;x<l.length;k={$jscomp$loop$prop$folder$31:k.$jscomp$loop$prop$folder$31},x++){k.$jscomp$loop$prop$folder$31=l[x];var r=createDiv(),u=createDiv("preset_container folder_header"),v=a.filter(function(t){return function(q){return 6<=q.length&&q[5]===t.$jscomp$loop$prop$folder$31.id}}(k)).length;v&&(u.dataset.toggle="collapse",u.dataset.target="#folder"+k.$jscomp$loop$prop$folder$31.id);u.dataset.folderid=k.$jscomp$loop$prop$folder$31.id;
var p=createDiv("d-flex my-auto ml-3 mr-2"),g=createDiv("preset_name align-self-center");g.innerHTML='<i class="fas fa-folder'+(v?"-open":" opacity4")+' mr-2 cur_move handle"></i>'+k.$jscomp$loop$prop$folder$31.name;p.appendChild(g);g=createDiv("ml-3 font_size_12 align-self-center font_color_half preset_count");g.textContent="( "+v+"\u4ef6 )";v&&p.appendChild(g);g=document.createElement("input");g.type="text";g.maxLength=50;g.className="form-control form-control-sm preset_name_edit mb-1 mr-3 d-none";
g.value=k.$jscomp$loop$prop$folder$31.name;p.appendChild(g);g=createDiv("d-flex ml-auto btns_container");var n=createDiv("ml-auto r_btn btn_commit_folder d-none");n.dataset.toggle="tooltip";n.dataset.offset="-50%";n.title="\u9078\u629e\u3057\u305f\u7de8\u6210\u3092\u3053\u306e\u30d5\u30a9\u30eb\u30c0\u30fc\u306b\u8ffd\u52a0\u3057\u307e\u3059\u3002";n.innerHTML='<i class="fas fa-save"></i>';g.appendChild(n);n=createDiv("ml-2 r_btn btn_rollback_folder d-none");n.dataset.toggle="tooltip";n.dataset.offset=
"-50%";n.title="\u30ad\u30e3\u30f3\u30bb\u30eb\u3057\u307e\u3059\u3002";n.innerHTML='<i class="fas fa-undo"></i>';g.appendChild(n);n=createDiv("ml-auto r_btn btn_add_preset");n.dataset.toggle="tooltip";n.dataset.offset="-50%";n.title="\u3053\u306e\u30d5\u30a9\u30eb\u30c0\u30fc\u306b\u79fb\u52d5\u3055\u305b\u308b\u7de8\u6210\u3092\u4e00\u62ec\u3067\u9078\u629e\u3057\u307e\u3059\u3002";n.innerHTML='<i class="fas fa-folder-download"></i>';g.appendChild(n);n=createDiv("ml-auto r_btn btn_commit d-none");
n.dataset.toggle="tooltip";n.dataset.offset="-50%";n.title="\u7de8\u96c6\u5185\u5bb9\u3092\u78ba\u5b9a\u3057\u307e\u3059\u3002";n.innerHTML='<i class="fas fa-save"></i>';g.appendChild(n);n=createDiv("ml-2 r_btn btn_rollback d-none");n.dataset.toggle="tooltip";n.dataset.offset="-50%";n.title="\u7de8\u96c6\u5185\u5bb9\u3092\u53d6\u308a\u6d88\u3057\u307e\u3059\u3002";n.innerHTML='<i class="fas fa-undo"></i>';g.appendChild(n);n=createDiv("ml-2 r_btn btn_edit_start");n.dataset.toggle="tooltip";n.dataset.offset=
"-50%";n.title="\u30d5\u30a9\u30eb\u30c0\u30fc\u540d\u306e\u5909\u66f4\u3092\u884c\u3044\u307e\u3059\u3002";n.innerHTML='<i class="fas fa-pencil"></i>';g.appendChild(n);p.appendChild(g);u.appendChild(p);p=document.createElement("div");p.id="folder"+k.$jscomp$loop$prop$folder$31.id;p.dataset.folderid=k.$jscomp$loop$prop$folder$31.id;p.className="folder_content pl-5";v&&(p.classList.add("collapse"),k.$jscomp$loop$prop$folder$31.isOpen&&p.classList.add("show"));r.appendChild(p);m.push({id:k.$jscomp$loop$prop$folder$31.id,
header:u,container:p})}l=createDiv("","preset_sortable_container");k={};x=$jscomp.makeIterator(a);for(r=x.next();!r.done;k={$jscomp$loop$prop$preset$33:k.$jscomp$loop$prop$preset$33},r=x.next())if(k.$jscomp$loop$prop$preset$33=r.value,k.$jscomp$loop$prop$preset$33[1]&&!(c&&e&&0>k.$jscomp$loop$prop$preset$33[1].indexOf(e))){r=createDiv();u=createDiv("preset_container");u.dataset.presetid=k.$jscomp$loop$prop$preset$33[0];c||(u.dataset.presetdata=k.$jscomp$loop$prop$preset$33[2]);v=createDiv("preset_header "+
(f?"sortable_handle":""));u.appendChild(v);v=createDiv("preset_body d-flex mx-2");p=createDiv("mr-2 preset_abstract flex-grow-1");p.appendChild(createDiv("preset_name","",k.$jscomp$loop$prop$preset$33[1]));g=document.createElement("input");g.type="text";g.maxLength=50;g.className="form-control form-control-sm preset_name_edit mb-1 d-none";g.value=k.$jscomp$loop$prop$preset$33[1];p.appendChild(g);n=decodePreset(k.$jscomp$loop$prop$preset$33[2]);g=n[0];n=n[1];for(var A=createDiv("d-none d-md-flex land_base_status"),
z=1;3>=z;z++)A.appendChild(createDiv("land_base_state no_"+z+" mr-1 "+(1<=g.length&&g[1].length>=z&&0<=g[1][z-1]?"":"disabled"),"","\u7b2c"+z+"\u57fa\u5730\u822a\u7a7a\u968a"));p.appendChild(A);g=createDiv("d-flex ships flex-wrap");n=$jscomp.makeIterator(n);for(A=n.next();!A.done;A=n.next()){A=A.value;if(5<g.childNodes.length)break;0>=A[0]||(z=document.createElement("img"),z.className="ship_image",z.width=100,z.height=25,z.src="../img/ship/"+A[0]+".png",g.appendChild(z))}p.appendChild(g);g=createDiv("preset_memo_view border mt-1 px-1 py-1 "+
(k.$jscomp$loop$prop$preset$33[3]?"":"d-none"),"");g.innerHTML=AutoLink(k.$jscomp$loop$prop$preset$33[3]);p.appendChild(g);g=document.createElement("textarea");g.className="form-control preset_memo mt-1 w-100 d-none";g.value=k.$jscomp$loop$prop$preset$33[3]?k.$jscomp$loop$prop$preset$33[3]:"";n=g.value.match(/\n/g);g.rows=n&&n.length?n.length+2:2;p.appendChild(g);v.appendChild(p);p=createDiv("d-flex ml-auto pt-2 btns_container");c?(g=createDiv("ml-auto r_btn btn_commit d-none"),g.dataset.toggle="tooltip",
g.dataset.offset="-50%",g.title="\u7de8\u96c6\u5185\u5bb9\u3092\u78ba\u5b9a\u3057\u307e\u3059\u3002",g.innerHTML='<i class="fas fa-save"></i>',p.appendChild(g),g=createDiv("ml-2 r_btn btn_rollback d-none"),g.dataset.toggle="tooltip",g.dataset.offset="-50%",g.title="\u7de8\u96c6\u5185\u5bb9\u3092\u53d6\u308a\u6d88\u3057\u307e\u3059\u3002",g.innerHTML='<i class="fas fa-undo"></i>',p.appendChild(g),g=createDiv("ml-auto r_btn btn_edit_start"),g.dataset.toggle="tooltip",g.dataset.offset="-50%",g.title=
"\u7de8\u6210\u540d\u3084\u7de8\u6210\u30e1\u30e2\u306e\u5909\u66f4\u3092\u884c\u3044\u307e\u3059\u3002",g.innerHTML='<i class="fas fa-pencil"></i>',p.appendChild(g),g=createDiv("ml-2 r_btn btn_copy"),g.dataset.toggle="tooltip",g.dataset.offset="-50%",g.title="\u7de8\u6210\u3092\u8907\u88fd\u3057\u3066\u65b0\u3057\u3044\u7de8\u6210\u30bf\u30d6\u3092\u4f5c\u6210\u3057\u307e\u3059\u3002",g.innerHTML='<i class="fas fa-copy"></i>',p.appendChild(g),g=createDiv("ml-2 r_btn btn_move_folder"),g.dataset.toggle=
"tooltip",g.dataset.offset="-50%",g.title="\u6240\u5c5e\u30d5\u30a9\u30eb\u30c0\u30fc\u3092\u5909\u66f4\u3057\u307e\u3059\u3002",g.innerHTML='<i class="fas fa-folder-upload"></i>',p.appendChild(g),g=createDiv("ml-2 r_btn btn_delete"),g.dataset.toggle="tooltip",g.dataset.offset="-50%",g.title="\u7de8\u6210\u3092\u524a\u9664\u3057\u307e\u3059\u3002",g.innerHTML='<i class="fas fa-trash-o"></i>',p.appendChild(g)):(g=createDiv("ml-2 r_btn btn_open"),g.dataset.toggle="tooltip",g.dataset.offset="-50%",g.title=
"\u7de8\u6210\u3092\u5c55\u958b\u3057\u307e\u3059\u3002",g.innerHTML='<i class="fas fa-folder-open-o"></i>',p.appendChild(g));v.appendChild(p);u.appendChild(v);c?(v=createDiv("update_date mr-1","","\u66f4\u65b0\u65e5\u6642: "+(k.$jscomp$loop$prop$preset$33[4]?k.$jscomp$loop$prop$preset$33[4].split(".")[0]:"-")),u.appendChild(v)):(v=createDiv("update_date mr-3","",(k.$jscomp$loop$prop$preset$33[5]?"\u4f5c\u6210\u8005: "+k.$jscomp$loop$prop$preset$33[5]+"\u3000":"")+" "+(k.$jscomp$loop$prop$preset$33[4]?
k.$jscomp$loop$prop$preset$33[4].split(".")[0]:"-")),u.appendChild(v));r.appendChild(u);c&&6<=k.$jscomp$loop$prop$preset$33.length?(u=m.find(function(t){return function(q){return q.id===t.$jscomp$loop$prop$preset$33[5]}}(k)))?u.container.appendChild(r):l.appendChild(r):l.appendChild(r)}h.appendChild(l);if(c){f=createDiv("","foldersParent");m=$jscomp.makeIterator(m);for(l=m.next();!l.done;l=m.next())l=l.value,k=createDiv(),k.appendChild(l.header),k.appendChild(l.container),f.appendChild(k);h.appendChild(f)}!c&&
prevSnapShot&&(f=createDiv("d-flex preset_container more_load"),m=createDiv("mx-auto my-auto","","\u3082\u3063\u3068\u8aad\u307f\u8fbc\u3080"),f.appendChild(m),h.appendChild(f));document.getElementById(b).innerHTML="";document.getElementById(b).appendChild(h);$("#"+b+" .r_btn").tooltip();if(0===d&&!e&&c)for(Sortable.create(document.getElementById("preset_sortable_container"),{animation:200,handle:".sortable_handle",onEnd:function(){for(var t=loadLocalStorage("presets"),q=[],y={},B=$jscomp.makeIterator(document.getElementsByClassName("preset_container")),
w=B.next();!w.done;y={$jscomp$loop$prop$c$35:y.$jscomp$loop$prop$c$35},w=B.next())y.$jscomp$loop$prop$c$35=w.value,(w=t.find(function(C){return function(D){return D[0]===C.$jscomp$loop$prop$c$35.dataset.presetid}}(y)))&&q.push(w);q.length&&(saveLocalStorage("presets",q),inform_success("\u7de8\u6210\u30c7\u30fc\u30bf\u306e\u9806\u5e8f\u304c\u66f4\u65b0\u3055\u308c\u307e\u3057\u305f\u3002"))}}),b=setting.presetFolders,d=0;d<b.length;d++)Sortable.create(document.getElementById("folder"+b[d].id),{animation:200,
handle:".sortable_handle",onEnd:function(){for(var t=loadLocalStorage("presets"),q=[],y={},B=$jscomp.makeIterator(document.getElementsByClassName("preset_container")),w=B.next();!w.done;y={$jscomp$loop$prop$c$37:y.$jscomp$loop$prop$c$37},w=B.next())y.$jscomp$loop$prop$c$37=w.value,(w=t.find(function(C){return function(D){return D[0]===C.$jscomp$loop$prop$c$37.dataset.presetid}}(y)))&&q.push(w);q.length&&(saveLocalStorage("presets",q),inform_success("\u7de8\u6210\u30c7\u30fc\u30bf\u306e\u9806\u5e8f\u304c\u66f4\u65b0\u3055\u308c\u307e\u3057\u305f\u3002"))}});
c&&document.getElementById("foldersParent")&&Sortable.create(document.getElementById("foldersParent"),{animation:200,handle:".handle",onEnd:function(){for(var t=setting.presetFolders,q=[],y={},B=$jscomp.makeIterator(document.getElementsByClassName("folder_header")),w=B.next();!w.done;y={$jscomp$loop$prop$c$39:y.$jscomp$loop$prop$c$39},w=B.next())y.$jscomp$loop$prop$c$39=w.value,(w=t.find(function(C){return function(D){return D.id===castInt(C.$jscomp$loop$prop$c$39.dataset.folderid)}}(y)))&&q.push(w);
q.length&&(setting.presetFolders=q,saveSetting(),inform_success("\u30d5\u30a9\u30eb\u30c0\u30fc\u306e\u9806\u5e8f\u304c\u66f4\u65b0\u3055\u308c\u307e\u3057\u305f\u3002"))}})}function AutoLink(a){return a.replace(/((h?)(ttps?:\/\/[a-zA-Z0-9.\-_@:/~?%&;=+#',()*!]+))/g,function(c,b,d,e){return'<a href="h'+e+'" target="_blank">'+b+"</a>"})}
...
function btn_commit_folder_Clicked(a,c){c.stopPropagation();var b=a.closest(".preset_container");b.find(".btn_commit_folder").tooltip("hide");var d=castInt(b[0].dataset.folderid);if(b=setting.presetFolders.find(function(f){return f.id===d})){var e=loadLocalStorage("presets");$(".folder_selectable.selected").each(function(f,h){var m=$(h)[0].dataset.presetid,l=e?e.find(function(k){return k[0]===m}):null;l&&6<=l.length?l[5]=d:l&&5===l.length&&l.push(d)});saveLocalStorage("presets",e);setLocalPresets();
...
h);d[f].name=h;saveSetting();inform_success("\u30d5\u30a9\u30eb\u30c0\u540d\u306e\u66f4\u65b0\u304c\u5b8c\u4e86\u3057\u307e\u3057\u305f\u3002")}}else{var m=b[0].dataset.presetid;(d=loadLocalStorage("presets"))||(d=[]);f=d.findIndex(function(k){return k[0]===m});if(0<=f){h=b.find(".preset_name_edit").val().trim();var l=b.find(".preset_memo").val().trim();h&&(50<h.length&&(h=h.slice(0,50),b.find(".preset_name_edit").val(h)),d[f][1]=h,b.find(".preset_name").text(h));400<l.length&&(l=l.slice(0,400),b.find(".preset_memo").val(l));
...
function preset_Clicked(a){var c=loadLocalStorage("presets"),b=a[0].dataset.presetid;c=c?c.find(function(e){return e[0]===b}):null;var d={id:getUniqueId(),name:getMaxUntitled(),history:{index:0,histories:["Noi6BpgWgRnX41BYLgAZKe-H6IBEB4cSaA3gQMYCuALgJYB2AkgCYEBcmBATgIZ0AplxjoedfgCMANiM6pwBKQHtebIb1HiAvhBwAzfjIDOQ8EdPnFZIA"]}};c&&(d.id=c[0],d.name=a.find(".preset_name").text(),d.history.histories[0]=c[2]);(a=loadLocalStorage("activePresets"))||(a={activeId:"",presets:[]});(c=a.presets.find(function(e){return e.id===
d.id}))?d=c:a.presets.push(d);a.activeId=d.id;saveLocalStorage("activePresets",a);window.location.href="../simulator/?p="+d.history.histories[d.history.index]}function public_preset_Clicked(a){var c=a.closest(".preset_container");a=c[0].dataset.presetdata;c=c.find(".preset_name").text();window.location.href="../simulator/?d="+a+"&name="+encodeURIComponent(c)}
function btn_copy_Clicked(a,c){c.stopPropagation();var b=loadLocalStorage("presets"),d=a.closest(".preset_container")[0].dataset.presetid;if(b=b?b.find(function(f){return f[0]===d}):null){b={id:getUniqueId(),name:b[1]+"_\u30b3\u30d4\u30fc",history:{index:0,histories:[b[2]]}};var e=loadLocalStorage("activePresets");e||(e={activeId:"",presets:[]});e.presets.push(b);e.activeId=b.id;saveLocalStorage("activePresets",e);window.location.href="../simulator/?p="+b.history.histories[b.history.index]}else inform_danger("\u8907\u88fd\u5bfe\u8c61\u306e\u7de8\u6210\u30c7\u30fc\u30bf\u304c\u898b\u3064\u304b\u308a\u307e\u305b\u3093\u3067\u3057\u305f\u3002")}
function btn_move_folder_Clicked(a,c){c.stopPropagation();var b=loadLocalStorage("presets"),d=a.closest(".preset_container")[0].dataset.presetid;if(b=b?b.find(function(m){return m[0]===d}):null){for(var e='<option value="0">\u6307\u5b9a\u306a\u3057</option>',f=$jscomp.makeIterator(setting.presetFolders),h=f.next();!h.done;h=f.next())h=h.value,e+='<option value="'+h.id+'">'+h.name+"</option>";$("#preset_folder").html(e);$("#modal_folder_confirm")[0].dataset.target=b[0];$("#modal_folder_confirm").modal("show")}else inform_danger("\u79fb\u52d5\u5bfe\u8c61\u306e\u30d7\u30ea\u30bb\u30c3\u30c8\u30c7\u30fc\u30bf\u304c\u8aad\u307f\u8fbc\u3081\u307e\u305b\u3093\u3067\u3057\u305f\u3002")}
...
1===d.type?"\u5909\u66f4":"\u4fee\u6b63";var m=document.createElement("span");m.innerHTML=d.title;f.appendChild(h);f.appendChild(m);e.appendChild(f);d.content&&(f=createDiv("font_size_12 pl-3"),f.innerHTML=d.content,e.appendChild(f));c.appendChild(e)}document.getElementById("version").textContent=a.id;document.getElementById("version_inform_body").appendChild(c);setting.version=a.id;saveSetting();document.getElementsByClassName("version_detail")[0].classList.remove("unread")}$("#modal_version_inform").modal("show")}
function loadSiteHistory(){if(!document.getElementById("site_history_body").innerHTML){for(var a=document.createDocumentFragment(),c=0,b=LATEST_VERSION,d=$jscomp.makeIterator(CHANGE_LOG),e=d.next();!e.done;e=d.next()){e=e.value;var f=createDiv("my-3 ver_log border-bottom"),h=createDiv("py-2","","v"+e.id);if(b===e.id){var m=document.createElement("span");m.className="ml-2 pt-1 badge badge-pill badge-danger";m.textContent="New";h.appendChild(m)}f.appendChild(h);for(h=0;h<e.changes.length;h++){m=e.changes[h];
var l="log_"+c++ +"_"+h,k=document.createElement("div");k.className="py-2 px-2 d-flex collapsed history_item history_item_no_content";var x=document.createElement("div");x.className="d-flex flex-nowrap align-self-center";var r=document.createElement("div");r.className="align-self-center";var u=document.createElement("span");u.className="mr-2 pt-1 badge badge-pill badge-"+(0===m.type?"success":1===m.type?"info":"danger");u.textContent=0===m.type?"\u65b0\u898f":1===m.type?"\u5909\u66f4":"\u4fee\u6b63";
var v=document.createElement("div");v.className="align-self-center";v.innerHTML=m.title;r.appendChild(u);x.appendChild(r);x.appendChild(v);k.appendChild(x);f.appendChild(k);m.content&&(k.dataset.toggle="collapse",k.dataset.target="#"+l,k.classList.remove("history_item_no_content"),k=document.createElement("div"),k.id=l,k.className="border-top collapse history_content",l=document.createElement("div"),l.className="pl-3 py-2 font_size_12",l.innerHTML=m.content,k.appendChild(l),f.appendChild(k));a.appendChild(f)}}c=
...
confirmType?(window.localStorage.clear(),setLocalPresets(),setTab(),a.modal("hide")):"sendComment"===confirmType&&(send_comment(),a.modal("hide"));$(".fleet_tab.active").removeClass("active")}function first_time_Clicked(){$("#abstract").collapse("show");setTimeout(function(){$("body,html").animate({scrollTop:$("#first_time").offset().top-80},300,"swing")},200);return!1}
...
document.createElement("div");h.className="comment_writer ml-1 mr-2";h.textContent=b.data().author;var m=b.data().createdAt?b.data().createdAt.toDate():new Date,l=document.createElement("div");l.className="comment_date opacity6 font_size_11 align-self-center";l.textContent=" -- "+formatDate(m,"yyyy/MM/dd HH:mm:ss");e.appendChild(f);e.appendChild(h);e.appendChild(l);f=new Date;f.setDate(f.getDate()-7);m>f&&(f.setDate(f.getDate()+4),h=document.createElement("div"),h.className="font_size_11 align-self-center ml-1 "+
(m>f?"text-danger":"text-success"),h.textContent="New",e.appendChild(h));m=document.createElement("div");m.className="comment_content align-self-center";m.textContent=b.data().content;d.appendChild(e);d.appendChild(m);c.appendChild(d)});document.getElementById("coment_board").innerHTML="";document.getElementById("coment_board").appendChild(c)});comment_text_Changed()}
...
function send_comment(){if(fb){var a=document.getElementById("comment_author").value.trim(),c=document.getElementById("comment_text").value.trim();a||(a="\u540d\u7121\u3057\u3055\u3093");fb.runTransaction(function(b){var d=fb.collection("comments"),e=d.doc();return b.get(e).then(function(){var f,h,m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(l){switch(l.nextAddress){case 1:return l.yield(d.orderBy("createdAt","desc").limit(1).get(),2);case 2:f=l.yieldResult;if(!f){l.jumpTo(0);break}h=
0;return l.yield(Promise.all(f.docs.map(function(k){var x;return $jscomp.asyncExecutePromiseGeneratorProgram(function(r){if(1==r.nextAddress)return r.yield(k.data(),2);if(3!=r.nextAddress)return x=r.yieldResult,r.yield(x.number,3);h=r.yieldResult;r.jumpToEnd()})})),4);case 4:if(!(0<=castInt(h,-1)))return l["return"](Promise.reject("ID\u63a1\u756a\u30a8\u30e9\u30fc :",h));m={number:castInt(h)+1,author:a,content:c,createdAt:firebase.firestore.FieldValue.serverTimestamp()};return l.yield(b.set(e,m),
6);case 6:return l["return"](m)}})})}).then(function(b){document.getElementById("comment_text").value="";document.getElementById("btn_send_comment").disabled=!0})["catch"](function(b){console.error(b);alert("\u30b3\u30e1\u30f3\u30c8\u306e\u6295\u7a3f\u306b\u5931\u6557\u3057\u307e\u3057\u305f\u3002\u30b5\u30fc\u30d0\u30fc\u30b5\u30a4\u30c9\u3067\u30a8\u30e9\u30fc\u304c\u767a\u751f\u3057\u307e\u3057\u305f\u3002")})}else alert("\u8b0e\u306e\u7406\u7531\u306b\u3088\u308a\u3001\u30b3\u30e1\u30f3\u30c8\u306e\u6295\u7a3f\u306b\u5931\u6557\u3057\u307e\u3057\u305f\u3002")}
...
e.jumpTo(2):e.yield(postURLData(b).then(function(f){f.error||!f.shortLink?(c.value="",inform_danger("\u5165\u529b\u3055\u308c\u305fURL\u306e\u77ed\u7e2e\u306b\u5931\u6557\u3057\u307e\u3057\u305f\u3002")):(c.value=f.shortLink,inform_success("URL\u306e\u77ed\u7e2e\u306b\u6210\u529f\u3057\u307e\u3057\u305f\u3002"))})["catch"](function(f){c.value="";inform_danger("\u5165\u529b\u3055\u308c\u305fURL\u306e\u77ed\u7e2e\u306b\u5931\u6557\u3057\u307e\u3057\u305f\u3002")}),2):(c.value="",(d=readDeckBuilder(b))?
window.location.href="../simulator/?predeck="+b:readEquipmentJson(b)?inform_success("\u6240\u6301\u88c5\u5099\u306e\u53cd\u6620\u306b\u6210\u529f\u3057\u307e\u3057\u305f\u3002"):readShipJson(b)?inform_success("\u6240\u6301\u8266\u5a18\u306e\u53cd\u6620\u306b\u6210\u529f\u3057\u307e\u3057\u305f\u3002"):inform_danger("\u5165\u529b\u3055\u308c\u305fURL\u306e\u77ed\u7e2e\u306b\u5931\u6557\u3057\u307e\u3057\u305f\u3002"),e.jumpTo(2)):(c.value="",inform_warning("URL\u3092\u5165\u529b\u3057\u3066\u304f\u3060\u3055\u3044\u3002"),
e.jumpTo(2))}a.textContent="URL\u77ed\u7e2e";a.classList.remove("shortening");e.jumpToEnd()})}
function public_preset_tab_Shown(){$("#btn_search_preset").parent().removeClass("d-none");$("#map_select").parent().removeClass("d-none");$("#search_preset_parent").addClass("d-none");0===castInt($("#presets_order").val())&&($("#presets_order").val(1),$("#presets_order").change(),$("#presets_order").addClass("d-none"));$("#presets_order").find('option[value="0"]').prop("disabled",!0);saveSessionStorage("display_public",!0);if(!$("#map_select").html()){for(var a='<option value="0">\u5168\u3066\u306e\u6d77\u57df\uff08\u6700\u65b0\u306e20\u4ef6\uff09</option>',
c={},b=$jscomp.makeIterator(WORLD_DATA),d=b.next();!d.done;c={$jscomp$loop$prop$world$41:c.$jscomp$loop$prop$world$41},d=b.next()){d=d.value;c.$jscomp$loop$prop$world$41=d.world;var e=MAP_DATA.filter(function(f){return function(h){return Math.floor(h.area/10)===f.$jscomp$loop$prop$world$41}}(c));a+='<optgroup label="'+d.name+'">';d=$jscomp.makeIterator(e);for(e=d.next();!e.done;e=d.next())e=e.value,a+='<option value="'+e.area+'">'+(20<c.$jscomp$loop$prop$world$41?"E":c.$jscomp$loop$prop$world$41)+
"-"+e.area%10+" : "+e.name+"</option>"}$("#map_select").html(a);if(a=loadSessionStorage("search_result"))$("#map_select").val(a.map),setPresets(a.presets,!1)}map_select_Changed()}
function public_preset_tab_Hidden(){$("#btn_search_preset").parent().addClass("d-none");$("#map_select").parent().addClass("d-none");$("#search_preset_parent").removeClass("d-none");$("#presets_order").find('option[value="0"]').prop("disabled",!1);$("#presets_order").removeClass("d-none");saveSessionStorage("display_public",!1)}
...
more_load_presets);$("#presets_container").on("click",".preset_container:not(.editting, .folder_header, .folder_selectable)",function(){preset_Clicked($(this))});$("#presets_container").on("click",".btn_edit_start",function(a){btn_edit_start_Clicked($(this),a)});$("#presets_container").on("click",".btn_commit",function(a){btn_commit_Clicked($(this),a)});$("#presets_container").on("click",".btn_rollback",function(a){btn_rollback_Clicked($(this),a)});$("#presets_container").on("click",".btn_copy",function(a){btn_copy_Clicked($(this),
a)});$("#presets_container").on("click",".btn_move_folder",function(a){btn_move_folder_Clicked($(this),a)});$("#presets_container").on("click",".btn_delete",function(a){btn_delete_Clicked($(this),a)});$("#presets_container").on("click",".folder_header.editting",function(a){a.stopPropagation()});$("#presets_container").on("click",".btn_add_preset",function(a){btn_add_preset_Clicked($(this),a)});$("#presets_container").on("click",".btn_commit_folder",function(a){btn_commit_folder_Clicked($(this),a)});
$("#presets_container").on("click",".btn_rollback_folder",function(a){btn_rollback_folder_Clicked($(this),a)});$("#presets_container").on("click",".preset_container.folder_selectable",function(){folder_selectable_Clicked($(this))});$("#public_preset_tab").on("shown.bs.tab",public_preset_tab_Shown);$("#public_preset_tab").on("hidden.bs.tab",public_preset_tab_Hidden);$("#site_history").on("show.bs.collapse",".collapse",loadSiteHistory);$("#site_board").on("show.bs.collapse",".collapse",initializeBoard);
$("#site_board").on("click","#btn_send_comment",btn_send_comment_Clicked);$("#site_board").on("input","#comment_author",comment_text_Changed);$("#site_board").on("input","#comment_text",comment_text_Changed);$("#site_board").on("click",".comment_index",function(){comment_index_Clicked($(this))});$("#config_content").on("click","#confirm_tab_close",confirm_tab_close_Clicked);$("#config_content").on("click","#btn_reset_localStorage",btn_reset_localStorage_Clicked);$("#btn_url_shorten").click(btn_url_shorten_Clicked);
