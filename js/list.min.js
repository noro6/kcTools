...
p.appendChild(w);b?(m=createDiv("update_date mr-1","","\u66f4\u65b0\u65e5\u6642: "+(m[4]?m[4].split(".")[0]:"-")),p.appendChild(m)):(m=createDiv("update_date mr-3","",(m[5]?"\u4f5c\u6210\u8005: "+m[5]+"\u3000":"")+" "+(m[4]?m[4].split(".")[0]:"-")),p.appendChild(m));n.appendChild(p);k.appendChild(n)}}h.appendChild(k);!b&&prevSnapShot&&(f=createDiv("d-flex preset_container more_load"),k=createDiv("mx-auto my-auto","","\u3082\u3063\u3068\u8aad\u307f\u8fbc\u3080"),f.appendChild(k),h.appendChild(f));
