...
$jscomp.asyncExecutePromiseGenerator=function(a){function b(e){return a.next(e)}function c(e){return a["throw"](e)}return new Promise(function(e,d){function f(h){h.done?e(h.value):Promise.resolve(h.value).then(b,c).then(f,d)}f(a.next())})};$jscomp.asyncExecutePromiseGeneratorFunction=function(a){return $jscomp.asyncExecutePromiseGenerator(a())};$jscomp.asyncExecutePromiseGeneratorProgram=function(a){return $jscomp.asyncExecutePromiseGenerator(new $jscomp.generator.Generator_(new $jscomp.generator.Engine_(a)))};
...
function setPresets(a,b){var c=(b=void 0===b?!0:b)?"presets_container":"public_presets_container",e=castInt(document.getElementById("presets_order").value),d=document.getElementById("search_preset").value.trim();if(b)switch(e){case 1:a.sort(function(v,t){return v[4]<t[4]?1:-1});break;case 2:a.sort(function(v,t){return v[4]>t[4]?1:-1});break;case 3:a.sort(function(v,t){return v[1]<t[1]?1:-1});break;case 4:a.sort(function(v,t){return v[1]>t[1]?1:-1})}setting.presetsOrder=e;saveSetting();var f=0===e&&
!d&&b,h=document.createDocumentFragment();if(b){var k=createDiv("preset_container new d-flex "+(a.length?"":"border_delete")),l=createDiv("new_body mx-auto my-auto","",a.length?"\u65b0\u898f\u4f5c\u6210":"\u7de8\u6210\u3092\u65b0\u898f\u4f5c\u6210");k.appendChild(l);h.appendChild(k)}else b||0!==a.length||(k=createDiv("d-flex empty_container"),l=createDiv("mx-auto my-auto","","\u30c7\u30fc\u30bf\u304c\u898b\u3064\u304b\u308a\u307e\u305b\u3093\u3067\u3057\u305f\u3002"),k.appendChild(l),h.appendChild(k));
k=createDiv("","preset_sortable_container");l=$jscomp.makeIterator(a);for(var n=l.next();!n.done;n=l.next()){var m=n.value;if(m[1]&&!(b&&d&&0>m[1].indexOf(d))){n=createDiv();var p=createDiv("preset_container");p.dataset.presetid=m[0];b||(p.dataset.presetdata=m[2]);var w=createDiv("preset_header "+(f?"sortable_handle":""));p.appendChild(w);w=createDiv("preset_body d-flex mx-2");var q=createDiv("mr-2 preset_abstract flex-grow-1");q.appendChild(createDiv("preset_name","",m[1]));var g=document.createElement("input");
...
x.value;if(5<g.childNodes.length)break;0>=x[0]||(r=document.createElement("img"),r.className="ship_image",r.width=100,r.height=25,r.src="../img/ship/"+x[0]+".png",g.appendChild(r))}q.appendChild(g);g=createDiv("preset_memo_view border mt-1 px-1 py-1 "+(m[3]?"":"d-none"),"");g.innerHTML=AutoLink(m[3]);q.appendChild(g);g=document.createElement("textarea");g.className="form-control preset_memo mt-1 w-100 d-none";g.value=m[3]?m[3]:"";u=g.value.match(/\n/g);g.rows=u&&u.length?u.length+2:2;q.appendChild(g);
w.appendChild(q);q=createDiv("d-flex ml-auto pt-2 btns_container");b?(g=createDiv("ml-auto r_btn btn_commit d-none"),g.dataset.toggle="tooltip",g.dataset.offset="-50%",g.title="\u7de8\u96c6\u5185\u5bb9\u3092\u78ba\u5b9a\u3057\u307e\u3059\u3002",g.innerHTML='<i class="fas fa-save"></i>',q.appendChild(g),g=createDiv("ml-2 r_btn btn_rollback d-none"),g.dataset.toggle="tooltip",g.dataset.offset="-50%",g.title="\u7de8\u96c6\u5185\u5bb9\u3092\u53d6\u308a\u6d88\u3057\u307e\u3059\u3002",g.innerHTML='<i class="fas fa-undo"></i>',
...
p.appendChild(w);b?(m=createDiv("update_date mr-1","","\u66f4\u65b0\u65e5\u6642: "+m[4].split(".")[0]),p.appendChild(m)):(m=createDiv("update_date mr-3","",(m[5]?"\u4f5c\u6210\u8005: "+m[5]+"\u3000":"")+" "+m[4].split(".")[0]),p.appendChild(m));n.appendChild(p);k.appendChild(n)}}h.appendChild(k);!b&&prevSnapShot&&(f=createDiv("d-flex preset_container more_load"),k=createDiv("mx-auto my-auto","","\u3082\u3063\u3068\u8aad\u307f\u8fbc\u3080"),f.appendChild(k),h.appendChild(f));document.getElementById(c).innerHTML=
"";document.getElementById(c).appendChild(h);$("#"+c+" .r_btn").tooltip();0===e&&!d&&b&&Sortable.create(document.getElementById("preset_sortable_container"),{animation:200,handle:".sortable_handle",onEnd:function(){for(var v=loadLocalStorage("presets"),t=[],z={},A=$jscomp.makeIterator(document.getElementsByClassName("preset_container")),y=A.next();!y.done;z={$jscomp$loop$prop$c$11:z.$jscomp$loop$prop$c$11},y=A.next())z.$jscomp$loop$prop$c$11=y.value,(y=v.find(function(B){return function(C){return C[0]===
B.$jscomp$loop$prop$c$11.dataset.presetid}}(z)))&&t.push(y);t.length&&(saveLocalStorage("presets",t),inform_success("\u7de8\u6210\u30c7\u30fc\u30bf\u306e\u9806\u5e8f\u304c\u66f4\u65b0\u3055\u308c\u307e\u3057\u305f\u3002"))}})}function AutoLink(a){return a.replace(/((h?)(ttps?:\/\/[a-zA-Z0-9.\-_@:/~?%&;=+#',()*!]+))/g,function(b,c,e,d){return'<a href="h'+d+'" target="_blank">'+c+"</a>"})}
...
function searchUploadedPreset(){var a=getPublicPresetsQuery(),b=[];fb||initializeFB();if(fb){var c=null;c=a.map?fb.collection("presets").where("map","==",a.map).where("level","==",a.level).orderBy(a.sortKey,a.order).limit(STEP):fb.collection("presets").orderBy(a.sortKey,a.order).limit(STEP);c.get().then(function(e){prevSnapShot=e.docs[e.docs.length-1];e.forEach(function(d){var f=d.data();d=d.data().createdAt?d.data().createdAt.toDate():new Date;d=["",f.name+(0===a.map&&0<f.level?"\u3010"+DIFFICULTY.find(function(h){return h.id===
f.level}).name+"\u3011":""),f.data,f.memo,formatDate(d,"yyyy/MM/dd HH:mm"),f.user];b.push(d)});if(b.length<STEP||!a.map)prevSnapShot=null;setPresets(b,!1);saveSessionStorage("search_result",{map:a.map,level:a.level,sortKey:a.sortKey,order:a.order,presets:b})})["catch"](function(e){console.error(e);inform_danger("\u7de8\u6210\u30c7\u30fc\u30bf\u306e\u8aad\u307f\u8fbc\u307f\u306b\u5931\u6557\u3057\u307e\u3057\u305f\u3002")})}}
function getPublicPresetsQuery(){$("#btn_search_preset").prop("disabled",!0);var a=castInt($("#map_select").val()),b=400<a?castInt($("#select_preset_level").val()):0,c="createdAt",e="desc";switch(castInt(document.getElementById("presets_order").value)){case 2:e="asc";break;case 3:c="name";break;case 4:c="name",e="asc"}return{map:a,level:b,sortKey:c,order:e}}
...
"==",b.level).orderBy(b.sortKey,b.order).startAfter(prevSnapShot).limit(STEP).get().then(function(e){prevSnapShot=e.docs[e.docs.length-1];e.forEach(function(d){var f=d.data();d=d.data().createdAt?d.data().createdAt.toDate():new Date;f=["",f.name,f.data,f.memo,formatDate(d,"yyyy/MM/dd HH:mm"),f.user];c.push(f)});e.docs.length<STEP&&(prevSnapShot=null);setPresets(c,!1);saveSessionStorage("search_result",{map:b.map,level:b.level,sortKey:b.sortKey,order:b.order,presets:c})})["catch"](function(e){console.error(e);
...
function btn_commit_Clicked(a,b){b=void 0===b?null:b;var c=a.closest(".preset_container"),e=c[0].dataset.presetid,d=loadLocalStorage("presets");d||(d=[]);var f=d.findIndex(function(l){return l[0]===e});if(0<=f){var h=c.find(".preset_name_edit").val().trim(),k=c.find(".preset_memo").val().trim();h&&(50<h.length&&(h=h.slice(0,50),c.find(".preset_name_edit").val(h)),d[f][1]=h,c.find(".preset_name").text(h));400<k.length&&(k=k.slice(0,400),c.find(".preset_memo").val(k));d[f][3]=k;f=k.replace(/\r?\n/g,
" ");c.find(".preset_memo_view").text(f);f.trim().length?c.find(".preset_memo_view").removeClass("d-none"):c.find(".preset_memo_view").addClass("d-none");saveLocalStorage("presets",d)}btn_rollback_Clicked(a,b);setTab();$(".fleet_tab.active").removeClass("active");inform_success("\u7de8\u6210\u60c5\u5831\u306e\u66f4\u65b0\u304c\u5b8c\u4e86\u3057\u307e\u3057\u305f\u3002")}
...
e.id}))?e=b:a.presets.push(e);a.activeId=e.id;saveLocalStorage("activePresets",a);window.location.href="../simulator/?p="+e.history.histories[e.history.index]}function public_preset_Clicked(a){var b=a.closest(".preset_container");a=b[0].dataset.presetdata;b=b.find(".preset_name").text();window.location.href="../simulator/?d="+a+"&name="+encodeURIComponent(b)}
function btn_copy_Clicked(a,b){b.stopPropagation();var c=loadLocalStorage("presets"),e=a.closest(".preset_container")[0].dataset.presetid;if(c=c?c.find(function(f){return f[0]===e}):null){c={id:getUniqueId(),name:c[1]+"_\u30b3\u30d4\u30fc",history:{index:0,histories:[c[2]]}};var d=loadLocalStorage("activePresets");d||(d={activeId:"",presets:[]});d.presets.push(c);d.activeId=c.id;saveLocalStorage("activePresets",d);window.location.href="../simulator/?p="+c.history.histories[c.history.index]}else inform_danger("\u8907\u88fd\u5bfe\u8c61\u306e\u7de8\u6210\u30c7\u30fc\u30bf\u304c\u898b\u3064\u304b\u308a\u307e\u305b\u3093\u3067\u3057\u305f\u3002")}
...
function version_detail_Clicked(){if(!document.getElementById("version_inform_body").innerHTML){for(var a=CHANGE_LOG.find(function(l){return l.id===LATEST_VERSION}),b=document.createDocumentFragment(),c=$jscomp.makeIterator(a.changes),e=c.next();!e.done;e=c.next()){e=e.value;var d=createDiv("mt-3"),f=document.createElement("div"),h=document.createElement("span");h.className="mr-1 pt-1 badge badge-pill badge-"+(0===e.type?"success":1===e.type?"info":"danger");h.textContent=0===e.type?"\u65b0\u898f":
1===e.type?"\u5909\u66f4":"\u4fee\u6b63";var k=document.createElement("span");k.innerHTML=e.title;f.appendChild(h);f.appendChild(k);d.appendChild(f);e.content&&(f=createDiv("font_size_12 pl-3"),f.innerHTML=e.content,d.appendChild(f));b.appendChild(d)}document.getElementById("version").textContent=a.id;document.getElementById("version_inform_body").appendChild(b);setting.version=a.id;saveSetting();document.getElementsByClassName("version_detail")[0].classList.remove("unread")}$("#modal_version_inform").modal("show")}
function loadSiteHistory(){if(!document.getElementById("site_history_body").innerHTML){for(var a=document.createDocumentFragment(),b=0,c=LATEST_VERSION,e=$jscomp.makeIterator(CHANGE_LOG),d=e.next();!d.done;d=e.next()){d=d.value;var f=createDiv("my-3 ver_log border-bottom"),h=createDiv("py-2","","v"+d.id);if(c===d.id){var k=document.createElement("span");k.className="ml-2 pt-1 badge badge-pill badge-danger";k.textContent="New";h.appendChild(k)}f.appendChild(h);for(h=0;h<d.changes.length;h++){k=d.changes[h];
...
function initializeBoard(){fb||initializeFB();if(fb)fb.collection("comments").orderBy("createdAt","desc").limit(30).onSnapshot(function(a){var b=document.createDocumentFragment();a.forEach(function(c){var e=document.createElement("div");e.className="general_box my-3 px-3 pt-3 pb-1 comment";var d=document.createElement("div");d.className="d-flex mb-1";var f=document.createElement("div");f.className="comment_index text-primary";f.dataset.number=c.data().number;f.textContent=c.data().number+":";var h=
document.createElement("div");h.className="comment_writer ml-1 mr-2";h.textContent=c.data().author;var k=c.data().createdAt?c.data().createdAt.toDate():new Date,l=document.createElement("div");l.className="comment_date opacity6 font_size_11 align-self-center";l.textContent=" -- "+formatDate(k,"yyyy/MM/dd HH:mm:ss");d.appendChild(f);d.appendChild(h);d.appendChild(l);f=new Date;f.setDate(f.getDate()-7);k>f&&(f.setDate(f.getDate()+4),h=document.createElement("div"),h.className="font_size_11 align-self-center ml-1 "+
(k>f?"text-danger":"text-success"),h.textContent="New",d.appendChild(h));k=document.createElement("div");k.className="comment_content align-self-center";k.textContent=c.data().content;e.appendChild(d);e.appendChild(k);b.appendChild(e)});document.getElementById("coment_board").innerHTML="";document.getElementById("coment_board").appendChild(b)});comment_text_Changed()}
...
function send_comment(){if(fb){var a=document.getElementById("comment_author").value.trim(),b=document.getElementById("comment_text").value.trim();a||(a="\u540d\u7121\u3057\u3055\u3093");fb.runTransaction(function(c){var e=fb.collection("comments"),d=e.doc();return c.get(d).then(function(){var f,h,k;return $jscomp.asyncExecutePromiseGeneratorProgram(function(l){switch(l.nextAddress){case 1:return l.yield(e.orderBy("createdAt","desc").limit(1).get(),2);case 2:f=l.yieldResult;if(!f){l.jumpTo(0);break}h=
...
function btn_url_shorten_Clicked(){var a,b,c,e;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress){a=document.getElementById("btn_url_shorten");b=document.getElementById("input_url");c=b.value.trim();if(a.classList.contains("shortening"))return d["return"]();a.classList.add("shortening");a.textContent="\u77ed\u7e2e\u4e2d";return c?c.match(/^(https?|ftp)(:\/\/[-_.!~*'()a-zA-Z0-9;\/?:@&=+\$,%#]+)$/)?c.match(/^(https:\/\/aircalc.page.link\/)([.!~*'()a-zA-Z0-9;\/?:@&=+\$,%#]+)$/)?
d.jumpTo(2):d.yield(postURLData(c).then(function(f){f.error||!f.shortLink?(b.value="",inform_danger("\u5165\u529b\u3055\u308c\u305fURL\u306e\u77ed\u7e2e\u306b\u5931\u6557\u3057\u307e\u3057\u305f\u3002")):(b.value=f.shortLink,inform_success("URL\u306e\u77ed\u7e2e\u306b\u6210\u529f\u3057\u307e\u3057\u305f\u3002"))})["catch"](function(f){b.value="";inform_danger("\u5165\u529b\u3055\u308c\u305fURL\u306e\u77ed\u7e2e\u306b\u5931\u6557\u3057\u307e\u3057\u305f\u3002")}),2):(b.value="",(e=readDeckBuilder(c))?
window.location.href="../simulator/?predeck="+c:readEquipmentJson(c)?inform_success("\u6240\u6301\u88c5\u5099\u306e\u53cd\u6620\u306b\u6210\u529f\u3057\u307e\u3057\u305f\u3002"):readShipJson(c)?inform_success("\u6240\u6301\u8266\u5a18\u306e\u53cd\u6620\u306b\u6210\u529f\u3057\u307e\u3057\u305f\u3002"):inform_danger("\u5165\u529b\u3055\u308c\u305fURL\u306e\u77ed\u7e2e\u306b\u5931\u6557\u3057\u307e\u3057\u305f\u3002"),d.jumpTo(2)):(b.value="",inform_warning("URL\u3092\u5165\u529b\u3057\u3066\u304f\u3060\u3055\u3044\u3002"),
...
b={},c=$jscomp.makeIterator(WORLD_DATA),e=c.next();!e.done;b={$jscomp$loop$prop$world$13:b.$jscomp$loop$prop$world$13},e=c.next()){e=e.value;b.$jscomp$loop$prop$world$13=e.world;var d=MAP_DATA.filter(function(f){return function(h){return Math.floor(h.area/10)===f.$jscomp$loop$prop$world$13}}(b));a+='<optgroup label="'+e.name+'">';e=$jscomp.makeIterator(d);for(d=e.next();!d.done;d=e.next())d=d.value,a+='<option value="'+d.area+'">'+(20<b.$jscomp$loop$prop$world$13?"E":b.$jscomp$loop$prop$world$13)+
"-"+d.area%10+" : "+d.name+"</option>"}$("#map_select").html(a);if(a=loadSessionStorage("search_result"))$("#map_select").val(a.map),setPresets(a.presets,!1)}map_select_Changed()}
