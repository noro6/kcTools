...
"","\u30c7\u30fc\u30bf\u304c\u898b\u3064\u304b\u308a\u307e\u305b\u3093\u3067\u3057\u305f\u3002"),l.appendChild(k),n.appendChild(l));k=setting.presetFolders;l=[];for(var u={},r=0;r<k.length;u={$jscomp$loop$prop$folder$31:u.$jscomp$loop$prop$folder$31},r++){u.$jscomp$loop$prop$folder$31=k[r];var y=createDiv(),v=a.filter(function(w){return function(q){return 6<=q.length&&q[5]===w.$jscomp$loop$prop$folder$31.id}}(u)).length,t=createDiv("preset_container folder_header "+(0!==v||f?"":"d-none"));v&&(t.dataset.toggle=
"collapse",t.dataset.target="#folder"+u.$jscomp$loop$prop$folder$31.id);t.dataset.folderid=u.$jscomp$loop$prop$folder$31.id;var g=createDiv("d-flex my-auto ml-3 mr-2"),p=createDiv("preset_name align-self-center");p.innerHTML='<i class="fas fa-folder'+(v?"-open":" opacity4")+' mr-2 cur_move handle"></i>'+u.$jscomp$loop$prop$folder$31.name;g.appendChild(p);p=createDiv("ml-3 font_size_12 align-self-center font_color_half preset_count");p.textContent="( "+v+"\u4ef6 )";v&&g.appendChild(p);p=document.createElement("input");
p.type="text";p.maxLength=50;p.className="form-control form-control-sm preset_name_edit mb-1 mr-3 d-none";p.value=u.$jscomp$loop$prop$folder$31.name;g.appendChild(p);p=createDiv("d-flex ml-auto btns_container");var m=createDiv("ml-auto r_btn btn_commit_folder d-none");m.dataset.toggle="tooltip";m.dataset.offset="-50%";m.title="\u9078\u629e\u3057\u305f\u7de8\u6210\u3092\u3053\u306e\u30d5\u30a9\u30eb\u30c0\u30fc\u306b\u8ffd\u52a0\u3057\u307e\u3059\u3002";m.innerHTML='<i class="fas fa-save"></i>';p.appendChild(m);
...
m.dataset.toggle="tooltip";m.dataset.offset="-50%";m.title="\u30d5\u30a9\u30eb\u30c0\u30fc\u540d\u306e\u5909\u66f4\u3092\u884c\u3044\u307e\u3059\u3002";m.innerHTML='<i class="fas fa-pencil"></i>';p.appendChild(m);g.appendChild(p);t.appendChild(g);g=document.createElement("div");g.id="folder"+u.$jscomp$loop$prop$folder$31.id;g.dataset.folderid=u.$jscomp$loop$prop$folder$31.id;g.className="folder_content pl-5";v&&(g.classList.add("collapse"),u.$jscomp$loop$prop$folder$31.isOpen&&g.classList.add("show"));
y.appendChild(g);l.push({id:u.$jscomp$loop$prop$folder$31.id,header:t,container:g})}f=createDiv("","preset_sortable_container");k={};u=$jscomp.makeIterator(a);for(r=u.next();!r.done;k={$jscomp$loop$prop$preset$33:k.$jscomp$loop$prop$preset$33},r=u.next())if(k.$jscomp$loop$prop$preset$33=r.value,k.$jscomp$loop$prop$preset$33[1]&&!(c&&e&&0>k.$jscomp$loop$prop$preset$33[1].indexOf(e))){r=createDiv();y=createDiv("preset_container");y.dataset.presetid=k.$jscomp$loop$prop$preset$33[0];c||(y.dataset.presetdata=
k.$jscomp$loop$prop$preset$33[2]);v=createDiv("preset_header");y.appendChild(v);v=createDiv("preset_body d-flex mx-2");h&&(t=createDiv("mt-4 sortable_handle_parent align-self-center"),t.innerHTML='<i class="sortable_handle fa-menu2"></i>',v.appendChild(t));t=createDiv("mr-2 preset_abstract flex-grow-1");t.appendChild(createDiv("preset_name","",k.$jscomp$loop$prop$preset$33[1]));g=document.createElement("input");g.type="text";g.maxLength=50;g.className="form-control form-control-sm preset_name_edit mb-1 d-none";
g.value=k.$jscomp$loop$prop$preset$33[1];t.appendChild(g);m=decodePreset(k.$jscomp$loop$prop$preset$33[2])[1];g=createDiv("d-flex ships flex-wrap");p=5;m.length&&6<=m[0].length&&2===m[0][5]&&(p=6);m=$jscomp.makeIterator(m);for(var B=m.next();!B.done;B=m.next()){B=B.value;if(g.childNodes.length>p)break;if(!(0>=B[0])){var C=document.createElement("img");C.className="ship_image";C.width=100;C.height=25;C.src="../img/ship/"+B[0]+".png";g.appendChild(C)}}t.appendChild(g);g=createDiv("preset_memo_view border mt-1 px-1 py-1 "+
(k.$jscomp$loop$prop$preset$33[3]?"":"d-none"),"");g.innerHTML=AutoLink(k.$jscomp$loop$prop$preset$33[3]);t.appendChild(g);g=document.createElement("textarea");g.className="form-control preset_memo mt-1 w-100 d-none";g.value=k.$jscomp$loop$prop$preset$33[3]?k.$jscomp$loop$prop$preset$33[3]:"";p=g.value.match(/\n/g);g.rows=p&&p.length?p.length+2:2;t.appendChild(g);v.appendChild(t);t=createDiv("d-flex ml-auto pt-2 btns_container");c?(g=createDiv("ml-auto r_btn btn_commit d-none"),g.dataset.toggle="tooltip",
g.dataset.offset="-50%",g.title="\u7de8\u96c6\u5185\u5bb9\u3092\u78ba\u5b9a\u3057\u307e\u3059\u3002",g.innerHTML='<i class="fas fa-save"></i>',t.appendChild(g),g=createDiv("ml-2 r_btn btn_rollback d-none"),g.dataset.toggle="tooltip",g.dataset.offset="-50%",g.title="\u7de8\u96c6\u5185\u5bb9\u3092\u53d6\u308a\u6d88\u3057\u307e\u3059\u3002",g.innerHTML='<i class="fas fa-undo"></i>',t.appendChild(g),g=createDiv("ml-auto r_btn btn_edit_start"),g.dataset.toggle="tooltip",g.dataset.offset="-50%",g.title=
"\u7de8\u6210\u540d\u3084\u7de8\u6210\u30e1\u30e2\u306e\u5909\u66f4\u3092\u884c\u3044\u307e\u3059\u3002",g.innerHTML='<i class="fas fa-pencil"></i>',t.appendChild(g),g=createDiv("ml-2 r_btn btn_copy"),g.dataset.toggle="tooltip",g.dataset.offset="-50%",g.title="\u7de8\u6210\u3092\u8907\u88fd\u3057\u3066\u65b0\u3057\u3044\u7de8\u6210\u30bf\u30d6\u3092\u4f5c\u6210\u3057\u307e\u3059\u3002",g.innerHTML='<i class="fas fa-copy"></i>',t.appendChild(g),g=createDiv("ml-2 r_btn btn_move_folder"),g.dataset.toggle=
"tooltip",g.dataset.offset="-50%",g.title="\u6240\u5c5e\u30d5\u30a9\u30eb\u30c0\u30fc\u3092\u5909\u66f4\u3057\u307e\u3059\u3002",g.innerHTML='<i class="fas fa-folder-upload"></i>',t.appendChild(g),g=createDiv("ml-2 r_btn btn_delete"),g.dataset.toggle="tooltip",g.dataset.offset="-50%",g.title="\u7de8\u6210\u3092\u524a\u9664\u3057\u307e\u3059\u3002",g.innerHTML='<i class="fas fa-trash-o"></i>',t.appendChild(g)):(g=createDiv("ml-2 r_btn btn_open"),g.dataset.toggle="tooltip",g.dataset.offset="-50%",g.title=
"\u7de8\u6210\u3092\u5c55\u958b\u3057\u307e\u3059\u3002",g.innerHTML='<i class="fas fa-folder-open-o"></i>',t.appendChild(g));v.appendChild(t);y.appendChild(v);c?(v=createDiv("update_date mr-1","","\u66f4\u65b0\u65e5\u6642: "+(k.$jscomp$loop$prop$preset$33[4]?k.$jscomp$loop$prop$preset$33[4].split(".")[0]:"-")),y.appendChild(v)):(v=createDiv("update_date mr-3","",(k.$jscomp$loop$prop$preset$33[5]?"\u4f5c\u6210\u8005: "+k.$jscomp$loop$prop$preset$33[5]+"\u3000":"")+" "+(k.$jscomp$loop$prop$preset$33[4]?
k.$jscomp$loop$prop$preset$33[4].split(".")[0]:"-")),y.appendChild(v));r.appendChild(y);c&&6<=k.$jscomp$loop$prop$preset$33.length?(y=l.find(function(w){return function(q){return q.id===w.$jscomp$loop$prop$preset$33[5]}}(k)))?y.container.appendChild(r):f.appendChild(r):f.appendChild(r)}n.appendChild(f);if(c){h=createDiv("","foldersParent");l=$jscomp.makeIterator(l);for(f=l.next();!f.done;f=l.next())f=f.value,k=createDiv(),k.appendChild(f.header),k.appendChild(f.container),h.appendChild(k);n.appendChild(h)}!c&&
prevSnapShot&&(h=createDiv("d-flex preset_container more_load"),l=createDiv("mx-auto my-auto","","\u3082\u3063\u3068\u8aad\u307f\u8fbc\u3080"),h.appendChild(l),n.appendChild(h));document.getElementById(b).innerHTML="";document.getElementById(b).appendChild(n);$("#"+b+" .r_btn").tooltip();if(0===d&&!e&&c)for(Sortable.create(document.getElementById("preset_sortable_container"),{animation:200,handle:".sortable_handle",onStart:function(){document.getElementById("header").classList.add("d-none");document.getElementById("main_footer").classList.add("d-none")},
onEnd:function(){document.getElementById("header").classList.remove("d-none");document.getElementById("main_footer").classList.remove("d-none");for(var w=loadLocalStorage("presets"),q=[],z={},A=$jscomp.makeIterator(document.getElementsByClassName("preset_container")),x=A.next();!x.done;z={$jscomp$loop$prop$c$35:z.$jscomp$loop$prop$c$35},x=A.next())z.$jscomp$loop$prop$c$35=x.value,(x=w.find(function(D){return function(E){return E[0]===D.$jscomp$loop$prop$c$35.dataset.presetid}}(z)))&&q.push(x);q.length&&
(saveLocalStorage("presets",q),inform_success("\u7de8\u6210\u30c7\u30fc\u30bf\u306e\u9806\u5e8f\u304c\u66f4\u65b0\u3055\u308c\u307e\u3057\u305f\u3002"))}}),b=setting.presetFolders,d=0;d<b.length;d++)Sortable.create(document.getElementById("folder"+b[d].id),{animation:200,handle:".sortable_handle",onStart:function(){document.getElementById("header").classList.add("d-none");document.getElementById("main_footer").classList.add("d-none")},onEnd:function(){document.getElementById("header").classList.remove("d-none");
document.getElementById("main_footer").classList.remove("d-none");for(var w=loadLocalStorage("presets"),q=[],z={},A=$jscomp.makeIterator(document.getElementsByClassName("preset_container")),x=A.next();!x.done;z={$jscomp$loop$prop$c$37:z.$jscomp$loop$prop$c$37},x=A.next())z.$jscomp$loop$prop$c$37=x.value,(x=w.find(function(D){return function(E){return E[0]===D.$jscomp$loop$prop$c$37.dataset.presetid}}(z)))&&q.push(x);q.length&&(saveLocalStorage("presets",q),inform_success("\u7de8\u6210\u30c7\u30fc\u30bf\u306e\u9806\u5e8f\u304c\u66f4\u65b0\u3055\u308c\u307e\u3057\u305f\u3002"))}});
c&&document.getElementById("foldersParent")&&Sortable.create(document.getElementById("foldersParent"),{animation:200,handle:".handle",onStart:function(){document.getElementById("header").classList.add("d-none");document.getElementById("main_footer").classList.add("d-none")},onEnd:function(){document.getElementById("header").classList.remove("d-none");document.getElementById("main_footer").classList.remove("d-none");for(var w=setting.presetFolders,q=[],z={},A=$jscomp.makeIterator(document.getElementsByClassName("folder_header")),
...
0;return l.yield(Promise.all(f.docs.map(function(k){var u;return $jscomp.asyncExecutePromiseGeneratorProgram(function(r){if(1==r.nextAddress)return r.yield(k.data(),2);if(3!=r.nextAddress)return u=r.yieldResult,r.yield(u.number,3);h=r.yieldResult;r.jumpToEnd()})})),4);case 4:if(!(0<=castInt(h,-1)))return l["return"](Promise.reject("ID\u63a1\u756a\u30a8\u30e9\u30fc :",h));n={number:castInt(h)+1,author:a,content:c,createdAt:firebase.firestore.FieldValue.serverTimestamp()};return l.yield(b.set(e,n),
