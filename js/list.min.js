...
function preset_Clicked(a){var c=loadLocalStorage("presets"),b=a[0].dataset.presetid;c=c?c.find(function(d){return d[0]===b}):null;var e={id:getUniqueId(),name:getMaxUntitled(),history:{index:0,histories:["Noi6BpgWgRnX41BYLgAZKe-H6IBEB4cSaA3gQMYCuALgJYB2AkgCYEBcmBATgIZ0AplxjoedfgCMANiM6pwBKQHtebIb1HiAvhBwAzfjIDOQ8EdPnFZIA"]}};c&&(e.id=c[0],e.name=a.find(".preset_name").text(),e.history.histories[0]=c[2]);(a=loadLocalStorage("activePresets"))||(a={activeId:"",presets:[]});(c=a.presets.find(function(d){return d.id===
