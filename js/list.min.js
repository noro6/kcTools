...
$jscomp.POLYFILL_PREFIX+e),$jscomp.defineProperty(d,$jscomp.propertyToPolyfillSymbol[e],{configurable:!0,writable:!0,value:c})))};$jscomp.underscoreProtoCanBeSet=function(){var a={a:!0},c={};try{return c.__proto__=a,c.a}catch(b){}return!1};$jscomp.setPrototypeOf=$jscomp.TRUST_ES6_POLYFILLS&&"function"==typeof Object.setPrototypeOf?Object.setPrototypeOf:$jscomp.underscoreProtoCanBeSet()?function(a,c){a.__proto__=c;if(a.__proto__!==c)throw new TypeError(a+" is not extensible");return a}:null;
...
k.$jscomp$loop$prop$preset$33[2]);v=createDiv("preset_header "+(h?"sortable_handle":""));y.appendChild(v);v=createDiv("preset_body d-flex mx-2");u=createDiv("mr-2 preset_abstract flex-grow-1");u.appendChild(createDiv("preset_name","",k.$jscomp$loop$prop$preset$33[1]));g=document.createElement("input");g.type="text";g.maxLength=50;g.className="form-control form-control-sm preset_name_edit mb-1 d-none";g.value=k.$jscomp$loop$prop$preset$33[1];u.appendChild(g);p=decodePreset(k.$jscomp$loop$prop$preset$33[2]);
g=p[0];p=p[1];m=createDiv("d-none d-md-flex land_base_status");for(var A=1;3>=A;A++)m.appendChild(createDiv("land_base_state no_"+A+" mr-1 "+(1<=g.length&&g[1].length>=A&&0<=g[1][A-1]?"":"disabled"),"","\u7b2c"+A+"\u57fa\u5730\u822a\u7a7a\u968a"));u.appendChild(m);g=createDiv("d-flex ships flex-wrap");p=$jscomp.makeIterator(p);for(m=p.next();!m.done;m=p.next()){m=m.value;if(5<g.childNodes.length)break;0>=m[0]||(A=document.createElement("img"),A.className="ship_image",A.width=100,A.height=25,A.src=
"../img/ship/"+m[0]+".png",g.appendChild(A))}u.appendChild(g);g=createDiv("preset_memo_view border mt-1 px-1 py-1 "+(k.$jscomp$loop$prop$preset$33[3]?"":"d-none"),"");g.innerHTML=AutoLink(k.$jscomp$loop$prop$preset$33[3]);u.appendChild(g);g=document.createElement("textarea");g.className="form-control preset_memo mt-1 w-100 d-none";g.value=k.$jscomp$loop$prop$preset$33[3]?k.$jscomp$loop$prop$preset$33[3]:"";p=g.value.match(/\n/g);g.rows=p&&p.length?p.length+2:2;u.appendChild(g);v.appendChild(u);u=
createDiv("d-flex ml-auto pt-2 btns_container");c?(g=createDiv("ml-auto r_btn btn_commit d-none"),g.dataset.toggle="tooltip",g.dataset.offset="-50%",g.title="\u7de8\u96c6\u5185\u5bb9\u3092\u78ba\u5b9a\u3057\u307e\u3059\u3002",g.innerHTML='<i class="fas fa-save"></i>',u.appendChild(g),g=createDiv("ml-2 r_btn btn_rollback d-none"),g.dataset.toggle="tooltip",g.dataset.offset="-50%",g.title="\u7de8\u96c6\u5185\u5bb9\u3092\u53d6\u308a\u6d88\u3057\u307e\u3059\u3002",g.innerHTML='<i class="fas fa-undo"></i>',
u.appendChild(g),g=createDiv("ml-auto r_btn btn_edit_start"),g.dataset.toggle="tooltip",g.dataset.offset="-50%",g.title="\u7de8\u6210\u540d\u3084\u7de8\u6210\u30e1\u30e2\u306e\u5909\u66f4\u3092\u884c\u3044\u307e\u3059\u3002",g.innerHTML='<i class="fas fa-pencil"></i>',u.appendChild(g),g=createDiv("ml-2 r_btn btn_copy"),g.dataset.toggle="tooltip",g.dataset.offset="-50%",g.title="\u7de8\u6210\u3092\u8907\u88fd\u3057\u3066\u65b0\u3057\u3044\u7de8\u6210\u30bf\u30d6\u3092\u4f5c\u6210\u3057\u307e\u3059\u3002",
g.innerHTML='<i class="fas fa-copy"></i>',u.appendChild(g),g=createDiv("ml-2 r_btn btn_move_folder"),g.dataset.toggle="tooltip",g.dataset.offset="-50%",g.title="\u6240\u5c5e\u30d5\u30a9\u30eb\u30c0\u30fc\u3092\u5909\u66f4\u3057\u307e\u3059\u3002",g.innerHTML='<i class="fas fa-folder-upload"></i>',u.appendChild(g),g=createDiv("ml-2 r_btn btn_delete"),g.dataset.toggle="tooltip",g.dataset.offset="-50%",g.title="\u7de8\u6210\u3092\u524a\u9664\u3057\u307e\u3059\u3002",g.innerHTML='<i class="fas fa-trash-o"></i>',
u.appendChild(g)):(g=createDiv("ml-2 r_btn btn_open"),g.dataset.toggle="tooltip",g.dataset.offset="-50%",g.title="\u7de8\u6210\u3092\u5c55\u958b\u3057\u307e\u3059\u3002",g.innerHTML='<i class="fas fa-folder-open-o"></i>',u.appendChild(g));v.appendChild(u);y.appendChild(v);c?(v=createDiv("update_date mr-1","","\u66f4\u65b0\u65e5\u6642: "+(k.$jscomp$loop$prop$preset$33[4]?k.$jscomp$loop$prop$preset$33[4].split(".")[0]:"-")),y.appendChild(v)):(v=createDiv("update_date mr-3","",(k.$jscomp$loop$prop$preset$33[5]?
...
f.value,k=createDiv(),k.appendChild(f.header),k.appendChild(f.container),h.appendChild(k);n.appendChild(h)}!c&&prevSnapShot&&(h=createDiv("d-flex preset_container more_load"),l=createDiv("mx-auto my-auto","","\u3082\u3063\u3068\u8aad\u307f\u8fbc\u3080"),h.appendChild(l),n.appendChild(h));document.getElementById(b).innerHTML="";document.getElementById(b).appendChild(n);$("#"+b+" .r_btn").tooltip();if(0===d&&!e&&c)for(Sortable.create(document.getElementById("preset_sortable_container"),{animation:200,
handle:".sortable_handle",onEnd:function(){for(var w=loadLocalStorage("presets"),q=[],z={},B=$jscomp.makeIterator(document.getElementsByClassName("preset_container")),x=B.next();!x.done;z={$jscomp$loop$prop$c$35:z.$jscomp$loop$prop$c$35},x=B.next())z.$jscomp$loop$prop$c$35=x.value,(x=w.find(function(C){return function(D){return D[0]===C.$jscomp$loop$prop$c$35.dataset.presetid}}(z)))&&q.push(x);q.length&&(saveLocalStorage("presets",q),inform_success("\u7de8\u6210\u30c7\u30fc\u30bf\u306e\u9806\u5e8f\u304c\u66f4\u65b0\u3055\u308c\u307e\u3057\u305f\u3002"))}}),
b=setting.presetFolders,d=0;d<b.length;d++)Sortable.create(document.getElementById("folder"+b[d].id),{animation:200,handle:".sortable_handle",onEnd:function(){for(var w=loadLocalStorage("presets"),q=[],z={},B=$jscomp.makeIterator(document.getElementsByClassName("preset_container")),x=B.next();!x.done;z={$jscomp$loop$prop$c$37:z.$jscomp$loop$prop$c$37},x=B.next())z.$jscomp$loop$prop$c$37=x.value,(x=w.find(function(C){return function(D){return D[0]===C.$jscomp$loop$prop$c$37.dataset.presetid}}(z)))&&
q.push(x);q.length&&(saveLocalStorage("presets",q),inform_success("\u7de8\u6210\u30c7\u30fc\u30bf\u306e\u9806\u5e8f\u304c\u66f4\u65b0\u3055\u308c\u307e\u3057\u305f\u3002"))}});c&&document.getElementById("foldersParent")&&Sortable.create(document.getElementById("foldersParent"),{animation:200,handle:".handle",onEnd:function(){for(var w=setting.presetFolders,q=[],z={},B=$jscomp.makeIterator(document.getElementsByClassName("folder_header")),x=B.next();!x.done;z={$jscomp$loop$prop$c$39:z.$jscomp$loop$prop$c$39},
x=B.next())z.$jscomp$loop$prop$c$39=x.value,(x=w.find(function(C){return function(D){return D.id===castInt(C.$jscomp$loop$prop$c$39.dataset.folderid)}}(z)))&&q.push(x);q.length&&(setting.presetFolders=q,saveSetting(),inform_success("\u30d5\u30a9\u30eb\u30c0\u30fc\u306e\u9806\u5e8f\u304c\u66f4\u65b0\u3055\u308c\u307e\u3057\u305f\u3002"))}})}
function AutoLink(a){return a.replace(/((h?)(ttps?:\/\/[a-zA-Z0-9.\-_@:/~?%&;=+#',()*!]+))/g,function(c,b,d,e){return'<a href="h'+e+'" target="_blank">'+b+"</a>"})}
