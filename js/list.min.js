...
$("#modal_share").on("input","#output_deck",function(){$(this).removeClass("is-valid")});$("#modal_share").on("click","#output_url",function(){output_data_Clicked($(this))});$("#modal_share").on("click","#output_deck",function(){output_data_Clicked($(this))});$("#modal_share").on("click","#open_deckBuilder",open_deckBuilder);$("#modal_share").on("click","#open_jervis",open_Jervis);$("#modal_inform_newversion").on("hide.bs.modal",function(){document.getElementById("read_new_version").checked?setting.checkedNewVersion=
!0:setting.checkedNewVersion=!1;saveSetting()})});window.onpageshow=function(){document.getElementById("search_preset").value&&(document.getElementById("search_preset").value="",setLocalPresets())};
