...
function pattern_Changed(a){a=castInt(a.data("disp"),-1);0>a||createEnemyPattern(a)}function enemy_display_mode_Changed(a){setting.enemyDisplayImage=a.attr("id").includes("enemy_display_image");saveLocalStorage("setting",setting);a=castInt($("#enemy_pattern_select").find(".nav-link.active").data("disp"));0<a?createEnemyPattern(a):createEnemyPattern()}
...
function btn_preset_all_Clicked(){loadMainPreset();$("#modal_main_preset").modal("show")}function btn_auto_expand_Clicked(){$("#alert_auto_expand").addClass("d-none");$("#modal_auto_expand").modal("show")}function btn_twitter_Clicked(){window.open("https://twitter.com/share?url=https://noro6.github.io/kcTools/?d="+encodePreset())}function btn_deckBuilder_Clicked(){window.open("http://kancolle-calc.net/deckbuilder.html?predeck="+convertToDeckBuilder())}
...
function btn_output_url_Clicked(){try{var a=$("#output_url");a.val(location.protocol+"//"+location.hostname+location.pathname+"?d="+encodePreset());a.nextAll(".valid-feedback").text("\u751f\u6210\u3057\u307e\u3057\u305f\u3002\u4e0a\u8a18URL\u3092\u30af\u30ea\u30c3\u30af\u3059\u308b\u3068\u30af\u30ea\u30c3\u30d7\u30dc\u30fc\u30c9\u306b\u30b3\u30d4\u30fc\u3055\u308c\u307e\u3059\u3002");a.removeClass("is-invalid").addClass("is-valid")}catch(b){$("#output_url").addClass("is-invalid").removeClass("is-valid")}}
...
function(){calculate_count_Changed($(this))});$("#config_content").on("click","#btn_reset_localStorage",btn_reset_localStorage_Clicked);$("#config_content").on("click","#innerProfSetting .custom-control-input",function(){innerProfSetting_Clicked($(this))});$("#config_content").on("click","#auto_save",auto_save_Clicked);$("#config_content").on("click","#clipboard_mode",clipboard_mode_Clicked);$("#config_content").on("click","#air_raid_max",air_raid_max_Clicked);$("#config_content").on("click",".dropdown-item",
...
$("#modal_plane_select").on("change","#plane_type_select",plane_type_select_Changed);$("#modal_plane_select").on("click","#disp_in_stock",disp_in_stock_Checked_Chenged);$("#modal_plane_select").on("click","#disp_equipped",disp_equipped_Checked_Chenged);$("#modal_plane_select").on("input","#plane_word",plane_word_TextChanged);$("#modal_plane_select").on("change","#plane_sort_select",function(){sort_Changed($(this))});$("#modal_plane_select").on("click","#plane_asc",function(){sort_Changed($(this))});
