...
$(".progress_area").each(function(a,b){$(b).find(".result_bar").attr("id","result_bar_"+(a+1));6>a&&$(b).find(".progress_label").text("\u57fa\u5730"+(Math.floor(a/2)+1)+" "+(a%2+1)+"\u6ce2\u76ee");6===a&&$(b).find(".progress_label").text("\u672c\u968a");7===a&&$(b).find(".progress_label").text("\u9632\u7a7a")});f=e=d=b="";for(g=1;10>=g;g++)b+='<td class="td_battle battle'+g+'">'+g+"\u6226\u76ee</td>",d+='<td class="td_battle battle'+g+' fap"></td>',e+='<td class="td_battle battle'+g+' eap"></td>',
...
f=$("#init_prof_parent").find(".type_name:last"),f.text(e.abbr),f.closest(".init_prof")[0].dataset.typeid=e.id;$("#init_prof_parent").find(".init_prof:first").remove();b=$jscomp.makeIterator(setting.defaultProf);for(e=b.next();!e.done;e=b.next())d=e.value,proficiency_Changed($('.init_prof[data-typeid="'+d.id+'"').find('.prof_opt[data-prof="'+d.prof+'"]').parent(),!0);if(setting.contentsOrder.length){b=$("#main_contents");d=$("#side_index");var m=[],l=[];$(".contents").each(function(a,b){m.push($(b))});
b.empty();d.find("li").each(function(a,b){l.push($(b))});d.empty();e={};f=$jscomp.makeIterator(setting.contentsOrder);for(g=f.next();!g.done;e={$jscomp$loop$prop$id$134$302:e.$jscomp$loop$prop$id$134$302},g=f.next())e.$jscomp$loop$prop$id$134$302=g.value,g=m.find(function(a){return function(b){return b.attr("id")===a.$jscomp$loop$prop$id$134$302}}(e)),b.append(g),g=l.find(function(a){return function(b){return b.attr("id")==="li_"+a.$jscomp$loop$prop$id$134$302}}(e)),d.append(g)}loadMainPreset();$("#stage2_detail_slot").val(18);
...
$("#lb_item1").attr("class").includes("tab-pane")||($(".lb_tab").addClass("tab-pane fade"),$(".baseNo").removeClass("cur_move sortable_handle"),$(".lb_tab:first").addClass("show active"),$("#lb_item1").addClass("active"));b=document.createDocumentFragment();d=0;e=$jscomp.makeIterator(CHANGE_LOG);for(f=e.next();!f.done;f=e.next())for(f=f.value,g=document.createElement("div"),g.className="my-3 ver_log border-bottom",h=document.createElement("div"),h.className="py-2",h.textContent="v"+f.id,c.id===f.id&&
(k=document.createElement("span"),k.className="ml-2 pt-1 badge badge-pill badge-danger",k.textContent="New",h.appendChild(k)),g.appendChild(h),h=0;h<f.changes.length;h++){k=f.changes[h];var n="log_"+d++ +"_"+h,u=document.createElement("div");u.className="py-2 px-2 d-flex collapsed history_item history_item_no_content";var p=document.createElement("div");p.className="d-flex flex-nowrap align-self-center";var q=document.createElement("div");q.className="align-self-center";var r=document.createElement("span");
r.className="mr-2 pt-1 badge badge-pill badge-"+(0===k.type?"success":1===k.type?"info":"danger");r.textContent=0===k.type?"\u65b0\u898f":1===k.type?"\u5909\u66f4":"\u4fee\u6b63";var t=document.createElement("div");t.className="align-self-center";t.innerHTML=k.title;q.appendChild(r);p.appendChild(q);p.appendChild(t);u.appendChild(p);g.appendChild(u);k.content&&(u.dataset.toggle="collapse",u.dataset.target="#"+n,u.classList.remove("history_item_no_content"),u=document.createElement("div"),u.id=n,u.className=
...
!1,document.getElementById("deep_blue_theme").checked=!1):"dark-gradient"===setting.themeColor?(document.getElementById("normal_theme").checked=!1,document.getElementById("dark_theme").checked=!1,document.getElementById("dark_gradient_theme").checked=!0,document.getElementById("deep_blue_theme").checked=!1):"deep-blue"===setting.themeColor?(document.getElementById("normal_theme").checked=!1,document.getElementById("dark_theme").checked=!0,document.getElementById("dark_gradient_theme").checked=!1,
document.getElementById("deep_blue_theme").checked=!0):(document.getElementById("normal_theme").checked=!0,document.getElementById("dark_theme").checked=!1,document.getElementById("dark_gradient_theme").checked=!1,document.getElementById("deep_blue_theme").checked=!1);site_theme_Changed(!1);$("#loading_text").addClass("load_end_text");$("#loading_text").text("\u5b8c\u4e86");$("#loading_line").addClass("loading_line_expand");$("#loading_back").addClass("load_end");setTimeout(function(){$("#loading_back").remove()},
1E3);$('[data-toggle="tooltip"]').tooltip();$("#modal_version_inform").find(".modal-body").html()&&$("#modal_version_inform").modal("show");a()}
...
"\u6b8b\u6a5f\u6570 [\u6a5f]",{mode:"index",callbacks:{title:function(a,b){var c=a[0].xLabel;if(!c)return"\u6b8b\u6a5f\u6570\uff1a"+c+" \u6a5f\n\u822a\u7a7a\u6226\u706b\u529b\uff1a0";var d=2===u.length?Math.floor(u[1]*(p*Math.sqrt(c)+25)):0;return"\u6b8b\u6a5f\u6570\uff1a"+c+" \u6a5f\n\u822a\u7a7a\u6226\u706b\u529b\uff1a"+(Math.floor(u[0]*(p*Math.sqrt(c)+25))+(d?" or "+d:""))},label:function(a,b){return[a.yLabel+" %"]}}});e=$("#show_detail_slot .nav-item");g=SHIP_DATA.find(function(a){return a.id===
c});f="";h=0;$("#land_base_detail_table").addClass("d-none");$("#detail_fire").addClass("d-none").removeClass("d-flex");$("#detail_wave").addClass("d-none").removeClass("d-flex");$("#detail_info").data("mode","fleet_slot_detail");$("#detail_info").data("ship_id",c);$("#detail_info").data("base_no",a);$("#detail_info").data("slot_no",b);$("#detail_warning").html("\n\t\t<div>\u203b \u822a\u7a7a\u6226\u706b\u529b\u306f\u30ad\u30e3\u30c3\u30d7\u524d\u3067\u30af\u30ea\u30c6\u30a3\u30ab\u30eb\u88dc\u6b63\u3001\u89e6\u63a5\u88dc\u6b63\u306a\u3057\u3002\u5c0f\u6570\u5207\u6368\u3066</div>\n\t\t<div>\u203b \u6700\u7d42\u6226\u95d8\u306e\u822a\u7a7a\u6226\u7d42\u4e86\u6642\u70b9\u3067\u306e\u6b8b\u6570\u306e\u5206\u5e03\u3092\u8868\u793a\u3057\u3066\u3044\u307e\u3059\u3002</div>");
e.find(".nav-link").addClass("disabled");e.addClass("d-none");a={};k=$jscomp.makeIterator(l);for(m=k.next();!m.done;a={$jscomp$loop$prop$pl$345:a.$jscomp$loop$prop$pl$345},m=k.next()){a.$jscomp$loop$prop$pl$345=m.value;(m=PLANE_DATA.find(function(a){return function(b){return b.id===a.$jscomp$loop$prop$pl$345.id}}(a)))&&m.id&&(e.eq(h).find(".nav-link").removeClass("disabled"),e.eq(h).data("slot_no",h));if(h===(g?g.slot.length:4))break;e.eq(h).removeClass("d-none");f+='\n\t\t<div class="row">\n\t\t\t<div class="col-2 align-self-center text-right font_size_12">\u88c5\u5099'+
(h+1)+':</div>\n\t\t\t<div class="col d-flex align-self-end font_size_12 pl-0">\n\t\t\t\t<img src="./img/type/'+(m?"type"+m.type:"undefined")+'.png" class="plane_img_sm align-self-center">\n\t\t\t\t<div class="align-self-end">'+(m?m.abbr?m.abbr:m.name:"-")+'</div>\n\t\t\t</div>\n\t\t\t<div class="col font_size_11 align-self-end">\n\t\t\t\t'+(m?"(\u642d\u8f09: "+l[h].slot+"\u6a5f"+(m.torpedo?"\u3000\u96f7\u88c5: "+m.torpedo:"")+(m.bomber?"\u3000\u7206\u88c5: "+m.bomber:"")+")":"")+"\n\t\t\t</div>\n\t\t</div>";
...
k/e+" %");e=$("#show_detail_slot .nav-item");e.eq(b).find(".nav-link").tab("show");d="";g=0;$("#land_base_detail_table").removeClass("d-none");$("#detail_fire").addClass("d-none").removeClass("d-flex");$("#detail_wave").removeClass("d-none").addClass("d-flex");$("#detail_info").data("mode","land_base_detail");$("#detail_info").data("base_no",a);$("#detail_info").data("slot_no",b);$("#detail_warning").html("\n\t\t<div>\u203b \u822a\u7a7a\u6226\u706b\u529b\u306f\u30af\u30ea\u30c6\u30a3\u30ab\u30eb\u88dc\u6b63\u3001\u89e6\u63a5\u88dc\u6b63\u306a\u3057\u3067\u5bfe\u6c34\u4e0a\u8266\u306e\u5834\u5408</div>\n\t\t<div>\u203b \u5bfe\u6575\u9023\u5408\u88dc\u6b63\u3001\u9678\u5075\u88dc\u6b63\u306b\u3064\u3044\u3066\u306f\u3001\u8a72\u5f53\u3059\u308b\u6226\u95d8\u3001\u88c5\u5099\u3067\u3042\u308c\u3070\u6709\u52b9</div>");
e.find(".nav-link").addClass("disabled");e.addClass("d-none");f={};c=$jscomp.makeIterator(c[a].planes);for(h=c.next();!h.done;f={$jscomp$loop$prop$pl$347:f.$jscomp$loop$prop$pl$347},h=c.next())f.$jscomp$loop$prop$pl$347=h.value,(h=PLANE_DATA.find(function(a){return function(b){return b.id===a.$jscomp$loop$prop$pl$347.id}}(f)))&&h.id&&(e.eq(g).find(".nav-link").removeClass("disabled"),e.eq(g).data("slot_no",g)),e.eq(g).removeClass("d-none"),d+='\n\t\t<div class="row">\n\t\t\t<div class="col-2 align-self-center text-right font_size_12">\u88c5\u5099'+
(g+1)+':</div>\n\t\t\t<div class="col d-flex align-self-end font_size_12 pl-0">\n\t\t\t\t<img src="./img/type/'+(h?"type"+h.type:"undefined")+'.png" class="plane_img_sm align-self-center">\n\t\t\t\t<div class="align-self-end">'+(h?h.abbr?h.abbr:h.name:"-")+'</div>\n\t\t\t</div>\n\t\t\t<div class="col font_size_11 align-self-end">\n\t\t\t\t'+(h?"(\u642d\u8f09: "+f.$jscomp$loop$prop$pl$347.slot+"\u6a5f"+(h.torpedo?"\u3000\u96f7\u88c5: "+h.torpedo:"")+(h.bomber?"\u3000\u7206\u88c5: "+h.bomber:"")+")":
...
c+" \u6a5f\n\u822a\u7a7a\u6226\u706b\u529b\uff1a0";var d=2===u.length?Math.floor(u[1]*(p*Math.sqrt(c)+25)):0;return"\u6b8b\u6a5f\u6570\uff1a"+c+" \u6a5f\n\u822a\u7a7a\u6226\u706b\u529b\uff1a"+(Math.floor(u[0]*(p*Math.sqrt(c)+25))+(d?" or "+d:""))}return"\u822a\u7a7a\u6226\u706b\u529b\uff1a"+c},label:function(a,b){return[a.yLabel+" %"]}}});d=$("#show_detail_slot .nav-item");d.eq(b).find(".nav-link").tab("show");if("enemy_slot_detail"!==$("#detail_info").data("mode")||$("#detail_info").data("base_no")!=
a||$("#detail_info").data("battle_no")!=g){$("#land_base_detail_table").addClass("d-none");$("#detail_fire").removeClass("d-none").addClass("d-flex");$("#detail_wave").addClass("d-none").removeClass("d-flex");$("#detail_info").data("mode","enemy_slot_detail");$("#detail_info").data("base_no",a);$("#detail_info").data("slot_no",b);$("#detail_info").data("battle_no",g);$("#detail_warning").text("\u203b \u822a\u7a7a\u6226\u706b\u529b\u306f\u30ad\u30e3\u30c3\u30d7\u524d\u3067\u30af\u30ea\u30c6\u30a3\u30ab\u30eb\u3001\u89e6\u63a5\u88dc\u6b63\u306a\u3057\u5c0f\u6570\u5207\u6368\u3066");
g="";e=0;d.addClass("d-none");f={};h=$jscomp.makeIterator(l.eqp);for(k=h.next();!k.done;f={$jscomp$loop$prop$id$349:f.$jscomp$loop$prop$id$349},k=h.next())f.$jscomp$loop$prop$id$349=k.value,k=ENEMY_PLANE_DATA.find(function(a){return function(b){return b.id===a.$jscomp$loop$prop$id$349}}(f)),d.eq(e).removeClass("d-none"),d.eq(e).data("slot_no",e),g+='\n\t\t\t<div class="row">\n\t\t\t\t<div class="col-2 align-self-center">\u88c5\u5099'+(e+1)+':</div>\n\t\t\t\t<div class="col d-flex align-self-end">\n\t\t\t\t\t<img src="./img/type/type'+
k.type+'.png" class="plane_img_sm align-self-center">\n\t\t\t\t\t<div class="align-self-end">'+k.name+'</div>\n\t\t\t\t</div>\n\t\t\t\t<div class="col font_size_12 align-self-end">\n\t\t\t\t\t(\u642d\u8f09: '+m.slots[e++]+"\u6a5f"+(k.torpedo?"\u3000\u96f7\u88c5: "+k.torpedo:"")+(k.bomber?"\u3000\u7206\u88c5: "+k.bomber:"")+")</span>\n\t\t\t\t</div>\n\t\t\t</div>";d='\n\t\t\t<img src="./img/enemy/'+l.id+'.png" class="ship_img align-self-center">\n\t\t\t<span class="ml-1 text-primary font_size_11 align-self-center">ID: '+
(l.id+1500)+'</span>\n\t\t\t<span class="ml-1 align-self-center">'+l.name+"</span>\n\t\t";$("#detail_legend").html(d);$("#detail_info").html(g)}}
...
$(".slot_select_parent").on("hide.bs.dropdown",function(){slot_select_parent_Close($(this))});$(".remodel_select_parent").on("hide.bs.dropdown",function(){remodelSelect_Changed($(this))});$(".remodel_select_parent").on("show.bs.dropdown",function(){$(this).find(".remodel_item_selected").removeClass("remodel_item_selected")});$(".main_preset_select").on("hidden.bs.tab",function(a){main_preset_tab_Changed(a)});$("#main").on("show.bs.dropdown",".enemy_ap_select_parent",function(){enemy_ap_select_parent_Show($(this))});
...
"#detail_calculate_count",function(){return $("#btn_calculate_detail").prop("disabled",!1)});$("#modal_result_detail").on("change",".custom-radio",btn_calculate_detail);$("#modal_result_detail").on("click","#show_detail_slot .nav-item",function(){detail_slot_tab_Changed($(this))});$("#modal_collectively_setting").on("click",".btn_remove_plane_all",function(){btn_remove_plane_all_Clicked($(this))});$("#modal_collectively_setting").on("click",".btn_remove_ship_all",btn_remove_ship_all_Clicked);$("#modal_collectively_setting").on("click",
...
'a[href^="#"]',function(){return smart_menu_modal_link_Clicked($(this))});$("#result_content").on({mouseenter:function(){shoot_down_table_tbody_MouseEnter($(this))},mouseleave:function(){shoot_down_table_tbody_MouseLeave($(this))}},"#shoot_down_table_tbody td");$("#result_content").on({mouseenter:function(){progress_area_MouseEnter($(this))},mouseleave:function(){progress_area_MouseLeave($(this))}},".progress_area");$("#result_content").on({mouseenter:function(){rate_table_MouseEnter($(this))},mouseleave:function(){rate_table_MouseLeave($(this))}},
...
c,d)}});$("#enemyFleet_content").droppable({accept:".enemy_content",tolerance:"pointer",over:function(a,b){isOut=!1;b.helper.stop().animate({opacity:"1.0"},100)},out:function(a,b){isOut=!0;b.helper.stop().animate({opacity:"0.2"},100)}});$(".sample_plane").draggable({delay:100,scroll:!1,handle:".drag_handle",zIndex:1E3,revert:!0,cursorAt:{top:10}})});