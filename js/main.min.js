...
for(c=b.next();!c.done;c=b.next())c.value.classList.remove("dropdown-header-dark")}else{$("#dark_blue_theme").prop("checked")&&(setting.themeColor="dark-blue",document.body.style.backgroundColor="#20222d");$("#dark_blue2_theme").prop("checked")&&(setting.themeColor="dark-blue2",document.body.classList.add("body-dark"));$("#deep_blue_theme").prop("checked")&&(setting.themeColor="deep-blue",document.body.classList.add("body-deep-blue"));mainColor="#e0e0e0";b=$jscomp.makeIterator(document.getElementsByClassName("contents"));
for(var c=b.next();!c.done;c=b.next())c=c.value,c.style.backgroundColor="rgba(255, 255, 255, 0.047)",c.classList.add("contents-dark");b=$jscomp.makeIterator(document.getElementsByClassName("form-control"));for(c=b.next();!c.done;c=b.next())c.value.classList.add("form-control-dark");b=$jscomp.makeIterator(document.getElementsByClassName("input-group-text"));for(c=b.next();!c.done;c=b.next())c.value.classList.add("input-group-text-dark");b=$jscomp.makeIterator(document.getElementsByClassName("custom-select"));
for(c=b.next();!c.done;c=b.next())c.value.classList.add("custom-select-dark");b=$jscomp.makeIterator(document.getElementsByClassName("border-top"));for(c=b.next();!c.done;c=b.next())c.value.classList.add("border-secondary");b=$jscomp.makeIterator(document.getElementsByClassName("border-bottom"));for(c=b.next();!c.done;c=b.next())c.value.classList.add("border-secondary");b=$jscomp.makeIterator(document.getElementsByClassName("border-left"));for(c=b.next();!c.done;c=b.next())c.value.classList.add("border-secondary");
b=$jscomp.makeIterator(document.getElementsByClassName("border"));for(c=b.next();!c.done;c=b.next())c.value.classList.add("border-secondary");b=$jscomp.makeIterator(document.getElementsByClassName("modal-content"));for(c=b.next();!c.done;c=b.next())c.value.classList.add("modal-content-dark");b=$jscomp.makeIterator(document.getElementsByClassName("modal-header"));for(c=b.next();!c.done;c=b.next())c.value.classList.add("modal-header-dark");b=$jscomp.makeIterator(document.getElementsByClassName("modal-footer"));
for(c=b.next();!c.done;c=b.next())c.value.classList.add("modal-footer-dark");b=$jscomp.makeIterator(document.getElementsByClassName("scroll_thead"));for(c=b.next();!c.done;c=b.next())c.value.classList.add("scroll_thead-dark");b=$jscomp.makeIterator(document.getElementsByClassName("nav-tabs"));for(c=b.next();!c.done;c=b.next())c.value.classList.add("nav-tabs-dark");b=$jscomp.makeIterator(document.getElementsByClassName("nav-link"));for(c=b.next();!c.done;c=b.next())c.value.classList.add("nav-link-dark");
b=$jscomp.makeIterator(document.getElementsByClassName("dropdown-menu"));for(c=b.next();!c.done;c=b.next())c.value.classList.add("dropdown-menu-dark");b=$jscomp.makeIterator(document.getElementsByClassName("dropdown-header"));for(c=b.next();!c.done;c=b.next())c.value.classList.add("dropdown-header-dark")}document.getElementById("input_url").classList.add("form-control-dark");saveLocalStorage("setting",setting);document.body.style.color=mainColor;a&&calculate()}
