...
function initialize(a){var b=document.createDocumentFragment();b="";for(var c=0;c<PLANE_TYPE.length;c++){b=new Image;var d=PLANE_TYPE[c].id;b.src="./img/type/type"+d+".png";IMAGES["type"+d]=b;c===PLANE_TYPE.length-1&&b.addEventListener("load",function(){setPlaneStockTable()},!1)}initializeSetting();c=CHANGE_LOG[CHANGE_LOG.length-1];setting.version!==c.id&&(deleteLocalStorage("version"),deleteLocalStorage("autoSave"),deleteLocalStorage("simulateCount"),deleteLocalStorage("emptySlotInvisible"),deleteLocalStorage("modalDisplayMode"),
deleteLocalStorage("defaultProf"),(b=loadLocalStorage("planeStock"))&&0<b.length&&!b[0].num.length&&deleteLocalStorage("planeStock"),document.getElementsByClassName("version_detail")[0].classList.add("unread"));setPlaneType(document.getElementById("plane_type_select"),PLANE_TYPE.filter(function(a){return 0<a.id}).map(function(a){return a.id}));setPlaneType(document.getElementById("stock_type_select"),PLANE_TYPE.filter(function(a){return 0<a.id}).map(function(a){return a.id}));b=document.getElementById("plane_type_select").getElementsByTagName("option");
d={};b=$jscomp.makeIterator(b);for(var e=b.next();!e.done;d={$jscomp$loop$prop$option$297:d.$jscomp$loop$prop$option$297},e=b.next())d.$jscomp$loop$prop$option$297=e.value,basicSortedPlanes=basicSortedPlanes.concat(PLANE_DATA.filter(function(a){return function(b){return Math.abs(b.type)===castInt(a.$jscomp$loop$prop$option$297.value)}}(d)));setShipType(SHIP_TYPE.filter(function(a){return 15>a.id}).map(function(a){return a.id}));setEnemyType(ENEMY_TYPE.filter(function(a){return 0<a.id}).map(function(a){return a.id}));
document.getElementById("display_final").checked=setting.visibleFinal;document.getElementById("frequent_ship").checked=setting.orderByFrequency;b=document.getElementById("lb_info_table").getElementsByTagName("tbody")[0].innerHTML;for(d=0;2>d;d++)document.getElementById("lb_info_table").getElementsByTagName("tbody")[0].innerHTML+=b;b=document.getElementsByClassName("lb_info_tr");for(d=0;d<b.length;d++)e=b[d],e.classList.add("lb_info_lb_"+(Math.floor(d/4)+1)),e=e.getElementsByClassName("info_name"),
e.length&&(e[0].textContent="\u7b2c"+(Math.floor(d/4)+1)+"\u57fa\u5730\u822a\u7a7a\u968a");b=document.getElementsByClassName("display_ship_count");b=$jscomp.makeIterator(b);for(d=b.next();!d.done;d=b.next())d.value.value=2;b=$("#battle_container").html();for(d=1;10>d;d++)$("#battle_container").append(b);$(".battle_content").each(function(a,b){$(b).find(".battle_no").text(a+1);0<a&&$(b).addClass("d-none");$(b).find(".custom-control-input").attr("id","grand_"+a);$(b).find(".custom-control-label").attr("for",
...
(Math.floor(a/2)+1)+" "+(a%2+1)+"\u6ce2\u76ee");6===a&&$(b).find(".progress_label").text("\u672c\u968a");7===a&&$(b).find(".progress_label").text("\u9632\u7a7a")});for(var f=e=d=b="",g=1;10>=g;g++)b+='<td class="td_battle battle'+g+'">'+g+"\u6226\u76ee</td>",d+='<td class="td_battle battle'+g+' fap"></td>',e+='<td class="td_battle battle'+g+' eap"></td>',f+='<td class="td_battle battle'+g+' cond"></td>';$("#shoot_down_table").find(".tr_header").append(b+'<td class="td_battle battle_end">\u51fa\u6483\u5f8c</td><td class="td_battle battle_death">\u5168\u6ec5\u7387</td>');
...
$("#config_content").on("click","#btn_reset_selected_ship_history",btn_reset_selected_ship_history_Clicked);$("#config_content").on("click",'input[name="site_theme"]',function(){site_theme_Changed()});$("#plane_stock").on("change","#stock_type_select",function(){stock_type_select_Changed($(this))});$("#plane_stock").on("click",".stock_td_fav",function(a){stock_td_fav_Clicked($(this));a.stopPropagation()});$("#plane_stock").on("click",".stock_tr",function(){stock_tr_Clicked($(this))});$("#plane_stock").on("click",
"#btn_load_equipment_json",btn_load_equipment_json_Clicked);$("#plane_stock").on("input","#input_equipment_json",function(){input_equipment_json_Changed($(this))});$("#plane_stock").on("focus","#input_equipment_json",function(){$(this).select()});$("#plane_stock").on("click","#btn_fav_clear",btn_fav_clear_Clicked);$("#plane_stock").on("click","#btn_stock_all_clear",btn_stock_all_clear_Clicked);$("#plane_stock").on("input","#stock_word",stock_word_TextChanged);$("#modal_plane_select").on("click",".plane",
function(){modal_plane_Selected($(this))});$("#modal_plane_select").on("click",".btn_remove",function(){modal_plane_select_btn_remove_Clicked($(this))});$("#modal_plane_select").on("change","#plane_type_select",plane_type_select_Changed);$("#modal_plane_select").on("click","#fav_only",fav_only_Checked_Chenged);$("#modal_plane_select").on("click","#disp_in_stock",disp_in_stock_Checked_Chenged);$("#modal_plane_select").on("click","#disp_equipped",disp_equipped_Checked_Chenged);$("#modal_plane_select").on("input",
...
$("#site_information").on("click",'a[href^="#"]',function(){return sidebar_Clicked($(this))});$("#modal_smart_menu").on("click",'a[href^="#"]',function(){return smart_menu_modal_link_Clicked($(this))});$("#result_content").on({mouseenter:function(){shoot_down_table_tbody_MouseEnter($(this))},mouseleave:function(){shoot_down_table_tbody_MouseLeave($(this))}},"#shoot_down_table_tbody td");$("#result_content").on({mouseenter:function(){progress_area_MouseEnter($(this))},mouseleave:function(){progress_area_MouseLeave($(this))}},
