...
g=0;g<e.changes.length;g++){h=e.changes[g];k="log_"+n++ +"_"+g;m=document.createElement("div");m.className="py-2 px-2 d-flex collapsed history_item history_item_no_content";var q=document.createElement("div");q.className="d-flex flex-nowrap align-self-center";var p=document.createElement("div");p.className="align-self-center";var r=document.createElement("span");r.className="mr-2 pt-1 badge badge-pill badge-"+(0===h.type?"success":1===h.type?"info":"danger");r.textContent=0===h.type?"\u65b0\u898f":
1===h.type?"\u5909\u66f4":"\u4fee\u6b63";var w=document.createElement("div");w.className="align-self-center";w.innerHTML=h.title;p.appendChild(r);q.appendChild(p);q.appendChild(w);m.appendChild(q);f.appendChild(m);h.content&&(m.dataset.toggle="collapse",m.dataset.target="#"+k,m.classList.remove("history_item_no_content"),m=document.createElement("div"),m.id=k,m.className="border-top collapse history_content",k=document.createElement("div"),k.className="pl-3 py-2 font_size_12",k.innerHTML=h.content,
m.appendChild(k),f.appendChild(m));b.appendChild(f)}c=document.createElement("div");c.className="mt-2 font_size_12";c.textContent=LAST_UPDATE_DATE;b.appendChild(c);document.getElementById("site_history_body").appendChild(b);$("#site_information").find(".collapse_content").collapse("hide");$("#loading_info").text("\u521d\u671f\u8a08\u7b97\u4e2d");a()}
...
function createPlaneTable(a){var b=$("#modal_plane_select").find(".modal-dialog"),c=$("#plane_tbody"),d=document.getElementById("plane_tbody"),e=document.createDocumentFragment(),f=b.find(".toggle_display_type.selected").data("mode"),g=loadPlaneStock(),h=setting.inStockOnly,k=setting.visibleEquiped,m=$("#plane_sort_select").val();"multi"===f?(b.addClass("modal-xl"),c.addClass("d-flex flex-wrap"),c.prev().addClass("d-none").removeClass("d-flex")):(b.removeClass("modal-xl"),c.removeClass("d-flex flex-wrap"),
c.prev().addClass("d-flex").removeClass("d-none"));h?($("#disp_equiped").closest("div").removeClass("d-none"),$("#disp_in_stock").prop("checked",!0)):($("#disp_equiped").closest("div").addClass("d-none"),$("#disp_in_stock").prop("checked",!1));b=a.length;for(var l=0,n=0,q=0,p=0,r={},w=0;w<b;r={$jscomp$loop$prop$plane$244:r.$jscomp$loop$prop$plane$244},w++){r.$jscomp$loop$prop$plane$244=a[w];var u=r.$jscomp$loop$prop$plane$244.antiAir+1.5*r.$jscomp$loop$prop$plane$244.interception,x=r.$jscomp$loop$prop$plane$244.antiAir+
r.$jscomp$loop$prop$plane$244.interception+2*r.$jscomp$loop$prop$plane$244.antiBomber,y=0<r.$jscomp$loop$prop$plane$244.antiBomber||0<r.$jscomp$loop$prop$plane$244.interception;if(h&&g){var t=g.find(function(a){return function(b){return b.id===a.$jscomp$loop$prop$plane$244.id}}(r)),v=usedPlane.find(function(a){return function(b){return b.id===a.$jscomp$loop$prop$plane$244.id}}(r)),A=v?getArraySum(v.num):0;p=t?getArraySum(t.num):0;if(0>=p||!k&&A>=p)continue;q=p-A;for(p=10;0<=p;p--)if(v&&(t.num[p]-=
v.num[p]),0<t.num[p]){n=p;break}}t=document.createElement("div");t.className="plane plane_tr d-flex py-2 py-lg-1"+("multi"===f?" tr_multi":"");t.dataset.planeid=r.$jscomp$loop$prop$plane$244.id;t.dataset.type=r.$jscomp$loop$prop$plane$244.type;t.dataset.remodel=n;h&&k&&0>=q&&(t.classList.remove("plane_tr","plane"),t.classList.add("plane_tr_disabled"));v=document.createElement("div");v.className="align-self-center size-25";p=document.createElement("canvas");A=p.getContext("2d");p.width=25;p.height=
25;A.drawImage(IMAGES["type"+r.$jscomp$loop$prop$plane$244.type],0,0,25,25);A=document.createElement("div");A.className="pl-1 plane_td_name align-self-center";A.textContent=r.$jscomp$loop$prop$plane$244.name;var B=document.createElement("div");B.className="ml-1 plane_td_stock align-self-center";B.textContent="\u00d7"+(0<q?q:0);var z=document.createElement("div");z.className="ml-auto plane_td_basic align-self-center "+(y?"text_existTooltip":"");y&&(z.dataset.toggle="tooltip",z.title="\u51fa\u6483\u6642:"+
u+" , \u9632\u7a7a\u6642:"+x);switch(m){case "battle_anti_air":z.textContent=u;break;case "defense_anti_air":z.textContent=x;break;default:z.textContent=r.$jscomp$loop$prop$plane$244.antiAir}u=document.createElement("div");u.className="plane_td_basic align-self-center";u.textContent=r.$jscomp$loop$prop$plane$244.radius;"multi"===f&&l!==r.$jscomp$loop$prop$plane$244.type&&"default"===m&&(l=document.createElement("div"),l.className="d-flex w-100 mt-3 mb-1",x=document.createElement("div"),x.className=
"font_size_12 font_color_777 align-self-center",x.textContent=PLANE_TYPE.find(function(a){return function(b){return b.id===a.$jscomp$loop$prop$plane$244.type}}(r)).name,y=document.createElement("div"),y.className="flex-grow-1 border-bottom align-self-center mx-2",l.appendChild(x),l.appendChild(y),e.appendChild(l));v.appendChild(p);t.appendChild(v);t.appendChild(A);(0<q||h&&k)&&t.appendChild(B);"single"===f&&(t.appendChild(z),t.appendChild(u));e.appendChild(t);l=r.$jscomp$loop$prop$plane$244.type}d.innerHTML=
...
99;n.appendChild(q);l.appendChild(n);l.appendChild(p);l.appendChild(r);l.appendChild(h);l.appendChild(k);b.appendChild(l)}a.innerHTML="";a.appendChild(b);$("#stock_type_select").change()}
function createShipTable(a){var b=$("#modal_ship_select").find(".modal-dialog"),c=$("#ship_tbody"),d=document.getElementById("ship_tbody"),e=document.createDocumentFragment(),f=[],g=0,h=b.find(".toggle_display_type.selected").data("mode"),k=$("#display_final").prop("checked"),m=$("#ship_word").val().trim();setting.visibleFinal=k;saveLocalStrage("setting",setting);for(var l={},n=$jscomp.makeIterator(SHIP_TYPE),q=n.next();!q.done;l={$jscomp$loop$prop$typeObj$248:l.$jscomp$loop$prop$typeObj$248},q=n.next())l.$jscomp$loop$prop$typeObj$248=
...
{$jscomp$loop$prop$ship$250:b.$jscomp$loop$prop$ship$250},c=f.next())if(b.$jscomp$loop$prop$ship$250=c.value,0===a[0]||a.includes(b.$jscomp$loop$prop$ship$250.type))if(!k||b.$jscomp$loop$prop$ship$250["final"])if(!m||b.$jscomp$loop$prop$ship$250.name.includes(m)){c=document.createElement("div");c.className="ship ship_tr d-flex "+("multi"===h?"tr_multi":"py-1");c.dataset.shipid=b.$jscomp$loop$prop$ship$250.id;l=document.createElement("div");l.className="ml-1 align-self-center pt-1";n=document.createElement("canvas");
q=n.getContext("2d");n.width=120;n.height=30;q.drawImage(IMAGES["ship"+b.$jscomp$loop$prop$ship$250.id],0,0,120,30);l.appendChild(n);n=document.createElement("div");n.className="ml-1 align-self-center";q=document.createElement("div");q.className="text-primary font_size_11";q.textContent="ID : "+(1E3<b.$jscomp$loop$prop$ship$250.id?b.$jscomp$loop$prop$ship$250.orig+"b":b.$jscomp$loop$prop$ship$250.id);var p=document.createElement("div");p.textContent=b.$jscomp$loop$prop$ship$250.name;n.appendChild(q);
n.appendChild(p);"multi"===h&&g!==b.$jscomp$loop$prop$ship$250.type&&(g=document.createElement("div"),g.className="w-100 d-flex mt-3",q=document.createElement("div"),q.className="font_size_12 font_color_777 align-self-center",q.textContent=SHIP_TYPE.find(function(a){return function(b){return b.id===a.$jscomp$loop$prop$ship$250.type}}(b)).name,p=document.createElement("div"),p.className="flex-grow-1 border-bottom align-self-center mx-2",g.appendChild(q),g.appendChild(p),e.appendChild(g));c.appendChild(l);
...
function createEnemyTable(a){for(var b=$("#modal_enemy_select").find(".modal-dialog"),c=$("#enemy_tbody"),d=document.getElementById("enemy_tbody"),e=document.createDocumentFragment(),f=[],g=0,h=b.find(".toggle_display_type.selected").data("mode"),k=$("#enemy_word").val().trim(),m={},l=$jscomp.makeIterator(ENEMY_TYPE),n=l.next();!n.done;m={$jscomp$loop$prop$typeObject$252:m.$jscomp$loop$prop$typeObject$252},n=l.next())m.$jscomp$loop$prop$typeObject$252=n.value,1!==m.$jscomp$loop$prop$typeObject$252.id&&
(n=ENEMY_DATA.filter(function(a){return function(b){return b.type[0]===a.$jscomp$loop$prop$typeObject$252.id}}(m)),f=f.concat(n.sort(function(a,b){return a.orig>b.orig?1:a.orig<b.orig?-1:a.id-b.id})));m=ENEMY_DATA.filter(function(a){return 1===a.type[0]});f=f.concat(m.sort(function(a,b){return a.id>b.id?1:-1}));"multi"===h?(b.addClass("modal-xl"),c.addClass("d-flex flex-wrap"),$(".enemy_thead").addClass("d-none").removeClass("d-flex")):(b.removeClass("modal-xl"),c.removeClass("d-flex flex-wrap"),
$(".enemy_thead").addClass("d-flex").removeClass("d-none"));b={};f=$jscomp.makeIterator(f);for(c=f.next();!c.done;b={$jscomp$loop$prop$enemy$257:b.$jscomp$loop$prop$enemy$257},c=f.next())if(b.$jscomp$loop$prop$enemy$257=c.value,0===a[0]||isContain(a,b.$jscomp$loop$prop$enemy$257.type))if(!k||b.$jscomp$loop$prop$enemy$257.name.includes(k)){c=m=0;l=b.$jscomp$loop$prop$enemy$257.slot.length;for(n={$jscomp$loop$prop$i$256:0};n.$jscomp$loop$prop$i$256<l;n={$jscomp$loop$prop$i$256:n.$jscomp$loop$prop$i$256},
n.$jscomp$loop$prop$i$256++){var q=ENEMY_PLANE_DATA.find(function(a,b){return function(c){return c.id===a.$jscomp$loop$prop$enemy$257.eqp[b.$jscomp$loop$prop$i$256]}}(b,n));q&&(5!==q.type?m+=Math.floor(q.antiAir*Math.sqrt(b.$jscomp$loop$prop$enemy$257.slot[n.$jscomp$loop$prop$i$256])):c+=Math.floor(q.antiAir*Math.sqrt(b.$jscomp$loop$prop$enemy$257.slot[n.$jscomp$loop$prop$i$256])))}c+=m;l=document.createElement("div");l.className="enemy enemy_tr d-flex "+("multi"===h?"enemy_tr_multi":"");l.dataset.enemyid=
b.$jscomp$loop$prop$enemy$257.id;n=document.createElement("div");n.className="ml-1 align-self-center pt-1_5";q=document.createElement("canvas");var p=q.getContext("2d");q.width=128;q.height=32;p.drawImage(IMAGES["enemy"+b.$jscomp$loop$prop$enemy$257.id],0,0,128,32);n.appendChild(q);q=document.createElement("div");q.className="ml-1 align-self-center";p=document.createElement("div");p.className="text-primary font_size_11";p.textContent="ID : "+(b.$jscomp$loop$prop$enemy$257.id+1500);var r=document.createElement("div");
r.className="font_size_12";r.innerHTML=drawEnemyGradeColor(b.$jscomp$loop$prop$enemy$257.name);q.appendChild(p);q.appendChild(r);"multi"===h&&g!==b.$jscomp$loop$prop$enemy$257.type[0]&&-1!==b.$jscomp$loop$prop$enemy$257.id&&(g=document.createElement("div"),g.className="w-100 d-flex mt-3",p=document.createElement("div"),p.className="font_size_12 font_color_777 align-self-center",p.textContent=ENEMY_TYPE.find(function(a){return function(b){return b.id===a.$jscomp$loop$prop$enemy$257.type[0]}}(b)).name,
r=document.createElement("div"),r.className="flex-grow-1 border-bottom align-self-center mx-2",g.appendChild(p),g.appendChild(r),e.appendChild(g),g=b.$jscomp$loop$prop$enemy$257.type[0]);l.appendChild(n);l.appendChild(q);"single"===h&&(n=document.createElement("div"),n.className="ml-auto align-self-center enemy_td_ap",n.textContent=m,m=document.createElement("div"),m.className="enemy_td_lbAp align-self-center",m.textContent=c,l.appendChild(n),l.appendChild(m));e.appendChild(l)}d.innerHTML="";d.appendChild(e);
...
0,k={},m=$jscomp.makeIterator(f.planes),l=m.next();!l.done;k={$jscomp$loop$prop$planeId$259:k.$jscomp$loop$prop$planeId$259},l=m.next())k.$jscomp$loop$prop$planeId$259=l.value,checkInvalidPlane(b,PLANE_DATA.find(function(a){return function(b){return b.id===a.$jscomp$loop$prop$planeId$259}}(k)))&&(g='\n        <div class="preset_td preset_td_info text-warning cur_help ml-auto" data-toggle="tooltip" data-boundary="window"\n          title="\u5c55\u958b\u3067\u304d\u306a\u3044\u88c5\u5099\u304c\u542b\u307e\u308c\u3066\u3044\u307e\u3059\u3002">\n          <i class="fas fa-exclamation-triangle"></i>\n        </div>\n      ',
...
g++){b.$jscomp$loop$prop$ship$267=a[g];var h=SHIP_DATA.find(function(a){return function(b){return b.id===a.$jscomp$loop$prop$ship$267[0]}}(b));if(h){d={i1:null,i2:null,i3:null,i4:null,i5:null};var k=$jscomp.makeIterator(b.$jscomp$loop$prop$ship$267[1]);for(e=k.next();!e.done;e=k.next()){var m=e.value,l={id:m[0],rf:m[2],mas:m[1]};d["i"+castInt(m[4]+1)]=l}var n={id:""+h.deckid,lv:99,luck:-1,items:d},q=b.$jscomp$loop$prop$ship$267[2];6>q?c.f1["s"+(q%6+1)]=n:c.f2["s"+(q%6+1)]=n}}return JSON.stringify(c)}catch(p){return""}}
...
a.$jscomp$loop$prop$planeId$269}}(a));m&&m.num[k]++}c.sort(function(a,b){return a.id-b.id});saveLocalStrage("planeStock",c);setting.inStockOnly=!0;saveLocalStrage("setting",setting)}catch(l){return!1}return!0}
...
function drawResult(){$("#rate_table tbody").find(".rate_tr").addClass("d-none disabled_tr");$(".progress_area").addClass("d-none disabled_bar").removeClass("d-flex");for(var a=Object.create(chartData),b=a.own.length,c={},d=0;d<b;c={$jscomp$loop$prop$abbr$273:c.$jscomp$loop$prop$abbr$273},d++){var e=a.own[d],f=a.enemy[d],g=a.rate[d],h=getAirStatusBorder(f),k=isDefMode?getAirStatusIndex(e,f):a.rate[d].indexOf(Math.max.apply({},a.rate[d])),m=0,l=!1,n=isDefMode?8:1===b?7:d+1,q=$("#result_bar_"+n),p=
$("#rate_row_"+n);4===k?m=e/h[3]*10:3===k?m=e/h[2]*20:2===k?m=e/h[1]*45:1>=k&&(m=e/h[0]*90);if(5===k&&(7>n||8===n))k=0,m=100;else if(5===k){c.$jscomp$loop$prop$abbr$273=$("#shoot_down_table").find(".cond.battle"+displayBattle).text();var r=AIR_STATUS.find(function(a){return function(b){return b.abbr===a.$jscomp$loop$prop$abbr$273}}(c));r&&(k=r.id);0===k&&(m=100)}r=q.data("airstatus");q.removeClass("bar_status"+r).addClass("bar_status"+k).css({width:(100<m?100:m)+"%"}).data("airstatus",k);p.find(".rate_td_ap").text(e);
...
c=b=0;a=castInt($("#calculate_count").val());for(g=0;g<chartData.slots.length;g++)if(k=chartData.slots[g],n=100*k.deathRate,l=document.getElementsByClassName("slot"+k.slot+" shipNo"+k.shipNo)[0])q=castInt(l.getElementsByClassName("battle1")[0].textContent),l.getElementsByClassName("battle1")[0].textContent&&(p='<div class="text-left"><div>\u6700\u5927\u6b8b\u6570\uff1a'+k.max+"</div><div>\u6700\u5c0f\u6b8b\u6570\uff1a"+k.min+"</div><div>\u5168\u6ec5\u56de\u6570\uff1a"+k.death+" / "+a+"</div><div></div>",
e=l.getElementsByClassName("battle_end")[0],e.textContent=Math.round(k.avg),e.dataset.toggle="tooltip",e.dataset.html="true",e.title=p,l=l.getElementsByClassName("battle_death")[0],l.textContent=0===k.deathRate?"-":10<=n?n.toFixed(1)+" %":n.toFixed(2)+" %",l.dataset.toggle="tooltip",l.dataset.html="true",l.title=p,0<q&&(b+=5*(q-k.avg),c+=5*(q-k.max),d+=5*(q-k.min)));$(".battle_end.fap").html('<img src="./img/util/bauxite.png" class="img-size-18" alt="\u30dc\u30fc\u30ad\u30b5\u30a4\u30c8"> \u6d88\u8cbb');
...
function updateLandBaseInfo(a,b){b=void 0===b?!0:b;for(var c=0,d=0,e=0,f="",g,h=castInt(document.getElementById("landBase_target").value),k=document.getElementsByClassName("lb_tab"),m=0;m<k.length;m++){var l=k[m],n=m+1,q={baseNo:n,planes:[],ap:0,mode:-1};g="\u7b2c"+n+"\u57fa\u5730\u822a\u7a7a\u968a\uff1a";for(var p=l.getElementsByClassName("lb_plane"),r=0;r<p.length;r++){var w=r+1;if(4<=r)break;var u=createLBPlaneObject(p[r],r);q.planes.push(u);q.ap+=u.ap;if(b){w=document.getElementsByClassName("lb_info_lb_"+
n+" slot"+w)[0];var x=w.getElementsByClassName("info_plane")[0],y=(u.abbr?u.abbr:u.name)+(0!==u.remodel?"\u2605"+u.remodel:"");x.classList="info_plane "+getPlaneCss(u.type).replace("css","shoot_table");x.textContent=y?y+" "+getProfString(u.level):"-";x=w.getElementsByClassName("info_slot")[0];var t=castInt(x.textContent);drawChangeValue(x,t,u.slot);y||(x.textContent="");x=w.getElementsByClassName("info_ap")[0];t=castInt(x.textContent);drawChangeValue(x,t,u.ap);y||(x.textContent="");c+=0===u.id?0:
Math.ceil(u.slot*(101===u.type?1.5:1));d+=0===u.id?0:101===u.type?Math.floor(.7*u.slot):Math.ceil(.6*u.slot);e+=u.cost*(RECONNAISSANCES.includes(u.type)?4:18);g+=" "+(y?y+" "+getProfString(u.level):"")+","}}g+="\n";r=!0;u=$jscomp.makeIterator(q.planes);for(p=u.next();!p.done;p=u.next())0<p.value.id&&(r=!1);if(r)for(q.mode=-1,l.getElementsByClassName("ohuda_select")[0].value="-1",p=$jscomp.makeIterator(l.getElementsByClassName("ohuda_select")[0].getElementsByTagName("option")),r=p.next();!r.done;r=
p.next())r=r.value,-1!==castInt(r.value,-1)&&(r.disabled=!0);else for(p=$jscomp.makeIterator(l.getElementsByClassName("ohuda_select")[0].getElementsByTagName("option")),r=p.next();!r.done;r=p.next())r.value.disabled=!1;q.mode=castInt(l.getElementsByClassName("ohuda_select")[0].value);getUpdateLBAirPower(q);a.push(q);if(b){u=l.getElementsByClassName("resource")[0];p=u.getElementsByClassName("bauxite")[0];r=u.getElementsByClassName("fuel")[0];u=u.getElementsByClassName("ammo")[0];1>q.mode&&(d=c=0);
drawChangeValue(r,castInt(r.textContent),c,!0);drawChangeValue(u,castInt(u.textContent),d,!0);drawChangeValue(p,castInt(p.textContent),e,!0);e=d=c=0;n=document.getElementsByClassName("lb_info_lb_"+n);r=n[0].getElementsByClassName("info_sumAp")[0];drawChangeValue(r,castInt(r.textContent),q.ap);r=l.getElementsByClassName("ap")[0];drawChangeValue(r,castInt(r.textContent),q.ap);p=getRange(q);r=n[0].getElementsByClassName("info_range")[0];drawChangeValue(r,castInt(r.textContent),p);r=l.getElementsByClassName("range")[0];
drawChangeValue(r,castInt(r.textContent),p);0<q.mode&&(l=document.getElementById("battle_container").getElementsByClassName("enemy_range"),l.length>=h-1&&castInt(l[h-1].textContent)>p&&(f+=(f.length?",":"")+(m+1)));n=$jscomp.makeIterator(n);for(l=n.next();!l.done;l=n.next())l=l.value,-1!==q.mode?l.classList.remove("d-none"):l.classList.add("d-none");-1!==q.mode&&q.planes.length&&(document.getElementById("input_summary").value+=g.trim()+"\n")}}if(b){c=0;d=document.getElementById("lb_info_table").getElementsByTagName("tbody")[0].getElementsByClassName("lb_info_tr");
...
function updateFriendFleetInfo(a,b){b=void 0===b?!0:b;var c=[],d=0,e=[0,0],f="",g=null,h=$("#union_fleet").prop("checked");g=h?document.getElementsByClassName("ship_tab"):$(".friendFleet_tab.show.active")[0].getElementsByClassName("ship_tab");setting.isUnion=h;saveLocalStrage("setting",setting);for(var k={},m=0;m<g.length;k={$jscomp$loop$prop$shipId$275:k.$jscomp$loop$prop$shipId$275},m++){f=g[m];var l=m+1;if(!f.classList.contains("d-none")&&!f.getElementsByClassName("ship_disabled")[0].checked){for(var n=
c.length=0,q=$jscomp.makeIterator(f.getElementsByClassName("ship_plane")),p=q.next();!p.done;p=q.next())p=p.value,p.classList.contains("ui-draggable")||(p=createFleetPlaneObject(p,l,n++),c.push(p));p=!1;q=n=0;for(var r=$jscomp.makeIterator(c),w=r.next();!w.done;w=r.next())w=w.value,n+=w.ap,!p&&0<w.id&&(p=!0),0<w.id&&0<w.slot&&q++;p&&a.push(c.concat());if(b)if(p=f.getElementsByClassName("ap")[0],r=castInt(p.textContent),drawChangeValue(p,r,n),e[6>=l?0:1]+=n,d+=n,0<q){k.$jscomp$loop$prop$shipId$275=
castInt(f.dataset.shipid);r=k.$jscomp$loop$prop$shipId$275?SHIP_DATA.find(function(a){return function(b){return b.id===a.$jscomp$loop$prop$shipId$275}}(k)):null;w=document.createDocumentFragment();p=document.createDocumentFragment();var u=!0,x=document.getElementById("empty_slot_invisible").checked;r&&!x&&(q=r.slot.length);f=(r?r.name:"\u672a\u6307\u5b9a")+"\uff1a";for(var y=0;y<c.length;y++){var t=c[y],v=t.name;if(r||0!==t.id&&0!==t.slot){if(r&&y===r.slot.length)break;f+=" "+v+" "+getProfString(t.level)+
",";if(!r||!x||0!==t.id&&0!==t.slot){var A=getPlaneCss(t.type).replace("css","shoot_table"),B=document.createElement("tr");B.className="slot"+y+" shipNo"+l;B.dataset.rowindex=l;B.dataset.css=A+"_hover";if(u){var z=document.createElement("td");z.rowSpan=q;z.className="td_name align-middle";z.textContent=r?r.name:"\u672a\u6307\u5b9a";B.appendChild(z)}z=document.createElement("td");z.className="pl-1 td_plane_name align-middle "+A;z.textContent=v;B.appendChild(z);for(z=1;10>=z;z++){var D=document.createElement("td");
D.className="td_battle battle"+z+" align-middle";B.appendChild(D)}z=document.createElement("td");z.className="td_battle battle_end align-middle";B.appendChild(z);z=document.createElement("td");z.className="td_battle battle_death align-middle";B.appendChild(z);w.appendChild(B);B=document.createElement("tr");B.className="ship_info_tr slot"+(y+1);u&&(z=document.createElement("td"),z.rowSpan=q,z.className="info_name",z.textContent=r?r.name:"\u672a\u6307\u5b9a",B.appendChild(z));z=document.createElement("td");
z.className="info_plane "+A;A=(t.abbr?t.abbr:t.name)+(0!==t.remodel?"\u2605"+t.remodel:"");z.textContent=(A?A:v)+" "+getProfString(t.level);B.appendChild(z);v=document.createElement("td");v.className="info_slot";v.textContent=t.slot;B.appendChild(v);v=document.createElement("td");v.className="info_ap";v.textContent=t.ap;B.appendChild(v);u&&(u=document.createElement("td"),u.rowSpan=q,u.className="info_sumAp",u.textContent=n,B.appendChild(u));p.appendChild(B);u=!1}}}document.getElementById("shoot_down_table_tbody").appendChild(w);
...
function updateEnemyFleetInfo(a,b){b=void 0===b?!0:b;var c=null,d=0,e=0,f=0,g="999-1",h="",k=!1,m={},l=$jscomp.makeIterator(document.getElementsByClassName("battle_content"));for(d=l.next();!d.done;m={$jscomp$loop$prop$formationId$277:m.$jscomp$loop$prop$formationId$277},d=l.next()){var n=d.value;isDefMode&&(n=document.getElementById("air_raid_enemies"));if(isDefMode&&0<a.length)break;if(!n.classList.contains("d-none")){c={enemies:[],cellType:0,stage2:[]};f=e=d=0;c.cellType=castInt(n.getElementsByClassName("cell_type")[0].value);
for(var q=$jscomp.makeIterator(n.getElementsByClassName("enemy_content")),p=q.next();!p.done;p=q.next()){var r=p.value,w=castInt(r.dataset.enemyid);p=createEnemyObject(w);0===w||r.classList.contains("d-none")||(-1===w&&(r=r.getElementsByClassName("enemy_ap")[0],r=castInt(r.textContent),p.ap=r,p.lbAp=r,p.origAp=r,p.origLbAp=r),c.enemies.push(p),d+=p.ap,e+=p.lbAp,f+=p.aabo)}m.$jscomp$loop$prop$formationId$277=castInt(n.getElementsByClassName("formation")[0].value);q=(q=FORMATION.find(function(a){return function(b){return b.id===
a.$jscomp$loop$prop$formationId$277}}(m)))?q.correction:1;c.stage2=createStage2Table(c.enemies,c.cellType,m.$jscomp$loop$prop$formationId$277);a.push(c);b&&(c=n.getElementsByClassName("enemy_sum_ap")[0],drawChangeValue(c,c.textContent,d,!0),c=n.getElementsByClassName("enemy_sum_lbap")[0],drawChangeValue(c,c.textContent,e,!0),c=n.getElementsByClassName("enemy_range")[0],castInt(c.textContent)?c.parentNode.classList.remove("d-none"):c.parentNode.classList.add("d-none"),c=n.getElementsByClassName("fleet_AA")[0],
...
g+"\uff1a"+h);h=a[isDefMode?0:displayBattle-1].enemies.filter(function(a){return 0<a.slots.length});g=document.createDocumentFragment();k=0;m={};for(l=0;l<h.length;m={$jscomp$loop$prop$enemy$279:m.$jscomp$loop$prop$enemy$279},l++)if(m.$jscomp$loop$prop$enemy$279=h[l],!m.$jscomp$loop$prop$enemy$279.isSpR&&m.$jscomp$loop$prop$enemy$279.slots.length){d="";e=document.createDocumentFragment();for(f={$jscomp$loop$prop$j$281:0};f.$jscomp$loop$prop$j$281<m.$jscomp$loop$prop$enemy$279.slots.length;f={$jscomp$loop$prop$j$281:f.$jscomp$loop$prop$j$281},
f.$jscomp$loop$prop$j$281++)if(p=ENEMY_PLANE_DATA.find(function(a,b){return function(c){return c.id===a.$jscomp$loop$prop$enemy$279.eqp[b.$jscomp$loop$prop$j$281]}}(m,f)))q=m.$jscomp$loop$prop$enemy$279.slots[f.$jscomp$loop$prop$j$281],r=getPlaneCss(p.type).replace("css","shoot_table"),n=f.$jscomp$loop$prop$j$281===m.$jscomp$loop$prop$enemy$279.slots.length-1?" last_slot":"",c=document.createElement("tr"),c.className="enemy_no_"+k+" slot_"+f.$jscomp$loop$prop$j$281,c.dataset.rowindex=k,c.dataset.enemyindex=
l,c.dataset.slotindex=f.$jscomp$loop$prop$j$281,c.dataset.css=r+"_hover",d+='<img src="./img/plane/'+p.id+'.png" class="img-size-36" title="'+p.name+'">',w=document.createElement("td"),w.className="pl-1 td_plane_name align-middle "+r+n,w.textContent=p.name,c.appendChild(w),p=document.createElement("td"),p.className="td_init_slot align-middle"+n,p.textContent=q,c.appendChild(p),p=document.createElement("td"),p.className="td_avg_slot align-middle"+n,p.textContent=q,c.appendChild(p),p=document.createElement("td"),
p.className="td_max_slot align-middle"+n,p.textContent=q,c.appendChild(p),p=document.createElement("td"),p.className="td_min_slot align-middle"+n,p.textContent=q,c.appendChild(p),isDefMode?document.getElementsByClassName("td_detail_slot")[0].classList.add("d-none"):(q=document.createElement("td"),q.className="td_detail_slot align-middle"+n,q.innerHTML='<i class="fas fa-file-signature"></i>',c.appendChild(q),document.getElementsByClassName("td_detail_slot")[0].classList.remove("d-none")),e.appendChild(c);
f=document.createElement("td");f.rowSpan=m.$jscomp$loop$prop$enemy$279.slots.length;f.className="td_name align-middle last_slot";f.innerHTML="<div>"+drawEnemyGradeColor(m.$jscomp$loop$prop$enemy$279.name)+"</div><div>"+d+"</div>";e.firstChild.insertBefore(f,e.firstChild.firstChild);g.appendChild(e);k++}g.childNodes.length||(h=document.createElement("tr"),k=document.createElement("td"),k.colSpan=6,k.className="font_size_11",k.textContent="\u6226\u95d8\u6a5f\u3001\u653b\u6483\u6a5f\u3092\u642d\u8f09\u3057\u305f\u6575\u8266\u306e\u3044\u306a\u3044\u6226\u95d8\u3067\u3059\u3002",
h.appendChild(k),g.appendChild(h));document.getElementById("enemy_shoot_down_tbody").appendChild(g)}}
function createStage2Table(a,b,c){for(var d=[[[],[]],[[],[]],[[],[]],[[],[]],[[],[]]],e=a.length,f=[],g=0,h=0;h<e;h++){var k=a[h];f.push(k.aaw);for(var m=0;m<AVOID_TYPE.length;m++){var l=AVOID_TYPE[m].adj[0];b===CELL_TYPE.grand?6>h?d[m][0].push(.8*Math.floor(k.aaw*l)/400):d[m][0].push(.48*Math.floor(k.aaw*l)/400):d[m][0].push(Math.floor(k.aaw*l)/400)}g+=k.aabo}a=FORMATION.find(function(a){return a.id===c});g=Math.floor((a?a.correction:1)*g);for(a=0;a<e;a++)for(h=f[a],k=0;k<AVOID_TYPE.length;k++)m=
AVOID_TYPE[k].adj[0],l=AVOID_TYPE[k].adj[1],b===CELL_TYPE.grand?6>a?d[k][1].push(Math.floor(.8*(Math.floor(h*m)+2*Math.floor(g*l))/10.6)):d[k][1].push(Math.floor(.48*(Math.floor(h*m)+2*Math.floor(g*l))/10.6)):d[k][1].push(Math.floor((Math.floor(h*m)+2*Math.floor(g*l))/10.6));b=d.length;for(f=0;f<e;f++){for(g=0;g<b;g++)d[g][0].push(0);for(g=0;g<b;g++)d[g][1].push(0)}if(1>d[0][0].length)for(e=0;e<b;e++)d[e][0].push(0);if(1>d[0][1].length)for(e=0;e<b;e++)d[e][1].push(0);return d}
...
k=0,m=0;1E3>m;m++){var l=g.slot;l-=getShootDownSlotFF(e,Math.round(l));g.canAttack&&d.cellType<=CELL_TYPE.grand&&(l-=Math.floor(d.stage2[g.avoid][0][Math.floor(Math.random()*h)]*l),l-=d.stage2[g.avoid][1][Math.floor(Math.random()*h)]);k+=0<l?l:0}g.slot=k/1E3;g.ap=updateAp(g)}}$("#shoot_down_table").find(".eap.battle"+(c+1)).text(b)}
function shootDownFriend(a,b,c){for(var d=b.length,e=0;e<d;e++)for(var f=b[e],g=f.length,h=0;h<g;h++){var k=f[h];if(!(0>=k.slot||!k.canBattle||6<k.fleetNo&&1===c.cellType)){5===a&&(a=0);k.slot-=getShootDownSlotFF(a,k.slot);if(k.canAttack&&c.cellType<=CELL_TYPE.grand){var m=c.stage2[k.avoid][0].length;k.slot-=Math.floor(c.stage2[k.avoid][0][Math.floor(Math.random()*m)]*k.slot);k.slot-=c.stage2[k.avoid][1][Math.floor(Math.random()*m)]}k.ap=updateAp(k)}}}
...
function rateCalculate(a){var b=a.landBaseData,c=a.friendFleetData,d=a.battleData,e=castInt($("#calculate_count").val());$("#calculate_count").val(0===e?++e:e);var f=isDefMode?0:castInt($("#landBase_target").val())-1,g=c.concat(),h=g.length,k=d.concat();c=isDefMode?0:displayBattle-1;var m=[0,0,0,0,0,0,0],l=[0,0,0,0,0,0],n=[],q=[],p=[];a=[];for(var r=[],w=[],u=[],x=isDefMode?1:battleCount,y=chartData.own[0],t=$jscomp.makeIterator(k),v=t.next();!v.done;v=t.next())v=v.value,v.enemies=v.enemies.filter(function(a){return 0<
a.slots.length});c=c<d.length?c:d.length-1;for(d=0;6>d;d++)p.push([0,0,0,0,0,0]);b=$jscomp.makeIterator(b);for(d=b.next();!d.done;d=b.next())d=d.value,n.push(d.ap),q.push(d.mode);for(b=0;b<h;b++)for(d=0;d<g[b].length;d++)r.push(Array(e));for(b=0;b<x;b++)w.push(0);for(b=0;b<k[c].enemies.length;b++)if(d=k[c].enemies[b],!d.isSpR)for(t=0===u.length?0:u[u.length-1][0]+1,v=0;v<d.slots.length;v++)u.push([t,v,0,0,999,[]]);b=$jscomp.makeIterator(g);for(d=b.next();!d.done;d=b.next())for(d=$jscomp.makeIterator(d.value),
t=d.next();!t.done;t=d.next())t=t.value,t.slot=t.origSlot,t.ap=t.origAp;for(b=0;b<e;b++){d=$jscomp.makeIterator(k[f].enemies);for(t=d.next();!t.done;t=d.next())t=t.value,t.slots=t.orgSlots.concat(),t.ap=t.origAp,t.lbAp=t.origLbAp;calculateLandBase(n,q,k[f].enemies,m,p);for(d=0;d<x;d++){t=k[d].enemies;v=k[d].cellType;var A=isDefMode?y:getFriendFleetAP(g,v);v=getEnemyFleetAP(t);var B=getAirStatusIndex(A,v);d===c&&l[B]++;w[d]+=A;shootDownFriend(B,g,k[d]);if(d===c)for(shootDownEnemy(B,t),B=A=0;B<t.length;B++){var z=
t[B];if(!z.isSpR){for(var D=z.slots,F=0;F<D.length;F++){var E=D[F],C=u[A++];C[2]+=E;C[3]<E&&(C[3]=E);C[4]>E&&(C[4]=E);C[5].push(v)}z.slots=z.orgSlots.concat();z.ap=z.origAp;z.lbAp=z.origLbAp}}}for(d=0;d<h;d++)for(t=g[d],v=t.length,A=0;A<v;A++)r[5*d+A][b]=t[A].slot,t[A].slot=t[A].origSlot,t[A].ap=t[A].origAp}k=m.map(function(a){return Math.round(a/e)});m=castInt($("#shoot_down_table").find(".fap.battle"+(f+1)).text());n=castInt(k[6]);if(0<m||0<n)$("#shoot_down_table").find(".eap.battle"+(f+1)).text(n),
$("#shoot_down_table").find(".cond.battle"+(f+1)).text(AIR_STATUS[getAirStatusIndex(m,n)].abbr);f===c&&(a=p.concat(),chartData.enemy=k);a.push(l);f=$jscomp.makeIterator(a);for(l=f.next();!l.done;l=f.next())for(l=l.value,p=l.length,k=0;k<p;k++)l[k]/=e;isDefMode&&(chartData.enemy[0]=chartData.enemy[6],a[0]=a[6]);for(l=f=0;l<h;l++)for(p=0;p<g[l].length;p++)k=r[f++],m={shipNo:g[l][p].fleetNo,slot:g[l][p].slotNo,max:Math.max.apply({},k),min:Math.min.apply({},k),avg:k.reduce(function(a,b){return a+b})/
e,death:k.filter(function(a){return 0===a}).length,deathRate:0},m.deathRate=m.death/k.length,chartData.slots.push(m);for(g=0;g<x;g++)h=Math.round(w[g]/e),r=castInt($("#shoot_down_table").find(".eap.battle"+(g+1)).text()),r=getAirStatusIndex(h,r),$("#shoot_down_table").find(".fap.battle"+(g+1)).text(h),$("#shoot_down_table").find(".cond.battle"+(g+1)).text(AIR_STATUS[r].abbr).addClass("airStatus"+r);isDefMode||(chartData.own[chartData.own.length-1]=Math.round(w[c]/e));chartData.rate=a.concat();chartData.enSlots=
u.concat()}function calculateLandBase(a,b,c,d,e){for(var f=0;3>f;f++){var g=a[f];if(0<b[f]){var h=2*f,k=getEnemyFleetLBAP(c);d[h]+=k;k=getLBAirStatusIndex(g,k);e[h][k]++;shootDownEnemy(k,c)}2===b[f]&&(h=2*f+1,k=getEnemyFleetLBAP(c),d[h]+=k,g=getLBAirStatusIndex(g,k),e[h][g]++,shootDownEnemy(g,c))}d[6]+=isDefMode?getEnemyFleetLBAP(c):getEnemyFleetAP(c)}
...
function enemySlotDetailCalculate(a,b){setPreCalculateTable();var c=[],d=[],e=[];updateLandBaseInfo(c,!1);updateFriendFleetInfo(d,!1);updateEnemyFleetInfo(e,!1);var f=castInt($("#calculate_count").val()),g=isDefMode?0:displayBattle-1,h=isDefMode?0:castInt($("#landBase_target").val())-1,k=[],m=e[g].enemies.filter(function(a){return 0<a.slots.length&&!a.isSpR})[a],l=ENEMY_DATA.find(function(a){return a.id===m.id}),n=ENEMY_PLANE_DATA.find(function(a){return a.id===l.eqp[b]});g=g<e.length?g:e.length-
1;for(var q=2===Math.abs(n.type)?[.8,1.5]:1===Math.abs(n.type)?[0]:[1],p=2===Math.abs(n.type)?n.torpedo:n.bomber,r=$("#slot_detail").prop("checked"),w=$jscomp.makeIterator(e),u=w.next();!u.done;u=w.next())u=u.value,u.enemies=u.enemies.filter(function(a){return 0<a.slots.length});w=[];u=[];c=$jscomp.makeIterator(c);for(var x=c.next();!x.done;x=c.next())x=x.value,w.push(x.ap),u.push(x.mode);for(c=0;c<f;c++){if(h<=g){x=$jscomp.makeIterator(e[h].enemies);for(var y=x.next();!y.done;y=x.next())y=y.value,
y.slots=y.orgSlots.concat(),y.ap=y.origAp,y.lbAp=y.origLbAp;x=e[h].enemies;for(y=0;3>y;y++){var t=w[y];if(0<u[y]){var v=getEnemyFleetLBAP(x);v=getLBAirStatusIndex(t,v);shootDownEnemy(v,x)}2===u[y]&&(v=getEnemyFleetLBAP(x),t=getLBAirStatusIndex(t,v),shootDownEnemy(t,x))}}for(x=0;x<=g;x++)if(y=e[x].enemies,t=e[x].cellType,t=isDefMode?defAp:getFriendFleetAP(d,t),v=getEnemyFleetAP(y),t=getAirStatusIndex(t,v),x===g)for(shootDownEnemy(t,y),r?k.push(m.slots[b]):m.slots[b]?k.push(Math.floor(q[Math.floor(Math.random()*
q.length)]*(p*Math.sqrt(m.slots[b])+25))):k.push(0),t=0;t<y.length;t++)v=y[t],v.isSpR||(v.slots=v.orgSlots.concat(),v.ap=v.origAp,v.lbAp=v.origLbAp);else shootDownFriend(t,d,e[x]);for(x=0;x<d.length;x++)for(y=d[x],t=y.length,v=0;v<t;v++)y[v].slot=y[v].origSlot,y[v].ap=y[v].origAp}d=[];e=[];g=[];h=Math.max.apply({},k);w=Math.min.apply({},k);t=y=x=c=u=0;for(v={$jscomp$loop$prop$i$200$285:w};v.$jscomp$loop$prop$i$200$285<=h;v={$jscomp$loop$prop$i$200$285:v.$jscomp$loop$prop$i$200$285},v.$jscomp$loop$prop$i$200$285++){var A=
k.filter(function(a){return function(b){return b===a.$jscomp$loop$prop$i$200$285}}(v)).length;A&&(d.push(v.$jscomp$loop$prop$i$200$285),e.push((100*A/f).toFixed(1E5<=f?5:1E4<=f?4:1E3<=f?3:2)),t+=100*A/f,g.push(t.toFixed(1)),!u&&50<=t&&(u=v.$jscomp$loop$prop$i$200$285),!c&&90<=t&&(c=v.$jscomp$loop$prop$i$200$285),!x&&95<=t&&(x=v.$jscomp$loop$prop$i$200$285),!y&&99<=t&&(y=v.$jscomp$loop$prop$i$200$285))}$("#detail_max").text(h);$("#detail_min").text(w);$("#detail_50").text(u);$("#detail_90").text(c);
$("#detail_95").text(x);$("#detail_99").text(y);f=r?"\u6b8b\u6a5f\u6570 [\u6a5f]":"\u822a\u7a7a\u6226\u706b\u529b(\u30ad\u30e3\u30c3\u30d7\u524d\u3001\u5c0f\u6570\u5207\u6368\u3066)";chartDataSet?(chartDataSet.data.labels=d,chartDataSet.data.datasets[0].data=e,chartDataSet.data.datasets[1].data=g,chartDataSet.options.scales.xAxes[0].scaleLabel.labelString=f,chartDataSet.options.tooltips.callbacks.title=function(a,b){var c=a[0].xLabel;if(r){var d=2===q.length?Math.floor(q[1]*(p*Math.sqrt(c)+25)):0;
return"\u6b8b\u6a5f\u6570\uff1a"+c+" \u6a5f\n\u822a\u7a7a\u6226\u706b\u529b\uff1a"+(Math.floor(q[0]*(p*Math.sqrt(c)+25))+(d?" or "+d:""))}return"\u822a\u7a7a\u6226\u706b\u529b\uff1a"+c},chartDataSet.update()):(k=document.getElementById("detailChart"),chartDataSet=new Chart(k,{type:"bar",data:{labels:d,datasets:[{label:"\u78ba\u7387\u5206\u5e03",data:e,borderColor:"rgb(255, 70, 100)",backgroundColor:"rgba(255, 120, 180, 0.4)",yAxisID:"y-axis-1"},{label:"\u7d2f\u7a4d\u78ba\u7387",data:g,type:"line",
fill:!1,borderColor:"rgb(54, 162, 235)",yAxisID:"y-axis-2"}]},options:{responsive:!0,scales:{xAxes:[{scaleLabel:{display:!0,labelString:f},gridLines:{display:!1},ticks:{fontSize:10}}],yAxes:[{id:"y-axis-1",type:"linear",position:"left",scaleLabel:{display:!0,labelString:"\u78ba\u7387\u5206\u5e03 [\uff05]"},ticks:{min:0}},{id:"y-axis-2",type:"linear",position:"right",scaleLabel:{display:!0,labelString:"\u7d2f\u7a4d\u78ba\u7387 [\uff05]"},ticks:{max:100,min:0,stepSize:25}}]},tooltips:{mode:"index",
callbacks:{title:function(a,b){var c=a[0].xLabel;if(r){var d=2===q.length?Math.floor(q[1]*(p*Math.sqrt(c)+25)):0;return"\u6b8b\u6a5f\u6570\uff1a"+c+" \u6a5f\n\u822a\u7a7a\u6226\u706b\u529b\uff1a"+(Math.floor(q[0]*(p*Math.sqrt(c)+25))+(d?" or "+d:""))}return"\u822a\u7a7a\u6226\u706b\u529b\uff1a"+c},label:function(a,b){return[a.yLabel+" %"]}}}}}),$("#detail_title").data("mode","enemy_slot_detail"),$("#detail_title").data("enemy_no",a),$("#detail_title").data("slot_no",b),n='\n    <div class="d-flex">\n      <div class="align-self-center">\u6575\u8266\uff1a</div>\n      <img src="./img/enemy/'+
l.id+'.png" class="enemy_img align-self-center">\n      <div class="ml-1 align-self-center">'+l.name+'</div>\n    </div>\n    <div class="mt-1 d-flex">\n      <div class="align-self-center">\u88c5\u5099\uff1a</div>\n      <img src="./img/type/type'+n.type+'.png" class="plane_img align-self-center">\n      <div class="ml-1 align-self-center">'+n.name+" (\u642d\u8f09\uff1a"+m.slots[b]+"\u6a5f\u3000\u96f7\u88c5\uff1a"+n.torpedo+"\u3000\u7206\u88c5\uff1a"+n.bomber+")</div>\n    </div>",$("#detail_title").html(n))}
...
d||e){var g=[];f=castInt($("#dest_range").val());for(var h={},k=$jscomp.makeIterator(a),m=k.next();!m.done;h={$jscomp$loop$prop$stock$287:h.$jscomp$loop$prop$stock$287},m=k.next())if(h.$jscomp$loop$prop$stock$287=m.value,!(0>=getArraySum(h.$jscomp$loop$prop$stock$287.num)||(m=PLANE_DATA.find(function(a){return function(b){return b.id===a.$jscomp$loop$prop$stock$287.id}}(h)),m.radius<f||-101===m.type||!b&&1===Math.abs(m.type)))){var l="type"+Math.abs(FIGHTERS.includes(m.type)?1:m.type);g.hasOwnProperty(l)||
(g[l]=[]);for(var n=0;n<h.$jscomp$loop$prop$stock$287.num.length;n++)for(var q=0;q<h.$jscomp$loop$prop$stock$287.num[n];q++){var p={id:m.id,type:m.type,antiAir:m.antiAir+1.5*m.interception,torpedo:m.torpedo,bomber:m.bomber,remodel:n};p.antiAir=getBonusAA(p,p.antiAir);g[l].push(p)}}Object.keys(g).forEach(function(a){"type1"===a?g[a].sort(function(a,b){return a.antiAir===b.antiAir?b.radius-a.radius:b.antiAir-a.antiAir}):"type2"===a?g[a].sort(function(a,b){return a.torpedo===b.torpedo?b.radius-a.radius:
...
a.$jscomp$loop$prop$stock$289.id}}(f)),100<g.type))){var h="type"+Math.abs(FIGHTERS.includes(g.type)?"1":g.type);e.hasOwnProperty(h)||(e[h]=[]);for(var k=0;k<f.$jscomp$loop$prop$stock$289.num.length;k++)for(var m=0;m<f.$jscomp$loop$prop$stock$289.num[k];m++){var l={id:g.id,type:g.type,antiAir:g.antiAir+1.5*g.interception,torpedo:g.torpedo,bomber:g.bomber,avoid:g.avoid,remodel:k,stock:1};l.antiAir=getBonusAA(l,l.antiAir);e[h].push(l)}}Object.keys(e).forEach(function(a){"type1"===a?e[a].sort(function(a,
...
k={shipId:c.id,shipType:c.type,slotNo:b,num:g,plane:{id:0,ap:0},order:q++,num_:g,slotId:"ship"+a+"_slot"+b,isLock:h,lockedPlane:null};if(h){var l=PLANE_DATA.find(function(a){return a.id===castInt($(f)[0].dataset.planeid)});if(l){var n=castInt($(f).find(".remodel_value").text());k.lockedPlane={id:l.id,remodel:n};Object.keys(e).forEach(function(a){var b=e[a].findIndex(function(a){return a.id===l.id&&a.remodel===n});-1<b&&e[a].splice(b,1)})}}else 0===g&&(k.isLock=!0);[1,2,3].includes(c.type)?10>g&&(k.num_=
g-100):k.num_=g-100;d.push(k)});n=n.concat(d)}});g=[2,6];f=0;n.sort(function(a,b){return b.num_-a.num_});h=$jscomp.makeIterator(n);for(a=h.next();!a.done;a=h.next())for(k=a.value,l=!1,m=$jscomp.makeIterator(g),a=m.next();!a.done;a=m.next()){a=a.value;if(k.isLock){k.lockedPlane&&(a=getShipPlaneObject(k.num,k.lockedPlane),k.plane=a,f+=a.ap);l=!0;break}var p=k.shipType;d&&[1,2,3].includes(p)&&1===k.slotNo&&(a=3);p={};var r=$jscomp.makeIterator(e["type"+a]);for(a=r.next();!a.done;p={$jscomp$loop$prop$plane$203$291:p.$jscomp$loop$prop$plane$203$291},
a=r.next())if(p.$jscomp$loop$prop$plane$203$291=a.value,!(0>=p.$jscomp$loop$prop$plane$203$291.stock)){checkInvalidPlane(k.shipId,PLANE_DATA.find(function(a){return function(b){return b.id===a.$jscomp$loop$prop$plane$203$291.id}}(p)))&&(a=getShipPlaneObject(k.num,p.$jscomp$loop$prop$plane$203$291),k.plane=a,f+=a.ap,p.$jscomp$loop$prop$plane$203$291.stock--,l=!0);break}if(l)break}n.sort(function(a,b){return a.num_===b.num_?b.slotNo-a.slotNo:a.num_-b.num_});g=f;h=[];d=[];k=[];for(m=0;m<n.length&&!(f>=
b);m++)if(!n[m].isLock){d=[];k=[];f=$jscomp.makeIterator(e.type1);for(a=f.next();!a.done;a=f.next())a=a.value,k.push({id:a.id,remodel:a.remodel,antiAir:a.antiAir,stock:a.stock});f=g;h.push(n[m]);for(l=h.length-1;0<=l;l--){p=h[l];r=!1;var w={},u=$jscomp.makeIterator(k);for(a=u.next();!a.done;w={$jscomp$loop$prop$plane$210$293:w.$jscomp$loop$prop$plane$210$293},a=u.next())if(w.$jscomp$loop$prop$plane$210$293=a.value,!(0>=w.$jscomp$loop$prop$plane$210$293.stock)){if(checkInvalidPlane(p.shipId,PLANE_DATA.find(function(a){return function(b){return b.id===
a.$jscomp$loop$prop$plane$210$293.id}}(w)))){a=getShipPlaneObject(p.num,w.$jscomp$loop$prop$plane$210$293);var x=p.plane.ap;if(x<a.ap){d.push(a);f+=a.ap-x;w.$jscomp$loop$prop$plane$210$293.stock--;r=!0;break}}if(r)break}r||d.push(p.plane)}}b=0;f=d.length;for(a=0;a<n.length;a++)if(!n[a].isLock){if(b>=f)break;n[a].plane=d[f-1-b++]}n.sort(function(a,b){return a.order-b.order});q=0;c.each(function(a,b){$(b).find(".ship_plane:not(.d-none)").each(function(b,c){var d=n.find(function(c){return c.slotId===
...
PLANE_DATA.find(function(a){return function(b){return b.id===a.$jscomp$loop$prop$stock$299.id}}(h)),RECONNAISSANCES.includes(k.type))for(var m=10;0<=m;m--){if(!(1>h.$jscomp$loop$prop$stock$299.num[m])){var l={id:k.id,antiAir:k.antiAir,type:k.type,adjust:1,scout:k.scout,remodel:m};l.adjust=getReconnaissancesAdjust(l,!0);for(var n=0;n<h.$jscomp$loop$prop$stock$299.num[m];n++)f.push(l)}}else for(m=10;0<=m;m--)if(!(1>h.$jscomp$loop$prop$stock$299.num[m])&&(l={id:k.id,type:k.type,remodel:m,antiAir:k.antiAir+
k.interception+2*k.antiBomber,interception:k.interception,antiBomber:k.antiBomber,isRocket:0},l.antiAir=getBonusAA(l,l.antiAir),0!==l.antiAir))for(n=0;n<h.$jscomp$loop$prop$stock$299.num[m];n++)e.push(Object.assign({},l))}if(d){e.sort(function(a,b){return b.antiAir-a.antiAir});for(g=0;3>g;g++)h=e.findIndex(function(a){return 0===a.isRocket&&ROCKETS.includes(a.id)}),-1<h&&(e[h].isRocket=1);e.sort(function(a,b){return b.isRocket-a.isRocket})}else e.sort(function(a,b){return a.antiAir===b.antiAir?b.radius-
a.radius:b.antiAir-a.antiAir});f.sort(function(a,b){return b.adjust===a.adjust?b.scout-a.scout:b.adjust-a.adjust});e=e.filter(function(b,c){return c<4*a});g=[];for(h=0;h<a;h++){c={ap:0,planes:[]};for(k=0;4>k;k++)c.planes.push({id:0});g.push(c)}for(k=c=h=0;k<a;k++){m={ap:0,planes:[]};l={ap:0,planes:[]};for(n=0;4>n;n++){var q=e[n],p=getLandBasePlaneObject(q);m.planes.push(p);m.ap+=p.ap;l.planes.push(p);l.ap+=p.ap;h+=p.ap;if(d){if(ROCKETS.includes(q.id)&&c++,Math.floor((0===c?.5:1===c?.8:2===c?1.1:1.2)*
h)>=b)break}else if(h>=b)break}f.length>k&&!(3>l.planes.length&&h>=b)&&(n=getLandBasePlaneObject(f[k]),q=Math.min(l.planes.length,3),(p=l.planes[q])||(p={id:0,ap:0}),p=p.ap,l.planes[q]=n,l.ap+=n.ap-p,getUpdateLBAirPower(l));if(l.ap>=m.ap||l.ap>=b)n=m.ap,m=l,h+=l.ap-n;l=m.planes.length;if(4!==l)for(n=0;n<4-l;n++)m.planes.push({id:0,ap:0});g[k]=m;l={};m=$jscomp.makeIterator(m.planes);for(n=m.next();!n.done;l={$jscomp$loop$prop$isFirst$301:l.$jscomp$loop$prop$isFirst$301,$jscomp$loop$prop$plane$238$302:l.$jscomp$loop$prop$plane$238$302},
...
"\u4e8c\u4e8c"),d=d.replace("34","\u4e09\u56db"),d=d.replace("96","\u4e5d\u516d"),d=d.replace("97","\u4e5d\u4e03"),d=d.replace("99","\u4e5d\u4e5d"),c=c.filter(function(a){return a.name.includes(d)||a.abbr.includes(d)}));var m=$("#plane_sort_select").val();a=$("#plane_asc").prop("checked");$("#plane_asc").prop("disabled",!1);$("#plane_desc").prop("disabled",!1);switch(m){case "battle_anti_air":a?c.sort(function(a,b){return a.antiAir+1.5*a.interception-(b.antiAir+1.5*b.interception)}):c.sort(function(a,
...
btn_save_stock_Clicked);$("#modal_plane_stock").on("click","#btn_stock_reset",btn_stock_reset_Clicked);$("#modal_result_detail").on("click","#btn_calculate_detail",btn_calculate_detail);$("#modal_result_detail").on("change","#detail_calculate_count",function(){return $("#btn_calculate_detail").prop("disabled",!1)});$("#modal_result_detail").on("change",".custom-radio",btn_calculate_detail);$("#modal_collectively_setting").on("click",".btn_remove_plane_all",function(){btn_remove_plane_all_Clicked($(this))});
