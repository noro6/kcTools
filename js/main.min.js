...
c+" \u6a5f\n\u822a\u7a7a\u6226\u706b\u529b\uff1a0";var d=2===u.length?Math.floor(u[1]*(p*Math.sqrt(c)+25)):0;return"\u6b8b\u6a5f\u6570\uff1a"+c+" \u6a5f\n\u822a\u7a7a\u6226\u706b\u529b\uff1a"+(Math.floor(u[0]*(p*Math.sqrt(c)+25))+(d?" or "+d:""))}return"\u822a\u7a7a\u6226\u706b\u529b\uff1a"+c},label:function(a,b){return[a.yLabel+" %"]}}});e=$("#show_detail_slot .nav-item");e.eq(b).find(".nav-link").tab("show");if("enemy_slot_detail"!==$("#detail_info").data("mode")||$("#detail_info").data("base_no")!=
...
d="";f=0;e.addClass("d-none");g={};h=$jscomp.makeIterator(l.eqp);for(k=h.next();!k.done;g={$jscomp$loop$prop$id$349:g.$jscomp$loop$prop$id$349},k=h.next())g.$jscomp$loop$prop$id$349=k.value,k=ENEMY_PLANE_DATA.find(function(a){return function(b){return b.id===a.$jscomp$loop$prop$id$349}}(g)),e.eq(f).removeClass("d-none"),e.eq(f).data("slot_no",f),d+='\n\t\t\t<div class="row">\n\t\t\t\t<div class="col-2 align-self-center">\u88c5\u5099'+(f+1)+':</div>\n\t\t\t\t<div class="col d-flex align-self-end">\n\t\t\t\t\t<img src="./img/type/type'+
k.type+'.png" class="plane_img_sm align-self-center">\n\t\t\t\t\t<div class="align-self-end">'+k.name+'</div>\n\t\t\t\t</div>\n\t\t\t\t<div class="col font_size_12 align-self-end">\n\t\t\t\t\t(\u642d\u8f09: '+m.slots[f++]+"\u6a5f"+(k.torpedo?"\u3000\u96f7\u88c5: "+k.torpedo:"")+(k.bomber?"\u3000\u7206\u88c5: "+k.bomber:"")+")</span>\n\t\t\t\t</div>\n\t\t\t</div>";e='\n\t\t\t<img src="./img/enemy/'+l.id+'.png" class="ship_img align-self-center">\n\t\t\t<span class="ml-1 text-primary font_size_11 align-self-center">ID: '+
