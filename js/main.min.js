...
c.textContent=LAST_UPDATE_DATE;b.appendChild(c);document.getElementById("site_history_body").appendChild(b);"dark-blue"===setting.themeColor?($("#normal_theme").prop("checked",!1),$("#dark_blue_theme").prop("checked",!0),$("#dark_blue2_theme").prop("checked",!1)):"dark-blue2"===setting.themeColor?($("#normal_theme").prop("checked",!1),$("#dark_blue_theme").prop("checked",!1),$("#dark_blue2_theme").prop("checked",!0)):($("#normal_theme").prop("checked",!0),$("#dark_blue_theme").prop("checked",!1),
$("#dark_blue2_theme").prop("checked",!1));site_theme_Changed(!1);$("#site_information").find(".collapse_content").collapse("hide");$('[data-toggle="tooltip"]').tooltip();$('[data-toggle="popover"]').popover();$("#loading_info").text("\u521d\u671f\u8a08\u7b97\u4e2d");a();$("#loading_text").addClass("load_end_text");$("#loading_text").text("\u5b8c\u4e86");$("#loading_line").addClass("loading_line_expand");$("#loading_back").addClass("load_end");$("#modal_version_inform").find(".modal-body").html()&&
$("#modal_version_inform").modal("show");setTimeout(function(){$("#loading_back").remove()},1E3)}
...
function site_theme_Changed(a){a=void 0===a?!0:a;if($("#normal_theme").prop("checked")){setting.themeColor="normal";document.body.style.backgroundColor="#f0ebe6";document.body.classList.remove("body-dark");mainColor="#000000";var b=$jscomp.makeIterator(document.getElementsByClassName("contents"));for(c=b.next();!c.done;c=b.next())c=c.value,c.style.backgroundColor="#fffffff0",c.classList.remove("contents-dark");b=$jscomp.makeIterator(document.getElementsByClassName("form-control"));for(c=b.next();!c.done;c=
b.next())c.value.classList.remove("form-control-dark");b=$jscomp.makeIterator(document.getElementsByClassName("input-group-text"));for(c=b.next();!c.done;c=b.next())c.value.classList.remove("input-group-text-dark");b=$jscomp.makeIterator(document.getElementsByClassName("custom-select"));for(c=b.next();!c.done;c=b.next())c.value.classList.remove("custom-select-dark");b=$jscomp.makeIterator(document.getElementsByClassName("border-top"));for(c=b.next();!c.done;c=b.next())c.value.classList.remove("border-secondary");
...
for(c=b.next();!c.done;c=b.next())c.value.classList.remove("dropdown-header-dark")}else{$("#dark_blue_theme").prop("checked")&&(setting.themeColor="dark-blue",document.body.classList.remove("body-dark"),document.body.style.backgroundColor="#20222d");$("#dark_blue2_theme").prop("checked")&&(setting.themeColor="dark-blue2",document.body.classList.add("body-dark"));mainColor="#e0e0e0";b=$jscomp.makeIterator(document.getElementsByClassName("contents"));for(var c=b.next();!c.done;c=b.next())c=c.value,
c.style.backgroundColor="#ffffff0c",c.classList.add("contents-dark");b=$jscomp.makeIterator(document.getElementsByClassName("form-control"));for(c=b.next();!c.done;c=b.next())c.value.classList.add("form-control-dark");b=$jscomp.makeIterator(document.getElementsByClassName("input-group-text"));for(c=b.next();!c.done;c=b.next())c.value.classList.add("input-group-text-dark");b=$jscomp.makeIterator(document.getElementsByClassName("custom-select"));for(c=b.next();!c.done;c=b.next())c.value.classList.add("custom-select-dark");
...
for(c=b.next();!c.done;c=b.next())c.value.classList.add("border-secondary");b=$jscomp.makeIterator(document.getElementsByClassName("modal-content"));for(c=b.next();!c.done;c=b.next())c.value.classList.add("modal-content-dark");b=$jscomp.makeIterator(document.getElementsByClassName("modal-header"));for(c=b.next();!c.done;c=b.next())c.value.classList.add("modal-header-dark");b=$jscomp.makeIterator(document.getElementsByClassName("modal-footer"));for(c=b.next();!c.done;c=b.next())c.value.classList.add("modal-footer-dark");
